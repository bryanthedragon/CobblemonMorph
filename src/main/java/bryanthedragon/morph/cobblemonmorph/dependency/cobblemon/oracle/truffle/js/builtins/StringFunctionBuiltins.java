...
extends JSBuiltinsContainer.SwitchEnum<StringFunction> {
    ...
    extends JSBuiltinNode {
        ...
        protected Object fromCodePoint(Object[] args, @Cached JSToNumberNode toNumberNode, @Cached TruffleString.FromCodePointNode fromCodePointNode, @Cached TruffleString.ConcatNode concatNode) {
            ...
            for (Object arg : args) {
                Number value2 = toNumberNode.executeNumber(arg);
                double valueDouble = JSRuntime.doubleValue(value2);
                int valueInt = JSRuntime.intValue(value2);
                if (JSRuntime.isNegativeZero(valueDouble)) {
                    ...
                    JSFromCodePointNode.throwRangeError(value2);
                }
        ...
        private static void throwRangeError(Number value2) {
            throw Errors.createRangeError("Invalid code point " + value2);
        }
    }
