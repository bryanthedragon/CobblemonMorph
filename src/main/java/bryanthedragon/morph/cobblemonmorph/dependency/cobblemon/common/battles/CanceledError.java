...
implements BattleStartError {
    ...
    public MutableComponent getMessageFor(@NotNull Entity entity2) {
        ...
        MutableComponent mutableComponent = this.reason;
        if (mutableComponent == null) {
            mutableComponent = LocalizationUtilsKt.battleLang("error.canceled", new Object[0]);
        }
