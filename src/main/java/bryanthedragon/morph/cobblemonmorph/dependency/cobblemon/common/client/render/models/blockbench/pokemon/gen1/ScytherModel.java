...
public class ScytherModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = ScytherModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            this,
            "standing",
            SetsKt.minus(SetsKt.plus(var12, var10002), PoseType.HOVER),
            null,
            0,
            null,
            null,
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "scyther", "ground_idle", null, 4, null)
            },
            null,
      ...
      this.setHover(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "scyther", "air_idle", null, 4, null),
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: ScytherModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
