...
public final class JSProxyObject extends JSClassObject {
   ...
   public void revoke(boolean isCallable, boolean isConstructor) {
      ...
      this.proxyTarget = JSProxyObject.RevokedTarget.lookup(isCallable, isConstructor);
   }
   ...
   public static final class RevokedTarget implements TruffleObject {
      ...
      static final Object[] REVOKED_TARGET = new Object[]{
         Null.instance, new JSProxyObject.RevokedTarget(true, false), new JSProxyObject.RevokedTarget(false, true), new JSProxyObject.RevokedTarget(true, true)
      };
