...
public class TemporalDurationPrototypeBuiltins extends JSBuiltinsContainer.SwitchEnum<TemporalDurationPrototypeBuiltins.TemporalDurationPrototype> {
   ...
   protected TemporalDurationPrototypeBuiltins() {
      super(JSTemporalDuration.PROTOTYPE_NAME, TemporalDurationPrototypeBuiltins.TemporalDurationPrototype.class);
   }

   protected Object createNode(
      JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, TemporalDurationPrototypeBuiltins.TemporalDurationPrototype builtinEnum
   ) {
      switch (builtinEnum) {
         case years:
         case months:
         ...
         case sign:
         case blank:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationGetterNodeGen.create(
               context, builtin, builtinEnum, args().withThis().createArgumentNodes(context)
            );
         case with:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationWithNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case negated:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationNegatedNodeGen.create(
               context, builtin, args().withThis().createArgumentNodes(context)
            );
         case abs:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationAbsNodeGen.create(
               context, builtin, args().withThis().createArgumentNodes(context)
            );
         case add:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationAddNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case subtract:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationSubtractNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case round:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationRoundNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case total:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationTotalNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case toJSON:
         case toLocaleString:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationToLocaleStringNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case toString:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationToStringNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case valueOf:
            return TemporalDurationPrototypeBuiltinsFactory.JSTemporalDurationValueOfNodeGen.create(
               context, builtin, args().withThis().createArgumentNodes(context)
            );
         default:
            return null;
   ...
   public abstract static class DurationOperation extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      ...
      protected JSTemporalDurationObject addDurationToOrSubtractDurationFromDuration(
         ...
         JSTemporalDurationRecord result = durationAddNode.execute(
            duration.getYears(),
            duration.getMonths(),
            duration.getWeeks(),
            duration.getDays(),
            ...
            sign * otherDuration.getYears(),
            sign * otherDuration.getMonths(),
            sign * otherDuration.getWeeks(),
            sign * otherDuration.getDays(),
            sign * otherDuration.getHours(),
            sign * otherDuration.getMinutes(),
            sign * otherDuration.getSeconds(),
            sign * otherDuration.getMilliseconds(),
            sign * otherDuration.getMicroseconds(),
            sign * otherDuration.getNanoseconds(),
            relativeTo
         );
   ...
   public abstract static class JSTemporalDurationAbs extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      ...
      protected JSDynamicObject abs(Object thisObj) {
         ...
         return JSTemporalDuration.createTemporalDuration(
            this.getContext(),
            Math.abs(duration.getYears()),
            Math.abs(duration.getMonths()),
            Math.abs(duration.getWeeks()),
            Math.abs(duration.getDays()),
            Math.abs(duration.getHours()),
            Math.abs(duration.getMinutes()),
            Math.abs(duration.getSeconds()),
            Math.abs(duration.getMilliseconds()),
            Math.abs(duration.getMicroseconds()),
            Math.abs(duration.getNanoseconds()),
            this.errorBranch
         );
      }
   }

   public abstract static class JSTemporalDurationAdd extends TemporalDurationPrototypeBuiltins.DurationOperation {
      ...
      protected JSDynamicObject add(
         ...
         JSTemporalDurationObject duration = this.requireTemporalDuration(thisObj);
         return this.addDurationToOrSubtractDurationFromDuration(
            1, duration, other, options, durationAddNode, toRelativeTemporalObjectNode, toLimitedTemporalDurationNode
         );
      }
   }

   public abstract static class JSTemporalDurationGetterNode extends JSBuiltinNode {
      public final TemporalDurationPrototypeBuiltins.TemporalDurationPrototype property;

      public JSTemporalDurationGetterNode(JSContext context, JSBuiltin builtin, TemporalDurationPrototypeBuiltins.TemporalDurationPrototype property) {
         super(context, builtin);
      ...
      protected Object durationGetter(Object thisObj) {
         ...
         switch (this.property) {
            ...
            case sign:
               return TemporalUtil.durationSign(
                  temporalD.getYears(),
                  temporalD.getMonths(),
                  temporalD.getWeeks(),
                  temporalD.getDays(),
                  temporalD.getHours(),
                  temporalD.getMinutes(),
                  temporalD.getSeconds(),
                  temporalD.getMilliseconds(),
                  temporalD.getMicroseconds(),
                  temporalD.getNanoseconds()
               );
            case blank:
   ...
   public abstract static class JSTemporalDurationNegated extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalDurationRound extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      ...
      protected JSDynamicObject round(
         ...
         if (roundToParam == Undefined.instance) {
            ...
            TemporalUtil.Unit defaultLargestUnit = TemporalUtil.defaultTemporalLargestUnit(
               duration.getYears(),
               duration.getMonths(),
               duration.getWeeks(),
               duration.getDays(),
            ...
            if (!smallestUnitPresent && !largestUnitPresent) {
               ...
               JSTemporalDurationRecord unbalanceResult = unbalanceDurationRelativeNode.execute(
                  duration.getYears(), duration.getMonths(), duration.getWeeks(), duration.getDays(), largestUnit, relativeTo
               );
               ...
               JSTemporalDurationRecord balanceResult = balanceDurationRelativeNode.execute(
                  adjustResult.getYears(), adjustResult.getMonths(), adjustResult.getWeeks(), adjustResult.getDays(), largestUnit, relativeTo
               );
               if (realtiveToIsZonedDateTime.profile(TemporalUtil.isTemporalZonedDateTime(relativeTo))) {
                  relativeTo = TemporalUtil.moveRelativeZonedDateTime(
                     this.getContext(),
                     relativeTo,
                     TemporalUtil.dtol(balanceResult.getYears()),
                     TemporalUtil.dtol(balanceResult.getMonths()),
                     TemporalUtil.dtol(balanceResult.getWeeks()),
                     0L
                  );
               }
               ...
               JSTemporalDurationRecord result = TemporalUtil.balanceDuration(
                  ...
                  adjustResult.getHours(),
                  adjustResult.getMinutes(),
                  adjustResult.getSeconds(),
                  adjustResult.getMilliseconds(),
                  adjustResult.getMicroseconds(),
                  toBigInt.executeBigInt(adjustResult.getNanoseconds()).bigIntegerValue(),
                  largestUnit,
                  relativeTo
               );
               return JSTemporalDuration.createTemporalDuration(
                  this.getContext(),
                  balanceResult.getYears(),
                  balanceResult.getMonths(),
                  balanceResult.getWeeks(),
                  result.getDays(),
                  result.getHours(),
                  result.getMinutes(),
                  result.getSeconds(),
   ...
   public abstract static class JSTemporalDurationSubtract extends TemporalDurationPrototypeBuiltins.DurationOperation {
   ...
   public abstract static class JSTemporalDurationToLocaleString extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      ...
      protected TruffleString toString(Object thisObj, @Cached JSNumberToBigIntNode toBigIntNode) {
         ...
         return JSTemporalDuration.temporalDurationToString(
            TemporalUtil.dtol(duration.getYears()),
            TemporalUtil.dtol(duration.getMonths()),
            TemporalUtil.dtol(duration.getWeeks()),
            TemporalUtil.dtol(duration.getDays()),
            TemporalUtil.dtol(duration.getHours()),
            TemporalUtil.dtol(duration.getMinutes()),
            TemporalUtil.dtol(duration.getSeconds()),
            TemporalUtil.dtol(duration.getMilliseconds()),
            TemporalUtil.dtol(duration.getMicroseconds()),
            TemporalUtil.dtol(duration.getNanoseconds()),
   ...
   public abstract static class JSTemporalDurationToString extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      ...
      protected TruffleString toString(
         ...
         if (precision.getUnit() == TemporalUtil.Unit.MINUTE) {
            ...
            JSTemporalDurationRecord result = roundDurationNode.execute(
               dur.getYears(),
               dur.getMonths(),
               dur.getWeeks(),
               dur.getDays(),
   ...
   public abstract static class JSTemporalDurationTotal extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
         ...
         if (totalOfParam == Undefined.instance) {
            ...
            if (TemporalUtil.isTemporalZonedDateTime(relativeTo)) {
               intermediate = TemporalUtil.moveRelativeZonedDateTime(
                  this.getContext(),
                  relativeTo,
                  TemporalUtil.dtol(unbalanceResult.getYears()),
                  TemporalUtil.dtol(unbalanceResult.getMonths()),
                  TemporalUtil.dtol(unbalanceResult.getWeeks()),
                  0L
               );
            }
            ...
            JSTemporalDurationRecord balanceResult = TemporalUtil.balanceDuration(
               ...
               duration.getMilliseconds(),
               duration.getMicroseconds(),
               toBigIntNode.executeBigInt(duration.getNanoseconds()).bigIntegerValue(),
               unit,
               intermediate
            );
            JSTemporalDurationRecord roundResult = roundDurationNode.execute(
               ...
               1.0,
               unit,
               TemporalUtil.RoundingMode.TRUNC,
               relativeTo
            );
            double whole = 0.0;
   ...
   public abstract static class JSTemporalDurationValueOf extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalDurationWith extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      protected JSTemporalDurationWith(JSContext context, JSBuiltin builtin) {
         super(context, builtin);
      }

      @Specialization
      protected JSDynamicObject with(Object thisObj, Object temporalDurationLike, @Cached("create()") JSToIntegerWithoutRoundingNode toInt) {
         JSTemporalDurationObject duration = this.requireTemporalDuration(thisObj);
         ...
         return JSTemporalDuration.createTemporalDuration(
            this.getContext(), years, months, weeks, days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, this.errorBranch
         );
      }
   }

   public static enum TemporalDurationPrototype implements BuiltinEnum<TemporalDurationPrototypeBuiltins.TemporalDurationPrototype> {
      years(0),
      months(0),
      weeks(0),
      days(0),
