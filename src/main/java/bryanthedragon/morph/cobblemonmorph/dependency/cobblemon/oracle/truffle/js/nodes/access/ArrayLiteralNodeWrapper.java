...
final class ArrayLiteralNodeWrapper extends ArrayLiteralNode implements InstrumentableNode.WrapperNode {
   @Node.Child
   ...
   public void executeVoid(VirtualFrame frame) {
      while (true) {
         ...
         try {
            ...
            Object result = this.probeNode.onReturnExceptionalOrUnwind(frame, var5, wasOnReturnExecuted);
            if (result == ProbeNode.UNWIND_ACTION_REENTER) {
               continue;
            }
