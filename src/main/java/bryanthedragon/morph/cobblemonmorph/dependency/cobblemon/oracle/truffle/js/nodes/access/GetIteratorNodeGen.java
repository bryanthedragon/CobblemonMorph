...
public final class GetIteratorNodeGen extends GetIteratorNode implements Introspection.Provider {
   ...
   @Node.Child
   private GetIteratorNodeGen.GetIteratorData getIterator_cache;
   ...
   public IteratorRecord execute(Object objectNodeValue) {
      ...
      if (state_0 != 0) {
         GetIteratorNodeGen.GetIteratorData s0_ = this.getIterator_cache;
         if (s0_ != null) {
   ...
   private IteratorRecord executeAndSpecialize(Object objectNodeValue) {
      ...
      try {
         int state_0 = this.state_0_;
         GetIteratorNodeGen.GetIteratorData s0_ = super.insert(new GetIteratorNodeGen.GetIteratorData());
