...
final class HostAdapterSuperMembersGen {
   ...
   static {
      LibraryExport.register(HostAdapterSuperMembers.class, new HostAdapterSuperMembersGen.InteropLibraryExports());
   }
   ...
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         InteropLibrary uncached = new HostAdapterSuperMembersGen.InteropLibraryExports.Uncached();
         return uncached;
      }
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return new HostAdapterSuperMembersGen.InteropLibraryExports.Cached(receiver);
      }
      ...
      private static final class Cached extends InteropLibrary {
         ...
         protected Cached(Object receiver) {
            ...
            this.receiverAdapterInteropLibrary_ = super.insert(HostAdapterSuperMembersGen.INTEROP_LIBRARY_.create(castReceiver.adapter));
         }

         @Override
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof HostAdapterSuperMembers)
               || HostAdapterSuperMembersGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";

            return !(receiver instanceof HostAdapterSuperMembers)
               ? false
               : this.receiverAdapterInteropLibrary_.accepts(((HostAdapterSuperMembers)receiver).adapter);
         }
         ...
         private Object readMemberNode_AndSpecialize(HostAdapterSuperMembers arg0Value, String arg1Value) throws UnsupportedMessageException, UnknownIdentifierException {
            ...
            try {
               ...
               lock.unlock();
               hasLock = false;
               var7 = arg0Value.readMember(arg1Value, this.cache, readMemberNode__readMember_interop__);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
         ...
         private Object invokeMemberNode_AndSpecialize(HostAdapterSuperMembers arg0Value, String arg1Value, Object[] arg2Value) throws UnsupportedMessageException, ArityException, UnknownIdentifierException, UnsupportedTypeException {
            ...
            try {
               ...
               lock.unlock();
               hasLock = false;
               var8 = arg0Value.invokeMember(arg1Value, arg2Value, this.cache, invokeMemberNode__invokeMember_interop__);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
         ...
         private boolean isMemberReadableNode_AndSpecialize(HostAdapterSuperMembers arg0Value, String arg1Value) {
            ...
            try {
               ...
               lock.unlock();
               hasLock = false;
               var7 = arg0Value.isMemberReadable(arg1Value, this.cache, isMemberReadableNode__isMemberReadable_interop__);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
         ...
         private boolean isMemberInvocableNode_AndSpecialize(HostAdapterSuperMembers arg0Value, String arg1Value) {
            ...
            try {
               ...
               lock.unlock();
               hasLock = false;
               var7 = arg0Value.isMemberInvocable(arg1Value, this.cache, isMemberInvocableNode__isMemberInvocable_interop__);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
      ...
      private static final class Uncached extends InteropLibrary {
         ...
         public Object readMember(Object arg0Value_, String arg1Value) throws UnsupportedMessageException, UnknownIdentifierException {
            ...
            return arg0Value.readMember(
               arg1Value, HostAdapterSuperMembers.NameCache.getUncached(), HostAdapterSuperMembersGen.INTEROP_LIBRARY_.getUncached(arg0Value.adapter)
            );
         }
         ...
         public Object invokeMember(Object arg0Value_, String arg1Value, Object... arg2Value) throws UnsupportedMessageException, ArityException, UnknownIdentifierException, UnsupportedTypeException {
            ...
            return arg0Value.invokeMember(
               arg1Value,
               arg2Value,
               HostAdapterSuperMembers.NameCache.getUncached(),
               HostAdapterSuperMembersGen.INTEROP_LIBRARY_.getUncached(arg0Value.adapter)
            );
         }
         ...
         public boolean isMemberInvocable(Object arg0Value_, String arg1Value) {
            ...
            HostAdapterSuperMembers arg0Value = (HostAdapterSuperMembers)arg0Value_;
            return arg0Value.isMemberInvocable(
               arg1Value, HostAdapterSuperMembers.NameCache.getUncached(), HostAdapterSuperMembersGen.INTEROP_LIBRARY_.getUncached(arg0Value.adapter)
            );
         }
