...
import com.cobblemon.mod.relocations.ibm.icu.impl.RBBIDataWrapper;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.BurmeseBreakEngine;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.CjkBreakEngine;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.DictionaryBreakEngine;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.KhmerBreakEngine;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.LSTMBreakEngine;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.LanguageBreakEngine;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.LaoBreakEngine;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.ThaiBreakEngine;
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.UnhandledBreakEngine;
...
public class RuleBasedBreakIterator extends BreakIterator {
   ...
   private RuleBasedBreakIterator.BreakCache fBreakCache = new RuleBasedBreakIterator.BreakCache();
   private boolean fPhraseBreaking = false;
   private int fDictionaryCharCount;
   private RuleBasedBreakIterator.DictionaryCache fDictionaryCache = new RuleBasedBreakIterator.DictionaryCache();
         ...
         try {
            ...
            if (this.fRData == other.fRData || this.fRData != null && other.fRData != null) {
               if (this.fRData != null && other.fRData != null && !this.fRData.fRuleSource.equals(other.fRData.fRuleSource)) {
                  ...
                  return this.fText != null && other.fText != null && this.fText.equals(other.fText) ? this.fPosition == other.fPosition : false;
               }
            } else {
               return false;
            }
   ...
   public int getRuleStatus() {
      ...
      return this.fRData.fStatusTable[idx];
   }
   ...
   private LanguageBreakEngine getLanguageBreakEngine(int c) {
      ...
      synchronized (gAllBreakEngines) {
         for (LanguageBreakEngine candidatex : gAllBreakEngines) {
            if (candidatex.handles(c)) {
               this.fBreakEngines.add(candidatex);
               return candidatex;
            }
         }
               ...
               if (backupPos > aBoundary) {
                  ...
                  if (aBoundary == backupPos + 1
                     || aBoundary == backupPos + 2
                        && Character.isHighSurrogate(RuleBasedBreakIterator.this.fText.setIndex(backupPos))
                        && Character.isLowSurrogate(RuleBasedBreakIterator.this.fText.next())) {
                     aBoundary = RuleBasedBreakIterator.this.handleNext();
                  }
               }
                  ...
                  if (backupPosition != -1 && backupPosition != textBegin) {
                     ...
                     if (position == backupPosition + 1
                        || position == backupPosition + 2
                           && Character.isHighSurrogate(RuleBasedBreakIterator.this.fText.setIndex(backupPosition))
                           && Character.isLowSurrogate(RuleBasedBreakIterator.this.fText.next())) {
                        position = RuleBasedBreakIterator.this.handleNext();
                     }
         ...
         if (endPos - startPos > 1) {
            ...
            while (true) {
               ...
               while ((current = RuleBasedBreakIterator.this.fText.getIndex()) >= rangeEnd || category >= dictStart) {
                  ...
                  if (lbe != null) {
                     foundBreakCount += lbe.findBreaks(
                        RuleBasedBreakIterator.this.fText, rangeStart, rangeEnd, this.fBreaks, RuleBasedBreakIterator.this.fPhraseBreaking
                     );
                  }
