 ...
 */final class CaughtCount : PokedexValueCalculator<Int>, GlobalPokedexValueCalculator<Int> {
 ...
 */final class SeenCount : PokedexValueCalculator<Int>, GlobalPokedexValueCalculator<Int> {
    override val outputIsPercentage = false
    override fun calculate(dexManager: AbstractPokedexManager): Int {
 ...
 */final class SeenPercent : PokedexValueCalculator<Float>, GlobalPokedexValueCalculator<Float> {
 ...
 */final class CaughtPercent : PokedexValueCalculator<Float>, GlobalPokedexValueCalculator<Float> {
    override val outputIsPercentage = true
