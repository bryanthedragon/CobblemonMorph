...
public
public class EnergyRootBlock(settings: Properties) : RootBlock(settings) {

    override fun getShape(BlockState state, BlockGetter world, (BlockPos pos, context: CollisionContext): VoxelShape = AABB
