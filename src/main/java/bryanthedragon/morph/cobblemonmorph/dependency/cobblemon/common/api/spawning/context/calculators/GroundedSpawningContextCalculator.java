...
public object GroundedSpawningContextCalculator : FlooredSpawningContextCalculator<GroundedSpawningContext> {
   public open val baseCondition: (BlockState) -> Boolean = SpawningContextCalculator.Companion.isSolidCondition()
   public open val name: String = "grounded"
   public open val surroundingCondition: (BlockState) -> Boolean = SpawningContextCalculator.Companion.isAirCondition()

   public open fun calculate(input: AreaSpawningInput): GroundedSpawningContext {
      ...
      return new GroundedSpawningContext(var2, var3, var4, var5, var6, var7, var8, var9, var11, var10);
   }
