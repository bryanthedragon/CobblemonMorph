...
public class LocalizedNumberFormatterAsFormat extends Format {
   ...
   public boolean equals(Object other) {
      if (this == other) {
         ...
         return !(other instanceof LocalizedNumberFormatterAsFormat)
            ? false
            : this.formatter.equals(((LocalizedNumberFormatterAsFormat)other).getNumberFormatter());
      }
   }

   private Object writeReplace() throws ObjectStreamException {
      LocalizedNumberFormatterAsFormat.Proxy proxy = new LocalizedNumberFormatterAsFormat.Proxy();
