...
@GeneratedBy(RegexObject.RegexObjectExecUTF8Method.class)
final class RegexObjectExecUTF8MethodGen {
   private RegexObjectExecUTF8MethodGen() {
   }

   static {
      LibraryExport.register(RegexObject.RegexObjectExecUTF8Method.class, new RegexObjectExecUTF8MethodGen.InteropLibraryExports());
   }
   ...
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         InteropLibrary uncached = new RegexObjectExecUTF8MethodGen.InteropLibraryExports.Uncached(receiver);
         return uncached;
      }
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return new RegexObjectExecUTF8MethodGen.InteropLibraryExports.Cached(receiver);
      }
      ...
      private static final class Cached extends AbstractRegexObjectGen.InteropLibraryExports.Cached {
         ...
         @Node.Child
         private RegexObjectExecUTF8MethodGen.InteropLibraryExports.Cached.ExecuteData execute_cache;
         ...
         public Object execute(Object arg0Value_, Object... arg1Value) throws UnsupportedTypeException, ArityException, UnsupportedMessageException {
            ...
            if (state_0 != 0) {
               RegexObjectExecUTF8MethodGen.InteropLibraryExports.Cached.ExecuteData s0_ = this.execute_cache;
               if (s0_ != null) {
         ...
         private Object executeAndSpecialize(RegexObject.RegexObjectExecUTF8Method arg0Value, Object[] arg1Value) throws ArityException, UnsupportedTypeException, UnsupportedMessageException {
            ...
            try {
               int state_0 = this.state_0_;
               RegexObjectExecUTF8MethodGen.InteropLibraryExports.Cached.ExecuteData s0_ = super.insert(
                  new RegexObjectExecUTF8MethodGen.InteropLibraryExports.Cached.ExecuteData()
               );
               ...
               lock.unlock();
               hasLock = false;
               var7 = arg0Value.execute(arg1Value, s0_.expectByteArrayHostObjectNode_, s0_.toLongNode_, s0_.execNode_);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
