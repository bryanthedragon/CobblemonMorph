...
import com.cobblemon.mod.relocations.ibm.icu.impl.ResourceBundleWrapper;
...
public abstract class UResourceBundle extends ResourceBundle {
   private static Map<String, UResourceBundle.RootType> ROOT_CACHE = new ConcurrentHashMap<>();
   ...
   public static UResourceBundle getBundleInstance(ULocale locale) {
      ...
      return getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", locale.getBaseName(), ICUResourceBundle.ICU_DATA_CLASS_LOADER, false);
   }
   ...
   private static UResourceBundle.RootType getRootType(String baseName, ClassLoader root) {
      UResourceBundle.RootType rootType = ROOT_CACHE.get(baseName);
      if (rootType == null) {
   ...
   private static void setRootType(String baseName, UResourceBundle.RootType rootType) {
      ROOT_CACHE.put(baseName, rootType);
   }
   ...
   protected static UResourceBundle instantiateBundle(String baseName, String localeName, ClassLoader root, boolean disableFallback) {
      UResourceBundle.RootType rootType = getRootType(baseName, root);
      switch (rootType) {
         case ICU:
      ...
      if (obj == null) {
         ...
         if (obj == null) {
            throw new MissingResourceException(
               "Can't find resource for bundle " + this.getClass().getName() + ", key " + this.getKey(), this.getClass().getName(), this.getKey()
            );
         }
      }
   ...
   private Object resolveObject(String aKey, UResourceBundle requested) {
      if (this.getType() == 0) {
         ...
         if (obj == null) {
            ...
            try {
               return obj.getType() == 8 ? obj.handleGetStringArray() : obj;
