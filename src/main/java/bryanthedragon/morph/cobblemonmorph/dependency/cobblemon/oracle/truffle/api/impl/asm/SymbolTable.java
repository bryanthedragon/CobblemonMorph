...
final class SymbolTable {
    ...
    Symbol addConstant(Object value2) {
        if (value2 instanceof Integer) {
            return this.addConstantInteger((Integer)value2);
        }
        if (value2 instanceof Byte) {
            return this.addConstantInteger(((Byte)value2).intValue());
        }
        if (value2 instanceof Character) {
            return this.addConstantInteger(((Character)value2).charValue());
        }
        if (value2 instanceof Short) {
            return this.addConstantInteger(((Short)value2).intValue());
        }
        if (value2 instanceof Boolean) {
            return this.addConstantInteger((Boolean)value2 != false ? 1 : 0);
        }
        if (value2 instanceof Float) {
            return this.addConstantFloat(((Float)value2).floatValue());
        }
        if (value2 instanceof Long) {
            return this.addConstantLong((Long)value2);
        }
        if (value2 instanceof Double) {
            return this.addConstantDouble((Double)value2);
        }
        if (value2 instanceof String) {
            return this.addConstantString((String)value2);
        }
        ...
        if (value2 instanceof Handle) {
            Handle handle2 = (Handle)value2;
            return this.addConstantMethodHandle(handle2.getTag(), handle2.getOwner(), handle2.getName(), handle2.getDesc(), handle2.isInterface());
        }
        ...
        throw new IllegalArgumentException("value " + value2);
    }

    Symbol addConstantClass(String value2) {
        return this.addConstantUtf8Reference(7, value2);
    }
    ...
    Symbol addConstantString(String value2) {
        return this.addConstantUtf8Reference(8, value2);
    }

    Symbol addConstantInteger(int value2) {
        return this.addConstantIntegerOrFloat(3, value2);
    }

    Symbol addConstantFloat(float value2) {
        return this.addConstantIntegerOrFloat(4, Float.floatToRawIntBits(value2));
    }

    private Symbol addConstantIntegerOrFloat(int tag, int value2) {
        int hashCode = SymbolTable.hash(tag, value2);
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == tag && entry.hashCode == hashCode && entry.data == (long)value2) {
                return entry;
            }
            entry = entry.next;
        }
        this.constantPool.putByte(tag).putInt(value2);
        return this.put(new Entry(this.constantPoolCount++, tag, value2, hashCode));
    }

    private void addConstantIntegerOrFloat(int index, int tag, int value2) {
        this.add(new Entry(index, tag, value2, SymbolTable.hash(tag, value2)));
    }

    Symbol addConstantLong(long value2) {
        return this.addConstantLongOrDouble(5, value2);
    }

    Symbol addConstantDouble(double value2) {
        return this.addConstantLongOrDouble(6, Double.doubleToRawLongBits(value2));
    }

    private Symbol addConstantLongOrDouble(int tag, long value2) {
        int hashCode = SymbolTable.hash(tag, value2);
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == tag && entry.hashCode == hashCode && entry.data == value2) {
                return entry;
            }
            entry = entry.next;
        }
        int index = this.constantPoolCount;
        this.constantPool.putByte(tag).putLong(value2);
        this.constantPoolCount += 2;
        return this.put(new Entry(index, tag, value2, hashCode));
    }

    private void addConstantLongOrDouble(int index, int tag, long value2) {
        this.add(new Entry(index, tag, value2, SymbolTable.hash(tag, value2)));
    }
    ...
    int addConstantUtf8(String value2) {
        int hashCode = SymbolTable.hash(1, value2);
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == 1 && entry.hashCode == hashCode && entry.value.equals(value2)) {
                return entry.index;
            }
            entry = entry.next;
        }
        this.constantPool.putByte(1).putUTF8(value2);
        return this.put((Entry)new Entry((int)this.constantPoolCount++, (int)1, (String)value2, (int)hashCode)).index;
    }

    private void addConstantUtf8(int index, String value2) {
        this.add(new Entry(index, 1, value2, SymbolTable.hash(1, value2)));
    }
    ...
    private Symbol addConstantUtf8Reference(int tag, String value2) {
        int hashCode = SymbolTable.hash(tag, value2);
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == tag && entry.hashCode == hashCode && entry.value.equals(value2)) {
                return entry;
            }
            entry = entry.next;
        }
        this.constantPool.put12(tag, this.addConstantUtf8(value2));
        return this.put(new Entry(this.constantPoolCount++, tag, value2, hashCode));
    }

    private void addConstantUtf8Reference(int index, int tag, String value2) {
        this.add(new Entry(index, tag, value2, SymbolTable.hash(tag, value2)));
    }
    ...
    int addType(String value2) {
        int hashCode = SymbolTable.hash(128, value2);
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == 128 && entry.hashCode == hashCode && entry.value.equals(value2)) {
                return entry.index;
            }
            entry = entry.next;
        }
        return this.addTypeInternal(new Entry(this.typeCount, 128, value2, hashCode));
    }

    int addUninitializedType(String value2, int bytecodeOffset) {
        int hashCode = SymbolTable.hash(129, value2, bytecodeOffset);
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == 129 && entry.hashCode == hashCode && entry.data == (long)bytecodeOffset && entry.value.equals(value2)) {
                return entry.index;
            }
            entry = entry.next;
        }
        return this.addTypeInternal(new Entry(this.typeCount, 129, value2, bytecodeOffset, hashCode));
    }
    ...
    private static int hash(int tag, int value2) {
        return Integer.MAX_VALUE & tag + value2;
    }

    private static int hash(int tag, long value2) {
        return Integer.MAX_VALUE & tag + (int)value2 + (int)(value2 >>> 32);
    }

    private static int hash(int tag, String value2) {
        return Integer.MAX_VALUE & tag + value2.hashCode();
    }
    ...
    extends Symbol {
        ...
        Entry(int index, int tag, String owner, String name, String value2, long data, int hashCode) {
            super(index, tag, owner, name, value2, data);
            this.hashCode = hashCode;
        }

        Entry(int index, int tag, String value2, int hashCode) {
            super(index, tag, null, null, value2, 0L);
            this.hashCode = hashCode;
        }

        Entry(int index, int tag, String value2, long data, int hashCode) {
            super(index, tag, null, null, value2, data);
            this.hashCode = hashCode;
        }

        Entry(int index, int tag, String name, String value2, int hashCode) {
            super(index, tag, null, name, value2, 0L);
            this.hashCode = hashCode;
        }
