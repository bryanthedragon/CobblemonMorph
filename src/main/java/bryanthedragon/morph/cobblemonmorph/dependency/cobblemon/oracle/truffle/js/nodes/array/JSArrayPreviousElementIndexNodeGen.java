    ...
    public long executeLong(Object arg0Value, long arg1Value, boolean arg2Value) {
        ...
        if (state_0 != 0) {
            if ((state_0 & 0x3F) != 0 && arg0Value instanceof JSDynamicObject) {
                PreviousWithHolesUncachedData s3_;
                ...
                if ((state_0 & 8) != 0 && (s3_ = this.previousWithHolesUncached_cache) != null && arg2Value && (this.hasPrototypeElements(arg0Value_) || JSArrayElementIndexNode.hasHoles(arg0Value_))) {
                ...
                if ((exclude & 2) == 0 && arg2Value && !this.hasPrototypeElements(arg0Value_)) {
                    ...
                    if (s2_ == null) {
                        ...
                        if (JSArrayElementIndexNode.getArrayType(arg0Value_) == cachedArrayType__1 && cachedArrayType__1.hasHoles(arg0Value_) && count2_ < 4) {
                            s2_ = super.insert(new PreviousWithHolesCachedData(this.previousWithHolesCached_cache));
                    ...
                    if (s2_ != null) {
                        lock.unlock();
                        hasLock = false;
                        long l = this.previousWithHolesCached(arg0Value_, arg1Value, arg2Value, s2_.cachedArrayType_, s2_.previousElementIndexNode_, s2_.isMinusOne_);
                        return l;
                    }
                }
                if (arg2Value && (this.hasPrototypeElements(arg0Value_) || JSArrayElementIndexNode.hasHoles(arg0Value_))) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    long l = this.previousWithHolesUncached(arg0Value_, arg1Value, arg2Value, s3_.previousElementIndexNode_, s3_.isMinusOne_, s3_.arrayTypeProfile_);
                    return l;
                }
