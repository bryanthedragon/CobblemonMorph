...
public abstract class JSToRegExpNode extends JavaScriptBaseNode {
   ...
   protected JSRegExpObject createRegExp(
      Object patternObj, @Cached("createUndefinedToEmpty()") JSToStringNode toStringNode, @Cached("create(context)") CompileRegexNode compileRegexNode
   ) {
