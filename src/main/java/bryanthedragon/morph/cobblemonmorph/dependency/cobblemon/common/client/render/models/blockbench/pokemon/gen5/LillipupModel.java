...
public class LillipupModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = LillipupModel::cryAnimation$lambda$0;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: LillipupModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
