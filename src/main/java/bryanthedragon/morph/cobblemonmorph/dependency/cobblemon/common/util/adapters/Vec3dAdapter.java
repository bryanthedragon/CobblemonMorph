...
implements JsonDeserializer<Vec3> {
    ...
    @NotNull
    public Vec3 deserialize(@NotNull JsonElement json, @NotNull Type type, @NotNull JsonDeserializationContext ctx) {
