...
abstract class NFSubstitution {
   ...
   public static NFSubstitution makeSubstitution(
      int pos, NFRule rule, NFRule rulePredecessor, NFRuleSet ruleSet, RuleBasedNumberFormat formatter, String description
   ) {
   ...
   public boolean equals(Object that) {
      if (that == null) {
         ...
         return this.pos == that2.pos
            && (this.ruleSet != null || that2.ruleSet == null)
            && (this.numberFormat == null ? that2.numberFormat == null : this.numberFormat.equals(that2.numberFormat));
      }
   }
   ...
   public String toString() {
      return this.ruleSet != null
         ? this.tokenChar() + this.ruleSet.getName() + this.tokenChar()
         : this.tokenChar() + this.numberFormat.toPattern() + this.tokenChar();
   }
