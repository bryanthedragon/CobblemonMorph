...
public final class AsyncGeneratorPrototypeBuiltins extends JSBuiltinsContainer.SwitchEnum<AsyncGeneratorPrototypeBuiltins.AsyncGeneratorPrototype> {
   ...
   protected AsyncGeneratorPrototypeBuiltins() {
      super(JSFunction.ASYNC_GENERATOR_PROTOTYPE_NAME, AsyncGeneratorPrototypeBuiltins.AsyncGeneratorPrototype.class);
   }

   protected Object createNode(
      JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, AsyncGeneratorPrototypeBuiltins.AsyncGeneratorPrototype builtinEnum
   ) {
      ...
      return AsyncGeneratorPrototypeBuiltinsFactory.AsyncGeneratorResumeNodeGen.create(
         context, builtin, resumeMethod, args().withThis().fixedArgs(1).createArgumentNodes(context)
      );
   }

   public static enum AsyncGeneratorPrototype implements BuiltinEnum<AsyncGeneratorPrototypeBuiltins.AsyncGeneratorPrototype> {
      next(1),
      return_(1),
      throw_(1);
