...
@GeneratedBy(value=JSArrayDeleteIndexNode.class)
public final class JSArrayDeleteIndexNodeGen
extends JSArrayDeleteIndexNode
    ...
    private boolean executeAndSpecialize(JSDynamicObject arg0Value, ScriptArray arg1Value, long arg2Value) {
        ...
        try {
            ...
            if (exclude == 0) {
                ...
                if (s0_ == null && (cachedArrayType__ = arg1Value).isInstance(arg1Value) && count0_ < 5) {
                ...
                if (s0_ != null) {
                    lock.unlock();
                    hasLock = false;
                    boolean bl = this.doCached(arg0Value, arg1Value, arg2Value, s0_.cachedArrayType_);
                    return bl;
                }
            }
            ...
            lock.unlock();
            hasLock = false;
            boolean bl = this.doUncached(arg0Value, arg1Value, arg2Value);
            return bl;
        }
        finally {
            if (hasLock) {
