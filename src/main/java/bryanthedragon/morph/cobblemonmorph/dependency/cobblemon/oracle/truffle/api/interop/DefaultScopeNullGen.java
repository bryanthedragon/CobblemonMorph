...
@GeneratedBy(value=DefaultNodeExports.DefaultScopeNull.class)
final class DefaultScopeNullGen {
    ...
    static {
        LibraryExport.register(DefaultNodeExports.DefaultScopeNull.class, new InteropLibraryExports());
    }
    ...
    extends LibraryExport<InteropLibrary> {
        ...
        extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert (!(receiver instanceof DefaultNodeExports.DefaultScopeNull) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null) : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
