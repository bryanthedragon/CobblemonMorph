...
public class KabutoModel(root: ModelPart) : PokemonPoseableModel {
   ...
   init {
      ...
      this.cryAnimation = KabutoModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "kabuto", "ground_idle", null, 4, null)},
            null,
      ...
      val var8: Array<StatelessAnimation> = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "kabuto", "ground_walk", null, 4, null)};
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: KabutoModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
