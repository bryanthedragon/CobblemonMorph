...
public class JSTemporalDateTimeRecord {
    ...
    protected JSTemporalDateTimeRecord(int year, int month, int day, int hour, int minute, int second, int millisecond, int microsecond, int nanosecond, TruffleString calendar, boolean hasCalendar) {
        this.year = year;
        this.month = month;
        this.day = day;
        this.hour = hour;
    ...
    public static JSTemporalDateTimeRecord createCalendar(int year, int month, int day, int hour, int minute, int second, int millisecond, int microsecond, int nanosecond, TruffleString calendar) {
