...
public class SwampertModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame {
   public final val armLeft: ModelPart
   public final val armRight: ModelPart
   ...
   init {
      ...
      this.cryAnimation = SwampertModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "swampert", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: SwampertModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
