...
public class DewottHisuiBiasModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = DewottHisuiBiasModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "dewott_hisui_bias", "sleep", null, 4, null)},
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "dewott_hisui_bias", "ground_idle", null, 4, null)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.scalchop_right).withVisibility(false),
               ModelPartExtensionsKt.createTransformation(this.scalchop_left).withVisibility(false),
      ...
      this.setWalk(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "dewott_hisui_bias", "ground_walk", null, 4, null)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.scalchop_right).withVisibility(false),
               ModelPartExtensionsKt.createTransformation(this.scalchop_left).withVisibility(false),
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: DewottHisuiBiasModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
