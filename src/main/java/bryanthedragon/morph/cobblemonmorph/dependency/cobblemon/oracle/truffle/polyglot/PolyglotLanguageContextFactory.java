...
final class PolyglotLanguageContextFactory {
   ...
   static final class ToGuestValueNodeGen extends PolyglotLanguageContext.ToGuestValueNode {
      private static final PolyglotLanguageContextFactory.ToGuestValueNodeGen.Uncached UNCACHED = new PolyglotLanguageContextFactory.ToGuestValueNodeGen.Uncached();
      @CompilerDirectives.CompilationFinal
      private volatile int state_0_;
      @CompilerDirectives.CompilationFinal
      private volatile int exclude_;
      @CompilerDirectives.CompilationFinal
      private PolyglotLanguageContextFactory.ToGuestValueNodeGen.CachedData cached_cache;
      ...
      Object execute(PolyglotLanguageContext arg0Value, Object arg1Value) {
         ...
         if (state_0 != 0) {
            ...
            if ((state_0 & 2) != 0 && arg1Value != null) {
               for (PolyglotLanguageContextFactory.ToGuestValueNodeGen.CachedData s1_ = this.cached_cache; s1_ != null; s1_ = s1_.next_) {
         ...
         try {
            ...
            if (arg1Value == null) {
               ...
               if (exclude == 0 && arg1Value != null) {
                  int count1_ = 0;
                  PolyglotLanguageContextFactory.ToGuestValueNodeGen.CachedData s1_ = this.cached_cache;
                  if ((state_0 & 2) != 0) {
                  ...
                  if (s1_ == null) {
                     ...
                     if (arg1Value.getClass() == cachedReceiver__ && count1_ < 3) {
                        s1_ = new PolyglotLanguageContextFactory.ToGuestValueNodeGen.CachedData(this.cached_cache);
      ...
      public static PolyglotLanguageContext.ToGuestValueNode create() {
         return new PolyglotLanguageContextFactory.ToGuestValueNodeGen();
      }
      ...
      private static final class CachedData {
         @CompilerDirectives.CompilationFinal
         PolyglotLanguageContextFactory.ToGuestValueNodeGen.CachedData next_;
         @CompilerDirectives.CompilationFinal
         Class<?> cachedReceiver_;

         CachedData(PolyglotLanguageContextFactory.ToGuestValueNodeGen.CachedData next_) {
            this.next_ = next_;
         }
      }
