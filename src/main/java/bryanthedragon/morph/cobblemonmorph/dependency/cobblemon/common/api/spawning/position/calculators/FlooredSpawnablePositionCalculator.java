...
package bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.api.spawning.position.calculators

import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.Cobblemon.config
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.api.spawning.position.*
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.api.spawning.position.calculators.SpawnablePositionCalculator.Companion.isAirCondition
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.api.spawning.position.calculators.SpawnablePositionCalculator.Companion.isLavaCondition
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.api.spawning.position.calculators.SpawnablePositionCalculator.Companion.isSolidCondition
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.api.spawning.position.calculators.SpawnablePositionCalculator.Companion.isWaterCondition
 ...
 */
public interface FlooredSpawnablePositionCalculator<T : FlooredSpawnablePosition> : AreaSpawnablePositionCalculator<T> {
 ...
 * @since February 7th, 2022
 */
public final class GroundedSpawnablePositionCalculator : FlooredSpawnablePositionCalculator<GroundedSpawnablePosition> {
 ...
 * @since February 7th, 2022
 */
public final class SeafloorSpawnablePositionCalculator : FlooredSpawnablePositionCalculator<SeafloorSpawnablePosition> {
 ...
 * @since February 7th, 2022
 */
public final class LavafloorSpawnablePositionCalculator : FlooredSpawnablePositionCalculator<LavafloorSpawnablePosition> {
 ...
 */
public final class SurfaceSpawnablePositionCalculator : FlooredSpawnablePositionCalculator<SurfaceSpawnablePosition> {
