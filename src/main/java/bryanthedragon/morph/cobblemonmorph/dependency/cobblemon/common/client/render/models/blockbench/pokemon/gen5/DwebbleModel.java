...
public class DwebbleModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = DwebbleModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "dwebble", "ground_idle", null, 4, null)
            },
            null,
            null,
            444,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: DwebbleModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
