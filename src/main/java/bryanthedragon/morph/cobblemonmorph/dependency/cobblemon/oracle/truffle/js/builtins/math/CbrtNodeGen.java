...
public final class CbrtNodeGen extends CbrtNode implements Introspection.Provider {
   @Node.Child
   ...
   public Object execute(VirtualFrame frameValue) {
      ...
      return this.cbrt(arguments0Value_);
   }
   ...
   public Introspection getIntrospectionData() {
      ...
      Object[] s = new Object[]{"cbrt", (byte)1, null};
      data[1] = s;
