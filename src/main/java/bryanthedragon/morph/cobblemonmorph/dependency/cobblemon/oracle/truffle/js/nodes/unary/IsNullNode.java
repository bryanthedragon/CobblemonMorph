...
import com.oracle.truffle.js.nodes.unary.IsNullNodeGen;
...
public abstract class IsNullNode
extends IsIdenticalBaseNode {
    ...
    protected static boolean doCached(Object operand, @CachedLibrary(value="operand") InteropLibrary interop) {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return IsNullNode.create(IsNullNode.cloneUninitialized(this.getOperand(), materializedTags), this.leftConstant);
    }
