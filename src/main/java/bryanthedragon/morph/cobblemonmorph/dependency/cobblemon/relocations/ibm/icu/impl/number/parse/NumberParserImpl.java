...
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.AffixMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.AffixTokenMatcherFactory;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.CombinedCurrencyMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.DecimalMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.IgnorablesMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.InfinityMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.MinusSignMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.MultiplierParseHandler;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.NanMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.NumberParseMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.PaddingMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.ParsedNumber;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.PercentMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.PermilleMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.PlusSignMatcher;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.RequireAffixValidator;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.RequireCurrencyValidator;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.RequireDecimalSeparatorValidator;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.RequireNumberValidator;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.ScientificMatcher;
...
public class NumberParserImpl {
    ...
    public void parse(String input, int start2, boolean greedy, ParsedNumber result) {
        assert (this.frozen);
