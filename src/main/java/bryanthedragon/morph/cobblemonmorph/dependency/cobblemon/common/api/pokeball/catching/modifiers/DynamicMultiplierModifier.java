...
implements CatchRateModifier {
    ...
    public float value(@NotNull LivingEntity thrower, @NotNull Pokemon pokemon) {
        ...
        return ((Number)this.multiplier.invoke((Object)thrower, (Object)pokemon)).floatValue();
    }
    ...
    public float modifyCatchRate(float currentCatchRate, @NotNull LivingEntity thrower, @NotNull Pokemon pokemon) {
        Intrinsics.checkNotNullParameter((Object)thrower, (String)"thrower");
        Intrinsics.checkNotNullParameter((Object)pokemon, (String)"pokemon");
        return this.isValid(thrower, pokemon) ? currentCatchRate * ((Number)this.behavior(thrower, pokemon).getMutator().invoke((Object)Float.valueOf(currentCatchRate), (Object)Float.valueOf(this.value(thrower, pokemon)))).floatValue() : currentCatchRate;
    }
}
