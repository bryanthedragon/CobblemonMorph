...
import com.oracle.truffle.js.builtins.math.TruncNode;
...
@GeneratedBy(value=TruncNode.class)
public final class TruncNodeGen
extends TruncNode
    ...
    private double executeAndSpecialize(Object arguments0Value) {
        ...
        try {
            ...
            if (exclude == 0 && (doubleCast0 = JSTypesGen.specializeImplicitDouble(arguments0Value)) != 0) {
                ...
                lock.unlock();
                hasLock = false;
                double d = TruncNode.truncDouble(arguments0Value_);
                return d;
            }
            ...
            lock.unlock();
            hasLock = false;
            double d = this.trunc(arguments0Value);
            return d;
        }
        finally {
            if (hasLock) {
