...
public final class TRegexDFAExecutorProperties {
    ...
    public TRegexDFAExecutorProperties(boolean forward, boolean searching, boolean genericCG, boolean allowSimpleCG, boolean regressionTestMode, boolean trackLastGroup, int minResultLength) {
