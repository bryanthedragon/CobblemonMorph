...
public abstract class PrivateFieldGetNode extends JSTargetableNode implements ReadNode {
   ...
   Object doField(JSObject target, HiddenKey key, @CachedLibrary("target") DynamicObjectLibrary access, @Cached BranchProfile errorBranch) {
   ...
   @Specialization
   Object doAccessor(JSObject target, Accessor accessor, @Cached("createCall()") JSFunctionCallNode callNode, @Cached BranchProfile errorBranch) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return create(cloneUninitialized(this.targetNode, materializedTags), cloneUninitialized(this.keyNode, materializedTags), this.context);
   }

   @Override
   public String expressionToString() {
      return this.targetNode != null && this.keyNode != null
         ? Objects.toString(this.targetNode.expressionToString(), "(intermediate value)") + "." + Objects.toString(this.keyAsString(), "(intermediate value)")
         : null;
   }
}
