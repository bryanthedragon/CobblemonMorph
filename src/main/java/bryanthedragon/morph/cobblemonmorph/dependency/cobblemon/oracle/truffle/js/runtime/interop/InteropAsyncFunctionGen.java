...
final class InteropAsyncFunctionGen {
   ...
   static {
      LibraryExport.register(InteropAsyncFunction.class, new InteropAsyncFunctionGen.InteropLibraryExports());
   }

   @GeneratedBy(InteropAsyncFunction.class)
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      static final FinalBitSet ENABLED_MESSAGES = createMessageBitSet(
         InteropAsyncFunctionGen.INTEROP_LIBRARY_, "isIdenticalOrUndefined", "identityHashCode", "isExecutable", "execute"
      );
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         return createDelegate(InteropAsyncFunctionGen.INTEROP_LIBRARY_, new InteropAsyncFunctionGen.InteropLibraryExports.Uncached());
      }

      protected InteropLibrary createCached(Object receiver) {
         assert receiver instanceof InteropAsyncFunction;

         return createDelegate(InteropAsyncFunctionGen.INTEROP_LIBRARY_, new InteropAsyncFunctionGen.InteropLibraryExports.Cached(receiver));
      }
      ...
      private static final class Cached extends InteropLibrary implements LibraryExport.DelegateExport {
         ...
         protected Cached(Object receiver) {
            ...
            this.receiverFunctionInteropLibrary_ = super.insert(InteropAsyncFunctionGen.INTEROP_LIBRARY_.create(castReceiver.function));
         }

         @Override
         public FinalBitSet getDelegateExportMessages() {
            return InteropAsyncFunctionGen.InteropLibraryExports.ENABLED_MESSAGES;
         }
         ...
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof InteropAsyncFunction) || InteropAsyncFunctionGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";

            return !(receiver instanceof InteropAsyncFunction)
               ? false
               : this.receiverFunctionInteropLibrary_.accepts(((InteropAsyncFunction)receiver).function);
         }
         ...
         protected TriState isIdenticalOrUndefined(Object arg0Value_, Object arg1Value) {
            ...
            if ((state_0 & 1) != 0) {
               return arg0Value.isIdenticalOrUndefined(
                  arg1Value,
                  this.isIdenticalOrUndefinedNode__isIdenticalOrUndefined_thisLib_,
                  this.isIdenticalOrUndefinedNode__isIdenticalOrUndefined_otherLib_
               );
            } else {
         ...
         private TriState isIdenticalOrUndefinedNode_AndSpecialize(InteropFunction arg0Value, Object arg1Value) {
            ...
            try {
               int state_0 = this.state_0_;
               this.isIdenticalOrUndefinedNode__isIdenticalOrUndefined_thisLib_ = super.insert(InteropAsyncFunctionGen.INTEROP_LIBRARY_.createDispatched(5));
               this.isIdenticalOrUndefinedNode__isIdenticalOrUndefined_otherLib_ = super.insert(InteropAsyncFunctionGen.INTEROP_LIBRARY_.createDispatched(5));
               int var10;
               this.state_0_ = var10 = state_0 | 1;
               lock.unlock();
               hasLock = false;
               var6 = arg0Value.isIdenticalOrUndefined(
                  arg1Value,
                  this.isIdenticalOrUndefinedNode__isIdenticalOrUndefined_thisLib_,
                  this.isIdenticalOrUndefinedNode__isIdenticalOrUndefined_otherLib_
               );
         ...
         public Object execute(Object arg0Value_, Object... arg1Value) throws UnsupportedTypeException, ArityException, UnsupportedMessageException {
            ...
            if ((state_0 & 2) != 0) {
               ...
               return arg0Value.execute(
                  arg1Value,
                  executeNode__execute_self__,
                  this.executeNode__execute_callNode_,
                  this.executeNode__execute_exportNode_,
                  this.executeNode__execute_unwrapPromise_
               );
            } else {
               CompilerDirectives.transferToInterpreterAndInvalidate();
      ...
      private static final class Uncached extends InteropLibrary implements LibraryExport.DelegateExport {
         ...
         public Library getDelegateExportLibrary(Object delegate_) {
            return InteropAsyncFunctionGen.INTEROP_LIBRARY_.getUncached(delegate_);
         }
         ...
         public TriState isIdenticalOrUndefined(Object arg0Value_, Object arg1Value) {
            ...
            return arg0Value.isIdenticalOrUndefined(
               arg1Value, InteropAsyncFunctionGen.INTEROP_LIBRARY_.getUncached(), InteropAsyncFunctionGen.INTEROP_LIBRARY_.getUncached()
            );
         }
         ...
         public Object execute(Object arg0Value_, Object... arg1Value) throws UnsupportedMessageException {
            ...
            return arg0Value.execute(
               ...
               JSInteropExecuteNodeGen.getUncached(),
               ExportValueNode.getUncached(),
               UnwrapPromiseNode.getUncached()
            );
         }
      }
   }
