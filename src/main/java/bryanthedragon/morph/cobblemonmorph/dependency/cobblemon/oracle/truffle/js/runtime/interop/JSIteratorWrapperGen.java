...
final class JSIteratorWrapperGen {
    ...
    extends LibraryExport<InteropLibrary> {
        static final FinalBitSet ENABLED_MESSAGES = InteropLibraryExports.createMessageBitSet(INTEROP_LIBRARY_, "isIterator", "hasIteratorNextElement", "getIteratorNextElement");
        ...
        implements LibraryExport.DelegateExport {
            ...
            public boolean accepts(Object receiver) {
                ...
                return this.receiverIteratorInteropLibrary_.accepts(((JSIteratorWrapper)receiver).iterator);
            }
            ...
            private boolean hasIteratorNextElementNode_AndSpecialize(JSIteratorWrapper arg0Value) {
                ...
                try {
                    ...
                    lock.unlock();
                    hasLock = false;
                    boolean bl = arg0Value.hasIteratorNextElement(hasIteratorNextElementNode__hasIteratorNextElement_self__, this.getIteratorNext);
                    return bl;
                }
                finally {
                    if (hasLock) {
            ...
            private Object getIteratorNextElementNode_AndSpecialize(JSIteratorWrapper arg0Value) throws StopIterationException {
                ...
                try {
                    ...
                    lock.unlock();
                    hasLock = false;
                    Object object = arg0Value.getIteratorNextElement(getIteratorNextElementNode__getIteratorNextElement_self__, this.getIteratorNext);
                    return object;
                }
                finally {
                    if (hasLock) {
