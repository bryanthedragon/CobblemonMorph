...
public final class BaseLocale {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return this.hashCode() == other.hashCode()
            && this._language.equals(other._language)
            && this._script.equals(other._script)
            && this._region.equals(other._region)
            && this._variant.equals(other._variant);
      }
   }
   ...
   private static class Key implements Comparable<BaseLocale.Key> {
      ...
      public boolean equals(Object obj) {
         return this == obj
            || obj instanceof BaseLocale.Key
               && AsciiUtil.caseIgnoreMatch(((BaseLocale.Key)obj)._lang, this._lang)
               && AsciiUtil.caseIgnoreMatch(((BaseLocale.Key)obj)._scrt, this._scrt)
               && AsciiUtil.caseIgnoreMatch(((BaseLocale.Key)obj)._regn, this._regn)
               && AsciiUtil.caseIgnoreMatch(((BaseLocale.Key)obj)._vart, this._vart);
      }
