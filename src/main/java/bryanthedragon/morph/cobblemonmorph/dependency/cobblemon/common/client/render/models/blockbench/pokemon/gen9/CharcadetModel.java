...
public class CharcadetModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = CharcadetModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "charcadet", "sleep", null, 4, null)},
            null,
            null,
            222,
            null
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "charcadet", "ground_idle", null, 4, null)
            },
            null,
      ...
      val var14: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "charcadet", "ground_walk", null, 4, null)
      };
      val var20: PoseableEntityModel = this;
      this.setWalking(PoseableEntityModel.registerPose$default(var20, "walking", var8, null, 10, null, null, var14, null, var11, 180, null));
      this.setShoulderLeft(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "charcadet", "shoulder_left", null, 4, null)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.getRootPart()).addPosition(1, -0.1),
      ...
      this.setShoulderRight(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "charcadet", "shoulder_right", null, 4, null)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.getRootPart()).addPosition(1, -0.1),
               ModelPartExtensionsKt.createTransformation(this.getRootPart()).addPosition(2, -1.1)
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isPosedIn(this.getStanding(), this.getWalking(), this.getSleep()))
         PoseableEntityModel.bedrockStateful$default(this, "charcadet", "faint", null, 4, null)
         else
         null;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: CharcadetModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
