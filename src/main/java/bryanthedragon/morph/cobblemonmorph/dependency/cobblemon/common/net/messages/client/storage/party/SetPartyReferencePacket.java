...
public class SetPartyReferencePacket(storeID: UUID) : NetworkPacket<SetPartyReferencePacket> {
   ...
   public companion object {
      ...
      public fun decode(buffer: FriendlyByteBuf): SetPartyReferencePacket {
         val var10002: UUID = buffer.m_130259_();
         return new SetPartyReferencePacket(var10002);
      }
   }
}
