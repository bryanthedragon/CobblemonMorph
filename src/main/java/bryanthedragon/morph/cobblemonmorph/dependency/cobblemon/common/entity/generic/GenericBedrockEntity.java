...
public class GenericBedrockEntity(Level world) : Entity(CobblemonEntities.GENERIC_BEDROCK_ENTITY, world), PosableEntity, Schedulable {
    final class Companion {
        val CATEGORY = SynchedEntityData.defineId(GenericBedrockEntity.class, IdentifierDataSerializer)
        val ASPECTS = SynchedEntityData.defineId(GenericBedrockEntity.class, StringSetDataSerializer)
        val POSE_TYPE = SynchedEntityData.defineId(GenericBedrockEntity.class, PoseTypeDataSerializer)
        val SCALE = SynchedEntityData.defineId(GenericBedrockEntity.class, EntityDataSerializers.FLOAT)
    }
