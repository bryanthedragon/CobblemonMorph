...
public abstract class ToStringNode extends Node {
   ...
   static String doBoxedCharArray(Object input, @CachedLibrary("input") InteropLibrary inputs, @Cached ToCharNode toCharNode) throws UnsupportedTypeException {
      try {
      ...
      } catch (InvalidArrayIndexException | UnsupportedMessageException var7) {
         CompilerDirectives.transferToInterpreterAndInvalidate();
         throw UnsupportedTypeException.create(new Object[]{input});
      }
   }
