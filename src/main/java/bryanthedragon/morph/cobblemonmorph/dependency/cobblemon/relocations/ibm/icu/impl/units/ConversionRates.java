...
import com.cobblemon.mod.relocations.ibm.icu.impl.units.UnitsConverter;
...
public class ConversionRates {
    ...
    extends UResource.Sink {
        ...
        public void put(UResource.Key key, UResource.Value value2, boolean noFallback) {
            ...
            UResource.Table conversionRateTable = value2.getTable();
            int i = 0;
            while (conversionRateTable.getKeyAndValue(i, key, value2)) {
                assert (value2.getType() == 2);
                String simpleUnit = key.toString();
                UResource.Table simpleUnitConversionInfo = value2.getTable();
                String target = null;
                String factor = null;
                String offset = "0";
                int j = 0;
                while (simpleUnitConversionInfo.getKeyAndValue(j, key, value2)) {
                    assert (value2.getType() == 0);
                    String keyString = key.toString();
                    String valueString = value2.toString().replaceAll(" ", "");
