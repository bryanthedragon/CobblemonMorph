...
public class TemporalPlainDateTimePrototypeBuiltins
   extends JSBuiltinsContainer.SwitchEnum<TemporalPlainDateTimePrototypeBuiltins.TemporalPlainDateTimePrototype> {
   ...
   protected TemporalPlainDateTimePrototypeBuiltins() {
      super(JSTemporalPlainDateTime.PROTOTYPE_NAME, TemporalPlainDateTimePrototypeBuiltins.TemporalPlainDateTimePrototype.class);
   }
   ...
   protected Object createNode(
      ...
      boolean construct,
      boolean newTarget,
      TemporalPlainDateTimePrototypeBuiltins.TemporalPlainDateTimePrototype builtinEnum
   ) {
      switch (builtinEnum) {
         case calendar:
         case year:
         ...
         case microsecond:
         case nanosecond:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeGetterNodeGen.create(
               context, builtin, builtinEnum, args().withThis().createArgumentNodes(context)
            );
         case add:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeAddNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case subtract:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeSubtractNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case with:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeWithNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case withPlainTime:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeWithPlainTimeNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case withPlainDate:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeWithPlainDateNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case withCalendar:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeWithCalendarNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case until:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeUntilNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case since:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeSinceNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case round:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeRoundNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case equals:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeEqualsNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case toPlainTime:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeToPlainTimeNodeGen.create(
               context, builtin, args().withThis().fixedArgs(0).createArgumentNodes(context)
            );
         case toPlainDate:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeToPlainDateNodeGen.create(
               context, builtin, args().withThis().fixedArgs(0).createArgumentNodes(context)
            );
         case toZonedDateTime:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeToZonedDateTimeNodeGen.create(
               context, builtin, args().withThis().fixedArgs(2).createArgumentNodes(context)
            );
         case toPlainYearMonth:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeToPlainYearMonthNodeGen.create(
               context, builtin, args().withThis().fixedArgs(0).createArgumentNodes(context)
            );
         case toPlainMonthDay:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeToPlainMonthDayNodeGen.create(
               context, builtin, args().withThis().fixedArgs(0).createArgumentNodes(context)
            );
         case getISOFields:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeGetISOFieldsNodeGen.create(
               context, builtin, args().withThis().createArgumentNodes(context)
            );
         case toString:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeToStringNodeGen.create(
               context, builtin, args().withThis().fixedArgs(1).createArgumentNodes(context)
            );
         case toLocaleString:
         case toJSON:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeToLocaleStringNodeGen.create(
               context, builtin, args().withThis().createArgumentNodes(context)
            );
         case valueOf:
            return TemporalPlainDateTimePrototypeBuiltinsFactory.JSTemporalPlainDateTimeValueOfNodeGen.create(
               context, builtin, args().withThis().createArgumentNodes(context)
            );
         default:
            return null;
   ...
   public abstract static class JSTemporalPlainDateTimeAdd extends TemporalPlainDateTimePrototypeBuiltins.PlainDateTimeOperation {
      ...
      public JSDynamicObject add(
         Object thisObj, Object temporalDurationLike, Object optParam, @Cached("create()") ToLimitedTemporalDurationNode toLimitedTemporalDurationNode
      ) {
   ...
   public abstract static class JSTemporalPlainDateTimeEquals extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      ...
      protected boolean equalsOtherObj(Object thisObj, JSDynamicObject otherObj, @Cached.Shared("toString") @Cached JSToStringNode toStringNode) {
      ...
      protected boolean equalsGeneric(
         Object thisObj,
         Object other,
         @Cached("create(getContext())") ToTemporalDateTimeNode toTemporalDateTime,
         @Cached.Shared("toString") @Cached JSToStringNode toStringNode
      ) {
      ...
      private static boolean equalsIntl(JSTemporalPlainDateTimeObject one, JSTemporalPlainDateTimeObject two, JSToStringNode toStringNode) {
         ...
         return result != 0 ? false : TemporalUtil.calendarEquals(one.getCalendar(), two.getCalendar(), toStringNode);
      }
   }

   public abstract static class JSTemporalPlainDateTimeGetISOFields extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeGetterNode extends JSBuiltinNode {
      public final TemporalPlainDateTimePrototypeBuiltins.TemporalPlainDateTimePrototype property;

      public JSTemporalPlainDateTimeGetterNode(
         JSContext context, JSBuiltin builtin, TemporalPlainDateTimePrototypeBuiltins.TemporalPlainDateTimePrototype property
      ) {
         super(context, builtin);
      ...
      protected Object dateTimeGetter(Object thisObj, @Cached("create(getContext())") TemporalCalendarGetterNode calendarGetterNode) {
   ...
   public abstract static class JSTemporalPlainDateTimeRoundNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      protected JSTemporalPlainDateTimeRoundNode(JSContext context, JSBuiltin builtin) {
         super(context, builtin);
      }

      @Specialization
      public JSDynamicObject round(
         Object thisObj, Object roundToParam, @Cached("create()") JSToNumberNode toNumberNode, @Cached TruffleString.EqualNode equalNode
      ) {
         JSTemporalPlainDateTimeObject dt = this.requireTemporalDateTime(thisObj);
         if (roundToParam == Undefined.instance) {
            ...
            if (smallestUnit == TemporalUtil.Unit.EMPTY) {
               ...
               return JSTemporalPlainDateTime.create(
                  this.getContext(),
                  TemporalUtil.dtoi(result.getYears()),
                  TemporalUtil.dtoi(result.getMonths()),
                  TemporalUtil.dtoi(result.getDays()),
   ...
   public abstract static class JSTemporalPlainDateTimeSinceNode extends TemporalPlainDateTimePrototypeBuiltins.PlainDateTimeOperation {
      ...
      public JSDynamicObject since(
         ...
         JSTemporalPlainDateTimeObject dateTime = this.requireTemporalDateTime(thisObj);
         return this.differenceTemporalPlainDateTime(
            -1, dateTime, otherObj, optionsParam, toNumber, namesNode, toTemporalDateTime, toStringNode, equalNode, roundDurationNode
         );
      }
   }

   public abstract static class JSTemporalPlainDateTimeSubtractNode extends TemporalPlainDateTimePrototypeBuiltins.PlainDateTimeOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeToLocaleString extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeToPlainDateNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeToPlainMonthDayNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeToPlainTimeNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeToPlainYearMonthNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeToString extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeToZonedDateTimeNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeUntilNode extends TemporalPlainDateTimePrototypeBuiltins.PlainDateTimeOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeValueOf extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeWith extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeWithCalendarNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeWithPlainDateNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class JSTemporalPlainDateTimeWithPlainTimeNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public abstract static class PlainDateTimeOperation extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      public PlainDateTimeOperation(JSContext context, JSBuiltin builtin) {
         super(context, builtin);
      }

      protected JSTemporalPlainDateTimeObject addDurationToOrSubtractDurationFromPlainDateTime(
         int sign,
         ...
         JSDynamicObject options = this.getOptionsObject(optParam);
         JSTemporalDateTimeRecord result = TemporalUtil.addDateTime(
            this.getContext(),
            dateTime.getYear(),
            dateTime.getMonth(),
            dateTime.getDay(),
            ...
            sign * duration.getYears(),
            sign * duration.getMonths(),
            sign * duration.getWeeks(),
            sign * duration.getDays(),
      ...
      protected JSTemporalDurationObject differenceTemporalPlainDateTime(
         int sign,
         JSTemporalPlainDateTimeObject dateTime,
         Object otherObj,
         Object optionsParam,
         ...
         ToTemporalDateTimeNode toTemporalDateTime,
         ...
         if (!TemporalUtil.calendarEquals(dateTime.getCalendar(), other.getCalendar(), toStringNode)) {
            ...
            JSTemporalDurationRecord diff = TemporalUtil.differenceISODateTime(
               this.getContext(),
               namesNode,
               dateTime.getYear(),
               dateTime.getMonth(),
            ...
            JSDynamicObject relativeTo = JSTemporalPlainDate.create(
               this.getContext(), dateTime.getYear(), dateTime.getMonth(), dateTime.getDay(), dateTime.getCalendar(), this.errorBranch
            );
            ...
            return JSTemporalDuration.createTemporalDuration(
               this.getContext(),
               sign * roundResult.getYears(),
               sign * roundResult.getMonths(),
               sign * roundResult.getWeeks(),
               sign * result.getDays(),
   ...
   public static enum TemporalPlainDateTimePrototype implements BuiltinEnum<TemporalPlainDateTimePrototypeBuiltins.TemporalPlainDateTimePrototype> {
      calendar(0),
      year(0),
      month(0),
      monthCode(0),
