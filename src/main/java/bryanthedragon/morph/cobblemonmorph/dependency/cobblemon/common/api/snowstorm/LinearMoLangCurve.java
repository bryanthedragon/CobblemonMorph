...
implements MoLangCurve {
    ...
    @NotNull
    private static final Codec<LinearMoLangCurve> CODEC;

    public LinearMoLangCurve(@NotNull String name, @NotNull Expression input, @NotNull Expression horizontalRange, @NotNull List<Double> nodes) {
    ...
    public /* synthetic */ LinearMoLangCurve(String string, Expression expression, Expression expression2, List list, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 1) != 0) {
            string = "variable";
        }
        if ((n & 2) != 0) {
    ...
    public double resolve(@NotNull MoLangRuntime runtime2, double inputValue) {
        ...
        double range = MoLangExtensionsKt.resolveDouble(runtime2, this.horizontalRange);
        double spaceBetweenNodes = range / (double)(this.nodes.size() - 1);
        int rangeIndex = (int)Math.floor(inputValue / spaceBetweenNodes);
        if (rangeIndex < 0) {
            return ((Number)this.nodes.get(0)).doubleValue();
        }
        if (rangeIndex + 1 >= this.nodes.size()) {
            return ((Number)CollectionsKt.last(this.nodes)).doubleValue();
        }
        double leftNode = ((Number)this.nodes.get(rangeIndex)).doubleValue();
        double rightNode = ((Number)this.nodes.get(rangeIndex + 1)).doubleValue();
        double d = inputValue % spaceBetweenNodes;
        double t = (!(d == 0.0) && !(Math.signum(d) == Math.signum(spaceBetweenNodes)) ? d + spaceBetweenNodes : d) / spaceBetweenNodes;
    ...
    public void readFromBuffer(@NotNull FriendlyByteBuf buffer) {
        ...
        List list = buffer.m_236845_(arg_0 -> LinearMoLangCurve.readFromBuffer$lambda$0(buffer, arg_0));
    ...
    public void writeToBuffer(@NotNull FriendlyByteBuf buffer) {
        ...
        buffer.m_236828_((Collection)this.nodes, LinearMoLangCurve::writeToBuffer$lambda$1);
    }
    ...
    private static final String CODEC$lambda$8$lambda$2(LinearMoLangCurve it) {
        return it.getType().name();
    }

    private static final String CODEC$lambda$8$lambda$3(LinearMoLangCurve it) {
        return it.getName();
    }

    private static final Expression CODEC$lambda$8$lambda$4(LinearMoLangCurve it) {
        return it.getInput();
    }

    private static final Expression CODEC$lambda$8$lambda$5(LinearMoLangCurve it) {
        return it.horizontalRange;
    }

    private static final List CODEC$lambda$8$lambda$6(LinearMoLangCurve it) {
        return it.nodes;
    }

    private static final LinearMoLangCurve CODEC$lambda$8$lambda$7(String string, String name, Expression input, Expression horizontalRange, List nodes) {
    ...
    private static final App CODEC$lambda$8(RecordCodecBuilder.Instance instance) {
        return instance.group((App)PrimitiveCodec.STRING.fieldOf("type").forGetter(LinearMoLangCurve::CODEC$lambda$8$lambda$2), (App)PrimitiveCodec.STRING.fieldOf("name").forGetter(LinearMoLangCurve::CODEC$lambda$8$lambda$3), (App)ExpressionCodecKt.getEXPRESSION_CODEC().fieldOf("input").forGetter(LinearMoLangCurve::CODEC$lambda$8$lambda$4), (App)ExpressionCodecKt.getEXPRESSION_CODEC().fieldOf("horizontalRange").forGetter(LinearMoLangCurve::CODEC$lambda$8$lambda$5), (App)new ListCodec((Codec)PrimitiveCodec.DOUBLE).fieldOf("nodes").forGetter(LinearMoLangCurve::CODEC$lambda$8$lambda$6)).apply((Applicative)instance, LinearMoLangCurve::CODEC$lambda$8$lambda$7);
    }

    public LinearMoLangCurve() {
        this(null, null, null, null, 15, null);
    }

    static {
        Codec codec2 = RecordCodecBuilder.create(LinearMoLangCurve::CODEC$lambda$8);
        Intrinsics.checkNotNullExpressionValue((Object)codec2, (String)"create { instance ->\n   \u2026)\n            }\n        }");
        CODEC = codec2;
    }

    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\b\u0010\tR\u001d\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u00028\u0006\u00a2\u0006\f\n\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007\u00a8\u0006\n"}, d2={"Lcom/cobblemon/mod/common/api/snowstorm/LinearMoLangCurve$Companion;", "", "Lcom/mojang/serialization/Codec;", "Lcom/cobblemon/mod/common/api/snowstorm/LinearMoLangCurve;", "CODEC", "Lcom/mojang/serialization/Codec;", "getCODEC", "()Lcom/mojang/serialization/Codec;", "<init>", "()V", "common"})
    public static final class Companion {
        private Companion() {
        }

        @NotNull
        public final Codec<LinearMoLangCurve> getCODEC() {
            return CODEC;
        }
