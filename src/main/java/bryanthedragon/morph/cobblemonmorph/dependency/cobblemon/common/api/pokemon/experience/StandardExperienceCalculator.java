...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.pokemon.requirements.LevelRequirement
import kotlin.math.pow
import kotlin.math.roundToInt

fun interface ExperienceCalculator {
    fun calculate(BattlePokemon battlePokemon, BattlePokemon opponentPokemon, participationMultiplier: Double): Int
}
public final class StandardExperienceCalculator : ExperienceCalculator {
    override fun calculate(BattlePokemon battlePokemon, BattlePokemon opponentPokemon, participationMultiplier: Double): Int {
