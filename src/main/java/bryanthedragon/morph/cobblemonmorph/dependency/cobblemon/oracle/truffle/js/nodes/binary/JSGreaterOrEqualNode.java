...
import com.oracle.truffle.js.nodes.binary.JSGreaterOrEqualNodeGen;
...
@NodeInfo(shortName=">=")
public abstract class JSGreaterOrEqualNode
extends JSCompareNode {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return JSGreaterOrEqualNodeGen.create(JSGreaterOrEqualNode.cloneUninitialized(this.getLeft(), materializedTags), JSGreaterOrEqualNode.cloneUninitialized(this.getRight(), materializedTags));
    }
}
