...
public abstract class JSGreaterOrEqualNode extends JSCompareNode {
   ...
   protected boolean doOverloaded(
      ...
      return result == Undefined.instance ? false : !toBooleanNode.executeBoolean(result);
   }
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return JSGreaterOrEqualNodeGen.create(cloneUninitialized(this.getLeft(), materializedTags), cloneUninitialized(this.getRight(), materializedTags));
   }
}
