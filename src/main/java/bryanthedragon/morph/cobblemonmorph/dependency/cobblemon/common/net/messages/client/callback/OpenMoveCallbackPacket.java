...
implements NetworkPacket<OpenMoveCallbackPacket> {
    ...
    @NotNull
    private static final ResourceLocation ID = MiscUtilsKt.cobblemonResource("open_move_callback");

    public OpenMoveCallbackPacket(@NotNull UUID uuid2, @NotNull MutableComponent title, @NotNull List<MoveSelectDTO> moves) {
    ...
    public void encode(@NotNull FriendlyByteBuf buffer) {
        ...
        buffer.m_236828_((Collection)this.moves, (arg_0, arg_1) -> OpenMoveCallbackPacket.encode$lambda$0(buffer, arg_0, arg_1));
    }
    ...
    private static final void encode$lambda$0(FriendlyByteBuf $buffer, FriendlyByteBuf friendlyByteBuf, MoveSelectDTO v) {
        Intrinsics.checkNotNullParameter((Object)$buffer, (String)"$buffer");
        v.writeToBuffer($buffer);
    }

    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\f\u0010\rJ\u0015\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0017\u0010\b\u001a\u00020\u00078\u0006\u00a2\u0006\f\n\u0004\b\b\u0010\t\u001a\u0004\b\n\u0010\u000b\u00a8\u0006\u000e"}, d2={"Lcom/cobblemon/mod/common/net/messages/client/callback/OpenMoveCallbackPacket$Companion;", "", "Lnet/minecraft/network/FriendlyByteBuf;", "buffer", "Lcom/cobblemon/mod/common/net/messages/client/callback/OpenMoveCallbackPacket;", "decode", "(Lnet/minecraft/network/FriendlyByteBuf;)Lcom/cobblemon/mod/common/net/messages/client/callback/OpenMoveCallbackPacket;", "Lnet/minecraft/resources/ResourceLocation;", "ID", "Lnet/minecraft/resources/ResourceLocation;", "getID", "()Lnet/minecraft/resources/ResourceLocation;", "<init>", "()V", "common"})
    public static final class Companion {
        ...
        @NotNull
        public final OpenMoveCallbackPacket decode(@NotNull FriendlyByteBuf buffer) {
            Intrinsics.checkNotNullParameter((Object)buffer, (String)"buffer");
            ...
            Intrinsics.checkNotNullExpressionValue((Object)list, (String)"buffer.readList { _ -> MoveSelectDTO(buffer) }");
            return new OpenMoveCallbackPacket(uUID, mutableComponent, list);
        }

        private static final MoveSelectDTO decode$lambda$0(FriendlyByteBuf $buffer, FriendlyByteBuf friendlyByteBuf) {
            Intrinsics.checkNotNullParameter((Object)$buffer, (String)"$buffer");
            return new MoveSelectDTO($buffer);
        }
