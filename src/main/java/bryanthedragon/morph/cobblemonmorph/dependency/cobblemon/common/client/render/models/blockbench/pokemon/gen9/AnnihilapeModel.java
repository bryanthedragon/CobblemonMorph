...
public class AnnihilapeModel(root: ModelPart) : PokemonPoseableModel, BipedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = AnnihilapeModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "annihilape", "sleep", null, 4, null),
               PoseableEntityModel.bedrock$default(this, "annihilape", "hair_overlay", null, 4, null)
            },
            null,
            null,
            222,
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "annihilape", "ground_idle", null, 4, null),
               PoseableEntityModel.bedrock$default(this, "annihilape", "hair_overlay", null, 4, null)
            },
            null,
      ...
      var var11: Array<StatelessAnimation> = new StatelessAnimation[]{
         PoseableEntityModel.bedrock$default(this, "annihilape", "ground_walk", null, 4, null),
         PoseableEntityModel.bedrock$default(this, "annihilape", "hair_overlay", null, 4, null)
      };
      ...
      var11 = new StatelessAnimation[]{
         PoseableEntityModel.bedrock$default(this, "annihilape", "battle_idle", null, 4, null),
         PoseableEntityModel.bedrock$default(this, "annihilape", "hair_overlay", null, 4, null)
      };
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isPosedIn(this.getStanding(), this.getWalking(), this.getBattleidle(), this.getSleep()))
         PoseableEntityModel.bedrockStateful$default(this, "annihilape", "faint", null, 4, null)
         else
         null;
   }

   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: AnnihilapeModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
