...
public abstract class JSBitwiseOrNode extends JSBinaryNode {
   ...
   public static JavaScriptNode create(JavaScriptNode left, JavaScriptNode right) {
      ...
      if (right instanceof JSConstantNode.JSConstantIntegerNode) {
         ...
         return rightValue == 0 ? JSToInt32Node.create(left, true) : JSBitwiseOrConstantNode.create(left, rightValue);
      } else {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return JSBitwiseOrNodeGen.create(cloneUninitialized(this.getLeft(), materializedTags), cloneUninitialized(this.getRight(), materializedTags));
   }
