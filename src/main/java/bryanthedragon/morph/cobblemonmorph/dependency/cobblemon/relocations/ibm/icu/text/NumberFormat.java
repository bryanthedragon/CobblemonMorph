...
public abstract class NumberFormat extends UFormat {
   ...
   public StringBuffer format(Object number, StringBuffer toAppendTo, FieldPosition pos) {
      ...
      } else if (number instanceof com.cobblemon.mod.relocations.ibm.icu.math.BigDecimal) {
         return this.format((com.cobblemon.mod.relocations.ibm.icu.math.BigDecimal)number, toAppendTo, pos);
   ...
   public final String format(com.cobblemon.mod.relocations.ibm.icu.math.BigDecimal number) {
      return this.format(number, new StringBuffer(), new FieldPosition(0)).toString();
   }
   ...
   public abstract StringBuffer format(com.cobblemon.mod.relocations.ibm.icu.math.BigDecimal var1, StringBuffer var2, FieldPosition var3);
   ...
   private static NumberFormat.NumberFormatShim getShim() {
      if (shim == null) {
         try {
            Class<?> cls = Class.forName("com.cobblemon.mod.relocations.ibm.icu.text.NumberFormatServiceShim");
   ...
   public boolean equals(Object obj) {
      if (obj == null) {
         ...
         return this.maximumIntegerDigits == other.maximumIntegerDigits
            ...
            && this.parseStrict == other.parseStrict
   ...
   public static class Field extends java.text.Format.Field {
      ...
      public static final NumberFormat.Field MEASURE_UNIT = new NumberFormat.Field("measure unit");
      public static final NumberFormat.Field COMPACT = new NumberFormat.Field("compact");
      public static final NumberFormat.Field APPROXIMATELY_SIGN = new NumberFormat.Field("approximately sign");
