...
public abstract class JSRegExpExecIntlNode extends JavaScriptBaseNode {
   ...
   @Node.Child
   private JSRegExpExecIntlNode.JSRegExpExecBuiltinNode regExpBuiltinNode;
   @Node.Child
   ...
   private Object builtinExec(JSRegExpObject regExp, TruffleString input) {
      if (this.regExpBuiltinNode == null) {
         CompilerDirectives.transferToInterpreterAndInvalidate();
         this.regExpBuiltinNode = this.insert(JSRegExpExecIntlNode.JSRegExpExecBuiltinNode.create(this.context));
      }
   ...
   public abstract static class BuildGroupsObjectNode extends JavaScriptBaseNode {
      ...
      final JSDynamicObject doCachedGroupsFactory(
         ...
         return doIt(context, this.getRealm(), cachedGroupsFactory, regexResult, input, isIndices);
      }
      ...
      final JSDynamicObject doVaryingGroupsFactory(JSContext context, JSDynamicObject regExp, Object regexResult, TruffleString input, boolean isIndices) {
         return doIt(context, this.getRealm(), JSRegExp.getGroupsFactory(regExp), regexResult, input, isIndices);
      }

      private static JSDynamicObject doIt(
         JSContext context, JSRealm realm, JSObjectFactory groupsFactory, Object regexResult, TruffleString input, boolean isIndices
      ) {
         return groupsFactory == null ? Undefined.instance : JSRegExp.createGroupsObject(context, realm, groupsFactory, regexResult, input, isIndices);
      }
   }
   ...
   public abstract static class JSRegExpExecBuiltinNode extends JavaScriptBaseNode {
      ...
      @Node.Child
      private JSRegExpExecIntlNode.BuildGroupsObjectNode groupsBuilder;
      ...
      Object doCached(JSRegExpObject regExp, TruffleString input, @Cached("getCompiledRegex(regExp)") Object cachedCompiledRegex) {
      ...
      private Object doExec(JSRegExpObject regExp, Object compiledRegex, TruffleString input) {
         ...
         if (!global && !sticky) {
            lastIndex = 0L;
         } else if (this.invalidLastIndex.profile(lastIndex < 0L || lastIndex > Strings.length(input))) {
      ...
      private JSArrayObject getMatchResult(JSRegExpObject regExp, Object regexResult, int groupCount, TruffleString inputStr, boolean hasIndices, JSRealm realm) {
         ...
         this.setIndexNode.putConstant(resultArray, JSRegExp.INDEX, JSRegExp.LAZY_INDEX_PROXY, JSAttributes.getDefault() | 16);
      ...
      private JSDynamicObject getGroupsObject(JSDynamicObject regExp, Object result, Object input, boolean isIndices) {
         if (this.groupsBuilder == null) {
            CompilerDirectives.transferToInterpreterAndInvalidate();
            this.groupsBuilder = this.insert(JSRegExpExecIntlNode.BuildGroupsObjectNode.create());
         }
