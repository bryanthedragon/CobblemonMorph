...
public class OlsonTimeZone extends BasicTimeZone {
   ...
   public boolean hasSameRules(TimeZone other) {
      if (this == other) {
         ...
         return this.transitionCount == o.transitionCount
            && Arrays.equals(this.transitionTimes64, o.transitionTimes64)
            && this.typeCount == o.typeCount
            && Arrays.equals(this.typeMapData, o.typeMapData)
            && Arrays.equals(this.typeOffsets, o.typeOffsets);
      }
   }
         ...
         if (this.transitionCount > 0) {
            ...
            if (transPre32 != null) {
               for (int i = 0; i < transPre32.length / 2; idx++) {
                  this.transitionTimes64[idx] = (transPre32[i * 2] & 4294967295L) << 32 | transPre32[i * 2 + 1] & 4294967295L;
                  i++;
               }
            }
            ...
            if (transPost32 != null) {
               for (int i = 0; i < transPost32.length / 2; idx++) {
                  this.transitionTimes64[idx] = (transPost32[i * 2] & 4294967295L) << 32 | transPost32[i * 2 + 1] & 4294967295L;
                  i++;
               }
            }
         } else {
   ...
   public OlsonTimeZone(String id) {
      ...
      UResourceBundle top = UResourceBundle.getBundleInstance(
         "com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", "zoneinfo64", ICUResourceBundle.ICU_DATA_CLASS_LOADER
      );
   ...
   public boolean equals(Object obj) {
      if (!super.equals(obj)) {
         ...
         return Utility.arrayEquals(this.typeMapData, z.typeMapData)
            || this.finalStartYear == z.finalStartYear
               && (
                  this.finalZone == null && z.finalZone == null
                     || this.finalZone != null
                        && z.finalZone != null
                        && this.finalZone.equals(z.finalZone)
                        && this.transitionCount == z.transitionCount
                        && this.typeCount == z.typeCount
                        && Utility.arrayEquals(this.transitionTimes64, z.transitionTimes64)
                        && Utility.arrayEquals(this.typeOffsets, z.typeOffsets)
                        && Utility.arrayEquals(this.typeMapData, z.typeMapData)
               );
      }
   }
   ...
   public int hashCode() {
      int ret = (int)(
         this.finalStartYear ^ (this.finalStartYear >>> 4) + this.transitionCount ^ (this.transitionCount >>> 6) + this.typeCount
            ^ (this.typeCount >>> 8)
               + Double.doubleToLongBits(this.finalStartMillis)
               + (this.finalZone == null ? 0 : this.finalZone.hashCode())
               + super.hashCode()
      );
      if (this.transitionTimes64 != null) {
         for (int i = 0; i < this.transitionTimes64.length; i++) {
            ret = (int)(ret + (this.transitionTimes64[i] ^ this.transitionTimes64[i] >>> 8));
         }
      }
   ...
   public TimeZoneTransition getNextTransition(long base, boolean inclusive) {
      ...
      if (this.historicRules == null) {
         ...
         if (ttidx == this.transitionCount - 1) {
            ...
            return from.getName().equals(to.getName()) && from.getRawOffset() == to.getRawOffset() && from.getDSTSavings() == to.getDSTSavings()
               ? this.getNextTransition(startTime, false)
               : new TimeZoneTransition(startTime, from, to);
         }
      }
   }
   ...
   public TimeZoneTransition getPreviousTransition(long base, boolean inclusive) {
      ...
      if (this.historicRules == null) {
         ...
         if (ttidx < this.firstTZTransitionIdx) {
            ...
            return from.getName().equals(to.getName()) && from.getRawOffset() == to.getRawOffset() && from.getDSTSavings() == to.getDSTSavings()
               ? this.getPreviousTransition(startTime, false)
               : new TimeZoneTransition(startTime, from, to);
         }
      }
   }
   ...
   public TimeZoneRule[] getTimeZoneRules() {
      ...
      if (this.historicRules != null) {
         for (int ix = 0; ix < this.historicRules.length; ix++) {
            if (this.historicRules[ix] != null) {
               rules[idx++] = this.historicRules[ix];
            }
         }
      }
      ...
      if (!this.transitionRulesInitialized) {
         ...
         if (this.transitionCount > 0) {
            ...
            if (transitionIdx != this.transitionCount) {
               ...
               this.firstTZTransition = new TimeZoneTransition(
                  this.transitionTimes64[this.firstTZTransitionIdx] * 1000L, this.initialRule, this.historicRules[var15]
               );
            }
         }
