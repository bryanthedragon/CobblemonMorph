...
extends AbstractConstantKeysObject {
    ...
    extends AbstractRegexObject {
        ...
        @ExportMessage
        boolean execute(Object[] args, @Cached ExpectStringOrTruffleObjectNode expectStringOrTruffleObjectNode, @Cached ToLongNode toLongNode, @Cached ExecCompiledRegexNode execNode) throws ArityException, UnsupportedTypeException, UnsupportedMessageException {
            if (args.length != 2) {
                CompilerDirectives.transferToInterpreterAndInvalidate();
                throw ArityException.create(2, 2, args.length);
            }
    ...
    extends Node {
        ...
        Object execIdentity(String symbol, RegexObject receiver, Object input, int fromIndex, @Cached(value="symbol") String cachedSymbol, @Cached ExpectStringOrTruffleObjectNode expectStringOrTruffleObjectNode, @Cached ExecCompiledRegexNode execNode) throws UnsupportedMessageException, ArityException, UnsupportedTypeException {
        ...
        Object execEquals(String symbol, RegexObject receiver, Object input, int fromIndex, @Cached(value="symbol") String cachedSymbol, @Cached ExpectStringOrTruffleObjectNode expectStringOrTruffleObjectNode, @Cached ExecCompiledRegexNode execNode) throws UnsupportedMessageException, ArityException, UnsupportedTypeException {
            return execNode.execute(receiver.getExecCallTarget(), expectStringOrTruffleObjectNode.execute(input), fromIndex);
        }

        @Specialization(guards={"symbol == cachedSymbol", "cachedSymbol.equals(PROP_EXEC_BOOLEAN)"}, limit="3")
        boolean execBooleanIdentity(String symbol, RegexObject receiver, Object input, int fromIndex, @Cached(value="symbol") String cachedSymbol, @Cached ExpectStringOrTruffleObjectNode expectStringOrTruffleObjectNode, @Cached ExecCompiledRegexNode execNode) throws UnsupportedMessageException, ArityException, UnsupportedTypeException {
        ...
        boolean execBooleanEquals(String symbol, RegexObject receiver, Object input, int fromIndex, @Cached(value="symbol") String cachedSymbol, @Cached ExpectStringOrTruffleObjectNode expectStringOrTruffleObjectNode, @Cached ExecCompiledRegexNode execNode) throws UnsupportedMessageException, ArityException, UnsupportedTypeException {
            return execNode.execute(receiver.getExecBooleanCallTarget(), expectStringOrTruffleObjectNode.execute(input), fromIndex) != RegexResult.getNoMatchInstance();
        }

        @Specialization(guards={"symbol == cachedSymbol", "cachedSymbol.equals(PROP_EXEC_BYTES)"}, limit="3")
        Object execBytesIdentity(String symbol, RegexObject receiver, Object input, int fromIndex, @Cached(value="symbol") String cachedSymbol, @Cached ExpectByteArrayHostObjectNode expectByteArrayHostObjectNode, @Cached ExecCompiledRegexNode execNode) throws UnsupportedMessageException, ArityException, UnsupportedTypeException {
        ...
        Object execBytesEquals(String symbol, RegexObject receiver, Object input, int fromIndex, @Cached(value="symbol") String cachedSymbol, @Cached ExpectByteArrayHostObjectNode expectByteArrayHostObjectNode, @Cached ExecCompiledRegexNode execNode) throws UnsupportedMessageException, ArityException, UnsupportedTypeException {
            return execNode.execute(receiver.getExecCallTarget(), expectByteArrayHostObjectNode.execute(input), fromIndex);
        }

        @Specialization(replaces={"execEquals", "execBooleanEquals", "execBytesEquals"})
        @ReportPolymorphism.Megamorphic
        static Object invokeGeneric(String symbol, RegexObject receiver, Object input, int fromIndex, @Cached ExpectStringOrTruffleObjectNode expectStringOrTruffleObjectNode, @Cached ExpectByteArrayHostObjectNode expectByteArrayHostObjectNode, @Cached ExecCompiledRegexNode execNode) throws UnsupportedMessageException, ArityException, UnsupportedTypeException, UnknownIdentifierException {
            switch (symbol) {
                case "exec": {
                    return execNode.execute(receiver.getExecCallTarget(), expectStringOrTruffleObjectNode.execute(input), fromIndex);
                }
    ...
    static abstract class IsMemberInvocable {
        ...
        static boolean isInvocable(RegexObject receiver, String symbol) {
            return RegexObject.PROP_EXEC.equals(symbol) || RegexObject.PROP_EXEC_BOOLEAN.equals(symbol) || RegexObject.PROP_EXEC_BYTES.equals(symbol);
        }
    }
}
