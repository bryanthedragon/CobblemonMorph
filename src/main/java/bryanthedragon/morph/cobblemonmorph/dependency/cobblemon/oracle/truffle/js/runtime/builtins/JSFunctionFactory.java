...
public abstract class JSFunctionFactory {
   ...
   public static JSFunctionFactory create(JSContext context, JSDynamicObject prototype) {
      ...
      JSObjectFactory factory = (JSObjectFactory)(prototype == null
         ? JSObjectFactory.createUnbound(context, initialShape)
         : JSObjectFactory.createBound(context, prototype, initialShape));
      return new JSFunctionFactory.Default(context, factory);
   }

   static JSFunctionFactory createIntrinsic(
      JSContext context, JSObjectFactory objectFactory, boolean isStrict, boolean isConstructor, boolean isGenerator, boolean isBound, boolean isAsync
   ) {
   ...
   public final JSFunctionObject createWithPrototype(
      JSFunctionData functionData, MaterializedFrame enclosingFrame, Object classPrototype, JSRealm realm, JSDynamicObject prototype
   ) {
   ...
   public final JSFunctionObject createBound(
      JSFunctionData functionData, Object classPrototype, JSRealm realm, JSDynamicObject boundTargetFunction, Object boundThis, Object[] boundArguments
   ) {
   ...
   private JSFunctionObject createBoundES5(
      Shape shape,
