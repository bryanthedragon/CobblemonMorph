...
public final class TemporalDeadZoneCheckNode extends FrameSlotNode {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return new TemporalDeadZoneCheckNode(
         this.getSlotIndex(), this.getIdentifier(), NodeUtil.cloneNode(this.levelFrameNode), cloneUninitialized(this.child, materializedTags)
      );
   }
}
