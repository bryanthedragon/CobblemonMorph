...
public final class WeakMapPrototypeBuiltinsFactory {
   ...
   public static final class JSWeakMapDeleteNodeGen extends WeakMapPrototypeBuiltins.JSWeakMapDeleteNode implements Introspection.Provider {
      ...
      public Object execute(VirtualFrame frameValue) {
         ...
         if ((state_0 & 3) != 0 && arguments0Value_ instanceof JSWeakMapObject) {
            ...
            if ((state_0 & 1) != 0 && arguments1Value_ instanceof JSObject) {
               ...
               return WeakMapPrototypeBuiltins.JSWeakMapDeleteNode.delete(
                  arguments0Value__, arguments1Value__, this.delete_invertedGetter_, this.delete_hasInvertedProfile_
               );
            }
         ...
         try {
            ...
            if (arguments0Value instanceof JSWeakMapObject) {
               ...
               if (arguments1Value instanceof JSObject) {
                  ...
                  this.delete_invertedGetter_ = super.insert(WeakMapPrototypeBuiltinsFactory.DYNAMIC_OBJECT_LIBRARY_.createDispatched(5));
                  ...
                  hasLock = false;
                  return WeakMapPrototypeBuiltins.JSWeakMapDeleteNode.delete(
                     arguments0Value_, arguments1Value_, this.delete_invertedGetter_, this.delete_hasInvertedProfile_
                  );
               }
      ...
      public Introspection getIntrospectionData() {
         ...
         data[2] = s;
         s = new Object[]{"notWeakMap", null, null};
         if ((state_0 & 4) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
      ...
      public static WeakMapPrototypeBuiltins.JSWeakMapDeleteNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new WeakMapPrototypeBuiltinsFactory.JSWeakMapDeleteNodeGen(context, builtin, arguments);
      }
   }
   ...
   public static final class JSWeakMapGetNodeGen extends WeakMapPrototypeBuiltins.JSWeakMapGetNode implements Introspection.Provider {
      ...
      private Object executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
         ...
         try {
            ...
            if (arguments0Value instanceof JSWeakMapObject) {
               ...
               if (arguments1Value instanceof JSObject) {
                  JSObject arguments1Value_ = (JSObject)arguments1Value;
                  this.get_invertedGetter_ = super.insert(WeakMapPrototypeBuiltinsFactory.DYNAMIC_OBJECT_LIBRARY_.createDispatched(5));
                  this.get_hasInvertedProfile_ = ConditionProfile.createBinaryProfile();
                  int var14;
                  this.state_0_ = var14 = state_0 | 1;
                  lock.unlock();
                  hasLock = false;
                  return this.get(arguments0Value_, arguments1Value_, this.get_invertedGetter_, this.get_hasInvertedProfile_);
               }
               ...
               if (!JSGuards.isJSObject(arguments1Value)) {
                  ...
                  lock.unlock();
                  hasLock = false;
                  return WeakMapPrototypeBuiltins.JSWeakMapGetNode.getNonObjectKey(arguments0Value_, arguments1Value);
               }
            }
            ...
            if (JSGuards.isJSWeakMap(arguments0Value)) {
               ...
               lock.unlock();
               hasLock = false;
               return WeakMapPrototypeBuiltins.JSWeakMapGetNode.notWeakMap(arguments0Value, arguments1Value);
            }
         } finally {
            if (hasLock) {
               lock.unlock();
      ...
      public Introspection getIntrospectionData() {
         ...
         data[0] = 0;
         int state_0 = this.state_0_;
         Object[] s = new Object[]{"get", null, null};
         if ((state_0 & 1) != 0) {
            s[1] = (byte)1;
            ArrayList<Object> cached = new ArrayList<>();
         ...
         data[1] = s;
         s = new Object[]{"getNonObjectKey", null, null};
         if ((state_0 & 2) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
      ...
      public static WeakMapPrototypeBuiltins.JSWeakMapGetNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new WeakMapPrototypeBuiltinsFactory.JSWeakMapGetNodeGen(context, builtin, arguments);
      }
   }
   ...
   public static final class JSWeakMapHasNodeGen extends WeakMapPrototypeBuiltins.JSWeakMapHasNode implements Introspection.Provider {
      ...
      private boolean executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
         ...
         try {
            ...
            if (arguments0Value instanceof JSWeakMapObject) {
               ...
               if (arguments1Value instanceof JSObject) {
                  JSObject arguments1Value_ = (JSObject)arguments1Value;
                  this.has_invertedGetter_ = super.insert(WeakMapPrototypeBuiltinsFactory.DYNAMIC_OBJECT_LIBRARY_.createDispatched(5));
                  this.has_hasInvertedProfile_ = ConditionProfile.createBinaryProfile();
                  int var14;
                  this.state_0_ = var14 = state_0 | 1;
                  lock.unlock();
                  hasLock = false;
                  return this.has(arguments0Value_, arguments1Value_, this.has_invertedGetter_, this.has_hasInvertedProfile_);
               }
               ...
               if (!JSGuards.isJSObject(arguments1Value)) {
                  ...
                  lock.unlock();
                  hasLock = false;
                  return WeakMapPrototypeBuiltins.JSWeakMapHasNode.hasNonObjectKey(arguments0Value_, arguments1Value);
               }
            }
            ...
            if (JSGuards.isJSWeakMap(arguments0Value)) {
               ...
               lock.unlock();
               hasLock = false;
               return WeakMapPrototypeBuiltins.JSWeakMapHasNode.notWeakMap(arguments0Value, arguments1Value);
            }
         } finally {
            if (hasLock) {
               lock.unlock();
      ...
      public static WeakMapPrototypeBuiltins.JSWeakMapHasNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new WeakMapPrototypeBuiltinsFactory.JSWeakMapHasNodeGen(context, builtin, arguments);
      }
   }
   ...
   public static final class JSWeakMapSetNodeGen extends WeakMapPrototypeBuiltins.JSWeakMapSetNode implements Introspection.Provider {
      ...
      private volatile int state_0_;
      @Node.Child
      private WeakMapPrototypeBuiltinsFactory.JSWeakMapSetNodeGen.SetData set_cache;
      ...
      public Object execute(VirtualFrame frameValue) {
         ...
         if (state_0 != 0) {
            if ((state_0 & 3) != 0 && arguments0Value_ instanceof JSWeakMapObject) {
               ...
               if ((state_0 & 1) != 0 && arguments1Value_ instanceof JSObject) {
                  JSObject arguments1Value__ = (JSObject)arguments1Value_;
                  WeakMapPrototypeBuiltinsFactory.JSWeakMapSetNodeGen.SetData s0_ = this.set_cache;
                  if (s0_ != null) {
      ...
      private Object executeAndSpecialize(Object arguments0Value, Object arguments1Value, Object arguments2Value) {
         ...
         try {
            ...
            if (arguments0Value instanceof JSWeakMapObject) {
               ...
               if (arguments1Value instanceof JSObject) {
                  JSObject arguments1Value_ = (JSObject)arguments1Value;
                  WeakMapPrototypeBuiltinsFactory.JSWeakMapSetNodeGen.SetData s0_ = super.insert(
                     new WeakMapPrototypeBuiltinsFactory.JSWeakMapSetNodeGen.SetData()
                  );
                  s0_.invertedGetter_ = s0_.insertAccessor(WeakMapPrototypeBuiltinsFactory.DYNAMIC_OBJECT_LIBRARY_.createDispatched(5));
                  s0_.invertedSetter_ = s0_.insertAccessor(WeakMapPrototypeBuiltinsFactory.DYNAMIC_OBJECT_LIBRARY_.createDispatched(5));
                  ...
                  lock.unlock();
                  hasLock = false;
                  return this.set(arguments0Value_, arguments1Value_, arguments2Value, s0_.invertedGetter_, s0_.invertedSetter_, s0_.hasInvertedProfile_);
               }
               ...
               if (!JSGuards.isJSObject(arguments1Value)) {
                  ...
                  lock.unlock();
                  hasLock = false;
                  return WeakMapPrototypeBuiltins.JSWeakMapSetNode.setNonObjectKey(arguments0Value_, arguments1Value, arguments2Value);
               }
            }
            ...
            if (JSGuards.isJSWeakMap(arguments0Value)) {
               ...
               lock.unlock();
               hasLock = false;
               return WeakMapPrototypeBuiltins.JSWeakMapSetNode.notWeakMap(arguments0Value, arguments1Value, arguments2Value);
            }
         } finally {
            if (hasLock) {
               lock.unlock();
      ...
      public Introspection getIntrospectionData() {
         ...
         data[1] = s;
         s = new Object[]{"setNonObjectKey", null, null};
         if ((state_0 & 2) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
      ...
      public static WeakMapPrototypeBuiltins.JSWeakMapSetNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new WeakMapPrototypeBuiltinsFactory.JSWeakMapSetNodeGen(context, builtin, arguments);
      }
