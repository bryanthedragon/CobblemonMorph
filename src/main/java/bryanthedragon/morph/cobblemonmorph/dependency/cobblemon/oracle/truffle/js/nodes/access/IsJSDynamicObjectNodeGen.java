...
@GeneratedBy(IsJSDynamicObjectNode.class)
public final class IsJSDynamicObjectNodeGen extends IsJSDynamicObjectNode implements Introspection.Provider {
   private static final IsJSDynamicObjectNodeGen.Uncached UNCACHED = new IsJSDynamicObjectNodeGen.Uncached();
   ...
   @GeneratedBy(IsJSDynamicObjectNode.class)
   @DenyReplace
   private static final class Uncached extends IsJSDynamicObjectNode {
