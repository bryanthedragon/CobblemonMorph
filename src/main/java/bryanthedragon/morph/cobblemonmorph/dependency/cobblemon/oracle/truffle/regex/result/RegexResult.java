...
extends AbstractConstantKeysObject {
    ...
    protected RegexResult(Object input, int fromIndex, int start2, int end2, int[] result, CallTarget lazyCallTarget) {
        this.input = input;
    ...
    public static RegexResult create(int start2, int end2) {
        return new RegexResult(null, -1, 0, 0, new int[]{start2, end2}, null);
    }
    ...
    public static RegexResult createLazy(Object input, int fromIndex, int start2, int end2, CallTarget lazyCallTarget) {
        return new RegexResult(input, fromIndex, start2, end2, null, lazyCallTarget);
    }
    ...
    extends Node {
        ...
        static int doResult(RegexResult receiver, int groupNumber, @Cached BranchProfile lazyProfile, @Cached DispatchNode getIndicesCall) {
            ...
            return (i = groupNumber * 2) < 0 || i >= receiver.result.length ? -1 : receiver.result[i];
        }
    ...
    extends Node {
        ...
        static int doResult(RegexResult receiver, int groupNumber, @Cached BranchProfile lazyProfile, @Cached DispatchNode getIndicesCall) {
            ...
            return (i = groupNumber * 2 + 1) < 0 || i >= receiver.result.length ? -1 : receiver.result[i];
        }
    }
    ...
    static abstract class ReadMember {
        ...
        static int lastGroupIdentity(RegexResult receiver, String symbol, @Cached(value="symbol") String cachedSymbol) {
        ...
        static int lastGroupEquals(RegexResult receiver, String symbol, @Cached(value="symbol") String cachedSymbol) {
            return receiver.getLastGroup();
        }
