...
import com.oracle.truffle.js.nodes.access.IteratorIsDoneNodeGen;
import com.oracle.truffle.js.runtime.objects.IteratorRecord;
import java.util.Set;

public abstract class IteratorIsDoneNode
extends JavaScriptNode {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return IteratorIsDoneNode.create(IteratorIsDoneNode.cloneUninitialized(this.iteratorNode, materializedTags));
    }
}
