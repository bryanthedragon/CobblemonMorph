...
public abstract class JSRightShiftConstantNode extends JSUnaryNode {
   ...
   public InstrumentableNode materializeInstrumentableNodes(Set<Class<? extends Tag>> materializedTags) {
      if (materializedTags.contains(JSTags.BinaryOperationTag.class)) {
         ...
         JavaScriptNode node = JSRightShiftNodeGen.create(cloneUninitialized(this.getOperand(), materializedTags), constantNode);
   ...
   protected int doGeneric(Object a, @Cached("create()") JSToNumericNode leftToNumeric, @Cached("makeCopy()") JSRightShiftConstantNode innerShiftNode) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return JSRightShiftConstantNodeGen.create(cloneUninitialized(this.getOperand(), materializedTags), this.shiftValue);
   }
