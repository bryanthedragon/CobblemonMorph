...
@GeneratedBy(value=JSArrayLastElementIndexNode.class)
public final class JSArrayLastElementIndexNodeGen
extends JSArrayLastElementIndexNode
            ...
            if (arg0Value instanceof JSDynamicObject) {
                ...
                if ((exclude & 2) == 0 && arg2Value && !this.hasPrototypeElements(arg0Value_)) {
                    ...
                    if (s2_ != null) {
                        lock.unlock();
                        hasLock = false;
                        long l = this.doWithHolesCached(arg0Value_, arg1Value, arg2Value, s2_.cachedArrayType_, s2_.previousElementIndexNode_, s2_.isLengthMinusOne_);
                        return l;
                    }
                }
                if (arg2Value && (this.hasPrototypeElements(arg0Value_) || JSArrayElementIndexNode.hasHoles(arg0Value_))) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    long l = this.doWithHolesUncached(arg0Value_, arg1Value, arg2Value, s3_.previousElementIndexNode_, s3_.isLengthMinusOne_, s3_.arrayTypeProfile_);
                    return l;
                }
                if (!arg2Value && this.isSuitableForEnumBasedProcessingUsingOwnKeys(arg0Value_, arg1Value)) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    long l = this.doObjectViaEnumeration(arg0Value_, arg1Value, arg2Value, this.objectViaEnumeration_hasPropertyNode_);
                    return l;
                }
                if (!arg2Value && !this.isSuitableForEnumBasedProcessingUsingOwnKeys(arg0Value_, arg1Value) && JSArrayElementIndexNode.isSuitableForEnumBasedProcessing(arg0Value_, arg1Value)) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    long l = this.doObjectViaFullEnumeration(arg0Value_, arg1Value, arg2Value, this.objectViaFullEnumeration_hasPropertyNode_);
                    return l;
                }
            }
