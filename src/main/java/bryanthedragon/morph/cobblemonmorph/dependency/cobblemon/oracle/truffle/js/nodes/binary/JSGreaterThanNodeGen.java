...
public final class JSGreaterThanNodeGen extends JSGreaterThanNode implements Introspection.Provider {
   ...
   @Node.Child
   private JSGreaterThanNodeGen.GenericData generic_cache;
   ...
   public boolean executeBoolean(Object leftNodeValue, Object rightNodeValue) {
      ...
      if ((state_0 & 229376) != 0) {
         ...
         if ((state_0 & 131072) != 0) {
            JSGreaterThanNodeGen.GenericData s17_ = this.generic_cache;
   ...
   private boolean executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
      ...
      try {
         ...
         if ((exclude & 256) == 0 && JSGuards.isJavaNumber(leftNodeValue) && JSGuards.isJavaNumber(rightNodeValue)) {
            ...
            JSGreaterThanNodeGen.GenericData s17_ = super.insert(new JSGreaterThanNodeGen.GenericData());
            ...
            hasLock = false;
            return this.doGeneric(
               leftNodeValue, rightNodeValue, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.greaterThanNode_
            );
         }
      } finally {
         if (hasLock) {
