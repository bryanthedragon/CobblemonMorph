...
QuadrupedFrame {
    ...
    public DeerlingModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "deerling");
        this.head = this.getPart("head");
        this.portraitScale = 3.5f;
        this.portraitTranslation = new Vec3(-0.55, -1.1, 0.0);
