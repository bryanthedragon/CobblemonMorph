...
public class MathBuiltins extends JSBuiltinsContainer.SwitchEnum<MathBuiltins.Math> {
   ...
   protected MathBuiltins() {
      super(JSMath.CLASS_NAME, MathBuiltins.Math.class);
   }

   protected Object createNode(JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, MathBuiltins.Math builtinEnum) {
      switch (builtinEnum) {
         case abs:
   ...
   public static enum Math implements BuiltinEnum<MathBuiltins.Math> {
      abs(1),
      acos(1),
      asin(1),
      atan2(2),
      ...
      public int getECMAScriptVersion() {
         return EnumSet.range(imul, fround).contains(this) ? 6 : BuiltinEnum.super.getECMAScriptVersion();
      }
   }
}
