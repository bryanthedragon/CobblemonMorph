...
public class TepigModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = TepigModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "tepig", "sleep", null, 4, null)},
            null,
            null,
            218,
            null
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "tepig", "ground_idle", null, 4, null)
            },
            null,
      ...
      this.setWalk(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "tepig", "ground_walk", null, 4, null)
            },
            null,
            new ModelQuirk[]{blink},
            180,
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isPosedIn(this.getStanding(), this.getWalk(), this.getSleep()))
         PoseableEntityModel.bedrockStateful$default(this, "tepig", "faint", null, 4, null)
         else
         null;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: TepigModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
