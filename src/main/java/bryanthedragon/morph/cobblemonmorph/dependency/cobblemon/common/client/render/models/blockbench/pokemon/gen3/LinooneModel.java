...
public class LinooneModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "linoone", "sleep", null, 4, null)},
            null,
            null,
            222,
            null
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "linoone", "ground_idle", null, 4, null)
            },
            null,
      ...
      var var11: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "linoone", "ground_walk", null, 4, null)
      };
      ...
      var11 = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "linoone", "battle_idle", null, 4, null)
      };
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isPosedIn(this.getStanding(), this.getWalking(), this.getBattleidle(), this.getSleep()))
         PoseableEntityModel.bedrockStateful$default(this, "linoone", "faint", null, 4, null)
         else
         null;
   }
