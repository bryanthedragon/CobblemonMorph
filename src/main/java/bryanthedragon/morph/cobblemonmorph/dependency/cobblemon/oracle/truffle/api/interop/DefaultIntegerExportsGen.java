...
@GeneratedBy(value=DefaultIntegerExports.class)
final class DefaultIntegerExportsGen {
    ...
    static {
        LibraryExport.register(DefaultIntegerExports.class, new InteropLibraryExports());
    }
    ...
    extends LibraryExport<InteropLibrary> {
        ...
        extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert (!(receiver instanceof Integer) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null) : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
