...
import com.oracle.truffle.api.impl.asm.Context;
...
import com.oracle.truffle.api.impl.asm.MethodWriter;
...
public class ClassReader {
    ...
    private void readCode(MethodVisitor methodVisitor, Context context, int codeOffset) {
        ...
        while (exceptionTableLength-- > 0) {
            Label start2 = this.createLabel(this.readUnsignedShort(currentOffset), labels);
            Label end2 = this.createLabel(this.readUnsignedShort(currentOffset + 2), labels);
            ...
            currentOffset += 8;
            methodVisitor.visitTryCatchBlock(start2, end2, handler, catchType);
        }
        ...
        while (currentOffset < bytecodeEndOffset) {
            ...
            switch (opcode) {
                ...
                case 186: {
                    ...
                    Handle handle2 = (Handle)this.readConst(this.readUnsignedShort(bootstrapMethodOffset), charBuffer);
                    ...
                    methodVisitor.visitInvokeDynamicInsn(name, descriptor, handle2, bootstrapMethodArguments);
                    currentOffset += 5;
                    break;
                }
                case 187: 
    ...
    final String readUtf(int constantPoolEntryIndex, char[] charBuffer) {
        String value2 = this.constantUtf8Values[constantPoolEntryIndex];
        if (value2 != null) {
            return value2;
        }
    ...
    private ConstantDynamic readConstantDynamic(int constantPoolEntryIndex, char[] charBuffer) {
        ...
        this.constantDynamicValues[constantPoolEntryIndex] = new ConstantDynamic(name, descriptor, handle2, bootstrapMethodArguments);
