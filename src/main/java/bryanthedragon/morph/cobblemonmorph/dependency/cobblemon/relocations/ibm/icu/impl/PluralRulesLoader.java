...
extends PluralRules.Factory {
        ...
        if (!haveMap) {
            ...
            try {
                ...
                for (i = 0; i < localeb.getSize(); ++i) {
                    b = localeb.get(i);
                    id = b.getKey();
                    value2 = b.getString().intern();
                    tempLocaleIdToCardinalRulesId.put(id, value2);
                    if (tempRulesIdToEquivalentULocale.containsKey(value2)) continue;
                    tempRulesIdToEquivalentULocale.put(value2, new ULocale(id));
                }
                ...
                for (i = 0; i < localeb.getSize(); ++i) {
                    ...
                    id = b.getKey();
                    value2 = b.getString().intern();
                    tempLocaleIdToOrdinalRulesId.put(id, value2);
                }
            }
    ...
    public UResourceBundle getPluralBundle() throws MissingResourceException {
        return ICUResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", "plurals", ICUResourceBundle.ICU_DATA_CLASS_LOADER, true);
    }
