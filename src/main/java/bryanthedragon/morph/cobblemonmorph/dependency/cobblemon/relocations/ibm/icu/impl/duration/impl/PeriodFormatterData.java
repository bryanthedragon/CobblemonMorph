...
public class PeriodFormatterData {
            ...
            System.out
               .println(
                  "Null Pointer in PeriodFormatterData["
                     ...
                     + form
                     + " pn: "
                     + Arrays.toString((Object[])this.dr.pluralNames)
               );
            throw var18;
         }
      }
   ...
   public int appendCount(
      TimeUnit unit, boolean omitCount, boolean useDigitPrefix, int count, int cv, boolean useSep, String name, boolean last, StringBuffer sb
   ) {
   ...
   public void appendDigits(long num, int mindigits, int maxdigits, StringBuffer sb) {
      ...
      while (ix > 0 && num > 0L) {
         buf[--ix] = (char)(this.dr.zero + num % 10L);
         num /= 10L;
      }
               ...
               switch (this.dr.fractionHandling) {
                  ...
                  case 2:
                     ...
                     if (vx == 1) {
                        ...
                        if ((vx & 1) == 1) {
                           if (this.dr.pl == 5 && vx > 21) {
                              return 5;
                           } else if (vx == 3 && this.dr.pl == 1 && this.dr.fractionHandling != 2) {
                              return 0;
                           }
                        }
                        break;
