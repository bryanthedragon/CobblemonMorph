...
import com.cobblemon.mod.relocations.ibm.icu.impl.duration.impl.Utils;
...
public class PeriodFormatterData {
    ...
    public boolean appendUnit(TimeUnit unit, int count, int cv, int uv, boolean useCountSep, boolean useDigitPrefix, boolean multiple, boolean last, boolean wasSkipped, StringBuffer sb) {
        ...
        String name = null;
        int form2 = this.computeForm(unit, count, cv, multiple && last);
        if (form2 == 4) {
            ...
            try {
                ...
                System.out.println("Null Pointer in PeriodFormatterData[" + this.localeName + "].au px: " + px + " form: " + form2 + " pn: " + Arrays.toString((Object[])this.dr.pluralNames));
                throw e;
            }
        }
        if (name == null) {
        ...
        boolean omitCount = form2 == 4 || form2 == 6 || this.dr.omitSingularCount && form2 == 1 || this.dr.omitDualCount && form2 == 2;
