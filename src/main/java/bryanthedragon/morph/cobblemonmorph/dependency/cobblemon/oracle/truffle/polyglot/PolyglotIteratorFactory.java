...
@GeneratedBy(value=PolyglotIterator.class)
final class PolyglotIteratorFactory {
    private static final LibraryFactory<InteropLibrary> INTEROP_LIBRARY_ = LibraryFactory.resolve(InteropLibrary.class);

    PolyglotIteratorFactory() {
    }

    @GeneratedBy(value=PolyglotIterator.Cache.class)
    static final class CacheFactory {
        CacheFactory() {
        }

        @GeneratedBy(value=PolyglotIterator.Cache.NextNode.class)
        static final class NextNodeGen
        extends PolyglotIterator.Cache.NextNode {
            ...
            private Object cached1Boundary(int state_0, Cached1Data s1_, PolyglotLanguageContext arg0Value, Object arg1Value, Object[] arg2Value) {
                ...
                try {
                    ...
                    Object object = this.doCached(arg0Value, arg1Value, arg2Value, iterators__, s1_.toHost_, s1_.error_, s1_.stop_);
                    return object;
                }
                finally {
                ...
                try {
                    ...
                    if (exclude == 0) {
                        ...
                        if (s0_ != null) {
                            lock.unlock();
                            hasLock = false;
                            Object object2 = this.doCached(arg0Value, arg1Value, arg2Value, s0_.iterators_, s0_.toHost_, s0_.error_, s0_.stop_);
                            return object2;
                        }
                    }
                    ...
                    try {
                        ...
                        lock.unlock();
                        hasLock = false;
                        object = this.doCached(arg0Value, arg1Value, arg2Value, iterators__, s1_.toHost_, s1_.error_, s1_.stop_);
                        encapsulating_.set(prev_);
                    }
        ...
        @GeneratedBy(value=PolyglotIterator.Cache.HasNextNode.class)
        static final class HasNextNodeGen
        extends PolyglotIterator.Cache.HasNextNode {
            @CompilerDirectives.CompilationFinal
            private volatile int state_0_;
            @CompilerDirectives.CompilationFinal
            private volatile int exclude_;
            ...
            private Object cached1Boundary(int state_0, PolyglotLanguageContext arg0Value, Object arg1Value, Object[] arg2Value) {
                ...
                try {
                    ...
                    Object object = this.doCached(arg0Value, arg1Value, arg2Value, cached1_iterators__, this.cached1_error_);
                    return object;
                }
                finally {
                    encapsulating_.set(prev_);
                ...
                try {
                    ...
                    if (exclude == 0) {
                        ...
                        if (s0_ != null) {
                            lock.unlock();
                            hasLock = false;
                            Object object2 = this.doCached(arg0Value, arg1Value, arg2Value, s0_.iterators_, s0_.error_);
                            return object2;
                        }
                    }
                    ...
                    try {
                        ...
                        lock.unlock();
                        hasLock = false;
                        object = this.doCached(arg0Value, arg1Value, arg2Value, cached1_iterators__, this.cached1_error_);
                        encapsulating_.set(prev_);
                    }
                    catch (Throwable throwable) {
                        encapsulating_.set(prev_);
