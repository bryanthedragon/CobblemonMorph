        ...
        if (this.debugStackTrace == null) {
            if (this.exception != null) {
                ...
                if (hostInfo) {
                    ...
                    Iterator<DebugStackTraceElement> mergedElements = Debugger.ACCESSOR.engineSupport().mergeHostGuestFrames(this.session.getDebugger().getEnv(), stack, debugStack.iterator(), true, new Function<StackTraceElement, DebugStackTraceElement>(){
