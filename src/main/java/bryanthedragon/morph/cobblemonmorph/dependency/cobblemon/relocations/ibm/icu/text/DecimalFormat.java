...
import com.cobblemon.mod.relocations.ibm.icu.impl.number.parse.NumberParserImpl;
...
extends NumberFormat {
        ...
        if (serialVersion == 5) {
            ...
            for (ObjectStreamField field : serializedFields) {
                ...
                if (name.equals("mathContext")) {
                    this.setMathContextICU((com.cobblemon.mod.relocations.ibm.icu.math.MathContext)fieldGetter.get("mathContext", null));
                    continue;
                }
    ...
    public synchronized void setSignAlwaysShown(boolean value2) {
        this.properties.setSignAlwaysShown(value2);
        this.refreshFormatter();
    }
    ...
    public synchronized void setRoundingIncrement(double increment) {
        if (increment == 0.0) {
            ...
            java.math.BigDecimal javaBigDecimal = java.math.BigDecimal.valueOf(increment).stripTrailingZeros();
            this.setRoundingIncrement(javaBigDecimal);
        }
    }
    ...
    public synchronized com.cobblemon.mod.relocations.ibm.icu.math.MathContext getMathContextICU() {
        MathContext mathContext = this.getMathContext();
        return new com.cobblemon.mod.relocations.ibm.icu.math.MathContext(mathContext.getPrecision(), this.icuMathContextForm, false, mathContext.getRoundingMode().ordinal());
    }

    public synchronized void setMathContextICU(com.cobblemon.mod.relocations.ibm.icu.math.MathContext mathContextICU) {
    ...
    @Override
    public synchronized void setMinimumIntegerDigits(int value2) {
        int max2 = this.properties.getMaximumIntegerDigits();
        if (max2 >= 0 && max2 < value2) {
            this.properties.setMaximumIntegerDigits(value2);
        }
        this.properties.setMinimumIntegerDigits(value2);
        this.refreshFormatter();
    }
    ...
    @Override
    public synchronized void setMaximumIntegerDigits(int value2) {
        int min2 = this.properties.getMinimumIntegerDigits();
        if (min2 >= 0 && min2 > value2) {
            this.properties.setMinimumIntegerDigits(value2);
        }
        this.properties.setMaximumIntegerDigits(value2);
        this.refreshFormatter();
    ...
    @Override
    public synchronized void setMinimumFractionDigits(int value2) {
        int max2 = this.properties.getMaximumFractionDigits();
        if (max2 >= 0 && max2 < value2) {
            this.properties.setMaximumFractionDigits(value2);
        }
        this.properties.setMinimumFractionDigits(value2);
        this.refreshFormatter();
    }
    ...
    @Override
    public synchronized void setMaximumFractionDigits(int value2) {
        int min2 = this.properties.getMinimumFractionDigits();
        if (min2 >= 0 && min2 > value2) {
            this.properties.setMinimumFractionDigits(value2);
        }
        this.properties.setMaximumFractionDigits(value2);
    ...
    public synchronized void setMinimumSignificantDigits(int value2) {
        int max2 = this.properties.getMaximumSignificantDigits();
        if (max2 >= 0 && max2 < value2) {
            this.properties.setMaximumSignificantDigits(value2);
        }
        this.properties.setMinimumSignificantDigits(value2);
        this.refreshFormatter();
    }
    ...
    public synchronized void setMaximumSignificantDigits(int value2) {
        int min2 = this.properties.getMinimumSignificantDigits();
        if (min2 >= 0 && min2 > value2) {
            this.properties.setMinimumSignificantDigits(value2);
        }
        this.properties.setMaximumSignificantDigits(value2);
    ...
    public synchronized void setDecimalSeparatorAlwaysShown(boolean value2) {
        this.properties.setDecimalSeparatorAlwaysShown(value2);
        this.refreshFormatter();
    }
    ...
    public synchronized void setParseBigDecimal(boolean value2) {
        this.properties.setParseToBigDecimal(value2);
        this.refreshFormatter();
    }
    ...
    public synchronized void setDecimalPatternMatchRequired(boolean value2) {
        this.properties.setDecimalPatternMatchRequired(value2);
        this.refreshFormatter();
    }
    ...
    public synchronized void setParseNoExponent(boolean value2) {
        this.properties.setParseNoExponent(value2);
        this.refreshFormatter();
    }
    ...
    public synchronized void setParseCaseSensitive(boolean value2) {
        this.properties.setParseCaseSensitive(value2);
        this.refreshFormatter();
    }
