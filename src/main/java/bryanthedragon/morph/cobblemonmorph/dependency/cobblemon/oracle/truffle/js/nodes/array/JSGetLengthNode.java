...
extends JavaScriptBaseNode {
    ...
    public int getArrayLengthInt(JSArrayObject target, @Cached(value="create()") ArrayLengthNode.ArrayLengthReadNode arrayLengthReadNode) throws UnexpectedResultException {
        return arrayLengthReadNode.executeInt(target);
    }

    @Specialization(replaces={"getArrayLengthInt"})
    public double getArrayLength(JSArrayObject target, @Cached(value="create()") ArrayLengthNode.ArrayLengthReadNode arrayLengthReadNode) {
    ...
    public double getLengthForeign(Object target, @CachedLibrary(value="target") InteropLibrary interop, @Cached(value="create()") ImportValueNode importValueNode) {
