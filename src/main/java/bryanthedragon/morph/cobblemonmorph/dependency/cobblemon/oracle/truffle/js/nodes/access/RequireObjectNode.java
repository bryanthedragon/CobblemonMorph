...
public abstract class RequireObjectNode extends JavaScriptNode {
   ...
   protected static Object doObjectShape(
      JSDynamicObject object, @Cached("object.getShape()") Shape cachedShape, @Cached("isJSObject(object)") boolean cachedResult
   ) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return RequireObjectNodeGen.create(cloneUninitialized(this.operandNode, materializedTags));
   }
}
