...
@GeneratedBy(NamedEvaluationTargetNode.class)
final class NamedEvaluationTargetNodeWrapper extends NamedEvaluationTargetNode implements InstrumentableNode.WrapperNode {
   @Node.Child
