...
@GeneratedBy(PolyglotMapEntry.class)
final class PolyglotMapEntryFactory {
   private static final LibraryFactory<InteropLibrary> INTEROP_LIBRARY_ = LibraryFactory.resolve(InteropLibrary.class);

   @GeneratedBy(PolyglotMapEntry.Cache.class)
   static final class CacheFactory {
      @GeneratedBy(PolyglotMapEntry.Cache.GetNode.class)
      static final class GetNodeGen extends PolyglotMapEntry.Cache.GetNode {
         @CompilerDirectives.CompilationFinal
         private volatile int state_0_;
         @CompilerDirectives.CompilationFinal
         private volatile int exclude_;
         @Node.Child
         private PolyglotMapEntryFactory.CacheFactory.GetNodeGen.Cached0Data cached0_cache;
         @Node.Child
         ...
         protected Object executeImpl(PolyglotLanguageContext arg0Value, Object arg1Value, Object[] arg2Value) {
            ...
            if (state_0 != 0) {
               if ((state_0 & 1) != 0) {
                  for (PolyglotMapEntryFactory.CacheFactory.GetNodeGen.Cached0Data s0_ = this.cached0_cache; s0_ != null; s0_ = s0_.next_) {
         ...
         private Object cached1Boundary(int state_0, PolyglotLanguageContext arg0Value, Object arg1Value, Object[] arg2Value) {
            ...
            Object var8;
            try {
               InteropLibrary cached1_interop__ = PolyglotMapEntryFactory.INTEROP_LIBRARY_.getUncached(arg1Value);
         ...
         private Object executeAndSpecialize(PolyglotLanguageContext arg0Value, Object arg1Value, Object[] arg2Value) {
            ...
            try {
               ...
               if (exclude == 0) {
                  int count0_ = 0;
                  PolyglotMapEntryFactory.CacheFactory.GetNodeGen.Cached0Data s0_ = this.cached0_cache;
                  if ((state_0 & 1) != 0) {
                  ...
                  if (s0_ == null && count0_ < 5) {
                     s0_ = super.insert(new PolyglotMapEntryFactory.CacheFactory.GetNodeGen.Cached0Data(this.cached0_cache));
                     s0_.interop_ = s0_.insertAccessor(PolyglotMapEntryFactory.INTEROP_LIBRARY_.create(arg1Value));
               ...
               try {
                  cached1_interop__ = PolyglotMapEntryFactory.INTEROP_LIBRARY_.getUncached(arg1Value);
         ...
         public static PolyglotMapEntry.Cache.GetNode create(PolyglotMapEntry.Cache cache, String name, long index, Class<?> elementClass, Type elementType) {
            return new PolyglotMapEntryFactory.CacheFactory.GetNodeGen(cache, name, index, elementClass, elementType);
         }

         @GeneratedBy(PolyglotMapEntry.Cache.GetNode.class)
         private static final class Cached0Data extends Node {
            @Node.Child
            PolyglotMapEntryFactory.CacheFactory.GetNodeGen.Cached0Data next_;
            @Node.Child
            ...
            Cached0Data(PolyglotMapEntryFactory.CacheFactory.GetNodeGen.Cached0Data next_) {
               this.next_ = next_;
            }
