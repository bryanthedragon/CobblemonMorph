...
public final class UTF16 {
   ...
   public static int charAt(String source, int offset16) {
      ...
      return single < 55296 ? single : _charAt(source, offset16, single);
   }
   ...
   public static char getLeadSurrogate(int char32) {
      return char32 >= 65536 ? (char)(55232 + (char32 >> 10)) : '\u0000';
   }

   public static char getTrailSurrogate(int char32) {
      return char32 >= 65536 ? (char)(56320 + (char32 & 1023)) : (char)char32;
   }
         ...
         if (index == minlength) {
            ...
            if (c1 >= '\ud800' && c2 >= '\ud800' && codepointcompare) {
               if ((c1 > '\udbff' || index + 1 == length1 || !UTF16.isTrailSurrogate(s1.charAt(index + 1)))
                  && (!UTF16.isTrailSurrogate(c1) || index == 0 || !UTF16.isLeadSurrogate(s1.charAt(index - 1)))) {
                  c1 = (char)(c1 - 10240);
               }

               if ((c2 > '\udbff' || index + 1 == length2 || !UTF16.isTrailSurrogate(s2.charAt(index + 1)))
                  && (!UTF16.isTrailSurrogate(c2) || index == 0 || !UTF16.isLeadSurrogate(s2.charAt(index - 1)))) {
                  c2 = (char)(c2 - 10240);
               }
            }
