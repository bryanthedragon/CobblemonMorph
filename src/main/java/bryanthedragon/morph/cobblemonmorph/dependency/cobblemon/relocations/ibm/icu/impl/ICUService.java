...
import com.cobblemon.mod.relocations.ibm.icu.impl.ICUNotifier;
import com.cobblemon.mod.relocations.ibm.icu.impl.ICURWLock;
...
extends ICUNotifier {
            ...
            try {
                ...
                block4: do {
                    ...
                    while (index < limit) {
                        ...
                        if ((service2 = f.create(key, this)) != null) {
                            result = new CacheEntry(currentDescriptor, service2);
    ...
    private static final class CacheEntry {
        ...
        CacheEntry(String actualDescriptor, Object service2) {
    ...
    implements Factory {
        ...
        @Override
        public Object create(Key key, ICUService service2) {
