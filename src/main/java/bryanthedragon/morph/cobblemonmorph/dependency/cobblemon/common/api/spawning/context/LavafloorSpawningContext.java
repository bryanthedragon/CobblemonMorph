...
extends FlooredSpawningContext {
    ...
    public boolean isSafeSpace(@NotNull ServerLevel world, @NotNull BlockPos pos, @NotNull BlockState state) {
        ...
        return state.m_60819_().m_205070_(FluidTags.f_13132_);
    }
}
