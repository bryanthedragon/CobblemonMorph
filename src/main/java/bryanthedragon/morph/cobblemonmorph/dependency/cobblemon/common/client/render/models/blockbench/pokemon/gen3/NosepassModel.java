...
implements BipedFrame {
    ...
    public NosepassModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "nosepass");
    ...
    public void registerPoses() {
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "nosepass", "sleep", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "nosepass", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "nosepass", "ground_walk", null, 4, null)};
    ...
    public BedrockStatefulAnimation<PokemonEntity> getFaintAnimation(@NotNull PokemonEntity pokemonEntity, @NotNull PoseableEntityState<PokemonEntity> state) {
        ...
        return state.isNotPosedIn(poseArray) ? PoseableEntityModel.bedrockStateful$default(this, "nosepass", "faint", null, 4, null) : null;
    }
}
