...
import com.oracle.truffle.api.exception.ExceptionAccessor;
...
@GeneratedBy(value=ExceptionAccessor.InteropList.class)
final class InteropListGen {
    ...
    static {
        LibraryExport.register(ExceptionAccessor.InteropList.class, new InteropLibraryExports());
    }
    ...
    extends LibraryExport<InteropLibrary> {
        ...
        extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert (!(receiver instanceof ExceptionAccessor.InteropList) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null) : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
