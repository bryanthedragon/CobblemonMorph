...
extends BreakIterator {
    ...
    extends FilteredBreakIteratorBuilder {
        ...
        public Builder(ULocale loc) {
            ICUResourceBundle rb = ICUResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/brkitr", loc, ICUResourceBundle.OpenType.LOCALE_ROOT);
