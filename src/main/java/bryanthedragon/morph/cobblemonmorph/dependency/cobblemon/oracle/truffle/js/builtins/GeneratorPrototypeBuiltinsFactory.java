...
public final class GeneratorPrototypeBuiltinsFactory {
   @GeneratedBy(GeneratorPrototypeBuiltins.GeneratorResumeNode.class)
   public static final class GeneratorResumeNodeGen extends GeneratorPrototypeBuiltins.GeneratorResumeNode implements Introspection.Provider {
      @Node.Child
      ...
      public static GeneratorPrototypeBuiltins.GeneratorResumeNode create(
         JSContext context, JSBuiltin builtin, Completion.Type resumeType, JavaScriptNode[] arguments
      ) {
         return new GeneratorPrototypeBuiltinsFactory.GeneratorResumeNodeGen(context, builtin, resumeType, arguments);
      }
   }
}
