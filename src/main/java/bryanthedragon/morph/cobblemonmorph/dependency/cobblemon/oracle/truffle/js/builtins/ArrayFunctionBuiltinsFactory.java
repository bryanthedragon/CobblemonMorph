...
public final class ArrayFunctionBuiltinsFactory {
   ...
   public static final class JSArrayFromNodeGen extends ArrayFunctionBuiltins.JSArrayFromNode implements Introspection.Provider {
      @Node.Child
      ...
      public Introspection getIntrospectionData() {
         ...
         int state_0 = this.state_0_;
         Object[] s = new Object[]{"arrayFrom", null, null};
         if (state_0 != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
      ...
      public static ArrayFunctionBuiltins.JSArrayFromNode create(JSContext context, JSBuiltin builtin, boolean isTypedArray, JavaScriptNode[] arguments) {
         return new ArrayFunctionBuiltinsFactory.JSArrayFromNodeGen(context, builtin, isTypedArray, arguments);
      }
   }

   @GeneratedBy(ArrayFunctionBuiltins.JSArrayOfNode.class)
   public static final class JSArrayOfNodeGen extends ArrayFunctionBuiltins.JSArrayOfNode implements Introspection.Provider {
      @Node.Child
      private JavaScriptNode arguments0_;
      @Node.Child
      private JavaScriptNode arguments1_;
      ...
      public Introspection getIntrospectionData() {
         Object[] data = new Object[]{0, null};
         int state_0 = this.state_0_;
         Object[] s = new Object[]{"arrayOf", null, null};
         if (state_0 != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
      ...
      public static ArrayFunctionBuiltins.JSArrayOfNode create(JSContext context, JSBuiltin builtin, boolean isTypedArray, JavaScriptNode[] arguments) {
         return new ArrayFunctionBuiltinsFactory.JSArrayOfNodeGen(context, builtin, isTypedArray, arguments);
      }
   }

   @GeneratedBy(ArrayFunctionBuiltins.JSIsArrayNode.class)
   public static final class JSIsArrayNodeGen extends ArrayFunctionBuiltins.JSIsArrayNode implements Introspection.Provider {
      @Node.Child
      private JavaScriptNode arguments0_;
      ...
      public Introspection getIntrospectionData() {
         Object[] data = new Object[]{0, null};
         Object[] s = new Object[]{"isArray", (byte)1, null};
         data[1] = s;
         return Introspection.Provider.create(data);
      }

      public static ArrayFunctionBuiltins.JSIsArrayNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new ArrayFunctionBuiltinsFactory.JSIsArrayNodeGen(context, builtin, arguments);
      }
   }
}
