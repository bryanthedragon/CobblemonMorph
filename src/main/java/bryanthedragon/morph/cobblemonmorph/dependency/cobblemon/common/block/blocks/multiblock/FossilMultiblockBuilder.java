...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.util.blockPositionsAsList
...
public class FossilMultiblockBuilder(val center(BlockPos pos) : MultiblockStructureBuilder {
    ...
    override fun form(ServerLevel world) {
