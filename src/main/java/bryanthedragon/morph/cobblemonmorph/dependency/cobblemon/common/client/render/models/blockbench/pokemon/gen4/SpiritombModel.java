...
extends PokemonPoseableModel {
    ...
    public SpiritombModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "spiritomb");
        this.portraitScale = 1.3f;
        this.portraitTranslation = new Vec3(-0.4, 0.3, 0.0);
        this.profileScale = 0.75f;
        this.profileTranslation = new Vec3(-0.2, 0.6, 0.0);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "spiritomb", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "spiritomb", "ground_idle", null, 4, null)};
