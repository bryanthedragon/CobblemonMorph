...
extends Node {
    public abstract Object execute(CallTarget var1, RegexResult var2);

    @Specialization(guards={"target == cachedTarget"})
    static Object executeDirect(CallTarget target, RegexResult result, @Cached(value="target") CallTarget cachedTarget, @Cached(value="create(cachedTarget)") DirectCallNode callNode) {
