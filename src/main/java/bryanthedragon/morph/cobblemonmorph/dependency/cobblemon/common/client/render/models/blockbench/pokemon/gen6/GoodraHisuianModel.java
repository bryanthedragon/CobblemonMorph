...
public class GoodraHisuianModel(root: ModelPart) : PokemonPoseableModel, BipedFrame, BimanualFrame, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = GoodraHisuianModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "goodra_hisuian", "ground_idle", null, 4, null)
            },
            null,
      ...
      val var8: Array<StatelessAnimation> = new StatelessAnimation[]{
         ...
         new BimanualSwingAnimation(this, 0.6F, 0.5F)
      };
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: GoodraHisuianModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
