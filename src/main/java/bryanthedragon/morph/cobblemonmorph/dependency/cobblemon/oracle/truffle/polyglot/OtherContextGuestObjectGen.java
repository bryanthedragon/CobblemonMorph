...
@GeneratedBy(value=OtherContextGuestObject.class)
                ...
                if (state_0 != 0) {
                    ...
                    if ((state_0 & 1) != 0 && (s0_ = this.cached_cache) != null) {
                        ...
                        if (OtherContextGuestObject.canCache(s0_.cachedLayer_, arg0Value.receiverContext, arg0Value.delegateContext)) {
                            return OtherContextGuestObject.Send.doCached(arg0Value, arg1Value, arg2Value, receiverLibrary__, s0_.cachedLayer_, s0_.delegateLibrary_, s0_.seenOther_, s0_.seenError_);
                        }
                    }
                    if ((state_0 & 2) != 0) {
                        return OtherContextGuestObject.Send.doSlowPath(arg0Value, arg1Value, arg2Value);
                ...
                try {
                    ...
                    if (exclude == 0) {
                        ...
                        if (Cached_duplicateFound_) {
                            lock.unlock();
                            hasLock = false;
                            Object object = OtherContextGuestObject.Send.doCached(arg0Value, arg1Value, arg2Value, receiverLibrary__, s0_.cachedLayer_, s0_.delegateLibrary_, s0_.seenOther_, s0_.seenError_);
                            return object;
                        }
                    }
                    ...
                    lock.unlock();
                    hasLock = false;
                    Object object = OtherContextGuestObject.Send.doSlowPath(arg0Value, arg1Value, arg2Value);
                    return object;
                }
                finally {
                    if (hasLock) {
