...
@GeneratedBy(JSBitwiseOrConstantNode.class)
public final class JSBitwiseOrConstantNodeGen extends JSBitwiseOrConstantNode implements Introspection.Provider {
   ...
   @Node.Child
   private JSBitwiseOrConstantNodeGen.GenericIntCaseData genericIntCase_cache;
   @Node.Child
   ...
   public Object executeObject(Object operandNodeValue) {
      ...
      if ((state_0 & 1) != 0 && operandNodeValue instanceof Integer) {
         ...
         if ((state_0 & 768) != 0) {
            if ((state_0 & 256) != 0) {
               JSBitwiseOrConstantNodeGen.GenericIntCaseData s8_ = this.genericIntCase_cache;
   ...
   private Object executeAndSpecialize(Object operandNodeValue) {
      ...
      try {
         ...
         if (operandNodeValue instanceof JSOverloadedOperatorsObject) {
            ...
            JSBitwiseOrConstantNodeGen.GenericIntCaseData s8_ = super.insert(new JSBitwiseOrConstantNodeGen.GenericIntCaseData());
   ...
   public Introspection getIntrospectionData() {
      ...
      data[8] = s;
      s = new Object[]{"doGenericIntCase", null, null};
      if ((state_0 & 256) != 0) {
         s[1] = (byte)1;
         ArrayList<Object> cached = new ArrayList<>();
         JSBitwiseOrConstantNodeGen.GenericIntCaseData s8_ = this.genericIntCase_cache;
         if (s8_ != null) {
            cached.add(Arrays.asList(s8_.toNumeric_, s8_.profileIsBigInt_, s8_.innerOrNode_));
         }
   ...
   @GeneratedBy(JSBitwiseOrConstantNode.class)
   private static final class GenericIntCaseData extends Node {
      @Node.Child
