...
implements Introspection.Provider {
    ...
    public Object executeObject(Object operandNodeValue) {
        ...
        if ((state_0 & 0x300) != 0) {
            ...
            if ((state_0 & 0x100) != 0 && (s8_ = this.genericIntCase_cache) != null && !this.hasOverloadedOperators(operandNodeValue)) {
                assert (this.isInt);
    ...
    private Object execute_generic2(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0x300) != 0) {
            GenericIntCaseData s8_;
            if ((state_0 & 0x100) != 0 && (s8_ = this.genericIntCase_cache) != null && !this.hasOverloadedOperators(operandNodeValue_)) {
                assert (this.isInt);
    ...
    private Object executeAndSpecialize(Object operandNodeValue) {
        ...
        try {
            ...
            if (!this.hasOverloadedOperators(operandNodeValue) && this.isInt) {
                GenericIntCaseData s8_ = super.insert(new GenericIntCaseData());
