...
public class ForInIterator {
   ...
   public boolean isVisitedKey(final Object key) {
      return this.visitedShapesSize > 0 && visitedShapeSetContainsKey(this.visitedShapes, this.visitedShapesSize, key)
         || this.visitedKeys != null && Boundaries.economicSetContains(this.visitedKeys, key);
   }
