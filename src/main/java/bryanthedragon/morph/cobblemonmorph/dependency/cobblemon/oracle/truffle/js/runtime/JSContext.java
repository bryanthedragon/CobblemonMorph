...
public class JSContext {
    ...
    private final Map<TruffleString, JSFunctionData> namedEmptyFunctionsDataMap = new ConcurrentHashMap<TruffleString, JSFunctionData>();
    ...
    protected JSContext(Evaluator evaluator, JSContextOptions contextOptions, JavaScriptLanguage lang, TruffleLanguage.Env env) {
        ...
        this.symbolSpeciesThisGetterFunctionData = JSFunctionData.createCallOnly(this, JSContext.createReadFrameThisCallTarget(lang), 0, JSNonProxy.GET_SYMBOL_SPECIES_NAME);
        this.symbolIteratorThisGetterFunctionData = JSFunctionData.createCallOnly(this, JSContext.createReadFrameThisCallTarget(lang), 0, JSRealm.SYMBOL_ITERATOR_NAME);
    ...
    private synchronized void createSymbolRegistry() {
        if (this.symbolRegistry == null) {
            this.symbolRegistry = new HashMap<TruffleString, Symbol>();
        }
    }
    ...
    public CallTarget getNotConstructibleCallTarget() {
        ...
        result = JSContext.createNotConstructibleCallTarget(this.getLanguage(), false, this);
    ...
    public CallTarget getGeneratorNotConstructibleCallTarget() {
        ...
        result = JSContext.createNotConstructibleCallTarget(this.getLanguage(), true, this);
    ...
    public JSFunctionData getBoundFunctionData(boolean constructor, boolean async) {
        if (async) {
            if (constructor) {
                return this.getOrCreateBuiltinFunctionData(BuiltinFunctionKey.BoundConstructorAsync, c -> JSContext.makeBoundFunctionData(c, true, true));
            }
            return this.getOrCreateBuiltinFunctionData(BuiltinFunctionKey.BoundFunctionAsync, c -> JSContext.makeBoundFunctionData(c, false, true));
        }
        if (constructor) {
            return this.getOrCreateBuiltinFunctionData(BuiltinFunctionKey.BoundConstructor, c -> JSContext.makeBoundFunctionData(c, true, false));
        }
        return this.getOrCreateBuiltinFunctionData(BuiltinFunctionKey.BoundFunction, c -> JSContext.makeBoundFunctionData(c, false, false));
    }
    ...
    private static JSFunctionData makeBoundFunctionData(JSContext context, boolean constructor, boolean async) {
        ...
        return JSFunctionData.create(context, callTarget, constructTarget, constructNewTarget, 0, Strings.BOUND, constructor, false, true, false, false, false, async, false, true, false, true);
    }
    ...
    public void notifyPromiseRejectionTracker(JSDynamicObject promise, int operation, Object value2) {
        if (!this.promiseRejectionTrackerNotUsedAssumption.isValid() && this.promiseRejectionTracker != null) {
            switch (operation) {
                case 0: {
                    this.invokePromiseRejected(promise, value2);
                    break;
                }
                case 1: {
                ...
                case 2: {
                    this.invokePromiseRejectedAfterResolved(promise, value2);
                    break;
                }
                case 3: {
                    this.invokePromiseResolvedAfterResolved(promise, value2);
                    break;
                }
                default: {
    ...
    @CompilerDirectives.TruffleBoundary
    private void invokePromiseRejected(JSDynamicObject promise, Object value2) {
        this.promiseRejectionTracker.promiseRejected(promise, value2);
    }
    ...
    @CompilerDirectives.TruffleBoundary
    private void invokePromiseRejectedAfterResolved(JSDynamicObject promise, Object value2) {
        this.promiseRejectionTracker.promiseRejectedAfterResolved(promise, value2);
    }

    @CompilerDirectives.TruffleBoundary
    private void invokePromiseResolvedAfterResolved(JSDynamicObject promise, Object value2) {
        this.promiseRejectionTracker.promiseResolvedAfterResolved(promise, value2);
    }
    ...
    public final JSFunctionData getOrCreateBuiltinFunctionData(BuiltinFunctionKey key, Function<JSContext, JSFunctionData> factory) {
        ...
        if (!FUNCTION_DATA_ARRAY_VAR_HANDLE.compareAndSet(this.builtinFunctionData, index, (JSFunctionData)null, functionData)) {
            functionData = FUNCTION_DATA_ARRAY_VAR_HANDLE.getVolatile(this.builtinFunctionData, index);
        }
    ...
    private JSFunctionData protoSetterFunction() {
        RootCallTarget callTarget = new JavaScriptRootNode(this.getLanguage(), null, null){
            ...
            public Object execute(VirtualFrame frame) {
                ...
                Object value2 = JSArguments.getUserArgument(arguments, 0);
                if (!JSDynamicObject.isJSDynamicObject(value2) || value2 == Undefined.instance) {
                    return Undefined.instance;
                }
                ...
                if (!JSObject.setPrototype(thisObj, (JSDynamicObject)value2)) {
                    throw Errors.createTypeErrorCannotSetProto(thisObj, (JSDynamicObject)value2);
                }
                return Undefined.instance;
            }
        }.getCallTarget();
    ...
    public Charset getCharset() {
        ...
        if (chrset == null) {
            CompilerDirectives.transferToInterpreterAndInvalidate();
            this.charset = chrset = this.getCharsetImpl();
        }
        return chrset;
    }
    ...
    static {
        functionPrototypeSupplier = JSRealm::getFunctionPrototype;
        asyncFunctionPrototypeSupplier = JSRealm::getAsyncFunctionPrototype;
        generatorFunctionPrototypeSupplier = JSRealm::getGeneratorFunctionPrototype;
        asyncGeneratorFunctionPrototypeSupplier = JSRealm::getAsyncGeneratorFunctionPrototype;
        TYPE_IMPORT_ASSERTION = Strings.constant("type");
