...
public class ResolveNamedImportNode extends StatementNode {
   ...
   public static StatementNode create(
      JSContext context, JavaScriptNode moduleNode, Module.ModuleRequest moduleRequest, TruffleString importName, JSWriteFrameSlotNode writeLocalNode
   ) {
   ...
   public Object execute(VirtualFrame frame) {
      ...
      ExportResolution resolution = this.resolutionProfile.profile(evaluator.resolveExport(importedModule, this.importName));
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return create(
         this.context,
         cloneUninitialized(this.moduleNode, materializedTags),
         this.moduleRequest,
         this.importName,
         cloneUninitialized(this.writeLocalNode, materializedTags)
      );
   }
}
