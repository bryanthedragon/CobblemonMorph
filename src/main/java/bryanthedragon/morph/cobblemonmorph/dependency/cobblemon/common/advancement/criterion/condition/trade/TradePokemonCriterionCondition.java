...
public class TradePokemonCriterion(Optional<ContextAwarePredicate> playerCtx, String traded, String received, String tradedHeldItem, String receivedHeldItem): SimpleCriterionCondition<TradePokemonContext>(playerCtx) {

    final class Companion {
        public final Codec<TradePokemonCriterion> CODEC = RecordCodecBuilder.create { it.group(EntityPredicate.ADVANCEMENT_CODEC.optionalFieldOf("player").forGetter(TradePokemonCriterion::playerCtx), Codec.STRING.optionalFieldOf("traded", "any").forGetter(TradePokemonCriterion::traded), Codec.STRING.optionalFieldOf("received", "any").forGetter(TradePokemonCriterion::received), Codec.STRING.optionalFieldOf("traded_held_item", "minecraft:air").forGetter(TradePokemonCriterion::tradedHeldItem), Codec.STRING.optionalFieldOf("received_held_item", "minecraft:air").forGetter(TradePokemonCriterion::receivedHeldItem)).apply(it, ::TradePokemonCriterion) }
    }

    public boolean matches(ServerPlayer player, TradePokemonContext context) {
...
public class TradePokemonCriterionCondition(id: Identifier, entity: LootContextPredicate) : SimpleCriterionCondition<TradePokemonContext>(id, entity) {
    var traded = "any"
    var received = "any"
    ...
    override fun matches(ServerPlayer player, context: TradePokemonContext): Boolean {
