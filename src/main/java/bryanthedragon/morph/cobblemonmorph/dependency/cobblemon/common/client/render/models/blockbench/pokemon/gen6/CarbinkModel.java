...
extends PokemonPoseableModel {
    ...
    public CarbinkModel(@NotNull ModelPart root) {
        ...
        this.cryAnimation = (arg_0, arg_1) -> CarbinkModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ CarbinkModel this$0;
            {
        ...
        Object[] objectArray3 = new ModelPartTransformation[]{ModelPartExtensionsKt.createTransformation(this.getRootPart()).addPosition(1, -0.5)};
        objectArray = objectArray3;
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "carbink", "air_idle", null, 4, null)};
        ...
        objectArray3 = new ModelPartTransformation[]{ModelPartExtensionsKt.createTransformation(this.getRootPart()).addPosition(1, -3)};
        objectArray = objectArray3;
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "carbink", "air_walk", null, 4, null)};
        objectArray3 = statelessAnimationArray;
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(CarbinkModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
