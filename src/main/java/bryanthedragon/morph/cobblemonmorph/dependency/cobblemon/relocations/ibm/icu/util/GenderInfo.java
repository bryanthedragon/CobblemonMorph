...
public class GenderInfo {
    ...
    private static class Cache {
        ...
        private static GenderInfo load(ULocale ulocale) {
            UResourceBundle rb = UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", "genderList", ICUResourceBundle.ICU_DATA_CLASS_LOADER, true);
