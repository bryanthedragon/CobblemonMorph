...
public class MegaInstruction(message: BattleMessage) : InterpreterInstruction {
      ...
      if (var10000 != null) {
         ...
         PokemonBattle.dispatchWaiting$default(battle, 0.0F, (new Function0<Unit>(battlePokemon, battle, this) {
            ...
            public final void invoke() {
               ...
               val var10001: MutableComponent = LocalizationUtilsKt.battleLang("mega", pokemonName);
