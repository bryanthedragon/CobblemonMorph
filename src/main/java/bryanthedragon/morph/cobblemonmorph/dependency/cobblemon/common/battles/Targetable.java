...
public enum MoveTarget(val targetList: (Targetable) -> List<Targetable>? = { null }) {
    ...
    final class Companion {
         ...
         */
        fun fromShowdownId(String showdownId): MoveTarget = VALUES.first { target -> target.name.equals(showdownId, true) }
