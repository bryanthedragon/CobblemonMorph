...
final class RegexObjectExecMethodGen {
   ...
   static {
      LibraryExport.register(RegexObject.RegexObjectExecMethod.class, new RegexObjectExecMethodGen.InteropLibraryExports());
   }
   ...
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         InteropLibrary uncached = new RegexObjectExecMethodGen.InteropLibraryExports.Uncached(receiver);
         return uncached;
      }
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return new RegexObjectExecMethodGen.InteropLibraryExports.Cached(receiver);
      }
      ...
      private static final class Cached extends AbstractRegexObjectGen.InteropLibraryExports.Cached {
         ...
         @Node.Child
         private RegexObjectExecMethodGen.InteropLibraryExports.Cached.ExecuteData execute_cache;
         ...
         public Object execute(Object arg0Value_, Object... arg1Value) throws UnsupportedTypeException, ArityException, UnsupportedMessageException {
            ...
            if (state_0 != 0) {
               RegexObjectExecMethodGen.InteropLibraryExports.Cached.ExecuteData s0_ = this.execute_cache;
               if (s0_ != null) {
         ...
         private Object executeAndSpecialize(RegexObject.RegexObjectExecMethod arg0Value, Object[] arg1Value) throws ArityException, UnsupportedTypeException, UnsupportedMessageException {
            ...
            try {
               int state_0 = this.state_0_;
               RegexObjectExecMethodGen.InteropLibraryExports.Cached.ExecuteData s0_ = super.insert(
                  new RegexObjectExecMethodGen.InteropLibraryExports.Cached.ExecuteData()
               );
