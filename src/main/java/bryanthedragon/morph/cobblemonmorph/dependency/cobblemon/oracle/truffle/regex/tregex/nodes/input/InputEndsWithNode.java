...
public abstract class InputEndsWithNode extends Node {
   ...
   public boolean doTString(
      TruffleString input, TruffleString suffix, Object mask, Encodings.Encoding encoding, @Cached TruffleString.RegionEqualByteIndexNode regionEqualsNode
   ) {
   ...
   public boolean doTruffleObjBytes(
      Object input, byte[] suffix, Object mask, Encodings.Encoding encoding, @Cached InputLengthNode lengthNode, @Cached InputReadNode charAtNode
   ) {
   ...
   public boolean doTruffleObjBytesMask(
      Object input, byte[] suffix, byte[] mask, Encodings.Encoding encoding, @Cached InputLengthNode lengthNode, @Cached InputReadNode charAtNode
   ) {
   ...
   public boolean doTruffleObjString(
      Object input, String suffix, Object mask, Encodings.Encoding encoding, @Cached InputLengthNode lengthNode, @Cached InputReadNode charAtNode
   ) {
      return endsWithTruffleObj(input, suffix, null, encoding, lengthNode, charAtNode);
   }
   ...
   public boolean doTruffleObjStringMask(
      Object input, String suffix, String mask, Encodings.Encoding encoding, @Cached InputLengthNode lengthNode, @Cached InputReadNode charAtNode
   ) {
      assert mask.length() == suffix.length();
   ...
   private static boolean endsWithTruffleObj(
      Object input, byte[] suffix, byte[] mask, Encodings.Encoding encoding, InputLengthNode lengthNode, InputReadNode charAtNode
   ) {
   ...
   private static boolean endsWithTruffleObj(
      Object input, String suffix, String mask, Encodings.Encoding encoding, InputLengthNode lengthNode, InputReadNode charAtNode
   ) {
      int inputLength = lengthNode.execute(input, encoding);
      if (inputLength < suffix.length()) {
         return false;
