...
public abstract class AbstractContiguousObjectArray
extends AbstractObjectArray {
    ...
    public Object getInBoundsFastObject(JSDynamicObject object, int index) {
        return this.castNonNull(AbstractContiguousObjectArray.getArray(object)[(int)((long)index - this.getIndexOffset(object))]);
    }

    @Override
    public void setInBoundsFast(JSDynamicObject object, int index, Object value2) {
        AbstractContiguousObjectArray.getArray((JSDynamicObject)object)[(int)((long)index - this.getIndexOffset((JSDynamicObject)object))] = AbstractContiguousObjectArray.checkNonNull(value2);
    }
    ...
    public final long lastElementIndex(JSDynamicObject object) {
        return this.getIndexOffset(object) + (long)this.getArrayOffset(object) + (long)AbstractContiguousObjectArray.getUsedLength(object) - 1L;
    }
