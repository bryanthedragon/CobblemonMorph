...
record Seat(
    ...
    final class Companion {
        fun decode(RegistryFriendlyByteBuf buffer) : Seat {
            return Seat(
...
public class SeatPoseOffset {
    ...
    final class Companion {
        fun decode(RegistryFriendlyByteBuf buffer) : SeatPoseOffset {
...
public class SeatPoseAnimations {
    val poseTypes = mutableSetOf<PoseType>()
    ...
    final class Companion {
        fun decode(RegistryFriendlyByteBuf buffer) : SeatPoseAnimations {
