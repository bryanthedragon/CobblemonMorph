...
implements HeadedFrame {
    ...
    public LileepModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "lileep");
        this.head = this.getPart("head");
        this.portraitScale = 2.0f;
        this.portraitTranslation = new Vec3(-0.3, -0.5, 0.0);
        this.profileScale = 0.8f;
        this.profileTranslation = new Vec3(0.0, 0.55, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> LileepModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ LileepModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "lileep", "blink", null, 4, null);
            }
        }, 7, null);
        Object object = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "lileep", "sleep", null, 4, null)};
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "lileep", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "lileep", "ground_walk", null, 4, null)};
        objectArray = statelessAnimationArray;
        ...
        objectArray = new ModelQuirk[]{blink7};
        objectArray2 = objectArray;
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "lileep", "water_idle", null, 4, null)};
        objectArray = statelessAnimationArray;
        this.setWaterIdle(PoseableEntityModel.registerPose$default((PoseableEntityModel)this, "water_idle", (PoseType)((Object)object), null, 0, null, null, (StatelessAnimation[])objectArray, null, (ModelQuirk[])objectArray2, 188, null));
        object = PoseType.SWIM;
        objectArray = new ModelQuirk[]{blink7};
        objectArray2 = objectArray;
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "lileep", "water_swim", null, 4, null)};
        objectArray = statelessAnimationArray;
        this.setWaterSwim(PoseableEntityModel.registerPose$default((PoseableEntityModel)this, "water_swim", (PoseType)((Object)object), null, 0, null, null, (StatelessAnimation[])objectArray, null, (ModelQuirk[])objectArray2, 188, null));
    }
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(LileepModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "lileep", "cry", null, 4, null);
    }
}
