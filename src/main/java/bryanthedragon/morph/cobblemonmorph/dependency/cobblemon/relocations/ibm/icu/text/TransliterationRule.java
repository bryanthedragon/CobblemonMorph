...
class TransliterationRule {
   ...
   public boolean masks(TransliterationRule r2) {
      ...
      return left == left2 && right == right2 && this.keyLength <= r2.keyLength && r2.pattern.regionMatches(0, this.pattern, 0, len)
         ? this.flags == r2.flags || (this.flags & 1) == 0 && (this.flags & 2) == 0 || (r2.flags & 1) != 0 && (r2.flags & 2) != 0
         : left <= left2
            && (right < right2 || right == right2 && this.keyLength <= r2.keyLength)
            && r2.pattern.regionMatches(left2 - left, this.pattern, 0, len);
   }
