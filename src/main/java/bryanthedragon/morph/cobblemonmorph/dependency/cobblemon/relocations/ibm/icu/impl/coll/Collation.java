...
public final class Collation {
   ...
   static long latinCE0FromCE32(int ce32) {
      return (long)(ce32 & 0xFF000000) << 32 | 83886080L | (ce32 & 0xFF0000) >> 8;
   }

   static long latinCE1FromCE32(int ce32) {
      return (ce32 & 65280L) << 16 | 1280L;
   }
   ...
   static long ceFromSimpleCE32(int ce32) {
      ...
      return (long)(ce32 & -65536) << 32 | (long)(ce32 & 0xFF00) << 16 | (ce32 & 0xFF) << 8;
   }

   static long ceFromCE32(int ce32) {
      int tertiary = ce32 & 0xFF;
      if (tertiary < 192) {
         return (long)(ce32 & -65536) << 32 | (long)(ce32 & 0xFF00) << 16 | tertiary << 8;
      } else {
         ce32 -= tertiary;
         if ((tertiary & 15) == 1) {
   ...
   static long decTwoBytePrimaryByOneStep(long basePrimary, boolean isCompressible, int step) {
      ...
      return basePrimary & 4278190080L | byte2 << 16;
   }
   ...
   static long decThreeBytePrimaryByOneStep(long basePrimary, boolean isCompressible, int step) {
      ...
      if (byte3 >= 2) {
         return basePrimary & 4294901760L | byte3 << 8;
      } else {
         byte3 += 254;
         ...
         return basePrimary & 4278190080L | byte2 << 16 | byte3 << 8;
      }
   }
