    ...
    protected JSDynamicObject execute(JSDynamicObject arg0Value, Object arg1Value) {
        ...
        if (state_0 != 0) {
            ...
            if ((state_0 & 2) != 0 && arg1Value instanceof JSDynamicObject) {
                arg1Value_ = (JSDynamicObject)arg1Value;
                assert (!this.isBuiltin);
                assert (this.isConstructor);
                assert (!this.context.isMultiContext());
            ...
            if ((state_0 & 4) != 0) {
                ...
                if (this.createWithProtoCachedClass_prototypeClass_.isInstance(arg1Value)) {
                    return this.createWithProtoCachedClass(arg0Value, arg1Value, this.setProtoNode, this.createWithProtoCachedClass_prototypeClass_, this.createWithProtoCachedClass_cachedShape_);
                }
            }
    ...
    private JSDynamicObject executeAndSpecialize(JSDynamicObject arg0Value, Object arg1Value) {
        ...
        try {
            ...
            try {
                ...
                Object createWithProtoCachedClass_prototypeClass__;
                JSDynamicObject jSDynamicObject2;
                Object s0_;
                if (exclude == 0 && !this.isBuiltin && this.isConstructor && !this.context.isMultiContext()) {
                    Object cachedPrototype__;
                    int count0_ = 0;
                    s0_ = this.cachedProto_cache;
                    if ((state_0 & 1) != 0) {
                        while (s0_ != null) {
                            assert (JSGuards.isJSObject(((CachedProtoData)s0_).cachedPrototype_));
                            if (arg1Value == ((CachedProtoData)s0_).cachedPrototype_) break;
                            s0_ = ((CachedProtoData)s0_).next_;
                            ++count0_;
                        }
                    }
                    if (s0_ == null && JSGuards.isJSObject(cachedPrototype__ = arg1Value) && count0_ < this.context.getPropertyCacheLimit()) {
                        s0_ = new CachedProtoData(this.cachedProto_cache);
                        ((CachedProtoData)s0_).cachedPrototype_ = cachedPrototype__;
                        ((CachedProtoData)s0_).shape_ = this.getProtoChildShape(arg1Value);
                    ...
                    if (s0_ != null) {
                        lock.unlock();
                        hasLock = false;
                        jSDynamicObject2 = this.doCachedProto(arg0Value, arg1Value, ((CachedProtoData)s0_).cachedPrototype_, ((CachedProtoData)s0_).shape_);
                ...
                if (arg1Value instanceof JSDynamicObject) {
                    ...
                    if (!this.isBuiltin && this.isConstructor && !this.context.isMultiContext() && JSGuards.isJSObject(arg1Value_)) {
                        ...
                        lock.unlock();
                        hasLock = false;
                        s0_ = this.doUncachedProto(arg0Value, arg1Value_, this.uncachedProto_slowBranch_);
                        return s0_;
                    }
                }
                ...
                if (!CreateWithProtoCachedClass_duplicateFound_ && !this.isBuiltin && this.isConstructor && this.context.isMultiContext() && (createWithProtoCachedClass_prototypeClass__ = JSGuards.getClassIfJSObject(arg1Value)) != null && ((Class)createWithProtoCachedClass_prototypeClass__).isInstance(arg1Value) && (state_0 & 4) == 0) {
                ...
                if (CreateWithProtoCachedClass_duplicateFound_) {
                    lock.unlock();
                    hasLock = false;
                    createWithProtoCachedClass_prototypeClass__ = this.createWithProtoCachedClass(arg0Value, arg1Value, this.setProtoNode, this.createWithProtoCachedClass_prototypeClass_, this.createWithProtoCachedClass_cachedShape_);
                    return createWithProtoCachedClass_prototypeClass__;
                }
                if (arg1Value instanceof JSDynamicObject) {
                    JSDynamicObject arg1Value_ = (JSDynamicObject)arg1Value;
                    if (!this.isBuiltin && this.isConstructor && this.context.isMultiContext() && JSGuards.isJSObject(arg1Value_)) {
                        ...
                        lock.unlock();
                        hasLock = false;
                        jSDynamicObject2 = this.createWithProto(arg0Value, arg1Value_, this.setProtoNode, this.createWithProto_cachedShape_);
                        return jSDynamicObject2;
                    }
                }
                if (!this.isBuiltin && this.isConstructor && !JSGuards.isJSObject(arg1Value)) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    jSDynamicObject = this.createDefaultProto(arg0Value, arg1Value);
                ...
                if (this.isBuiltin && this.isConstructor) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    jSDynamicObject = SpecializedNewObjectNode.builtinConstructor(arg0Value, arg1Value);
                    return jSDynamicObject;
                }
                if (!this.isConstructor) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    jSDynamicObject = this.throwNotConstructorFunctionTypeError(arg0Value, arg1Value);
                    return jSDynamicObject;
                }
