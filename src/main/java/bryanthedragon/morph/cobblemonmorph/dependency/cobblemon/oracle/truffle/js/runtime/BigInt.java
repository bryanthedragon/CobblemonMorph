...
public final class BigInt implements Comparable<BigInt>, TruffleObject {
   ...
   public static final BigInt MAX_INT = new BigInt(BigInteger.valueOf(2147483647L));
   public static final BigInt MIN_INT = new BigInt(BigInteger.valueOf(-2147483648L));
   ...
   public static BigInt fromBigInteger(BigInteger value) {
      if (value.equals(BigInteger.ZERO)) {
         ...
         return value.equals(BigInteger.ONE) ? ONE : new BigInt(value);
      }
   }
   ...
   public static BigInt valueOfUnsigned(long i) {
      return i >= 0L ? new BigInt(BigInteger.valueOf(i)) : new BigInt(BigInteger.valueOf(i).mod(TWO64));
   }
   ...
   boolean fitsInDouble() {
      if (this.value.bitLength() <= 53) {
         ...
         return !Double.isFinite(doubleValue) ? false : new BigDecimal(doubleValue).toBigIntegerExact().equals(this.value);
      }
   }
   ...
   boolean fitsInFloat() {
      if (this.value.bitLength() <= 24) {
         ...
         return !Float.isFinite(floatValue) ? false : new BigDecimal((double)floatValue).toBigIntegerExact().equals(this.value);
      }
   }
