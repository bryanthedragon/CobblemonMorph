...
public class PerformPromiseThenNode extends JavaScriptBaseNode {
   ...
   public JSDynamicObject execute(JSDynamicObject promise, Object onFulfilled, Object onRejected, PromiseCapabilityRecord resultCapability) {
      ...
      Object onRejectedHandler = this.isCallableRejectNode.executeBoolean(onRejected) ? onRejected : Undefined.instance;
      ...
      if (this.pendingProf.profile(promiseState == 0)) {
         ...
         Object value = this.getPromiseResult(promise);
      ...
      return resultCapability == null ? Undefined.instance : resultCapability.getPromise();
   }
