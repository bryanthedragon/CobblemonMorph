...
implements Truncatable {
    ...
    public static JavaScriptNode create(JavaScriptNode left, JavaScriptNode right, boolean truncate) {
        ...
        if (left instanceof JSConstantNode.JSConstantIntegerNode && right instanceof JSConstantNode.JSConstantIntegerNode) {
            ...
            long value2 = (long)leftValue + (long)(rightValue = ((JSConstantNode.JSConstantIntegerNode)right).executeInt(null));
            return JSRuntime.longIsRepresentableAsInt(value2) ? JSConstantNode.createInt((int)value2) : JSConstantNode.createDouble(value2);
        }
    ...
    @Specialization
    protected TruffleString doString(TruffleString a, TruffleString b, @Cached @Cached.Shared(value="concatStringsNode") JSConcatStringsNode concatStringsNode) {
        return concatStringsNode.executeTString(a, b);
    }

    @Specialization
    protected TruffleString doStringInt(TruffleString a, int b, @Cached @Cached.Shared(value="concatStringsNode") JSConcatStringsNode concatStringsNode, @Cached @Cached.Shared(value="stringFromLongNode") TruffleString.FromLongNode stringFromLongNode) {
        return concatStringsNode.executeTString(a, Strings.fromLong(stringFromLongNode, b));
    }

    @Specialization
    protected TruffleString doIntString(int a, TruffleString b, @Cached @Cached.Shared(value="concatStringsNode") JSConcatStringsNode concatStringsNode, @Cached @Cached.Shared(value="stringFromLongNode") TruffleString.FromLongNode stringFromLongNode) {
        return concatStringsNode.executeTString(Strings.fromLong(stringFromLongNode, a), b);
    }

    @Specialization(guards={"isNumber(b)"})
    protected Object doStringNumber(TruffleString a, Object b, @Cached @Cached.Shared(value="concatStringsNode") JSConcatStringsNode concatStringsNode, @Cached @Cached.Shared(value="doubleToStringNode") JSDoubleToStringNode doubleToStringNode) {
        return concatStringsNode.executeTString(a, doubleToStringNode.executeString(b));
    }

    @Specialization(guards={"isNumber(a)"})
    protected Object doNumberString(Object a, TruffleString b, @Cached @Cached.Shared(value="concatStringsNode") JSConcatStringsNode concatStringsNode, @Cached @Cached.Shared(value="doubleToStringNode") JSDoubleToStringNode doubleToStringNode) {
        return concatStringsNode.executeTString(doubleToStringNode.executeString(a), b);
    }

    @Specialization(guards={"hasOverloadedOperators(a) || hasOverloadedOperators(b)"})
    protected Object doOverloaded(Object a, Object b, @Cached(value="createHintDefault(getOverloadedOperatorName())") JSOverloadedBinaryNode overloadedOperatorNode) {
    ...
    protected Object doPrimitiveConversion(Object a, Object b, @Cached(value="createHintDefault()") JSToPrimitiveNode toPrimitiveA, @Cached(value="createHintDefault()") JSToPrimitiveNode toPrimitiveB, @Cached(value="create()") JSToNumericNode toNumericA, @Cached(value="create()") JSToNumericNode toNumericB, @Cached(value="create()") JSToStringNode toStringA, @Cached(value="create()") JSToStringNode toStringB, @Cached(value="createBinaryProfile()") ConditionProfile profileA, @Cached(value="createBinaryProfile()") ConditionProfile profileB, @Cached(value="copyRecursive()") JSAddNode add2, @Cached(value="create()") BranchProfile mixedNumericTypes) {
        ...
        return add2.execute(castA, castB);
    }
