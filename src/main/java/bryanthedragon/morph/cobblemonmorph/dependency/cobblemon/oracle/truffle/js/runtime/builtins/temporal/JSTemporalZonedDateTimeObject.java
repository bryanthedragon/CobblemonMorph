...
implements TemporalCalendar {
    ...
    final LocalDate asDate() throws UnsupportedMessageException {
        LocalDate ld = LocalDate.ofInstant((Instant)this.toInstant(), (ZoneId)this.asTimeZone());
        return ld;
    }
    ...
    final LocalTime asTime() throws UnsupportedMessageException {
        LocalTime lt = LocalTime.ofInstant((Instant)this.toInstant(), (ZoneId)this.asTimeZone());
        return lt;
    }
}
