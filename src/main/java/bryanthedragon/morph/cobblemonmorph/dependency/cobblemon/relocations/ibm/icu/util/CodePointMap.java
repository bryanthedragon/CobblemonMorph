...
implements Iterable<Range> {
    ...
    public boolean getRange(int start2, RangeOption option, int surrogateValue, ValueFilter filter, Range range) {
        assert (option != null);
        if (!this.getRange(start2, filter, range)) {
            return false;
        }
