...
public class MausholdModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = MausholdModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "maushold_three", "ground_idle", null, 4, null)
            },
            null,
      ...
      val var11: Array<ModelQuirk> = new ModelQuirk[]{blink1, blink2, blink3};
      val var12: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         new SingleBoneLookAnimation(head2, false, false, false, false, null, null, null, null, null, null, 2016, null),
         new SingleBoneLookAnimation(head3, false, false, false, false, null, null, null, null, null, null, 2016, null),
         PoseableEntityModel.bedrock$default(this, "maushold_three", "ground_walk", null, 4, null)
      };
      val var14: PoseableEntityModel = this;
      this.setWalk(PoseableEntityModel.registerPose$default(var14, "walk", var10, null, 10, null, null, var12, null, var11, 180, null));
   }
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isNotPosedIn(this.getSleep())) PoseableEntityModel.bedrockStateful$default(this, "maushold_three", "faint", null, 4, null) else null;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: MausholdModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
