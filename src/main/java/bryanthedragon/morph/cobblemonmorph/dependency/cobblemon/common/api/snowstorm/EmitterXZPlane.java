...
public class EmitterXZPlane : ParticleCameraMode {
   public open val type: ParticleCameraModeType = ParticleCameraModeType.EMITTER_XZ_PLANE
   ...
   public override fun getRotation(
      ...
      var10001 = Axis.f_252529_.m_252977_(-90.0F);
      QuaternionUtilsKt.hamiltonProduct(rotation, var10001);
      return rotation;
   }
   ...
   @JvmStatic
   fun `CODEC$lambda$2$lambda$0`(it: EmitterXZPlane): java.lang.String {
      return it.getType().name();
   }

   @JvmStatic
   fun `CODEC$lambda$2$lambda$1`(it: java.lang.String): EmitterXZPlane {
      return new EmitterXZPlane();
   }

   @JvmStatic
   fun `CODEC$lambda$2`(instance: Instance): App {
      return instance.group(PrimitiveCodec.STRING.fieldOf("type").forGetter(EmitterXZPlane::CODEC$lambda$2$lambda$0) as App)
         .apply(instance as Applicative, EmitterXZPlane::CODEC$lambda$2$lambda$1);
   }

   @JvmStatic
   fun {
      val var10000: Codec = RecordCodecBuilder.create(EmitterXZPlane::CODEC$lambda$2);
      CODEC = var10000;
   }

   public companion object {
      public final val CODEC: Codec<EmitterXZPlane>
   }
}
