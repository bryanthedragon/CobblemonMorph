...
class AsyncGeneratorYieldStarNode extends AsyncGeneratorYieldNode {
   ...
   protected AsyncGeneratorYieldStarNode(
      JSContext context,
   ...
   public Object execute(VirtualFrame frame) {
         ...
         switch (state) {
            case 1:
               if (received.isNormal()) {
                  Object innerResult = this.iteratorNextNode.execute(iteratorRecord, received.getValue());
                  ...
                  Object innerResult = this.callThrowMethod(throwMethod, iterator, received.getValue());
                  this.awaitWithNext(frame, innerResult, 2);
               } else {
                  ...
                  Object returnMethod = this.getReturnMethodNode.executeWithTarget(iterator);
                  if (returnMethod != Undefined.instance) {
                     Object innerReturnResult = this.callReturnMethod(returnMethod, iterator, received.getValue());
            ...
            case 2: {
               ...
               JSDynamicObject innerResult = this.checkcastIterResult(awaited);
            ...
            case 3: {
               Object awaited = this.resumeAwait(frame);
               JSDynamicObject innerReturnResult = this.checkcastIterResult(awaited);
      ...
      } while ($assertionsDisabled || state == 1);
