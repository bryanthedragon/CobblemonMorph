...
public class GrookeyModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BimanualFrame {
   ...
   public final val stick_hair: ModelPart
   ...
   init {
      ...
      this.cryAnimation = GrookeyModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "grookey", "ground_idle", null, 4, null)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.stick).withVisibility(false),
               ModelPartExtensionsKt.createTransformation(this.stick_hair).withVisibility(true)
            },
      ...
      var var13: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "grookey", "ground_walk", null, 4, null)
      };
      ...
      var11 = new ModelPartTransformation[]{
         ...
         ModelPartExtensionsKt.createTransformation(this.stick_hair).withVisibility(false)
      };
      var13 = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "grookey", "battle_idle", null, 4, null)
      };
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: GrookeyModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
