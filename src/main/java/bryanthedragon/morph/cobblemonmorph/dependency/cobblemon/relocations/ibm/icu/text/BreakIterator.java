...
import com.cobblemon.mod.relocations.ibm.icu.impl.CSCharacterIterator;
...
public abstract class BreakIterator implements Cloneable {
   ...
   public void setText(String newText) {
      this.setText(new java.text.StringCharacterIterator(newText));
   }
   ...
   private static BreakIterator.BreakIteratorServiceShim getShim() {
      if (shim == null) {
         try {
            Class<?> cls = Class.forName("com.cobblemon.mod.relocations.ibm.icu.text.BreakIteratorFactory");
