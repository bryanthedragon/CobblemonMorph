...
@GeneratedBy(value=HostContext.ClassNamesObject.class)
final class ClassNamesObjectGen {
    ...
    static {
        LibraryExport.register(HostContext.ClassNamesObject.class, new InteropLibraryExports());
    }
    ...
    extends LibraryExport<InteropLibrary> {
        ...
        extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert (!(receiver instanceof HostContext.ClassNamesObject) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null) : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
