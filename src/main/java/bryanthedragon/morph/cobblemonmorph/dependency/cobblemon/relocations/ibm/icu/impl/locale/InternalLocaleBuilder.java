...
public final class InternalLocaleBuilder {
   ...
   private HashMap<InternalLocaleBuilder.CaseInsensitiveChar, String> _extensions;
   private HashSet<InternalLocaleBuilder.CaseInsensitiveString> _uattributes;
   private HashMap<InternalLocaleBuilder.CaseInsensitiveString, String> _ukeywords;
         ...
         if (extKeys != null) {
            for (Character key : extKeys) {
               ...
               if (e instanceof UnicodeLocaleExtension) {
                  ...
                  this._extensions.put(new InternalLocaleBuilder.CaseInsensitiveChar(key), e.getValue());
               }
            }
         }
   ...
   public LocaleExtensions getLocaleExtensions() {
      return this._extensions != null && this._extensions.size() != 0
            || this._uattributes != null && this._uattributes.size() != 0
            || this._ukeywords != null && this._ukeywords.size() != 0
         ? new LocaleExtensions(this._extensions, this._uattributes, this._ukeywords)
   ...
   static class CaseInsensitiveChar {
      ...
      public boolean equals(Object obj) {
         if (this == obj) {
            ...
            return !(obj instanceof InternalLocaleBuilder.CaseInsensitiveChar)
               ? false
               : this._c == AsciiUtil.toLower(((InternalLocaleBuilder.CaseInsensitiveChar)obj).value());
         }
      }
   }
   ...
   static class CaseInsensitiveString {
      ...
      public boolean equals(Object obj) {
         if (this == obj) {
            ...
            return !(obj instanceof InternalLocaleBuilder.CaseInsensitiveString)
               ? false
               : AsciiUtil.caseIgnoreMatch(this._s, ((InternalLocaleBuilder.CaseInsensitiveString)obj).value());
         }
      }
   }
}
