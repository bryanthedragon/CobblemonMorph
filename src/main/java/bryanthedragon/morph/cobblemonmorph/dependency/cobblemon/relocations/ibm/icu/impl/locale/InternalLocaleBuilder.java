...
import com.cobblemon.mod.relocations.ibm.icu.impl.locale.StringTokenIterator;
...
public final class InternalLocaleBuilder {
    ...
    public InternalLocaleBuilder setExtension(char singleton, String value2) throws LocaleSyntaxException {
        ...
        boolean remove2 = value2 == null || value2.length() == 0;
        ...
        if (remove2) {
            ...
            String val = value2.replaceAll("_", "-");
    ...
    public InternalLocaleBuilder setExtensions(String subtags) throws LocaleSyntaxException {
        ...
        while (!itr.isDone() && LanguageTag.isExtensionSingleton(s = itr.current())) {
            ...
            if (parsed < start2) {
                throw new LocaleSyntaxException("Incomplete extension '" + singleton + "'", start2);
            }
            if (extensions == null) {
        ...
        if (!itr.isDone() && LanguageTag.isPrivateusePrefix(s = itr.current())) {
            ...
            if (parsed <= start2) {
                throw new LocaleSyntaxException("Incomplete privateuse:" + subtags.substring(start2), start2);
            }
    ...
    public InternalLocaleBuilder setLocale(BaseLocale base, LocaleExtensions extensions) throws LocaleSyntaxException {
        ...
        this.clearExtensions();
        Set<Character> set2 = extKeys = extensions == null ? null : extensions.getKeys();
        if (extKeys != null) {
