...
public class WooperModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = WooperModel::cryAnimation$lambda$0;
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "wooper", "sleep", null, 4, null)},
            null,
            null,
            444,
            null
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "wooper", "ground_idle", null, 4, null)
            },
            null,
      ...
      this.setWalk(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "wooper", "ground_walk", null, 4, null)
            },
            null,
            new ModelQuirk[]{blink},
            188,
      ...
      this.setFloat(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "wooper", "water_idle", null, 4, null)
            },
            null,
            new ModelQuirk[]{blink},
            94,
      ...
      this.setSwim(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "wooper", "water_swim", null, 4, null)
            },
            null,
            new ModelQuirk[]{blink},
            94,
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isNotPosedIn(this.getShoulderRight(), this.getShoulderLeft()))
         PoseableEntityModel.bedrockStateful$default(this, "wooper", "faint", null, 4, null)
         else
         null;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: WooperModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
