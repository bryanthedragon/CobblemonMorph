...
@GeneratedBy(CoshNode.class)
public final class CoshNodeGen extends CoshNode implements Introspection.Provider {
   @Node.Child
   private JavaScriptNode arguments0_;
   @CompilerDirectives.CompilationFinal
   private int state_0_;

   private CoshNodeGen(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
   ...
   private Object execute_double0(int state_0, VirtualFrame frameValue) {
      ...
      return CoshNode.cosh(arguments0Value_);
   }
   ...
   private Object execute_generic1(int state_0, VirtualFrame frameValue) {
      ...
      if ((state_0 & 1) != 0 && JSTypesGen.isImplicitDouble((state_0 & 60) >>> 2, arguments0Value_)) {
         ...
         return CoshNode.cosh(arguments0Value__);
      } else if ((state_0 & 2) != 0) {
         return this.cosh(arguments0Value_);
      } else {
         CompilerDirectives.transferToInterpreterAndInvalidate();
   ...
   private double executeAndSpecialize(Object arguments0Value) {
      ...
      if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(arguments0Value)) != 0) {
         ...
         return this.cosh(arguments0Value);
      }
   }
   ...
   public Introspection getIntrospectionData() {
      ...
      int state_0 = this.state_0_;
      Object[] s = new Object[]{"cosh", null, null};
      if ((state_0 & 1) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
   ...
   public static CoshNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
      return new CoshNodeGen(context, builtin, arguments);
   }
}
