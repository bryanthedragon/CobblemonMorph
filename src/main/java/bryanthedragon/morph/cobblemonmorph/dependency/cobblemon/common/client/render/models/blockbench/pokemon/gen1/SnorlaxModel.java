...
implements HeadedFrame {
    ...
    public SnorlaxModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "snorlax");
        this.head = this.getPart("head");
        this.portraitScale = 2.3f;
        this.portraitTranslation = new Vec3(-0.45, 0.75, 0.0);
        this.profileScale = 0.75f;
        this.profileTranslation = new Vec3(0.0, 0.55, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> SnorlaxModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "snorlax", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "snorlax", "ground_walk", null, 4, null)};
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(SnorlaxModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "snorlax", "cry", null, 4, null);
    }
}
