...
extends UFormat {
    ...
    static int findSubMessage(MessagePattern pattern, int partIndex, PluralSelector selector2, Object context, double number) {
        ...
        do {
            ...
            if (pattern.getPartType(partIndex).hasNumericValue()) {
                ...
                if (pattern.partSubstringMatches(part, "other")) {
                    ...
                    if (keyword == null) {
                        keyword = selector2.select(context, number - offset);
