...
public final class BytesTrie implements Cloneable, Iterable<BytesTrie.Entry> {
   ...
   public static final class Iterator implements java.util.Iterator<BytesTrie.Entry> {
      private byte[] bytes_;
      private int pos_;
      ...
      public BytesTrie.Entry next() {
         ...
         if (pos < 0) {
            ...
            int length = (int)top;
            pos = (int)(top >> 32);
            this.entry_.truncateString(length & 65535);
            length >>>= 16;
            if (length > 1) {
      ...
      private int branchNext(int pos, int length) {
         while (length > 5) {
            this.stack_.add((long)BytesTrie.skipDelta(this.bytes_, ++pos) << 32 | length - (length >> 1) << 16 | this.entry_.length);
            length >>= 1;
         ...
         this.stack_.add((long)pos << 32 | length - 1 << 16 | this.entry_.length);
