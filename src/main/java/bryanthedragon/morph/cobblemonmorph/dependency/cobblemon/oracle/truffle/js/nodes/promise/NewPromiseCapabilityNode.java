...
public class NewPromiseCapabilityNode extends JavaScriptBaseNode {
   ...
   public static PromiseCapabilityRecord createDefault(JSRealm realm) {
      ...
      assert JSFunction.isConstructor((JSDynamicObject)constructor);
   ...
   private JSDynamicObject getCapabilitiesExecutor(PromiseCapabilityRecord promiseCapability) {
      JSFunctionData functionData = this.context
         .getOrCreateBuiltinFunctionData(JSContext.BuiltinFunctionKey.PromiseGetCapabilitiesExecutor, c -> createGetCapabilitiesExecutorImpl(c));
   ...
   private static JSDynamicObject getCapabilitiesExecutor(JSContext context, JSRealm realm, PromiseCapabilityRecord promiseCapability) {
      JSFunctionData functionData = context.getOrCreateBuiltinFunctionData(
         JSContext.BuiltinFunctionKey.PromiseGetCapabilitiesExecutor, c -> createGetCapabilitiesExecutorImpl(c)
      );
   ...
   private static JSFunctionData createGetCapabilitiesExecutorImpl(JSContext context) {
      class GetCapabilitiesExecutorNode extends JavaScriptRootNode {
         ...
         @Node.Child
         private PropertyGetNode getPromiseCapability = PropertyGetNode.createGetHidden(NewPromiseCapabilityNode.PROMISE_CAPABILITY_KEY, context);
         private final BranchProfile errorBranch = BranchProfile.create();
