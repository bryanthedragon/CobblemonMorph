    ...
    private boolean executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if (!this.hasOverloadedOperators(leftNodeValue) && !this.hasOverloadedOperators(rightNodeValue)) {
                ...
                lock.unlock();
                hasLock = false;
                boolean bl = this.doGeneric(leftNodeValue, rightNodeValue, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.lessOrEqualNode_);
                return bl;
            }
