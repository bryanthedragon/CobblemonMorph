...
@GeneratedBy(JSLessOrEqualNode.class)
public final class JSLessOrEqualNodeGen extends JSLessOrEqualNode implements Introspection.Provider {
   ...
   @Node.Child
   private JSLessOrEqualNodeGen.GenericData generic_cache;
   ...
   public boolean executeBoolean(Object leftNodeValue, Object rightNodeValue) {
      ...
      if ((state_0 & 229376) != 0) {
         ...
         if ((state_0 & 131072) != 0) {
            JSLessOrEqualNodeGen.GenericData s17_ = this.generic_cache;
   ...
   private boolean executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
      ...
      try {
         ...
         if ((exclude & 256) == 0 && JSGuards.isJavaNumber(leftNodeValue) && JSGuards.isJavaNumber(rightNodeValue)) {
            ...
            JSLessOrEqualNodeGen.GenericData s17_ = super.insert(new JSLessOrEqualNodeGen.GenericData());
            ...
            hasLock = false;
            return this.doGeneric(
               leftNodeValue, rightNodeValue, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.lessOrEqualNode_
            );
         }
      } finally {
         if (hasLock) {
