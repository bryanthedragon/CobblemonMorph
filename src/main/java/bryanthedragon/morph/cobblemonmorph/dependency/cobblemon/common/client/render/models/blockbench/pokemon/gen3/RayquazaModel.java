...
implements HeadedFrame {
    ...
    public RayquazaModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "rayquaza");
        this.head = this.getPart("head");
        this.portraitScale = 1.5f;
        this.portraitTranslation = new Vec3(-1.85, 3.5, 0.0);
        this.profileScale = 0.4f;
        this.profileTranslation = new Vec3(0.0, 1.3, -6.0);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "rayquaza", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "rayquaza", "ground_idle", null, 4, null)};
