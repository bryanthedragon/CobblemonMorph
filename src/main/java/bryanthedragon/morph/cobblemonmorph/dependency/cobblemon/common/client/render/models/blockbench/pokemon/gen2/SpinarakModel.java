...
implements HeadedFrame {
    ...
    public SpinarakModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "spinarak");
        this.head = this.getPart("head");
        this.portraitScale = 2.8f;
        this.portraitTranslation = new Vec3(-0.35, -2.65, 0.0);
        this.profileScale = 1.1f;
        this.profileTranslation = new Vec3(-0.1, 0.0, 0.0);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "spinarak", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "spinarak", "ground_walk", null, 4, null)};
