...
public class GlobalPropertyNode extends JSTargetableNode implements ReadNode {
   ...
   public boolean hasTag(Class<? extends Tag> tag) {
      if ((tag == JSTags.ReadVariableTag.class || tag == StandardTags.ReadVariableTag.class) && this.isScopeAccess()) {
         ...
         return tag == JSTags.ReadPropertyTag.class && !this.isScopeAccess() ? true : super.hasTag(tag);
      }
   }
   ...
   public final Object evaluateTarget(VirtualFrame frame) {
      return this.globalObjectNode != null ? this.globalObjectNode.execute(frame) : this.getRealm().getGlobalObject();
   }
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      GlobalPropertyNode copy = new GlobalPropertyNode(this.context, this.propertyName, cloneUninitialized(this.globalObjectNode, materializedTags));
      if (this.cache != null && this.cache.isMethod()) {
