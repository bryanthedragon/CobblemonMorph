...
public abstract class Precision {
    ...
    private static int getRoundingMagnitudeSignificant(DecimalQuantity value2, int maxSig) {
        if (maxSig == -1) {
            return Integer.MIN_VALUE;
        }
        int magnitude = value2.isZeroish() ? 0 : value2.getMagnitude();
    ...
    void setResolvedMinFraction(DecimalQuantity value2, int resolvedMinFraction) {
        if (this.trailingZeroDisplay == null || this.trailingZeroDisplay == NumberFormatter.TrailingZeroDisplay.AUTO || value2.getPluralOperand(PluralRules.Operand.t) != 0.0) {
            value2.setMinFraction(resolvedMinFraction);
        }
    }

    private static int getDisplayMagnitudeSignificant(DecimalQuantity value2, int minSig) {
        int magnitude = value2.isZeroish() ? 0 : value2.getMagnitude();
    ...
    extends CurrencyPrecision {
        ...
        @Override
        public void apply(DecimalQuantity value2) {
            throw new AssertionError();
        }
    ...
    extends IncrementRounderImpl {
        ...
        @Override
        public void apply(DecimalQuantity value2) {
            value2.roundToNickel(-this.maxFrac, this.mathContext);
            this.setResolvedMinFraction(value2, this.minFrac);
        }
    ...
    extends IncrementRounderImpl {
        ...
        @Override
        public void apply(DecimalQuantity value2) {
            value2.roundToMagnitude(-this.maxFrac, this.mathContext);
            this.setResolvedMinFraction(value2, this.minFrac);
        }
    ...
    extends Precision {
        ...
        @Override
        public void apply(DecimalQuantity value2) {
            value2.roundToIncrement(this.increment, this.mathContext);
            this.setResolvedMinFraction(value2, Math.max(0, this.increment.scale()));
        }
    ...
    extends Precision {
        ...
        public void apply(DecimalQuantity value2) {
            ...
            int roundingMag2 = Precision.getRoundingMagnitudeSignificant(value2, this.maxSig);
            ...
            if (!value2.isZeroish()) {
                int upperMag = value2.getMagnitude();
                value2.roundToMagnitude(roundingMag, this.mathContext);
                if (!value2.isZeroish() && value2.getMagnitude() != upperMag && roundingMag1 == roundingMag2) {
                    ++roundingMag2;
                }
            }
            int displayMag1 = Precision.getDisplayMagnitudeFraction(this.minFrac);
            int displayMag2 = Precision.getDisplayMagnitudeSignificant(value2, this.minSig);
            if (this.retain) {
            ...
            this.setResolvedMinFraction(value2, Math.max(0, -displayMag));
        }
    ...
    extends Precision {
        ...
        @Override
        public void apply(DecimalQuantity value2) {
            value2.roundToMagnitude(Precision.getRoundingMagnitudeSignificant(value2, this.maxSig), this.mathContext);
            this.setResolvedMinFraction(value2, Math.max(0, -Precision.getDisplayMagnitudeSignificant(value2, this.minSig)));
            if (value2.isZeroish() && this.minSig > 0) {
                value2.setMinInteger(1);
            }
        }
    ...
    extends FractionPrecision {
        ...
        @Override
        public void apply(DecimalQuantity value2) {
            value2.roundToMagnitude(Precision.getRoundingMagnitudeFraction(this.maxFrac), this.mathContext);
            this.setResolvedMinFraction(value2, Math.max(0, -Precision.getDisplayMagnitudeFraction(this.minFrac)));
        }
    ...
    extends Precision {
        @Override
        public void apply(DecimalQuantity value2) {
            value2.roundToInfinity();
            this.setResolvedMinFraction(value2, 0);
        }
