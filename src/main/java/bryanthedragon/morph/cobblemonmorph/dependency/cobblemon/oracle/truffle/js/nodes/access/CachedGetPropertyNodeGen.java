...
@GeneratedBy(value=CachedGetPropertyNode.class)
final class CachedGetPropertyNodeGen
extends CachedGetPropertyNode
implements Introspection.Provider {
        ...
        if (state_0 != 0) {
            ...
            if ((state_0 & 0x1C) != 0) {
                ...
                if ((state_0 & 4) != 0 && !JSGuards.isJSProxy(arg0Value)) {
                    ...
                    while (s2_ != null) {
                        ...
                        if (s2_.toArrayIndexNode_.isResultArrayIndex(maybeIndex__)) {
                            return this.doArrayIndex(arg0Value, arg1Value, arg2Value, arg3Value, s2_.requireObjectCoercibleNode_, s2_.toArrayIndexNode_, maybeIndex__, s2_.jsclassProfile_);
                        }
                        s2_ = s2_.next_;
                    }
                }
                ...
                if ((state_0 & 0x10) != 0 && (s4_ = this.generic_cache) != null) {
                    return this.doGeneric(arg0Value, arg1Value, arg2Value, arg3Value, s4_.requireObjectCoercibleNode_, s4_.toArrayIndexNode_, s4_.getType_, s4_.jsclassProfile_, s4_.highFrequency_, s4_.hotKey_, s4_.equalsNode_);
                }
            }
        }
    ...
    private Object executeAndSpecialize(JSDynamicObject arg0Value, Object arg1Value, Object arg2Value, Object arg3Value) {
        ...
        try {
            ...
            block32: {
                ...
                block31: {
                    ...
                    block30: {
                        ...
                        block29: {
                            ...
                            int count0_ = 0;
                            s0_ = this.cachedKey_cache;
                            if ((state_0 & 1) != 0) {
                                while (s0_ != null) {
                                    assert (((CachedKeyData)s0_).cachedKey_ != null);
                                    assert (!JSRuntime.isArrayIndex(((CachedKeyData)s0_).cachedKey_));
                                    if (JSRuntime.propertyKeyEquals(((CachedKeyData)s0_).equalsNode_, ((CachedKeyData)s0_).cachedKey_, arg1Value)) break;
                                    s0_ = ((CachedKeyData)s0_).next_;
                                    ++count0_;
                                }
                            }
                            if (s0_ == null && (cachedKey__ = CachedGetPropertyNode.cachedPropertyKey(arg1Value)) != null && !JSRuntime.isArrayIndex(cachedKey__) && JSRuntime.propertyKeyEquals(equalsNode__ = super.insert(TruffleString.EqualNode.create()), cachedKey__, arg1Value) && count0_ < 2) {
                                s0_ = super.insert(new CachedKeyData(this.cachedKey_cache));
                                ((CachedKeyData)s0_).cachedKey_ = cachedKey__;
                                ((CachedKeyData)s0_).propertyNode_ = ((CachedKeyData)s0_).insertAccessor(PropertyGetNode.create(cachedKey__, this.context));
                                ((CachedKeyData)s0_).equalsNode_ = ((CachedKeyData)s0_).insertAccessor(equalsNode__);
                            ...
                            lock.unlock();
                            hasLock = false;
                            cachedKey__ = this.doCachedKey(arg0Value, arg1Value, arg2Value, arg3Value, ((CachedKeyData)s0_).cachedKey_, ((CachedKeyData)s0_).propertyNode_, ((CachedKeyData)s0_).equalsNode_);
                            if (oldState_0 != 0) {
                        ...
                        lock.unlock();
                        hasLock = false;
                        s0_ = this.doIntIndex(arg0Value, arg1Value_, arg2Value, arg3Value, this.intIndex_jsclassProfile_);
                        if (oldState_0 != 0) {
                            this.checkForPolymorphicSpecialize(oldState_0);
                        }
                        return s0_;
                    ...
                    try {
                        ...
                        lock.unlock();
                        hasLock = false;
                        Object object = this.doArrayIndex(arg0Value, arg1Value, arg2Value, arg3Value, s2_.requireObjectCoercibleNode_, s2_.toArrayIndexNode_, maybeIndex__, s2_.jsclassProfile_);
                        if (oldState_0 != 0) {
                            this.checkForPolymorphicSpecialize(oldState_0);
                        }
                        return object;
                ...
                lock.unlock();
                hasLock = false;
                maybeIndex__ = this.doProxy(arg0Value, arg1Value, arg2Value, arg3Value, this.proxy_proxyGet_);
                if (oldState_0 != 0) {
                    this.checkForPolymorphicSpecialize(oldState_0);
                }
                return maybeIndex__;
            ...
            s4_.hotKey_ = s4_.insertAccessor(FrequencyBasedPolymorphicAccessNode.createFrequencyBasedPropertyGet(this.context));
            ...
            lock.unlock();
            hasLock = false;
            Object object = this.doGeneric(arg0Value, arg1Value, arg2Value, arg3Value, s4_.requireObjectCoercibleNode_, s4_.toArrayIndexNode_, s4_.getType_, s4_.jsclassProfile_, s4_.highFrequency_, s4_.hotKey_, s4_.equalsNode_);
            if (oldState_0 != 0) {
                this.checkForPolymorphicSpecialize(oldState_0);
            }
            return object;
    ...
    public Introspection getIntrospectionData() {
        ...
        if ((state_0 & 0x10) != 0) {
            ...
            if (s4_ != null) {
                cached.add(Arrays.asList(s4_.requireObjectCoercibleNode_, s4_.toArrayIndexNode_, s4_.getType_, s4_.jsclassProfile_, s4_.highFrequency_, s4_.hotKey_, s4_.equalsNode_));
            }
            s[2] = cached;
        } else {
            s[1] = (byte)0;
