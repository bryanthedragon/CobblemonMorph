...
extends MethodVisitor {
    ...
    public void visitLocalVariable(String name, String descriptor, String signature, Label start2, Label end2, int index) {
        ...
        super.visitLocalVariable(name, descriptor, signature, start2, end2, remappedIndex);
    }
    ...
    public AnnotationVisitor visitLocalVariableAnnotation(int typeRef, TypePath typePath, Label[] start2, Label[] end2, int[] index, String descriptor, boolean visible) {
        ...
        return super.visitLocalVariableAnnotation(typeRef, typePath, start2, end2, remappedIndex, descriptor, visible);
    }
    ...
    private int remap(int var, Type type) {
        ...
        if ((value2 = this.remappedVariableIndices[key]) == 0) {
            value2 = this.newLocalMapping(type);
            this.setLocalType(value2, type);
            this.remappedVariableIndices[key] = value2 + 1;
        } else {
            --value2;
        }
        return value2;
