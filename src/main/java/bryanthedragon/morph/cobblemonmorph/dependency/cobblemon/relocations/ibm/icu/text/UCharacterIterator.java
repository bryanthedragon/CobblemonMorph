...
import com.cobblemon.mod.relocations.ibm.icu.impl.ReplaceableUCharacterIterator;
import com.cobblemon.mod.relocations.ibm.icu.impl.UCharArrayIterator;
import com.cobblemon.mod.relocations.ibm.icu.impl.UCharacterIteratorWrapper;
import com.cobblemon.mod.relocations.ibm.icu.text.Replaceable;
import com.cobblemon.mod.relocations.ibm.icu.text.UForwardCharacterIterator;
...
UForwardCharacterIterator {
    ...
    public static final UCharacterIterator getInstance(char[] source, int start2, int limit) {
        return new UCharArrayIterator(source, start2, limit);
    }
