...
extends StatementNode {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return WithNode.create(WithNode.cloneUninitialized(this.writeActiveObject, materializedTags), WithNode.cloneUninitialized(this.statement, materializedTags));
    }
}
