...
public class CottoneeModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = CottoneeModel::cryAnimation$lambda$0;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: CottoneeModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
