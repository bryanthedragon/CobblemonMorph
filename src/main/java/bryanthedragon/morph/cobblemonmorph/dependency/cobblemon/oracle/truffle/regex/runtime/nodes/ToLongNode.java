...
extends Node {
    public abstract long execute(Object var1) throws UnsupportedTypeException;
    ...
    static long doBoxed(Object arg, @CachedLibrary(value="arg") InteropLibrary args) throws UnsupportedTypeException {
        try {
