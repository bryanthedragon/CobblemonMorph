...
public class PropertyNode extends Node {
   ...
   public String getKeyName() {
      return this.key instanceof PropertyKey ? ((PropertyKey)this.key).getPropertyName() : null;
   }

   public TruffleString getKeyNameTS() {
      return this.key instanceof PropertyKey ? ((PropertyKey)this.key).getPropertyNameTS() : null;
   }

   @Override
   public Node accept(final NodeVisitor<? extends LexicalContext> visitor) {
      return (Node)(visitor.enterPropertyNode(this)
         ? visitor.leavePropertyNode(
            this.setKey(this.key == null ? null : (Expression)this.key.accept(visitor))
   ...
   public PropertyNode setGetter(final FunctionNode getter) {
      return this.getter == getter
         ? this
         : new PropertyNode(this, this.key, this.value, getter, this.setter, this.isStatic, this.computed, this.coverInitializedName, this.proto);
   }
   ...
   private PropertyNode setKey(final Expression key) {
      return this.key == key
         ? this
         : new PropertyNode(this, key, this.value, this.getter, this.setter, this.isStatic, this.computed, this.coverInitializedName, this.proto);
   }
   ...
   public PropertyNode setSetter(final FunctionNode setter) {
      return this.setter == setter
         ? this
         : new PropertyNode(this, this.key, this.value, this.getter, setter, this.isStatic, this.computed, this.coverInitializedName, this.proto);
   }
   ...
   public PropertyNode setValue(final Expression value) {
      return this.value == value
         ? this
         : new PropertyNode(this, this.key, value, this.getter, this.setter, this.isStatic, this.computed, this.coverInitializedName, this.proto);
   }
