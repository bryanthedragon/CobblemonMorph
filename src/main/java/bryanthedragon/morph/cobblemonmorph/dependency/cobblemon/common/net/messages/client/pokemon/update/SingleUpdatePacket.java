 ...
 */
public abstract class SingleUpdatePacket<T, N : NetworkPacket<N>>(pokemon: () -> Pokemon?, val value: T) extends PokemonUpdatePacket<N>(pokemon) {
    ...
    abstract fun encodeValue(RegistryFriendlyByteBuf buffer) {}

    /** Sets the value in the client-side Pokémon. */
    abstract fun set(Pokemon pokemon, T value) {}
}