...
public final class InitErrorObjectNode extends JavaScriptBaseNode {
   ...
   @Node.Child
   private InitErrorObjectNode.DefineStackPropertyNode defineStackProperty;
   ...
   private InitErrorObjectNode(JSContext context, boolean defaultColumnNumber) {
      ...
      this.defineStackProperty = InitErrorObjectNode.DefineStackPropertyNode.create();
   ...
   public abstract static class DefineStackPropertyNode extends JavaScriptBaseNode {
      static InitErrorObjectNode.DefineStackPropertyNode create() {
      ...
      void doCached(JSDynamicObject errorObj, @CachedLibrary("errorObj") DynamicObjectLibrary objectLibrary) {
         ...
         Properties.putConstant(objectLibrary, errorObj, JSError.STACK_NAME, JSError.STACK_PROXY, attrs | 16);
      }
   }
}
