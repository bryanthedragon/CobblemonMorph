...
implements PokemonSelectingItem {
    ...
    public StatusCureItem(@NotNull String itemName, Status ... status) {
        ...
        this.bagItem = new BagItem(this){
            @NotNull
            private final String itemName;
            final /* synthetic */ StatusCureItem this$0;
            {
                this.this$0 = $receiver;
                this.itemName = $receiver.getItemName();
            }
