...
extends PokemonPoseableModel {
    ...
    public PiloswineModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "piloswine");
        this.portraitScale = 1.7f;
        this.portraitTranslation = new Vec3(-0.6, -1.03, 0.0);
        this.profileScale = 0.78f;
        this.profileTranslation = new Vec3(0.0, 0.49, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> PiloswineModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "piloswine", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "piloswine", "ground_idle", null, 4, null)};
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(PiloswineModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "piloswine", "cry", null, 4, null);
    }
}
