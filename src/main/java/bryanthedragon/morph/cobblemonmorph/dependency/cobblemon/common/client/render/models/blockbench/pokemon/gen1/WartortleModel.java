...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.util.isUnderWater
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.util.isInWater
import net.minecraft.client.model.geom.ModelPart
import net.minecraft.world.phys.Vec3

public class WartortleModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame {
    override val rootPart = root.registerChildWithAllChildren("wartortle")
    override val head = getPart("head_ai")

    override var portraitScale = 1.57F
    override var portraitTranslation = Vec3(-0.17, 0.54, 0.0)
