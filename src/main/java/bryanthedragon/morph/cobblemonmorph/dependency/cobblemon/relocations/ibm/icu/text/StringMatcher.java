...
UnicodeReplacer {
    ...
    public StringMatcher(String theString, int start2, int limit, int segmentNum, RuleBasedTransliterator.Data theData) {
        this(theString.substring(start2, limit), segmentNum, theData);
    }
