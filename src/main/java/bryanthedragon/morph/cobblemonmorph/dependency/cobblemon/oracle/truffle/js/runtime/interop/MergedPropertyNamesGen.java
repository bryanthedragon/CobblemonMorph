...
final class MergedPropertyNamesGen {
   ...
   static {
      LibraryExport.register(TopScopeObject.MergedPropertyNames.class, new MergedPropertyNamesGen.InteropLibraryExports());
   }
   ...
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         InteropLibrary uncached = new MergedPropertyNamesGen.InteropLibraryExports.Uncached();
         return uncached;
      }
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return new MergedPropertyNamesGen.InteropLibraryExports.Cached();
      }
      ...
      private static final class Cached extends InteropLibrary {
         ...
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof TopScopeObject.MergedPropertyNames)
               || MergedPropertyNamesGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
         ...
         private boolean isArrayElementReadableNode_AndSpecialize(TopScopeObject.MergedPropertyNames arg0Value, long arg1Value) {
            ...
            try {
               int state_0 = this.state_0_;
               this.interop = super.insert(this.interop == null ? MergedPropertyNamesGen.INTEROP_LIBRARY_.createDispatched(5) : this.interop);
               int var11;
               this.state_0_ = var11 = state_0 | 1;
               lock.unlock();
               hasLock = false;
               var7 = arg0Value.isArrayElementReadable(arg1Value, this.interop);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
         ...
         private Object readArrayElementNode_AndSpecialize(TopScopeObject.MergedPropertyNames arg0Value, long arg1Value) throws InvalidArrayIndexException, UnsupportedMessageException {
            ...
            try {
               ...
               lock.unlock();
               hasLock = false;
               var7 = arg0Value.readArrayElement(arg1Value, this.interop);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
      ...
      private static final class Uncached extends InteropLibrary {
         ...
         public boolean isArrayElementReadable(Object arg0Value_, long arg1Value) {
            ...
            TopScopeObject.MergedPropertyNames arg0Value = (TopScopeObject.MergedPropertyNames)arg0Value_;
            return arg0Value.isArrayElementReadable(arg1Value, MergedPropertyNamesGen.INTEROP_LIBRARY_.getUncached());
         }
         ...
         public Object readArrayElement(Object arg0Value_, long arg1Value) throws InvalidArrayIndexException, UnsupportedMessageException {
            ...
            TopScopeObject.MergedPropertyNames arg0Value = (TopScopeObject.MergedPropertyNames)arg0Value_;
            return arg0Value.readArrayElement(arg1Value, MergedPropertyNamesGen.INTEROP_LIBRARY_.getUncached());
         }
      }
   }
}
