...
public abstract class CollationIterator {
   ...
   public CollationIterator(CollationData d, boolean numeric) {
      ...
      this.ceBuffer = new CollationIterator.CEBuffer();
   }
   ...
   public final long nextCE() {
      if (this.cesIndex < this.ceBuffer.length) {
         ...
         int t = ce32 & 0xFF;
         if (t < 192) {
            return this.ceBuffer.set(this.cesIndex++, (long)(ce32 & -65536) << 32 | (long)(ce32 & 0xFF00) << 16 | t << 8);
         } else {
            CollationData d;
            if (t == 192) {
               if (c < 0) {
   ...
   protected long makeCodePointAndCE32Pair(int c, int ce32) {
      return (long)c << 32 | ce32 & 4294967295L;
   }
      ...
      while (Collation.isSpecialCE32(ce32)) {
         switch (Collation.tagFromCE32(ce32)) {
            ...
            case 6:
               ...
               do {
                  this.ceBuffer.appendUnsafe(d.ces[indexx++]);
               } while (--length > 0);
      ...
      if (nextCp < 0) {
         ...
         if (fcd16 <= 255) {
            ...
            if (this.skipped != null && !this.skipped.isEmpty()) {
               ...
               if (this.skipped == null) {
                  this.skipped = new CollationIterator.SkippedState();
               }
   ...
   private final void appendNumericCEs(int ce32, boolean forward) {
      ...
      if (forward) {
         ...
         while (true) {
            char digitx = Collation.digitFromCE32(ce32);
            digits.append(digitx);
            int cx = this.previousCodePoint();
            if (cx >= 0) {
               ce32 = this.data.getCE32(cx);
               if (ce32 == 192) {
                  ce32 = this.data.base.getCE32(cx);
               }
   ...
   private final void appendNumericSegmentCEs(CharSequence digits) {
      ...
      if (length <= 7) {
         ...
         int var22 = 40;
         if (value < var22 * 254) {
            long primary = numericPrimary | firstByte + value / 254 << 16 | 2 + value % 254 << 8;
            this.ceBuffer.append(Collation.makeCE(primary));
            return;
         }
      ...
      long primary = numericPrimary | 128 + numPairs << 16;
