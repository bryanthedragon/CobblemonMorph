...
public class PachirisuModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame {
   ...
   init {
      this.rootPart = this.registerChildWithAllChildren(root, "pachirisu");
      ...
      val blink: SimpleQuirk = PoseableEntityModel.quirk$default(
         this, null, null, null, (new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this) {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
               return PoseableEntityModel.bedrockStateful$default(this.this$0, "pachirisu", "blink", null, 4, null);
            }
         }) as Function1, 7, null
      );
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "pachirisu", "ground_idle", null, 4, null)
            },
            null,
