...
public final class IteratorToArrayNodeGen extends IteratorToArrayNode implements Introspection.Provider {
      ...
      try {
         ...
         if (iteratorNodeValue instanceof IteratorRecord) {
            ...
            if (!iteratorNodeValue_.isDone()) {
               ...
               lock.unlock();
               hasLock = false;
               return this.doIterator(frameValue, iteratorNodeValue_, this.iterator_growProfile_);
            }
            ...
            if (iteratorNodeValue_.isDone()) {
               ...
               lock.unlock();
               hasLock = false;
               return this.doDoneIterator(iteratorNodeValue_);
            }
         }
   ...
   public Introspection getIntrospectionData() {
      ...
      data[1] = s;
      s = new Object[]{"doDoneIterator", null, null};
      if ((state_0 & 2) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
