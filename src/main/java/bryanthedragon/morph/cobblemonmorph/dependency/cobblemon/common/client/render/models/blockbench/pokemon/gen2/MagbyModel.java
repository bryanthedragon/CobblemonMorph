...
implements HeadedFrame {
    ...
    public MagbyModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "magby");
        this.head = this.getPart("head");
        this.portraitScale = 2.4f;
        this.portraitTranslation = new Vec3(-0.05, -0.45, 0.0);
        this.profileScale = 0.78f;
        this.profileTranslation = new Vec3(-0.03, 0.61, 0.0);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "magby", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "magby", "ground_idle", null, 4, null)};
