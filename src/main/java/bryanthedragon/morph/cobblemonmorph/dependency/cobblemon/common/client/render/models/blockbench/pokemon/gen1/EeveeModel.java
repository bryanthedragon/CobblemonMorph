...
public class EeveeModel(root: ModelPart) : PokemonPoseableModel, EaredFrame, HeadedFrame, QuadrupedFrame {
   public final val body: ModelPart
   ...
   init {
      ...
      this.leftEarJoint = new EarJoint(this.getPart("ear_left"), 2, new RangeOfMotion(AngleExtensionsKt.toRadians(50.0F), 0.0F));
      this.rightEarJoint = new EarJoint(this.getPart("ear_right"), 2, new RangeOfMotion(AngleExtensionsKt.toRadians(-50.0F), 0.0F));
      ...
      this.cryAnimation = EeveeModel::cryAnimation$lambda$0;
   ...
   public override fun registerPoses() {
      ...
      this.setStand(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "eevee", "ground_idle", null, 4, null)
            },
            null,
      ...
      val var13: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "eevee", "ground_walk", null, 4, null)
      };
      val var18: PoseableEntityModel = this;
      this.setWalk(PoseableEntityModel.registerPose$default(var18, "walk", var7, null, 10, null, null, var13, null, var10, 180, null));
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: EeveeModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
