...
extends JavaScriptBaseNode {
    ...
    private void asyncGeneratorRejectBrokenPromise(VirtualFrame frame, JSDynamicObject generator, AbstractTruffleException exception) {
        ...
        this.enterThrowBranch();
        this.setGeneratorStateNode.setValue(generator, (Object)JSFunction.AsyncGeneratorState.Completed);
    ...
    private static JSFunctionData createAsyncGeneratorReturnProcessorFulfilledImpl(JSContext context) {
        ...
        extends JavaScriptRootNode {
            ...
            AsyncGeneratorReturnFulfilledRootNode(JSContext val$context) {
        ...
        return JSFunctionData.createCallOnly(context, new AsyncGeneratorReturnFulfilledRootNode(context).getCallTarget(), 1, Strings.EMPTY_STRING);
    }
    ...
    private static JSFunctionData createAsyncGeneratorReturnProcessorRejectedImpl(JSContext context) {
        ...
        extends JavaScriptRootNode {
            ...
            AsyncGeneratorReturnRejectedRootNode(JSContext val$context) {
                this.val$context = val$context;
            }
        ...
        return JSFunctionData.createCallOnly(context, new AsyncGeneratorReturnRejectedRootNode(context).getCallTarget(), 1, Strings.EMPTY_STRING);
    }
