...
@GeneratedBy(value=DefaultTopScope.class)
final class DefaultTopScopeGen {
    ...
    static {
        LibraryExport.register(DefaultTopScope.class, new InteropLibraryExports());
    }
    ...
    extends LibraryExport<InteropLibrary> {
        ...
        extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert (!(receiver instanceof DefaultTopScope) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null) : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
