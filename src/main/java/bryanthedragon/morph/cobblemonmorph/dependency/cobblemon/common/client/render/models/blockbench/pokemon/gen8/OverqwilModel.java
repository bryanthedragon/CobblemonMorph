...
implements HeadedFrame {
    ...
    public OverqwilModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "overqwil");
        this.head = this.getPart("body");
        this.tail = this.getPart("tail");
        this.wtail = new WaveSegment(this.tail, 7.0f);
        this.portraitScale = 1.99f;
        this.portraitTranslation = new Vec3(-0.65, 0.87, 0.0);
        this.profileScale = 0.62f;
        this.profileTranslation = new Vec3(-0.02, 0.95, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> OverqwilModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ OverqwilModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "overqwil", "blink", null, 4, null);
            }
        }, 7, null);
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "overqwil", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray[0] = PoseableEntityModel.bedrock$default(this, "overqwil", "ground_idle", null, 4, null);
        ...
        statelessAnimationArray[1] = new WaveAnimation(this, function1, 8.0f, modelPart, 0.1f, false, 1, 0, true, waveSegmentArray2, 32, null);
        objectArray = statelessAnimationArray;
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(OverqwilModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "overqwil", "cry", null, 4, null);
    }
}
