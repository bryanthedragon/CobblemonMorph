...
public abstract class CoerceOptionsToObjectNode
extends JavaScriptBaseNode {
    ...
    @Specialization(guards={"!isUndefined(opts)"})
    public JSDynamicObject fromOtherThanUndefined(Object opts, @Cached(value="createToObject(getContext())") JSToObjectNode toObjectNode) {
