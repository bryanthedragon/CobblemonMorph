...
public final class UScriptRun {
    ...
    @Deprecated
    public UScriptRun(String text, int start2, int count) {
        this.reset(text, start2, count);
    }
    ...
    @Deprecated
    public UScriptRun(char[] chars, int start2, int count) {
        this.reset(chars, start2, count);
    }
    ...
    @Deprecated
    public final void reset(int start2, int count) throws IllegalArgumentException {
        int len = 0;
        if (this.text != null) {
            len = this.text.length;
        }
        if (start2 < 0 || count < 0 || start2 > len - count) {
            throw new IllegalArgumentException();
        }
        this.textStart = start2;
        this.textLimit = start2 + count;
        this.reset();
    }

    @Deprecated
    public final void reset(char[] chars, int start2, int count) {
        if (chars == null) {
            chars = this.emptyCharArray;
        }
        this.text = chars;
        this.reset(start2, count);
    }
    ...
    @Deprecated
    public final void reset(String str, int start2, int count) {
        char[] chars = null;
        if (str != null) {
