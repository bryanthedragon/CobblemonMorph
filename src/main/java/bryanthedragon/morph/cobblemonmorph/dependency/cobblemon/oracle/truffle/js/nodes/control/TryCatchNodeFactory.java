...
@GeneratedBy(TryCatchNode.class)
public final class TryCatchNodeFactory {
   @GeneratedBy(TryCatchNode.GetErrorObjectNode.class)
   public static final class GetErrorObjectNodeGen extends TryCatchNode.GetErrorObjectNode implements Introspection.Provider {
      ...
      public Object execute(Throwable arg0Value) {
         ...
         } else if ((state_0 & 2) != 0 && arg0Value instanceof UserScriptException) {
         ...
         } else if ((state_0 & 4) != 0 && arg0Value instanceof StackOverflowError) {
      ...
      private Object executeAndSpecialize(Throwable arg0Value) {
         ...
         if (arg0Value instanceof JSException) {
            ...
            return TryCatchNode.GetErrorObjectNode.doUserScriptException(arg0Value_);
         } else if (arg0Value instanceof StackOverflowError) {
            StackOverflowError arg0Value_ = (StackOverflowError)arg0Value;
            int var5;
      ...
      public Introspection getIntrospectionData() {
         ...
         data[0] = 0;
         int state_0 = this.state_0_;
         Object[] s = new Object[]{"doJSException", null, null};
         if ((state_0 & 1) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
         ...
         data[1] = s;
         s = new Object[]{"doUserScriptException", null, null};
         if ((state_0 & 2) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
         ...
         data[2] = s;
         s = new Object[]{"doStackOverflowError", null, null};
         if ((state_0 & 4) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
      ...
      private static boolean fallbackGuard_(int state_0, Throwable arg0Value) {
         if ((state_0 & 1) == 0 && arg0Value instanceof JSException) {
            ...
            return (state_0 & 2) == 0 && arg0Value instanceof UserScriptException ? false : (state_0 & 4) != 0 || !(arg0Value instanceof StackOverflowError);
         }
      }

      public static TryCatchNode.GetErrorObjectNode create(JSContext context) {
         return new TryCatchNodeFactory.GetErrorObjectNodeGen(context);
      }
   }
}
