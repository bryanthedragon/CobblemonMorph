...
import com.oracle.truffle.js.nodes.unary.VoidNodeGen;
import com.oracle.truffle.js.runtime.objects.Undefined;
import java.util.Set;

@NodeInfo(shortName="void", cost=NodeCost.NONE)
public abstract class VoidNode
extends JSUnaryNode {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return VoidNodeGen.create(VoidNode.cloneUninitialized(this.getOperand(), materializedTags));
    }
}
