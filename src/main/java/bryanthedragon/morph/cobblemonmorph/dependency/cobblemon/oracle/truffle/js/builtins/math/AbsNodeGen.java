...
public final class AbsNodeGen extends AbsNode implements Introspection.Provider {
   ...
   private Object execute_generic2(int state_0, VirtualFrame frameValue) {
      ...
      if ((state_0 & 4) != 0 && JSTypesGen.isImplicitDouble((state_0 & 240) >>> 4, arguments0Value_)) {
         double arguments0Value__x = JSTypesGen.asImplicitDouble((state_0 & 240) >>> 4, arguments0Value_);
         return AbsNode.absDouble(arguments0Value__x);
      } else if ((state_0 & 8) != 0) {
   ...
   public double executeDouble(VirtualFrame frameValue) throws UnexpectedResultException {
      ...
      if ((state_0 & 12) == 0 && (state_0 & 14) != 0) {
         ...
         return (state_0 & 10) == 0 && (state_0 & 14) != 0 ? this.executeDouble_double4(state_0, frameValue) : this.executeDouble_generic5(state_0, frameValue);
      }
   }
   ...
   public void executeVoid(VirtualFrame frameValue) {
      ...
      try {
         ...
         } else if ((state_0 & 1) == 0 && (state_0 & 15) != 0) {
      ...
      try {
         ...
         if (!(arguments0Value instanceof Integer)) {
            ...
            if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(arguments0Value)) == 0) {
               ...
               lock.unlock();
               hasLock = false;
               return this.absGeneric(arguments0Value);
            }
         ...
         try {
            ...
            var8 = this.executeAndSpecialize(arguments0Value_);
         }
      } finally {
         if (hasLock) {
            lock.unlock();
   ...
   public Introspection getIntrospectionData() {
      ...
      int state_0 = this.state_0_;
      int exclude = this.exclude_;
      Object[] s = new Object[]{"absInt", null, null};
      if ((state_0 & 1) != 0) {
         s[1] = (byte)1;
      ...
      data[1] = s;
      s = new Object[]{"absIntSpecial", null, null};
      if ((state_0 & 2) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
      ...
      data[2] = s;
      s = new Object[]{"absDouble", null, null};
      if ((state_0 & 4) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
      ...
      data[3] = s;
      s = new Object[]{"absGeneric", null, null};
      if ((state_0 & 8) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
