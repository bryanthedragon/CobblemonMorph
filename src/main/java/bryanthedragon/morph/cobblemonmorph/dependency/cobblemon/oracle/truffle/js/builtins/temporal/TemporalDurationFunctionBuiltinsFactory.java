...
@GeneratedBy(TemporalDurationFunctionBuiltins.class)
public final class TemporalDurationFunctionBuiltinsFactory {
   @GeneratedBy(TemporalDurationFunctionBuiltins.JSTemporalDurationCompare.class)
   public static final class JSTemporalDurationCompareNodeGen
      ...
      @Node.Child
      private TemporalDurationFunctionBuiltinsFactory.JSTemporalDurationCompareNodeGen.CompareData compare_cache;
      ...
      public Object execute(VirtualFrame frameValue) {
         ...
         if (state_0 != 0) {
            TemporalDurationFunctionBuiltinsFactory.JSTemporalDurationCompareNodeGen.CompareData s0_ = this.compare_cache;
            if (s0_ != null) {
               return this.compare(
                  arguments0Value_,
                  arguments1Value_,
      ...
      private int executeAndSpecialize(Object arguments0Value, Object arguments1Value, Object arguments2Value) {
         ...
         try {
            int state_0 = this.state_0_;
            TemporalDurationFunctionBuiltinsFactory.JSTemporalDurationCompareNodeGen.CompareData s0_ = super.insert(
               new TemporalDurationFunctionBuiltinsFactory.JSTemporalDurationCompareNodeGen.CompareData()
            );
      ...
      public static TemporalDurationFunctionBuiltins.JSTemporalDurationCompare create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new TemporalDurationFunctionBuiltinsFactory.JSTemporalDurationCompareNodeGen(context, builtin, arguments);
      }
   ...
   @GeneratedBy(TemporalDurationFunctionBuiltins.JSTemporalDurationFrom.class)
   public static final class JSTemporalDurationFromNodeGen extends TemporalDurationFunctionBuiltins.JSTemporalDurationFrom implements Introspection.Provider {
      @Node.Child
      private JavaScriptNode arguments0_;
      @CompilerDirectives.CompilationFinal
      private volatile int state_0_;
      ...
      private JSDynamicObject executeAndSpecialize(Object arguments0Value) {
         ...
         try {
            ...
            lock.unlock();
            hasLock = false;
            var5 = this.from(arguments0Value, this.toTemporalDurationNode_);
         } finally {
            if (hasLock) {
               lock.unlock();
            }
      ...
      public static TemporalDurationFunctionBuiltins.JSTemporalDurationFrom create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new TemporalDurationFunctionBuiltinsFactory.JSTemporalDurationFromNodeGen(context, builtin, arguments);
      }
   }
}
