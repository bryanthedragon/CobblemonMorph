...
implements PokemonSelectingItem {
    ...
    public RevivalHerbItem(@NotNull RevivalHerbBlock block) {
        ...
        this.bagItem = new BagItem(this){
            ...
            final /* synthetic */ RevivalHerbItem this$0;
            {
                this.this$0 = $receiver;
                this.itemName = "item.cobblemon.revival_herb";
            }
            ...
            public String getShowdownInput(@NotNull BattleActor actor, @NotNull BattlePokemon battlePokemon, @Nullable String data) {
                ...
                Pokemon.decrementFriendship$default(battlePokemon.getEffectedPokemon(), CobblemonMechanics.INSTANCE.getRemedies().getFriendshipDrop(RevivalHerbItem.access$getRuntime$p(this.this$0)), false, 2, null);
                return "revive 0.25";
            }
    ...
    public InteractionResultHolder<ItemStack> m_7203_(@NotNull Level world, @NotNull Player user, @NotNull InteractionHand hand) {
        ...
        if (user instanceof ServerPlayer) {
            ...
            InteractionResultHolder<ItemStack> result = this.use(serverPlayer, itemStack);
    ...
    public InteractionResultHolder<ItemStack> applyToPokemon(@NotNull ServerPlayer player, @NotNull ItemStack stack, @NotNull Pokemon pokemon) {
        ...
        if (pokemon.isFainted()) {
            ...
            pokemon.setCurrentHealth((int)Math.ceil((float)pokemon.getHp() / 4.0f));
            ...
            interactionResultHolder = InteractionResultHolder.m_19098_((Object)stack);
        }
        return interactionResultHolder;
    }
    ...
    public static final /* synthetic */ MoLangRuntime access$getRuntime$p(RevivalHerbItem $this) {
        return $this.runtime;
    }
}
