...
public final class Boundaries {
    ...
    @CompilerDirectives.TruffleBoundary
    public static <K, V> V mapPut(Map<K, V> map, K key, V value2) {
        return map.put(key, value2);
    }

    @CompilerDirectives.TruffleBoundary
    public static <K, V> V mapPutIfAbsent(Map<K, V> map, K key, V value2) {
        return map.putIfAbsent(key, value2);
    }
    ...
    @CompilerDirectives.TruffleBoundary
    public static <T> void listSet(List<T> list, int index, T value2) {
    ...
    @CompilerDirectives.TruffleBoundary
    public static <K, V> V economicMapPut(EconomicMap<K, V> map, K key, V value2) {
        return map.put(key, value2);
    }
