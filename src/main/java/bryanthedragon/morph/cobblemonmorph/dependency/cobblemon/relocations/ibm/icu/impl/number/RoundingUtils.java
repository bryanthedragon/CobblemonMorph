...
public class RoundingUtils {
    ...
    public static MathContext getMathContextOrUnlimited(DecimalFormatProperties properties2) {
        MathContext mathContext = properties2.getMathContext();
        if (mathContext == null) {
            RoundingMode roundingMode = properties2.getRoundingMode();
    ...
    public static MathContext getMathContextOr34Digits(DecimalFormatProperties properties2) {
        MathContext mathContext = properties2.getMathContext();
        if (mathContext == null) {
            RoundingMode roundingMode = properties2.getRoundingMode();
            if (roundingMode == null) {
    ...
    public static Scale scaleFromProperties(DecimalFormatProperties properties2) {
        MathContext mc = RoundingUtils.getMathContextOr34Digits(properties2);
        if (properties2.getMagnitudeMultiplier() != 0) {
            return Scale.powerOfTen(properties2.getMagnitudeMultiplier()).withMathContext(mc);
        }
        if (properties2.getMultiplier() != null) {
            return Scale.byBigDecimal(properties2.getMultiplier()).withMathContext(mc);
        }
        return null;
    }
