...
public final class ChangeScaleAndSize {
    ...
    public final void register(@NotNull CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        LiteralArgumentBuilder literalArgumentBuilder = Commands.m_82127_((String)"changescaleandsize");
        Intrinsics.checkNotNullExpressionValue((Object)literalArgumentBuilder, (String)"literal(\"changescaleandsize\")");
        LiteralArgumentBuilder command = (LiteralArgumentBuilder)((LiteralArgumentBuilder)PermissionUtilsKt.permission$default((ArgumentBuilder)literalArgumentBuilder, CobblemonPermissions.INSTANCE.getCHANGE_SCALE_AND_SIZE(), false, 2, null)).then(((RequiredArgumentBuilder)Commands.m_82129_((String)"pokemon", (ArgumentType)PokemonArgumentType.Companion.pokemon()).then(Commands.m_82129_((String)"scale", (ArgumentType)((ArgumentType)FloatArgumentType.floatArg())).then(Commands.m_82129_((String)"width", (ArgumentType)((ArgumentType)FloatArgumentType.floatArg())).then(Commands.m_82129_((String)"height", (ArgumentType)((ArgumentType)FloatArgumentType.floatArg())).executes(this::execute))))).executes(this::execute));
