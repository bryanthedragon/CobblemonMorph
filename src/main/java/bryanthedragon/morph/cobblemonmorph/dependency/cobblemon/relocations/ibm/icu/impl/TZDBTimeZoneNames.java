...
extends TimeZoneNames {
    ...
    @Override
    public Collection<TimeZoneNames.MatchInfo> find(CharSequence text, int start2, EnumSet<TimeZoneNames.NameType> nameTypes) {
        ...
        TZDB_NAMES_TRIE.find(text, start2, handler);
