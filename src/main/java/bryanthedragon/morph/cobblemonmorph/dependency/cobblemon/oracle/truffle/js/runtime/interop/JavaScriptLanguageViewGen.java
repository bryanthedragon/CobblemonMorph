...
final class JavaScriptLanguageViewGen {
   ...
   static {
      LibraryExport.register(JavaScriptLanguageView.class, new JavaScriptLanguageViewGen.InteropLibraryExports());
   }

   @GeneratedBy(JavaScriptLanguageView.class)
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      static final FinalBitSet ENABLED_MESSAGES = createMessageBitSet(
         JavaScriptLanguageViewGen.INTEROP_LIBRARY_, "hasLanguage", "getLanguage", "toDisplayString", "hasMetaObject", "getMetaObject"
      );
      private static final JavaScriptLanguageViewGen.InteropLibraryExports.Uncached UNCACHED = new JavaScriptLanguageViewGen.InteropLibraryExports.Uncached();
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return createDelegate(JavaScriptLanguageViewGen.INTEROP_LIBRARY_, new JavaScriptLanguageViewGen.InteropLibraryExports.Cached(receiver));
      }
      ...
      private static final class Cached extends InteropLibrary implements LibraryExport.DelegateExport {
         ...
         protected Cached(Object receiver) {
            ...
            this.receiverDelegateInteropLibrary_ = super.insert(JavaScriptLanguageViewGen.INTEROP_LIBRARY_.create(castReceiver.delegate));
         }

         @Override
         public FinalBitSet getDelegateExportMessages() {
            return JavaScriptLanguageViewGen.InteropLibraryExports.ENABLED_MESSAGES;
         }
         ...
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof JavaScriptLanguageView)
               || JavaScriptLanguageViewGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";

            return !(receiver instanceof JavaScriptLanguageView)
               ? false
               : this.receiverDelegateInteropLibrary_.accepts(((JavaScriptLanguageView)receiver).delegate);
         }
      ...
      private static final class Uncached extends InteropLibrary implements LibraryExport.DelegateExport {
         ...
         public Library getDelegateExportLibrary(Object delegate_) {
            return JavaScriptLanguageViewGen.INTEROP_LIBRARY_.getUncached(delegate_);
         }
         ...
         public boolean hasMetaObject(Object arg0Value_) {
            ...
            JavaScriptLanguageView arg0Value = (JavaScriptLanguageView)arg0Value_;
            return arg0Value.hasMetaObject(JavaScriptLanguageViewGen.INTEROP_LIBRARY_.getUncached(arg0Value.delegate));
         }
         ...
         public Object getMetaObject(Object arg0Value_) throws UnsupportedMessageException {
            ...
            JavaScriptLanguageView arg0Value = (JavaScriptLanguageView)arg0Value_;
            return arg0Value.getMetaObject(JavaScriptLanguageViewGen.INTEROP_LIBRARY_.getUncached(arg0Value.delegate));
         }
      }
   }
}
