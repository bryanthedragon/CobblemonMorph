...
extends RegexBodyNode {
    ...
    public final Void execute(VirtualFrame frame) {
        ...
        int start2 = this.findStartCallTarget != null ? ((Integer)this.findStartCallNode.call(receiver)).intValue() : receiver.getStart();
        int[] result = (int[])this.entryNode.execute(frame, receiver.getInput(), receiver.getFromIndex(), start2, receiver.getEnd());
