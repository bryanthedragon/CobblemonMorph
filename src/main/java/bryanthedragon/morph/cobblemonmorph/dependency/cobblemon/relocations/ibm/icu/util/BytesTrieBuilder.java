...
extends StringTrieBuilder {
    ...
    public BytesTrieBuilder add(byte[] sequence, int length, int value2) {
        this.addImpl(new BytesAsCharSequence(sequence, length), value2);
        return this;
    }
    ...
    protected int writeValueAndType(boolean hasValue, int value2, int node) {
        ...
        if (hasValue) {
            offset = this.writeValueAndFinal(value2, false);
        }
        return offset;
    }
