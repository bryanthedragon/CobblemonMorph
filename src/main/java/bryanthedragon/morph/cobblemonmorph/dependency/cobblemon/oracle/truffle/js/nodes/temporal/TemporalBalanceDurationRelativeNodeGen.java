...
@GeneratedBy(TemporalBalanceDurationRelativeNode.class)
public final class TemporalBalanceDurationRelativeNodeGen extends TemporalBalanceDurationRelativeNode implements Introspection.Provider {
   @CompilerDirectives.CompilationFinal
   private volatile int state_0_;
   @Node.Child
   private TemporalBalanceDurationRelativeNodeGen.BalanceDurationRelativeData balanceDurationRelative_cache;
   ...
   public JSTemporalDurationRecord execute(
      ...
      if ((state_0 & 1) != 0) {
         TemporalBalanceDurationRelativeNodeGen.BalanceDurationRelativeData s0_ = this.balanceDurationRelative_cache;
         if (s0_ != null) {
            return this.balanceDurationRelative(
               arg0Value, arg1Value, arg2Value, arg3Value, arg4Value, arg5Value, s0_.unitIsYear_, s0_.unitIsMonth_, s0_.unitIsDay_, s0_.toTemporalDateNode_
            );
         }
      }
   ...
   private JSTemporalDurationRecord executeAndSpecialize(
      ...
      try {
         int state_0 = this.state_0_;
         TemporalBalanceDurationRelativeNodeGen.BalanceDurationRelativeData s0_ = super.insert(
            new TemporalBalanceDurationRelativeNodeGen.BalanceDurationRelativeData()
         );
         ...
         lock.unlock();
         hasLock = false;
         var15 = this.balanceDurationRelative(
            arg0Value, arg1Value, arg2Value, arg3Value, arg4Value, arg5Value, s0_.unitIsYear_, s0_.unitIsMonth_, s0_.unitIsDay_, s0_.toTemporalDateNode_
         );
      } finally {
         if (hasLock) {
   ...
   public Introspection getIntrospectionData() {
      ...
      int state_0 = this.state_0_;
      Object[] s = new Object[]{"balanceDurationRelative", null, null};
      if ((state_0 & 1) != 0) {
         s[1] = (byte)1;
   ...
   @GeneratedBy(TemporalBalanceDurationRelativeNode.class)
   private static final class BalanceDurationRelativeData extends Node {
      @CompilerDirectives.CompilationFinal
