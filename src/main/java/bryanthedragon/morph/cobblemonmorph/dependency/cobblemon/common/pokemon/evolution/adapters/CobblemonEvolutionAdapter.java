 ...
 */
public final class CobblemonEvolutionAdapter : EvolutionAdapter {
    ...
    override fun deserialize(jsonIn: JsonElement, typeOfT: Type, JsonDeserializationContext context): Evolution {
    ...
    override fun serialize(src: Evolution, typeOfT srcype, context: JsonSerializationContext): JsonElement {
