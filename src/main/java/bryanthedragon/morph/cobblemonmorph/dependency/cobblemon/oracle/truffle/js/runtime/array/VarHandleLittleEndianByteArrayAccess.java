...
final class VarHandleLittleEndianByteArrayAccess
extends ByteArrayAccess {
    private static final VarHandle INT16 = MethodHandles.byteArrayViewVarHandle(short[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
    private static final VarHandle INT32 = MethodHandles.byteArrayViewVarHandle(int[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
    private static final VarHandle INT64 = MethodHandles.byteArrayViewVarHandle(long[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
    private static final VarHandle FLOAT = MethodHandles.byteArrayViewVarHandle(float[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
    private static final VarHandle DOUBLE = MethodHandles.byteArrayViewVarHandle(double[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
    static final ByteArrayAccess INSTANCE = new VarHandleLittleEndianByteArrayAccess();

    VarHandleLittleEndianByteArrayAccess() {
    }
