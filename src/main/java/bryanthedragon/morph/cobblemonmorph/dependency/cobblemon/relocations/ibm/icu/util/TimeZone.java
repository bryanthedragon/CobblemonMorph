...
Freezable<TimeZone> {
    ...
    public static String getWindowsID(String id) {
        ...
        UResourceBundle top = UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", "windowsZones", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
