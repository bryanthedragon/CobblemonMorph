...
import com.cobblemon.mod.relocations.ibm.icu.text.RBBIRuleParseTable;
import com.cobblemon.mod.relocations.ibm.icu.text.RBBISymbolTable;
...
class RBBIRuleScanner {
    ...
    boolean doParseActions(int action2) {
        RBBINode n = null;
