...
public class TemporalZonedDateTimeFunctionBuiltins extends JSBuiltinsContainer.SwitchEnum<TemporalZonedDateTimeFunctionBuiltins.TemporalZonedDateTimeFunction> {
   ...
   protected TemporalZonedDateTimeFunctionBuiltins() {
      super(JSTemporalZonedDateTime.CLASS_NAME, TemporalZonedDateTimeFunctionBuiltins.TemporalZonedDateTimeFunction.class);
   }
   ...
   protected Object createNode(
      ...
      boolean construct,
      boolean newTarget,
      TemporalZonedDateTimeFunctionBuiltins.TemporalZonedDateTimeFunction builtinEnum
   ) {
      switch (builtinEnum) {
         case from:
            return TemporalZonedDateTimeFunctionBuiltinsFactory.JSTemporalZonedDateTimeFromNodeGen.create(
               context, builtin, args().fixedArgs(2).createArgumentNodes(context)
            );
         case compare:
            return TemporalZonedDateTimeFunctionBuiltinsFactory.JSTemporalZonedDateTimeCompareNodeGen.create(
               context, builtin, args().fixedArgs(2).createArgumentNodes(context)
            );
         default:
            return null;
   ...
   public abstract static class JSTemporalZonedDateTimeCompareNode extends JSBuiltinNode {
      ...
      @Specialization
      protected int compare(Object obj1, Object obj2, @Cached("create(getContext())") ToTemporalZonedDateTimeNode toTemporalZonedDateTime) {
   ...
   public abstract static class JSTemporalZonedDateTimeFromNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
   ...
   public static enum TemporalZonedDateTimeFunction implements BuiltinEnum<TemporalZonedDateTimeFunctionBuiltins.TemporalZonedDateTimeFunction> {
      from(1),
      compare(2);
