...
public class RotationFunctionStatelessAnimation<T extends Entity>(part: ModelPart,
   ...
   protected override fun setAngles(
      ...
      val var10000: Bone = this.part as Bone;
      ...
      ModelPartExtensionsKt.addRotation(var10000, var10001, (var10002.invoke(var10003 ?: 0.0F) as java.lang.Number).floatValue() * intensity);
   }
}
