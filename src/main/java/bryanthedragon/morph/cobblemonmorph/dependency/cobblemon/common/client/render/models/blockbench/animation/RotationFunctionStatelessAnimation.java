...
extends StatelessAnimation<T, ModelFrame> {
    ...
    public RotationFunctionStatelessAnimation(@NotNull ModelPart part, @NotNull Function1<? super Float, Float> function, int axis, @NotNull Function3<? super PoseableEntityState<T>, ? super Float, ? super Float, Float> timeVariable, @NotNull ModelFrame frame) {
    ...
    protected void setAngles(@Nullable T entity2, @NotNull PoseableEntityModel<T> model, @Nullable PoseableEntityState<T> state, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch, float intensity) {
        ...
        ModelPartExtensionsKt.addRotation((Bone)this.part, this.axis, ((Number)this.function.invoke((Object)Float.valueOf(f != null ? f.floatValue() : 0.0f))).floatValue() * intensity);
    }
}
