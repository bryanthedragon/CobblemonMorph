...
implements PokemonSelectingItem {
    ...
    public static final int EV_YIELD = 1;

    public FeatherItem(@NotNull Stat stat) {
    ...
    public InteractionResultHolder<ItemStack> applyToPokemon(@NotNull ServerPlayer player, @NotNull ItemStack stack, @NotNull Pokemon pokemon) {
        ...
        Intrinsics.checkNotNullParameter((Object)pokemon, (String)"pokemon");
        int evsGained = pokemon.getEvs().add(this.stat, 1);
        if (evsGained > 0) {
            player.m_6330_(CobblemonSounds.MEDICINE_FEATHER_USE, SoundSource.PLAYERS, 1.0f, 1.0f);
            if (!player.m_7500_()) {
                stack.m_41774_(1);
            }
    ...
    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2={"Lcom/cobblemon/mod/common/item/interactive/FeatherItem$Companion;", "", "", "EV_YIELD", "I", "<init>", "()V", "common"})
