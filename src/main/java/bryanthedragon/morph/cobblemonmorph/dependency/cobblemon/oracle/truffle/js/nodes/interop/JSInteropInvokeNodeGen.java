...
public final class JSInteropInvokeNodeGen extends JSInteropInvokeNode implements Introspection.Provider {
   private static final JSInteropInvokeNodeGen.Uncached UNCACHED = new JSInteropInvokeNodeGen.Uncached();
      ...
      if (state_0 != 0) {
         if ((state_0 & 1) != 0 && JSGuards.stringEquals(this.cached_equalNode_, this.cached_cachedName_, arg1Value)) {
            return this.doCached(
               ...
               arg1Value,
               arg2Value,
               this.cached_cachedName_,
               this.cached_equalNode_,
               this.cached_functionPropertyGetNode_,
               this.isCallable,
               this.call,
               this.importValue
            );
      ...
      try {
         ...
         if (exclude == 0) {
            ...
            if (!Cached_duplicateFound_) {
               ...
               if (JSGuards.stringEquals(cached_equalNode__, arg1Value, arg1Value) && (state_0 & 1) == 0) {
                  this.cached_cachedName_ = arg1Value;
                  this.cached_equalNode_ = super.insert(cached_equalNode__);
                  this.cached_functionPropertyGetNode_ = super.insert(this.createGetProperty(arg1Value));
   ...
   public Introspection getIntrospectionData() {
      ...
      if ((state_0 & 1) != 0) {
         ...
         cached.add(
            Arrays.asList(this.cached_cachedName_, this.cached_equalNode_, this.cached_functionPropertyGetNode_, this.isCallable, this.call, this.importValue)
         );
         s[2] = cached;
      } else if (exclude != 0) {
         s[1] = (byte)2;
