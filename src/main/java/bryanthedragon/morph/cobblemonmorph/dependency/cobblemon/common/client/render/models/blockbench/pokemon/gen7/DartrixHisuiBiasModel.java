...
public class DartrixHisuiBiasModel(root: ModelPart) : PokemonPoseableModel, BipedFrame, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = DartrixHisuiBiasModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "dartrix_hisui_bias", "ground_idle", null, 4, null)},
      ...
      this.setFlyidle(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "dartrix_hisui_bias", "ground_idle", null, 4, null),
      ...
      this.setWalk(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "dartrix_hisui_bias", "ground_idle", null, 4, null), new BipedWalkAnimation(this, 0.75F, 0.7F)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.wingsOpen).withVisibility(false),
               ModelPartExtensionsKt.createTransformation(this.wingsClosed).withVisibility(true)
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: DartrixHisuiBiasModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
