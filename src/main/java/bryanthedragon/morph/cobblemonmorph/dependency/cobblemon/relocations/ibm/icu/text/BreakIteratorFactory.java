...
extends BreakIterator.BreakIteratorServiceShim {
    ...
    private static BreakIterator createBreakInstance(ULocale locale, int kind) {
        ...
        ICUResourceBundle rb = ICUResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/brkitr", locale, ICUResourceBundle.OpenType.LOCALE_ROOT);
        ...
        if (kind == 2) {
            ...
            if ((language = locale.getLanguage()) != null && language.equals("ja") && (keyValue = locale.getKeywordValue("lw")) != null && keyValue.equals("phrase")) {
