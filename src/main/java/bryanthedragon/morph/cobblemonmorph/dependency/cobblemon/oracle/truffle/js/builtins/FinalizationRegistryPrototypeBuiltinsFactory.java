...
@GeneratedBy(value=FinalizationRegistryPrototypeBuiltins.class)
public final class FinalizationRegistryPrototypeBuiltinsFactory {

    @GeneratedBy(value=FinalizationRegistryPrototypeBuiltins.JSFinalizationRegistryCleanupSomeNode.class)
    ...
    implements Introspection.Provider {
        ...
        public static FinalizationRegistryPrototypeBuiltins.JSFinalizationRegistryCleanupSomeNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
            return new JSFinalizationRegistryCleanupSomeNodeGen(context, builtin, arguments);
        }
    }

    @GeneratedBy(value=FinalizationRegistryPrototypeBuiltins.JSFinalizationRegistryUnregisterNode.class)
    ...
    implements Introspection.Provider {
        ...
        public static FinalizationRegistryPrototypeBuiltins.JSFinalizationRegistryUnregisterNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
            return new JSFinalizationRegistryUnregisterNodeGen(context, builtin, arguments);
        }
    }

    @GeneratedBy(value=FinalizationRegistryPrototypeBuiltins.JSFinalizationRegistryRegisterNode.class)
    ...
    implements Introspection.Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if (state_0 != 0) {
                ...
                if ((state_0 & 2) != 0 && !JSGuards.isJSFinalizationRegistry(arguments0Value_)) {
                    return FinalizationRegistryPrototypeBuiltins.JSFinalizationRegistryRegisterNode.notFinalizationRegistry(arguments0Value_, arguments1Value_, arguments2Value_, arguments3Value_);
                }
            }
            CompilerDirectives.transferToInterpreterAndInvalidate();
        ...
        private JSDynamicObject executeAndSpecialize(Object arguments0Value, Object arguments1Value, Object arguments2Value, Object arguments3Value) {
            ...
            if (!JSGuards.isJSFinalizationRegistry(arguments0Value)) {
                this.state_0_ = state_0 |= 2;
                return FinalizationRegistryPrototypeBuiltins.JSFinalizationRegistryRegisterNode.notFinalizationRegistry(arguments0Value, arguments1Value, arguments2Value, arguments3Value);
            }
        ...
        public static FinalizationRegistryPrototypeBuiltins.JSFinalizationRegistryRegisterNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
