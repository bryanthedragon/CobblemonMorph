...
@GeneratedBy(TemporalPlainTimeFunctionBuiltins.class)
public final class TemporalPlainTimeFunctionBuiltinsFactory {
   @GeneratedBy(TemporalPlainTimeFunctionBuiltins.JSTemporalPlainTimeCompareNode.class)
   public static final class JSTemporalPlainTimeCompareNodeGen
      ...
      private int executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
         ...
         try {
            ...
            lock.unlock();
            hasLock = false;
            var6 = this.compare(arguments0Value, arguments1Value, this.toTemporalTime_);
         } finally {
            if (hasLock) {
               lock.unlock();
            }
      ...
      public static TemporalPlainTimeFunctionBuiltins.JSTemporalPlainTimeCompareNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new TemporalPlainTimeFunctionBuiltinsFactory.JSTemporalPlainTimeCompareNodeGen(context, builtin, arguments);
      }
   }

   @GeneratedBy(TemporalPlainTimeFunctionBuiltins.JSTemporalPlainTimeFromNode.class)
   public static final class JSTemporalPlainTimeFromNodeGen
      ...
      private Object executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
         ...
         try {
            ...
            lock.unlock();
            hasLock = false;
            var6 = this.from(arguments0Value, arguments1Value, this.toTemporalTime_);
         } finally {
            if (hasLock) {
               lock.unlock();
            }
      ...
      public static TemporalPlainTimeFunctionBuiltins.JSTemporalPlainTimeFromNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new TemporalPlainTimeFunctionBuiltinsFactory.JSTemporalPlainTimeFromNodeGen(context, builtin, arguments);
      }
   }
}
