...
import com.cobblemon.mod.relocations.ibm.icu.text.FilteredNormalizer2;
...
implements Cloneable {
    ...
    @Deprecated
    public static QuickCheckResult quickCheck(char[] source, int start2, int limit, Mode mode, int options) {
        CharBuffer srcBuffer = CharBuffer.wrap(source, start2, limit - start2);
        return mode.getNormalizer2(options).quickCheck(srcBuffer);
    }

    @Deprecated
    public static boolean isNormalized(char[] src, int start2, int limit, Mode mode, int options) {
        CharBuffer srcBuffer = CharBuffer.wrap(src, start2, limit - start2);
    ...
    @Deprecated
    public void setOption(int option, boolean value2) {
        this.options = value2 ? (this.options |= option) : (this.options &= ~option);
        this.norm2 = this.mode.getNormalizer2(this.options);
    }
    ...
    public static final class QuickCheckResult {
        private QuickCheckResult(int value2) {
        }
    }
