...
public final class Normalizer implements Cloneable {
   ...
   public int next() {
      if (this.bufferPos >= this.buffer.length() && !this.nextNormalize()) {
         ...
         this.bufferPos = this.bufferPos + Character.charCount(c);
         return c;
      }
   }
            ...
            if (level1 == 0 && (options & 65536) != 0 && (length = csp.toFullFolding(cp1, fold1, options)) >= 0) {
               ...
               if (level1 < 2 && (options & 524288) != 0 && (decomp1 = nfcImpl.getDecomposition(cp1)) != null) {
                  ...
                  if (level2 >= 2 || (options & 524288) == 0 || (decomp2 = nfcImpl.getDecomposition(cp2)) == null) {
                     if (c1 >= 55296 && c2 >= 55296 && (options & 32768) != 0) {
                        if ((c1 > 56319 || s1 == limit1 || !Character.isLowSurrogate(cs1.charAt(s1)))
   ...
   private static final class FCD32ModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(
         new FilteredNormalizer2(Norm2AllModes.getFCDNormalizer2(), Normalizer.Unicode32.INSTANCE)
      );
   }
   ...
   private static final class NFC32ModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(
         new FilteredNormalizer2(Normalizer2.getNFCInstance(), Normalizer.Unicode32.INSTANCE)
      );
   }
   ...
   private static final class NFCModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(Normalizer2.getNFCInstance());
   }

   private static final class NFD32ModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(
         new FilteredNormalizer2(Normalizer2.getNFDInstance(), Normalizer.Unicode32.INSTANCE)
      );
   }
   ...
   private static final class NFDModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(Normalizer2.getNFDInstance());
   }

   private static final class NFKC32ModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(
         new FilteredNormalizer2(Normalizer2.getNFKCInstance(), Normalizer.Unicode32.INSTANCE)
      );
   }
   ...
   private static final class NFKCModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(Normalizer2.getNFKCInstance());
   }

   private static final class NFKD32ModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(
         new FilteredNormalizer2(Normalizer2.getNFKDInstance(), Normalizer.Unicode32.INSTANCE)
      );
   }
   ...
   private static final class NFKDModeImpl {
      private static final Normalizer.ModeImpl INSTANCE = new Normalizer.ModeImpl(Normalizer2.getNFKDInstance());
   }
