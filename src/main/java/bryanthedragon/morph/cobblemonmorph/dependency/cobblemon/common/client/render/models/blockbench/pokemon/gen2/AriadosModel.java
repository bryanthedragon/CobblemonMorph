...
implements HeadedFrame {
    ...
    public AriadosModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "ariados");
        this.head = this.getPart("head");
        this.portraitScale = 2.5f;
        this.portraitTranslation = new Vec3(-0.45, -2.0, 0.0);
        this.profileScale = 0.9f;
        this.profileTranslation = new Vec3(-0.1, 0.27, 0.0);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "ariados", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "ariados", "ground_walk", null, 4, null)};
