...
public class SliggooModel(root: ModelPart) : PokemonPoseableModel, BimanualFrame, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = SliggooModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "sliggoo", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: SliggooModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
