...
public final class NFAStateTransition implements AbstractTransition<NFAState, NFAStateTransition>, JsonConvertible {
   ...
   public JsonValue toJson() {
      return Json.obj(
         ...
         Json.prop("matcherBuilder", this.codePointSet.toString()),
         Json.prop("groupBoundaries", this.groupBoundaries),
         Json.prop("sourceSections", this.groupBoundaries.indexUpdateSourceSectionsToJson(this.source.getStateSet().getStateIndex()))
      );
   }
   ...
   public JsonValue toJson(boolean forward) {
      return Json.obj(
         Json.prop("id", this.id),
         Json.prop("source", this.getSource(forward).getId()),
         Json.prop("target", this.getTarget(forward).getId()),
         Json.prop("matcherBuilder", this.codePointSet.toString()),
         Json.prop("groupBoundaries", this.groupBoundaries),
         Json.prop("sourceSections", this.groupBoundaries.indexUpdateSourceSectionsToJson(this.source.getStateSet().getStateIndex()))
      );
