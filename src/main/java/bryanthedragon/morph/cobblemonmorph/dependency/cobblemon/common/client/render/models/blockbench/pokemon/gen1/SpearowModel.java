...
public class SpearowModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = SpearowModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStand(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "spearow", "ground_idle", null, 4, null)
            },
            null,
      ...
      this.setHover(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "spearow", "blink", null, 4, null),
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: SpearowModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
