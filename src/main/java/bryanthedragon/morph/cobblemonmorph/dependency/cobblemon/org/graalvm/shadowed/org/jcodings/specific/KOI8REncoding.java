...
public final class KOI8REncoding extends CaseFoldMapEncoding {
   static final short[] KOI8R_CtypeTable = new short[]{
      16392,
      16392,
      16392,
      16392,
   ...
   static final byte[] KOI8R_ToLowerCaseTable = new byte[]{
      0,
      1,
      2,
      3,
   ...
   static final int[][] KOI8R_CaseFoldMap = new int[][]{
      {163, 179},
      {192, 224},
      {193, 225},
      {194, 226},
   ...
   protected KOI8REncoding() {
      super("KOI8-R", KOI8R_CtypeTable, KOI8R_ToLowerCaseTable, KOI8R_CaseFoldMap, false);
   }
