...
public class DFAStateNode extends DFAAbstractStateNode {
   ...
   protected final DFAStateNode.IndexOfCall indexOfCall;
   ...
   DFAStateNode(DFAStateNode nodeSplitCopy, short copyID) {
      this(
         copyID,
         nodeSplitCopy.flags,
         nodeSplitCopy.loopTransitionIndex,
         nodeSplitCopy.indexOfCall,
         Arrays.copyOf(nodeSplitCopy.getSuccessors(), nodeSplitCopy.getSuccessors().length),
         nodeSplitCopy.getMatchers(),
         nodeSplitCopy.simpleCG
      );
   }

   public DFAStateNode(
      short id, byte flags, short loopTransitionIndex, DFAStateNode.IndexOfCall indexOfCall, short[] successors, Matchers matchers, DFASimpleCG simpleCG
   ) {
      super(id, successors);
   ...
   void atEnd(TRegexDFAExecutorLocals locals, TRegexDFAExecutorNode executor) {
      CompilerAsserts.partialEvaluationConstant(this);
      boolean anchored = this.isAnchoredFinalState() && executor.inputAtEnd(locals);
   ...
   public JsonValue toJson() {
      ...
      return Json.obj(
         ...
         Json.prop("finalState", this.isFinalState()),
         Json.prop("loopToSelf", this.hasLoopToSelf()),
         Json.prop("transitions", transitions)
      );
   }

   public static final class IndexOfAnyByteCall extends DFAStateNode.IndexOfAnyCall {
   ...
   public abstract static class IndexOfAnyCall extends DFAStateNode.IndexOfCall {
      @Override
   ...
   public static final class IndexOfAnyCharCall extends DFAStateNode.IndexOfAnyCall {
      @CompilerDirectives.CompilationFinal(dimensions = 1)
   ...
   public static final class IndexOfAnyIntCall extends DFAStateNode.IndexOfAnyCall {
      @CompilerDirectives.CompilationFinal(dimensions = 1)
   ...
   public static final class IndexOfStringCall extends DFAStateNode.IndexOfCall {
      ...
      public int execute(TRegexDFAExecutorNode executor, Object input, int fromIndex, int maxIndex, Encodings.Encoding encoding, boolean tString) {
         return executor.getIndexOfStringNode()
            .execute(input, fromIndex, maxIndex, this.literal.getLiteralContent(tString), this.literal.getMaskContent(tString), encoding);
      }
