...
@GeneratedBy(value=ToTemporalTimeZoneNode.class)
public final class ToTemporalTimeZoneNodeGen
extends ToTemporalTimeZoneNode
implements Introspection.Provider {
    ...
    private JSDynamicObject executeAndSpecialize(Object arg0Value) {
        ...
        try {
            ...
            lock.unlock();
            hasLock = false;
            JSDynamicObject jSDynamicObject = this.toTemporalTimeZone(arg0Value, this.isObjectNode_, this.toStringNode_);
