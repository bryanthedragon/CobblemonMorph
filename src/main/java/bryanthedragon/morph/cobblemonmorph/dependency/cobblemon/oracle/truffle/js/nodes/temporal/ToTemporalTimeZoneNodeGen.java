...
@GeneratedBy(ToTemporalTimeZoneNode.class)
public final class ToTemporalTimeZoneNodeGen extends ToTemporalTimeZoneNode implements Introspection.Provider {
   ...
   private ToTemporalTimeZoneNodeGen(JSContext context) {
      super(context);
   }
   ...
   public JSDynamicObject executeDynamicObject(Object arg0Value) {
      ...
      if (state_0 != 0) {
         return this.toTemporalTimeZone(arg0Value, this.isObjectNode_, this.toStringNode_);
      } else {
   ...
   private JSDynamicObject executeAndSpecialize(Object arg0Value) {
      ...
      try {
         ...
         lock.unlock();
         hasLock = false;
         var5 = this.toTemporalTimeZone(arg0Value, this.isObjectNode_, this.toStringNode_);
      } finally {
         if (hasLock) {
            lock.unlock();
         }
   ...
   public Introspection getIntrospectionData() {
      ...
      int state_0 = this.state_0_;
      Object[] s = new Object[]{"toTemporalTimeZone", null, null};
      if (state_0 != 0) {
         s[1] = (byte)1;
   ...
   public static ToTemporalTimeZoneNode create(JSContext context) {
      return new ToTemporalTimeZoneNodeGen(context);
   }
}
