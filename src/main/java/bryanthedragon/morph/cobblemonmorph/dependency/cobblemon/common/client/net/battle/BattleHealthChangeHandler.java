...
@Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u00c6\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\t\u0010\nJ\u001f\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016\u00a2\u0006\u0004\b\u0007\u0010\b\u00a8\u0006\u000b"}, d2={"Lcom/cobblemon/mod/common/client/net/battle/BattleHealthChangeHandler;", "Lcom/cobblemon/mod/common/api/net/ClientNetworkPacketHandler;", "Lcom/cobblemon/mod/common/net/messages/client/battle/BattleHealthChangePacket;", "packet", "Lnet/minecraft/client/Minecraft;", "client", "", "handle", "(Lcom/cobblemon/mod/common/net/messages/client/battle/BattleHealthChangePacket;Lnet/minecraft/client/Minecraft;)V", "<init>", "()V", "common"})
...
public final class BattleHealthChangeHandler
implements ClientNetworkPacketHandler<BattleHealthChangePacket> {
    @NotNull
    public static final BattleHealthChangeHandler INSTANCE = new BattleHealthChangeHandler();

    private BattleHealthChangeHandler() {
    }

    @Override
    public void handle(@NotNull BattleHealthChangePacket packet, @NotNull Minecraft client) {
        ...
        ActiveClientBattlePokemon activePokemon = (ActiveClientBattlePokemon)battle2.getPokemonFromPNX(packet.getPnx()).component2();
        Float f = packet.getNewMaxHealth();
        if (f != null) {
            float it = ((Number)f).floatValue();
            boolean bl = false;
            ClientBattlePokemon clientBattlePokemon = activePokemon.getBattlePokemon();
            if (clientBattlePokemon != null) {
                clientBattlePokemon.setMaxHp(it);
            }
        }
    ...
    @Override
    public void handleOnNettyThread(@NotNull BattleHealthChangePacket packet) {
