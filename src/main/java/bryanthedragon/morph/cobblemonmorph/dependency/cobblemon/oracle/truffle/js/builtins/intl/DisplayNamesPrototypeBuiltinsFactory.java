...
@GeneratedBy(value=DisplayNamesPrototypeBuiltins.class)
public final class DisplayNamesPrototypeBuiltinsFactory {

    @GeneratedBy(value=DisplayNamesPrototypeBuiltins.JSDisplayNamesOfNode.class)
    public static final class JSDisplayNamesOfNodeGen
    extends DisplayNamesPrototypeBuiltins.JSDisplayNamesOfNode
    ...
    @GeneratedBy(value=DisplayNamesPrototypeBuiltins.JSDisplayNamesResolvedOptionsNode.class)
