...
public class OshawottHisuiBiasModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = OshawottHisuiBiasModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "oshawott_hisui_bias", "sleep", null, 4, null)},
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "oshawott_hisui_bias", "ground_idle", null, 4, null)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.scalchop).withVisibility(false),
               ModelPartExtensionsKt.createTransformation(this.scalchopbody).withVisibility(true)
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: OshawottHisuiBiasModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
