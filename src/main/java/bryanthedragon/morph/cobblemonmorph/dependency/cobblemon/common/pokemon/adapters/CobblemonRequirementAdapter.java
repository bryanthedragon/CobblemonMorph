...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.api.pokemon.adapters.RequirementAdapter
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.api.pokemon.requirement.Requirement
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.pokemon.requirements.*
 ...
 */
public final class CobblemonRequirementAdapter : RequirementAdapter {
    ...
    override fun deserialize(JsonElement json, typeOfT: Type, JsonDeserializationContext context): Requirement {
    ...
    override fun serialize(src: Requirement, typeOfT srcype, context: JsonSerializationContext): JsonElement {
