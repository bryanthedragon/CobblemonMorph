...
@GeneratedBy(DefaultTStringExports.class)
final class DefaultTStringExportsGen {
   ...
   static {
      LibraryExport.register(DefaultTStringExports.class, new DefaultTStringExportsGen.InteropLibraryExports());
   }
   ...
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         InteropLibrary uncached = new DefaultTStringExportsGen.InteropLibraryExports.Uncached();
         return uncached;
      }
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return new DefaultTStringExportsGen.InteropLibraryExports.Cached();
      }
      ...
      private static final class Cached extends InteropLibrary {
         ...
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof TruffleString) || DefaultTStringExportsGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
         ...
         private String executeAndSpecialize(TruffleString arg0Value) {
            ...
            try {
               ...
               lock.unlock();
               hasLock = false;
               var5 = DefaultTStringExports.asString(arg0Value, this.toJavaStringNode_);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
