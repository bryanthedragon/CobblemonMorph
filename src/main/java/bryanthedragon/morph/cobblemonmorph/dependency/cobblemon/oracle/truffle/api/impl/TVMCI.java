...
public abstract class TVMCI {
   ...
   private boolean checkCaller() {
      ...
      assert packageName.equals("org.graalvm.compiler.truffle.runtime")
         ...
         || packageName.equals("com.oracle.truffle.api.impl") : TVMCI.class.getName() + " subclass is not in trusted package: " + this.getClass().getName();

      return true;
   }

   protected abstract Accessor.RuntimeSupport createRuntimeSupport(Object permission);
