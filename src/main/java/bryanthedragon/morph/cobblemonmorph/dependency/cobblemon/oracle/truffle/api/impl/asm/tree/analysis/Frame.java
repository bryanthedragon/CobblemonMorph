...
public class Frame<V extends Value> {
    ...
    public void setLocal(int index, V value2) {
        if (index >= this.numLocals) {
    ...
    public void setStack(int index, V value2) {
        this.values[this.numLocals + index] = value2;
    }
    ...
    public void push(V value2) {
        ...
        this.values[this.numLocals + this.numStack++] = value2;
    }
    ...
    public boolean merge(Frame<? extends V> frame, boolean[] localsUsed) {
        ...
        for (int i = 0; i < this.numLocals; ++i) {
            if (localsUsed[i] || this.values[i].equals(frame.values[i])) continue;
