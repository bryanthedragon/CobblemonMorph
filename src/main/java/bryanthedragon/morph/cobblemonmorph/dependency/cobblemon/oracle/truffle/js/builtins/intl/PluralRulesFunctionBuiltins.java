...
public final class PluralRulesFunctionBuiltins extends JSBuiltinsContainer.SwitchEnum<PluralRulesFunctionBuiltins.PluralRulesFunction> {
   ...
   protected PluralRulesFunctionBuiltins() {
      super(JSPluralRules.CLASS_NAME, PluralRulesFunctionBuiltins.PluralRulesFunction.class);
   }

   protected Object createNode(
      JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, PluralRulesFunctionBuiltins.PluralRulesFunction builtinEnum
   ) {
      switch (builtinEnum) {
   ...
   public static enum PluralRulesFunction implements BuiltinEnum<PluralRulesFunctionBuiltins.PluralRulesFunction> {
