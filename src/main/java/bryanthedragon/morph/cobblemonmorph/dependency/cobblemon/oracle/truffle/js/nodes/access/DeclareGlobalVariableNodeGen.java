...
@GeneratedBy(value=DeclareGlobalVariableNode.class)
public final class DeclareGlobalVariableNodeGen
extends DeclareGlobalVariableNode
implements Introspection.Provider {
    ...
    private DeclareGlobalVariableNodeGen(TruffleString varName, boolean configurable) {
    ...
    protected void executeVoid(JSDynamicObject arg0Value, JSContext arg1Value) {
        ...
        if (state_0 != 0) {
            if ((state_0 & 1) != 0 && arg1Value.getPropertyCacheLimit() > 0 && JSGlobal.isJSGlobalObject(arg0Value)) {
    ...
    private void executeAndSpecialize(JSDynamicObject arg0Value, JSContext arg1Value) {
        ...
        try {
            ...
            if (exclude == 0 && arg1Value.getPropertyCacheLimit() > 0 && JSGlobal.isJSGlobalObject(arg0Value)) {
