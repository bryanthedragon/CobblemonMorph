...
final class UserScriptExceptionGen {
   ...
   static {
      LibraryExport.register(UserScriptException.class, new UserScriptExceptionGen.InteropLibraryExports());
   }

   @GeneratedBy(UserScriptException.class)
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      static final FinalBitSet ENABLED_MESSAGES = createMessageBitSet(
         UserScriptExceptionGen.INTEROP_LIBRARY_,
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         return createDelegate(UserScriptExceptionGen.INTEROP_LIBRARY_, new UserScriptExceptionGen.InteropLibraryExports.Uncached());
      }

      protected InteropLibrary createCached(Object receiver) {
         assert receiver instanceof UserScriptException;

         return createDelegate(UserScriptExceptionGen.INTEROP_LIBRARY_, new UserScriptExceptionGen.InteropLibraryExports.Cached(receiver));
      }
      ...
      private static final class Cached extends InteropLibrary implements LibraryExport.DelegateExport {
         ...
         protected Cached(Object receiver) {
            ...
            this.receiverExceptionObjectInteropLibrary_ = super.insert(UserScriptExceptionGen.INTEROP_LIBRARY_.create(castReceiver.exceptionObject));
         }

         @Override
         public FinalBitSet getDelegateExportMessages() {
            return UserScriptExceptionGen.InteropLibraryExports.ENABLED_MESSAGES;
         }
         ...
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof UserScriptException) || UserScriptExceptionGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";

            return !(receiver instanceof UserScriptException)
               ? false
               : this.receiverExceptionObjectInteropLibrary_.accepts(((UserScriptException)receiver).exceptionObject);
         }
         ...
         private TriState isIdenticalOrUndefinedAndSpecialize(GraalJSException arg0Value, Object arg1Value) {
            ...
            try {
               ...
               if (arg1Value instanceof GraalJSException) {
                  ...
                  this.thisLib = super.insert(this.thisLib == null ? UserScriptExceptionGen.INTEROP_LIBRARY_.createDispatched(5) : this.thisLib);
                  this.otherLib = super.insert(this.otherLib == null ? UserScriptExceptionGen.INTEROP_LIBRARY_.createDispatched(5) : this.otherLib);
                  int var15;
         ...
         private int identityHashCodeNode_AndSpecialize(GraalJSException arg0Value) throws UnsupportedMessageException {
            ...
            try {
               int state_0 = this.state_0_;
               this.identityHashCodeNode__identityHashCode_delegateLib_ = super.insert(UserScriptExceptionGen.INTEROP_LIBRARY_.createDispatched(5));
               int var9;
      ...
      private static final class Uncached extends InteropLibrary implements LibraryExport.DelegateExport {
         ...
         public Library getDelegateExportLibrary(Object delegate_) {
            return UserScriptExceptionGen.INTEROP_LIBRARY_.getUncached(delegate_);
         }
         ...
         public TriState isIdenticalOrUndefined(Object arg0Value_, Object arg1Value) {
            ...
            if (arg1Value instanceof GraalJSException) {
               ...
               return GraalJSException.IsIdenticalOrUndefined.doException(
                  arg0Value, arg1Value_, UserScriptExceptionGen.INTEROP_LIBRARY_.getUncached(), UserScriptExceptionGen.INTEROP_LIBRARY_.getUncached()
               );
               ...
               return GraalJSException.IsIdenticalOrUndefined.doOther(
                  arg0Value, arg1Value, UserScriptExceptionGen.INTEROP_LIBRARY_.getUncached(), UserScriptExceptionGen.INTEROP_LIBRARY_.getUncached()
               );
            } else {
               throw new UnsupportedSpecializationException(this, new Node[]{null, null}, arg0Value, arg1Value);
            }
         ...
         public int identityHashCode(Object arg0Value_) throws UnsupportedMessageException {
            ...
            GraalJSException arg0Value = (GraalJSException)arg0Value_;
            return arg0Value.identityHashCode(UserScriptExceptionGen.INTEROP_LIBRARY_.getUncached());
         }
