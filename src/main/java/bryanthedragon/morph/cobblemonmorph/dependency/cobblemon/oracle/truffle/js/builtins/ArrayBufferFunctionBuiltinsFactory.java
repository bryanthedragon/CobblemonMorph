...
public final class ArrayBufferFunctionBuiltinsFactory {
   @GeneratedBy(ArrayBufferFunctionBuiltins.JSIsArrayBufferViewNode.class)
   public static final class JSIsArrayBufferViewNodeGen extends ArrayBufferFunctionBuiltins.JSIsArrayBufferViewNode implements Introspection.Provider {
      @Node.Child
      ...
      public Introspection getIntrospectionData() {
         ...
         Object[] s = new Object[]{"isArrayBufferView", (byte)1, null};
         data[1] = s;
      ...
      public static ArrayBufferFunctionBuiltins.JSIsArrayBufferViewNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new ArrayBufferFunctionBuiltinsFactory.JSIsArrayBufferViewNodeGen(context, builtin, arguments);
      }
   }
}
