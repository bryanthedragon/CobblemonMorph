...
import com.oracle.truffle.js.nodes.access.SuperPropertyReferenceNodeWrapper;
import java.util.Set;

@GenerateWrapper
public class SuperPropertyReferenceNode
...
implements RepeatableNode {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return new SuperPropertyReferenceNode(SuperPropertyReferenceNode.cloneUninitialized(this.baseValueNode, materializedTags), SuperPropertyReferenceNode.cloneUninitialized(this.thisValueNode, materializedTags));
    }
}
