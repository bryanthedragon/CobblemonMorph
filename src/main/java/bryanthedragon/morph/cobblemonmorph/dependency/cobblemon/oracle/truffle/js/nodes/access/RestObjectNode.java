...
public abstract class RestObjectNode extends JavaScriptNode {
   ...
   public static JavaScriptNode create(JSContext context, JavaScriptNode targetNode, JavaScriptNode sourceNode, JavaScriptNode excludedNode) {
      return (JavaScriptNode)(excludedNode == null
         ? RestObjectNodeGen.create(context, targetNode, sourceNode)
         : RestObjectWithExcludedNodeGen.create(context, targetNode, sourceNode, excludedNode));
   }
   ...
   protected final Object doOther(JSDynamicObject restObj, Object source, @Cached("createToObjectNoCheck(context)") JSToObjectNode toObjectNode) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return RestObjectNodeGen.create(
         this.context, cloneUninitialized(this.targetNode, materializedTags), cloneUninitialized(this.sourceNode, materializedTags)
      );
   }
}
