...
public class RegexProperties implements JsonConvertible {
   ...
   public JsonValue toJson() {
      return Json.obj(
         Json.prop("alternations", this.hasAlternations()),
         Json.prop("charClasses", this.hasCharClasses()),
         Json.prop("captureGroups", this.hasCaptureGroups()),
         Json.prop("lookAheadAssertions", this.hasLookAheadAssertions()),
         Json.prop("negativeLookAheadAssertions", this.hasNegativeLookAheadAssertions()),
         Json.prop("lookBehindAssertions", this.hasLookBehindAssertions()),
         Json.prop("nonLiteralLookBehindAssertions", this.hasNonLiteralLookBehindAssertions()),
         Json.prop("negativeLookBehindAssertions", this.hasNegativeLookBehindAssertions()),
         Json.prop("largeCountedRepetitions", this.hasLargeCountedRepetitions()),
         Json.prop("captureGroupsInLookAroundAssertions", this.hasCaptureGroupsInLookAroundAssertions()),
         Json.prop("backReferences", this.hasBackReferences())
      );
   }
}
