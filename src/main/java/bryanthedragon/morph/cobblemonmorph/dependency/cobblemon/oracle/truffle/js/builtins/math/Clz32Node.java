...
public abstract class Clz32Node
extends MathOperation {
    ...
    @Specialization
    protected int clz32(Object a, @Cached(value="create()") JSToUInt32Node toUInt32Node) {
        return Clz32Node.clz32((int)toUInt32Node.executeLong(a));
    }
}
