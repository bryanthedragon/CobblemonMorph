...
public final class SwapPCPokemonHandler : ServerNetworkPacketHandler<SwapPCPokemonPacket> {
    override fun handle(packet: SwapPCPokemonPacket, server: MinecraftServer, ServerPlayer player) {
