...
public final class Edits {
    ...
    public void addReplace(int oldLength, int newLength) {
        ...
        if (oldLength < 61 && newLength < 61) {
            ...
            if (newLength < 61) {
                ...
                head5 |= 62 + (newLength >> 30);
                this.array[limit++] = (char)(0x8000 | newLength >> 15);
                this.array[limit++] = (char)(0x8000 | newLength);
            }
            this.array[this.length] = (char)head5;
            this.length = limit;
        }
    }
    ...
    public static final class Iterator {
        ...
        private int readLength(int head5) {
            if (head5 < 61) {
                return head5;
            }
            if (head5 < 62) {
            ...
            int len = (head5 & 1) << 30 | (this.array[this.index] & Short.MAX_VALUE) << 15 | this.array[this.index + 1] & Short.MAX_VALUE;
            this.index += 2;
            return len;
        }
