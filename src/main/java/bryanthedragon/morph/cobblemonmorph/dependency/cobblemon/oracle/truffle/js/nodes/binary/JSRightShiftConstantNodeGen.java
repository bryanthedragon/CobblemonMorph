...
public final class JSRightShiftConstantNodeGen extends JSRightShiftConstantNode implements Introspection.Provider {
   ...
   public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
      ...
      } else if ((state_0 & 38) == 0 && (state_0 & 39) != 0) {
         return this.executeInt_int3(state_0, frameValue);
      } else {
         return (state_0 & 35) == 0 && (state_0 & 39) != 0 ? this.executeInt_double4(state_0, frameValue) : this.executeInt_generic5(state_0, frameValue);
      }
   }
