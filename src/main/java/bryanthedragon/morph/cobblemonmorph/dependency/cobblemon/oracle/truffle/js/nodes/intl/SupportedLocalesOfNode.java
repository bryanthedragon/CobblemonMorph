...
public abstract class SupportedLocalesOfNode
extends JSBuiltinNode {
    ...
    @Specialization(guards={"!isUndefined(opts)"})
    protected Object getSupportedLocalesWithOptions(Object locales, Object opts, @Cached(value="createToObject(getContext())") JSToObjectNode toObjectNode, @Cached(value="createMatcherGetter(getContext())") GetStringOptionNode getMatcherNode) {
