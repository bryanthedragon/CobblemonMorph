...
implements List<T> {
    ...
    public boolean contains(Object o) {
        for (int i = this.first; i < this.last; ++i) {
            if (o != this.arr[i] && (o == null || !o.equals(this.arr[i]))) continue;
            return true;
        }
        return false;
    }
    ...
    public <A> A[] toArray(A[] b) {
        Object[] a = b.length < this.size() ? (Object[])Array.newInstance(b.getClass().getComponentType(), this.size()) : b;
        int i = 0;
    ...
    public int indexOf(Object o) {
        for (int i = this.first; i < this.last; ++i) {
            if (!(this.arr[i] == null ? o == null : this.arr[i].equals(o))) continue;
            return i - this.first;
        }
        return -1;
    }
