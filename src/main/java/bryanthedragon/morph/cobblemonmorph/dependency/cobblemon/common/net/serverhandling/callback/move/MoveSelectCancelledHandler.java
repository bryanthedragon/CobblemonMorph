...
public final class MoveSelectCancelledHandler : ServerNetworkPacketHandler<MoveSelectCancelledPacket> {
    override fun handle(packet: MoveSelectCancelledPacket, server: MinecraftServer, ServerPlayer player) {
