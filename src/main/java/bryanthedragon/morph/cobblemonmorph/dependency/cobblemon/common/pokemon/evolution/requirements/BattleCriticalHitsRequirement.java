...
@SourceDebugExtension(["SMAP\nBattleCriticalHitsRequirement.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BattleCriticalHitsRequirement.kt\ncom/cobblemon/mod/common/pokemon/evolution/requirements/BattleCriticalHitsRequirement\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,42:1\n800#2,11:43\n1747#2,3:54\n*S KotlinDebug\n*F\n+ 1 BattleCriticalHitsRequirement.kt\ncom/cobblemon/mod/common/pokemon/evolution/requirements/BattleCriticalHitsRequirement\n*L\n35#1:43,11\n36#1:54,3\n*E\n"])
public class BattleCriticalHitsRequirement(amount: Int) : EvolutionRequirement {
   ...
   public override fun check(pokemon: Pokemon): Boolean {
      ...
      for (Object element$iv$iv : $this$any$iv) {
         if (`element$iv$iv` is LastBattleCriticalHitsEvolutionProgress) {
      ...
      if (`element$iv` as java.util.List is java.util.Collection && ((`element$iv` as java.util.List) as java.util.Collection).isEmpty()) {
         ...
         for (Object element$ivx : $this$any$iv) {
            if ((`element$ivx` as LastBattleCriticalHitsEvolutionProgress).currentProgress().getAmount() >= this.amount) {
               return true;
            }
         }
