...
import com.cobblemon.mod.relocations.ibm.icu.impl.CharTrie;
import com.cobblemon.mod.relocations.ibm.icu.impl.ICUBinary;
import com.cobblemon.mod.relocations.ibm.icu.impl.StringPrepDataReader;
      ...
      if (this.checkBiDi) {
         if (leftToRight && rightToLeft) {
            throw new StringPrepParseException(
               "The input does not conform to the rules for BiDi code points.", 4, iter.getText(), rtlPos > ltrPos ? rtlPos : ltrPos
            );
         }
