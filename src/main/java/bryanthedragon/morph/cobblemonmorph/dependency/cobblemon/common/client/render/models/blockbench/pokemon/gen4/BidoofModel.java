...
public class BidoofModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.wateroffset = -2;
      this.cryAnimation = BidoofModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "bidoof", "ground_idle", null, 4, null)
            },
            null,
      ...
      var var12: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "bidoof", "ground_walk", null, 4, null)
      };
      val var14: PoseableEntityModel = this;
      this.setWalking(PoseableEntityModel.registerPose$default(var14, "walk", var7, null, 10, null, null, var12, null, var10, 180, null));
      var7 = PoseType.Companion.getSWIMMING_POSES();
      var10 = new ModelQuirk[]{blink};
      var12 = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "bidoof", "water_float", null, 4, null)
      };
      val var6: Array<ModelPartTransformation> = new ModelPartTransformation[]{
      ...
      this.setFloating(PoseableEntityModel.registerPose$default(var15, "float", var7, null, 10, null, null, var12, var6, var10, 52, null));
      this.setSleeping(
         PoseableEntityModel.registerPose$default(
            this,
            PoseType.SLEEP,
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "bidoof", "sleep", null, 4, null)},
            null,
            null,
            218,
            null
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isPosedIn(this.getStanding(), this.getWalking(), this.getSleeping()))
         PoseableEntityModel.bedrockStateful$default(this, "bidoof", "faint", null, 4, null)
         else
         null;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: BidoofModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
