...
implements TranscodingInstruction {
    ...
    public static int o3(int b1, int b2, int b3) {
        return (b1 << 8 | b2 << 16 | b3 << 24 | 5) & 0xFFFFFFFF;
    }

    public static int o4(int b0, int b1, int b2, int b3) {
        return (b1 << 8 | b2 << 16 | b3 << 24 | (b0 & 7) << 5 | 6) & 0xFFFFFFFF;
    }

    public static int g4(int b0, int b1, int b2, int b3) {
        return (b0 << 8 | b2 << 16 | (b1 & 0xF) << 24 | (b3 & 0xF) << 28 | 0x12) & 0xFFFFFFFF;
    }
