...
import com.cobblemon.mod.relocations.ibm.icu.impl.RelativeDateFormat;
...
public abstract class DateFormat extends UFormat {
   ...
   private EnumSet<DateFormat.BooleanAttribute> booleanAttributes = EnumSet.allOf(DateFormat.BooleanAttribute.class);
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return (
               this.calendar == null && other.calendar == null
                  || this.calendar != null && other.calendar != null && this.calendar.isEquivalentTo(other.calendar)
            )
            && (
               this.numberFormat == null && other.numberFormat == null
                  || this.numberFormat != null && other.numberFormat != null && this.numberFormat.equals(other.numberFormat)
            )
            && this.capitalizationSetting == other.capitalizationSetting;
      } else {
         return false;
      }
   }
   ...
   private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
      ...
      if (this.booleanAttributes == null) {
         this.booleanAttributes = EnumSet.allOf(DateFormat.BooleanAttribute.class);
      }
   ...
   public static class Field extends java.text.Format.Field {
      ...
      private static final Map<String, DateFormat.Field> FIELD_NAME_MAP;
      ...
      @Deprecated
      public static final DateFormat.Field RELATED_YEAR = new DateFormat.Field("related year", -1);
      public static final DateFormat.Field AM_PM_MIDNIGHT_NOON = new DateFormat.Field("am/pm/midnight/noon", -1);
      public static final DateFormat.Field FLEXIBLE_DAY_PERIOD = new DateFormat.Field("flexible day period", -1);
      @Deprecated
      public static final DateFormat.Field TIME_SEPARATOR = new DateFormat.Field("time separator", -1);
