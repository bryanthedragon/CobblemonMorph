...
public class MeowthModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = MeowthModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "meowth", "ground_idle", null, 4, null)
            },
            null,
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "meowth", "sleep", null, 4, null)},
            null,
            null,
            222,
            null
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: MeowthModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
