...
@GeneratedBy(AsinNode.class)
public final class AsinNodeGen extends AsinNode implements Introspection.Provider {
   @Node.Child
   ...
   public Introspection getIntrospectionData() {
      ...
      int state_0 = this.state_0_;
      Object[] s = new Object[]{"asinDouble", null, null};
      if ((state_0 & 1) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
      ...
      data[1] = s;
      s = new Object[]{"asinGeneric", null, null};
      if ((state_0 & 2) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
