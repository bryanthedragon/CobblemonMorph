...
import com.cobblemon.mod.relocations.ibm.icu.impl.number.AdoptingModifierStore;
...
import com.cobblemon.mod.relocations.ibm.icu.impl.number.ConstantMultiFieldModifier;
import com.cobblemon.mod.relocations.ibm.icu.impl.number.CurrencySpacingEnabledModifier;
...
MicroPropsGenerator {
    ...
    public String getCurrencySymbolForUnitWidth() {
        ...
        return this.currency.getName(this.symbols.getULocale(), selector2, null);
    }
