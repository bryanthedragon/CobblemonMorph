...
final class PolyglotThreadInfo {
   ...
   private PolyglotThreadInfo.ClassLoaderEntry prevContextClassLoader;
   private PolyglotThreadInfo.SpecializationStatisticsEntry executionStatisticsEntry;
   ...
   private void enterStatistics(SpecializationStatistics statistics) {
      ...
      if (prev != null || this.executionStatisticsEntry != null) {
         this.executionStatisticsEntry = new PolyglotThreadInfo.SpecializationStatisticsEntry(prev, this.executionStatisticsEntry);
      }
   }

   @CompilerDirectives.TruffleBoundary
   private void leaveStatistics(SpecializationStatistics statistics) {
      PolyglotThreadInfo.SpecializationStatisticsEntry entry = this.executionStatisticsEntry;
      if (entry == null) {
   ...
   private void setContextClassLoader() {
      ...
      if (hostClassLoader != null) {
         ...
         if (this.originalContextClassLoader != NULL_CLASS_LOADER) {
            this.prevContextClassLoader = new PolyglotThreadInfo.ClassLoaderEntry((ClassLoader)this.originalContextClassLoader, this.prevContextClassLoader);
         }
   ...
   private static final class ClassLoaderEntry {
      ...
      final PolyglotThreadInfo.ClassLoaderEntry next;

      ClassLoaderEntry(ClassLoader classLoader, PolyglotThreadInfo.ClassLoaderEntry next) {
   ...
   private static final class SpecializationStatisticsEntry {
      ...
      final PolyglotThreadInfo.SpecializationStatisticsEntry next;

      SpecializationStatisticsEntry(SpecializationStatistics statistics, PolyglotThreadInfo.SpecializationStatisticsEntry next) {
