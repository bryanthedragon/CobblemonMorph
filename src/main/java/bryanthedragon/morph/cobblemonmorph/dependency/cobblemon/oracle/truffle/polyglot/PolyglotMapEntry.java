...
class PolyglotMapEntry<K, V> implements Entry<K, V>, PolyglotWrapper {
   ...
   PolyglotMapEntry(PolyglotLanguageContext languageContext, Object obj, Class<K> keyClass, Type keyType, Class<V> valueClass, Type valueType) {
      ...
      this.cache = PolyglotMapEntry.Cache.lookup(languageContext, obj.getClass(), keyClass, keyType, valueClass, valueType);
   }

   static <K, V> PolyglotMapEntry<K, V> create(
      ...
      return (PolyglotMapEntry<K, V>)(implementsFunction
         ? new PolyglotMapEntryAndFunction<>(languageContext, foreignObject, keyClass, keyType, valueClass, valueType)
         : new PolyglotMapEntry<>(languageContext, foreignObject, keyClass, keyType, valueClass, valueType));
   }
   ...
   public final boolean equals(Object o) {
      return o instanceof PolyglotMapEntry ? PolyglotWrapper.equals(this.languageContext, this.guestObject, ((PolyglotMapEntry)o).guestObject) : false;
   }
   ...
   static final class Cache {
      ...
      Cache(PolyglotLanguageInstance languageInstance, Class<?> receiverClass, Class<?> keyClass, Type keyType, Class<?> valueClass, Type valueType) {
         ...
         this.apply = new PolyglotMapEntry.Cache.Apply(this).getCallTarget();
      }

      static PolyglotMapEntry.Cache lookup(
         ...
         protected Object doCached(
            ...
            if (interop.hasArrayElements(receiver)) {
               ...
               try {
                  ...
                  error.enter();
                  throw this.invalidArrayIndex(languageContext, receiver, var10.getInvalidIndex());
               }
