...
public abstract class IsArrayNode extends JavaScriptBaseNode {
   ...
   protected final boolean doJSFastArrayShape(JSArrayObject object, @Cached("getInitialArrayShape()") Shape cachedShape) {
      return this.checkResult(object, true);
   }
   ...
   protected final boolean doJSFastArray(JSArrayObject object) {
      return this.checkResult(object, JSArray.isJSFastArray((JSDynamicObject)object));
   }
   ...
   protected final boolean doJSArgumentsObject(JSArgumentsObject object) {
      return this.checkResult(
         object, this.kind == IsArrayNode.Kind.AnyArray || this.kind == IsArrayNode.Kind.FastOrTypedArray && JSArgumentsArray.isJSFastArgumentsObject(object)
      );
   }
   ...
   protected final boolean isArray(Object object) {
      if (this.kind != IsArrayNode.Kind.FastOrTypedArray) {
         if (this.kind == IsArrayNode.Kind.FastArray) {
            return JSArray.isJSFastArray(object);
         } else if (this.kind == IsArrayNode.Kind.Array) {
   ...
   protected final boolean doOtherCached(Object object, @Cached("object.getClass()") Class<?> cachedClass) {
      return this.checkResult(object, false);
   }
   ...
   public static IsArrayNode createIsAnyArray() {
      return IsArrayNodeGen.create(IsArrayNode.Kind.AnyArray);
   }

   public static IsArrayNode createIsArray() {
      return IsArrayNodeGen.create(IsArrayNode.Kind.Array);
   }

   public static IsArrayNode createIsFastArray() {
      return IsArrayNodeGen.create(IsArrayNode.Kind.FastArray);
   }

   public static IsArrayNode createIsFastOrTypedArray() {
      return IsArrayNodeGen.create(IsArrayNode.Kind.FastOrTypedArray);
   }
