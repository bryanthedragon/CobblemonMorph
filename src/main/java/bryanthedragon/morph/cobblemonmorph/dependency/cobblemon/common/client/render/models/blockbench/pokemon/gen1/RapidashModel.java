...
public class RapidashModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = RapidashModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "rapidash", "sleep", null, 4, null)},
            null,
            null,
            222,
            null
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "rapidash", "ground_idle", null, 4, null)
            },
            null,
      ...
      var var11: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "rapidash", "ground_walk", null, 4, null)
      };
      ...
      this.setBattling(
         PoseableEntityModel.registerPose$default(var16, "battlestanding", var7, <unrepresentable>.INSTANCE, 10, null, null, var11, null, var9, 176, null)
      );
   }
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isPosedIn(this.getStanding(), this.getWalk(), this.getSleep()))
         PoseableEntityModel.bedrockStateful$default(this, "rapidash", "faint", null, 4, null)
         else
         (if (state.isPosedIn(this.getBattling())) PoseableEntityModel.bedrockStateful$default(this, "rapidash", "battle_faint", null, 4, null) else null);
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: RapidashModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
