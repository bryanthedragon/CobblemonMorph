...
@GeneratedBy(value=ApplyDecoratorsToElementDefinition.class)
public final class ApplyDecoratorsToElementDefinitionNodeGen
extends ApplyDecoratorsToElementDefinition {
    ...
    public void executeDecorator(VirtualFrame frameValue, JSDynamicObject arg0Value, ClassElementDefinitionRecord arg1Value, List<Object> arg2Value) {
        ...
        if (state_0 != 0) {
            if ((state_0 & 0xF) != 0) {
                DecorateGetterSetterData s3_;
                DecorateMethodData s2_;
                DecorateFieldData s1_;
                ...
                if ((state_0 & 2) != 0 && (s1_ = this.decorateField_cache) != null && arg1Value.isField() && ApplyDecoratorsToElementDefinition.hasDecorators(arg1Value)) {
                ...
                if ((state_0 & 4) != 0 && (s2_ = this.decorateMethod_cache) != null && arg1Value.isMethod() && ApplyDecoratorsToElementDefinition.hasDecorators(arg1Value)) {
                    this.decorateMethod(frameValue, arg0Value, arg1Value, arg2Value, s2_.createDecoratorContextNode_, s2_.callNode_, s2_.setFunctionName_, s2_.isCallableNode_);
                    return;
                }
                if ((state_0 & 8) != 0 && (s3_ = this.decorateGetterSetter_cache) != null && ApplyDecoratorsToElementDefinition.hasDecorators(arg1Value) && ApplyDecoratorsToElementDefinition.isGetterOrSetter(arg1Value)) {
                    this.decorateGetterSetter(frameValue, arg0Value, arg1Value, arg2Value, s3_.createDecoratorContextNode_, s3_.callNode_, s3_.isCallableNode_, s3_.setFunctionNameNode_, s3_.toStringNode_, s3_.concatNode_);
                    return;
                }
            }
            if ((state_0 & 0x10) != 0 && arg1Value instanceof ClassElementDefinitionRecord.AutoAccessor) {
                ClassElementDefinitionRecord.AutoAccessor arg1Value_ = (ClassElementDefinitionRecord.AutoAccessor)arg1Value;
                DecorateAutoData s4_ = this.decorateAuto_cache;
                if (s4_ != null && arg1Value_.isAutoAccessor() && ApplyDecoratorsToElementDefinition.hasDecorators(arg1Value_)) {
                    this.decorateAuto(frameValue, arg0Value, arg1Value_, arg2Value, s4_.createDecoratorContextNode_, s4_.callNode_, s4_.getGetterNode_, s4_.getSetterNode_, s4_.getInitNode_, s4_.isCallableNode_, s4_.createObjectNode_, s4_.isObjectNode_);
                    return;
                }
            }
        }
    ...
    private void executeAndSpecialize(VirtualFrame frameValue, JSDynamicObject arg0Value, ClassElementDefinitionRecord arg1Value, List<Object> arg2Value) {
        ...
        lock.lock();
        try {
            ClassElementDefinitionRecord.AutoAccessor arg1Value_;
            int state_0 = this.state_0_;
            ...
            if (arg1Value.isField() && ApplyDecoratorsToElementDefinition.hasDecorators(arg1Value)) {
                DecorateFieldData s1_ = super.insert(new DecorateFieldData());
            ...
            if (arg1Value.isMethod() && ApplyDecoratorsToElementDefinition.hasDecorators(arg1Value)) {
                DecorateMethodData s2_ = super.insert(new DecorateMethodData());
            ...
            if (ApplyDecoratorsToElementDefinition.hasDecorators(arg1Value) && ApplyDecoratorsToElementDefinition.isGetterOrSetter(arg1Value)) {
                DecorateGetterSetterData s3_ = super.insert(new DecorateGetterSetterData());
            ...
            if (arg1Value instanceof ClassElementDefinitionRecord.AutoAccessor && (arg1Value_ = (ClassElementDefinitionRecord.AutoAccessor)arg1Value).isAutoAccessor() && ApplyDecoratorsToElementDefinition.hasDecorators(arg1Value_)) {
                DecorateAutoData s4_ = super.insert(new DecorateAutoData());
    ...
    @GeneratedBy(value=ApplyDecoratorsToElementDefinition.class)
    private static final class DecorateAutoData
    extends Node {
        @Node.Child
    ...
    @GeneratedBy(value=ApplyDecoratorsToElementDefinition.class)
    private static final class DecorateGetterSetterData
    extends Node {
        @Node.Child
        CreateDecoratorContextObjectNode createDecoratorContextNode_;
        @Node.Child
    ...
    @GeneratedBy(value=ApplyDecoratorsToElementDefinition.class)
    private static final class DecorateMethodData
    extends Node {
        @Node.Child
        CreateDecoratorContextObjectNode createDecoratorContextNode_;
        @Node.Child
    ...
    @GeneratedBy(value=ApplyDecoratorsToElementDefinition.class)
    private static final class DecorateFieldData
    extends Node {
        @Node.Child
        CreateDecoratorContextObjectNode createDecoratorContextNode_;
        @Node.Child
