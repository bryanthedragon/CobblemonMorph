...
public final class UCaseProps {
   ...
   private final void readData(ByteBuffer bytes) throws IOException {
      ICUBinary.readHeader(bytes, 1665225541, new UCaseProps.IsAcceptable());
      ...
      switch (c) {
         ...
         default:
            ...
            if (!propsHasException(props)) {
               ...
               int var21 = closureOffset;

               while (var21 < limit) {
                  c = this.exceptions.codePointAt(var21);
                  set.add(c);
                  var21 += UTF16.getCharCount(c);
               }
            }
      }
   }
   ...
   private final int strcmpMax(String s, int unfoldOffset, int max) {
      ...
      return max != 0 && this.unfold[unfoldOffset] != 0 ? -max : 0;
   }
   ...
   public final boolean hasBinaryProperty(int c, int which) {
      switch (which) {
         ...
         case 55:
            dummyStringBuilder.setLength(0);
            return this.toFullLower(c, null, dummyStringBuilder, 1) >= 0
               || this.toFullUpper(c, null, dummyStringBuilder, 1) >= 0
               || this.toFullTitle(c, null, dummyStringBuilder, 1) >= 0;
      }
   }
   ...
   static final class LatinCase {
      ...
      static final byte[] TO_LOWER_NORMAL = new byte[]{
         0,
         0,
         0,
         0,
      ...
      static final byte[] TO_LOWER_TR_LT = new byte[]{
         0,
         0,
         0,
         0,
      ...
      static final byte[] TO_UPPER_NORMAL = new byte[]{
         0,
         0,
         0,
         0,
      ...
      static final byte[] TO_UPPER_TR = new byte[]{
         0,
         0,
         0,
         0,
