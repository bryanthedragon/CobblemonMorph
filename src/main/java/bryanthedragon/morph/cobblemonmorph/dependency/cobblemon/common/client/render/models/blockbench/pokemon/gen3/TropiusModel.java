...
public class TropiusModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = TropiusModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "tropius", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: TropiusModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
