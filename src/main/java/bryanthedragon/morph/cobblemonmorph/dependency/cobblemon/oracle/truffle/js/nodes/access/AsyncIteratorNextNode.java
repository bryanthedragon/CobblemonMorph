...
public class AsyncIteratorNextNode extends AbstractAwaitNode implements ResumableNode.WithIntState {
   ...
   protected AsyncIteratorNextNode(
      JSContext context, int stateSlot, JavaScriptNode iterator, JSReadFrameSlotNode asyncContextNode, JSReadFrameSlotNode asyncResultNode
   ) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return new AsyncIteratorNextNode(
         this.context,
         this.stateSlot,
