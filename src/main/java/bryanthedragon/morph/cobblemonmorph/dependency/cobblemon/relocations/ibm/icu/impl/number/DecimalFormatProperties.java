...
Serializable {
    ...
    private int _hashCodeHelper(boolean value2) {
        return value2 ? 1 : 0;
    }

    private int _hashCodeHelper(int value2) {
        return value2 * 13;
    }

    private int _hashCodeHelper(Object value2) {
        if (value2 == null) {
            return 0;
        }
    ...
    void writeObjectImpl(ObjectOutputStream oos) throws IOException {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            Object value2 = valuesToSerialize.get(i);
