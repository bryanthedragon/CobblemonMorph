...
public class BasculegionModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = BasculegionModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "basculegion", "water_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: BasculegionModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
