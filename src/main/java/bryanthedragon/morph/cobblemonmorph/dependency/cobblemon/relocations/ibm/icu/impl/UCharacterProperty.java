...
public final class UCharacterProperty {
    ...
    public int digit(int c) {
        int value2 = UCharacterProperty.getNumericTypeValue(this.getProperty(c)) - 1;
        if (value2 <= 9) {
            return value2;
        }
        return -1;
    ...
    public UnicodeSet addPropertyStarts(UnicodeSet set2) {
    ...
    public void upropsvec_addPropertyStarts(UnicodeSet set2) {
        if (this.m_additionalColumnsCount_ > 0) {
    ...
    static UnicodeSet ulayout_addPropertyStarts(int src, UnicodeSet set2) {
        return LayoutProps.INSTANCE.addPropertyStarts(src, set2);
    }
    ...
    extends IntProperty {
        ...
        NormQuickCheckIntProperty(int source, int which, int max2) {
            super(source);
            this.which = which;
            this.max = max2;
        }
    ...
    private class IntProperty {
        ...
        IntProperty(int column, int mask, int shift2) {
            this.column = column;
            this.mask = mask;
            this.shift = shift2;
        }
    ...
    private static final class LayoutProps {
        ...
        public UnicodeSet addPropertyStarts(int src, UnicodeSet set2) {
            CodePointTrie trie;
            switch (src) {
                case 12: {
                    trie = this.inpcTrie;
            ...
            int start2 = 0;
            while (trie.getRange(start2, null, range)) {
                set2.add(start2);
