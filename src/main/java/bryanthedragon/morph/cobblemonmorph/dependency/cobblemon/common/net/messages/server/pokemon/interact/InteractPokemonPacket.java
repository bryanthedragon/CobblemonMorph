...
public class InteractPokemonPacket(pokemonID: UUID, mountShoulder: Boolean) : NetworkPacket<InteractPokemonPacket> {
   ...
   public companion object {
      ...
      public fun decode(buffer: FriendlyByteBuf): InteractPokemonPacket {
         val var10002: UUID = buffer.m_130259_();
         return new InteractPokemonPacket(var10002, buffer.readBoolean());
      }
   }
}
