...
public class BibarelModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.wateroffset = -1;
      this.cryAnimation = BibarelModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "bibarel", "ground_idle", null, 4, null)
            },
            null,
      ...
      var var11: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "bibarel", "ground_idle", null, 4, null),
         new QuadrupedWalkAnimation(this, 0.6F, 0.75F)
      };
      ...
      this.setFloating(PoseableEntityModel.registerPose$default(var15, "float", var7, null, 10, null, null, var11, var6, var9, 52, null));
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: BibarelModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
