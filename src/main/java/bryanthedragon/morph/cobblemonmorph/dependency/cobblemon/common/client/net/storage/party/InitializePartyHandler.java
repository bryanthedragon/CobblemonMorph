...
public final class InitializePartyHandler : ClientNetworkPacketHandler<InitializePartyPacket> {
    override fun handle(packet: InitializePartyPacket, Minecraft client) {
