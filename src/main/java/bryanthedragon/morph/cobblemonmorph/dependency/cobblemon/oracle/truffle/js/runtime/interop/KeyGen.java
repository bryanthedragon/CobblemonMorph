...
@GeneratedBy(ScopeMembers.Key.class)
final class KeyGen {
   ...
   static {
      LibraryExport.register(ScopeMembers.Key.class, new KeyGen.InteropLibraryExports());
   }

   @GeneratedBy(ScopeMembers.Key.class)
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      private static final KeyGen.InteropLibraryExports.Uncached UNCACHED = new KeyGen.InteropLibraryExports.Uncached();
      private static final KeyGen.InteropLibraryExports.Cached CACHE = new KeyGen.InteropLibraryExports.Cached();
      ...
      private static final class Cached extends InteropLibrary {
         ...
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof ScopeMembers.Key) || KeyGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
