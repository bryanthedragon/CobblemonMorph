...
public class PersianModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = PersianModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "persian", "ground_idle", null, 4, null)
            },
            null,
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "persian", "sleep", null, 4, null)},
            null,
            null,
            222,
            null
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: PersianModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
