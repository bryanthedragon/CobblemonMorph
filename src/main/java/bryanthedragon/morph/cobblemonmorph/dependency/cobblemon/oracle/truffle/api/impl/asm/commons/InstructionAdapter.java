...
extends MethodVisitor {
    ...
    public void visitLdcInsn(Object value2) {
        ...
        if (value2 instanceof Integer) {
            this.iconst((Integer)value2);
        } else if (value2 instanceof Byte) {
            this.iconst(((Byte)value2).intValue());
        } else if (value2 instanceof Character) {
            this.iconst(((Character)value2).charValue());
        } else if (value2 instanceof Short) {
            this.iconst(((Short)value2).intValue());
        } else if (value2 instanceof Boolean) {
            this.iconst((Boolean)value2 != false ? 1 : 0);
        } else if (value2 instanceof Float) {
            this.fconst(((Float)value2).floatValue());
        } else if (value2 instanceof Long) {
            this.lconst((Long)value2);
        } else if (value2 instanceof Double) {
            this.dconst((Double)value2);
        } else if (value2 instanceof String) {
            this.aconst(value2);
        } else if (value2 instanceof Type) {
            this.tconst((Type)value2);
        } else if (value2 instanceof Handle) {
            this.hconst((Handle)value2);
        } else if (value2 instanceof ConstantDynamic) {
            this.cconst((ConstantDynamic)value2);
        } else {
            throw new IllegalArgumentException();
        }
    }
    ...
    public void visitTableSwitchInsn(int min2, int max2, Label dflt, Label ... labels) {
        this.tableswitch(min2, max2, dflt, labels);
    }
    ...
    public void aconst(Object value2) {
        if (value2 == null) {
            this.mv.visitInsn(1);
        } else {
    ...
    public void hconst(Handle handle2) {
    ...
    public void tableswitch(int min2, int max2, Label dflt, Label ... labels) {
