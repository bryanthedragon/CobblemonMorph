   ...
   public void setSource(String newSource) {
      ...
      if (newSource.length() == 0) {
         ...
         for (int var6 = 0; var6 < this.pieces.length; var6++) {
            ...
            this.pieces[var6] = this.getEquivalents(segmentList.get(var6));
         }
      }
   }
   ...
   private Set<String> extract(int comp, String segment, int segmentPos, StringBuffer buf) {
      ...
      if (!ok) {
         ...
         if (buf.length() == 0) {
            ...
            return 0 != Normalizer.compare(UTF16.valueOf(comp) + remainder, segment.substring(segmentPos), 0) ? null : this.getEquivalents2(remainder);
         }
      }
   }
