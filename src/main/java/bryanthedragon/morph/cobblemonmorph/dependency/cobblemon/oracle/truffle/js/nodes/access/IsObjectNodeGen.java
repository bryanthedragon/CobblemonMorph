...
implements Introspection.Provider {
    ...
    public boolean executeBoolean(Object arg0Value) {
        ...
        if ((state_0 & 0x200) != 0 && arg0Value instanceof TruffleString) {
            ...
            return IsObjectNode.doTString(arg0Value_9);
        }
    ...
    private boolean executeAndSpecialize(Object arg0Value) {
        ...
        try {
            ...
            if (arg0Value instanceof TruffleString) {
                ...
                lock.unlock();
                hasLock = false;
                boolean arg0Value_6 = IsObjectNode.doTString(arg0Value_9);
                return arg0Value_6;
            }
            if (arg0Value instanceof JSDynamicObject && JSGuards.isJSObject(arg0Value_ = (JSDynamicObject)arg0Value)) {
                ...
                lock.unlock();
                hasLock = false;
                boolean arg0Value_6 = IsObjectNode.doIsObject(arg0Value_);
                return arg0Value_6;
            }
            if (exclude == 0) {
                int count11_ = 0;
                ...
                if (s11_ != null) {
                    lock.unlock();
                    hasLock = false;
                    boolean bl = IsObjectNode.doForeignObject(arg0Value, s11_.interop_);
                    return bl;
                }
            }
    ...
    extends IsObjectNode {
        ...
        public boolean executeBoolean(Object arg0Value) {
            ...
            if (JSGuards.isForeignObject(arg0Value)) {
                return IsObjectNode.doForeignObject(arg0Value, INTEROP_LIBRARY_.getUncached(arg0Value));
            }
            throw new UnsupportedSpecializationException(this, new Node[]{null}, arg0Value);
        }
