...
public class FomantisModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = FomantisModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "fomantis", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: FomantisModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
