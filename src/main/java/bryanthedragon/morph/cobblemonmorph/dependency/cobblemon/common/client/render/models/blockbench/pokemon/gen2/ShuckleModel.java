...
public class ShuckleModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "shuckle", "ground_idle", null, 4, null)
            },
            null,
      ...
      var var10: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "shuckle", "ground_walk", null, 4, null)
      };
      ...
      var10 = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "shuckle", "sleep", null, 4, null)
      };
      val var14: PoseableEntityModel = this;
      this.setSleep(PoseableEntityModel.registerPose$default(var14, "sleep", var6, null, 5, null, null, var10, null, var8, 180, null));
   }
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isPosedIn(this.getStanding(), this.getWalk()))
         PoseableEntityModel.bedrockStateful$default(this, "shuckle", "faint", null, 4, null)
         else
         null;
   }
