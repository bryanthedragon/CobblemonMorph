...
public final class ContinueExpression extends StringHolder implements Expression {
   @Override
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         return !(o instanceof ContinueExpression other) ? false : other.canEqual(this);
      }
   }
