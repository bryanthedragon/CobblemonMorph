...
public class KommoOModel(root: ModelPart) : PokemonPoseableModel, BipedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = KommoOModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "kommo-o", "ground_idle", null, 4, null)},
            null,
      ...
      val var8: Array<StatelessAnimation> = new StatelessAnimation[]{
         PoseableEntityModel.bedrock$default(this, "kommo-o", "ground_idle", null, 4, null),
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: KommoOModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
