...
public final class JSBitwiseXorNodeGen extends JSBitwiseXorNode implements Introspection.Provider {
   ...
   @Node.Child
   private JSBitwiseXorNodeGen.GenericData generic_cache;
   ...
   public Object executeObject(Object leftNodeValue, Object rightNodeValue) {
      ...
      if ((state_0 & 192) != 0) {
         ...
         if ((state_0 & 128) != 0) {
            JSBitwiseXorNodeGen.GenericData s7_ = this.generic_cache;
   ...
   private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
      ...
      try {
         ...
         if (this.hasOverloadedOperators(leftNodeValue) || this.hasOverloadedOperators(rightNodeValue)) {
            ...
            JSBitwiseXorNodeGen.GenericData s7_ = super.insert(new JSBitwiseXorNodeGen.GenericData());
