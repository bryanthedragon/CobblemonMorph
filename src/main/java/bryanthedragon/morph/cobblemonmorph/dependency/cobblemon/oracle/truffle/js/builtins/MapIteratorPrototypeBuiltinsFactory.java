...
public final class MapIteratorPrototypeBuiltinsFactory {
   @GeneratedBy(MapIteratorPrototypeBuiltins.MapIteratorNextNode.class)
   public static final class MapIteratorNextNodeGen extends MapIteratorPrototypeBuiltins.MapIteratorNextNode implements Introspection.Provider {
      @Node.Child
      ...
      private boolean fallbackGuard_(Object arguments0Value) {
         if (arguments0Value instanceof JSDynamicObject) {
            ...
            if (this.isMapIterator(arguments0Value_)) {
               return false;
            }
         }
      ...
      public Object execute(VirtualFrame frameValue) {
         ...
         if ((state_0 & 1) != 0 && arguments0Value_ instanceof JSDynamicObject) {
            ...
            if (this.isMapIterator(arguments0Value__)) {
      ...
      public Introspection getIntrospectionData() {
         ...
         int state_0 = this.state_0_;
         Object[] s = new Object[]{"doMapIterator", null, null};
         if ((state_0 & 1) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
      ...
      public static MapIteratorPrototypeBuiltins.MapIteratorNextNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new MapIteratorPrototypeBuiltinsFactory.MapIteratorNextNodeGen(context, builtin, arguments);
      }
   }
}
