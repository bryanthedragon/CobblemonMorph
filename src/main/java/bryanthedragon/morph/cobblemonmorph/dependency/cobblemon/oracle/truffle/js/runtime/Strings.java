...
public final class Strings {
   ...
   public static final TruffleString ALL = constant("all");
   public static final TruffleString ANY = constant("any");
   public static final TruffleString APPLY = constant("apply");
   public static final TruffleString ARGUMENTS = constant("arguments");
   ...
   public static final TruffleString CONSTRUCT = constant("construct");
   ...
   public static final TruffleString THEN = constant("then");
   public static final TruffleString THIS = constant("this");
   public static final TruffleString THROW = constant("throw");
   ...
   public static final TruffleString PARSE_INT = constant("parseInt");
   public static final TruffleString PARSE_FLOAT = constant("parseFloat");
   ...
   public static final TruffleString METHOD_ERROR_PROTOTYPE_TO_STRING_CALLED_ON_INCOMPATIBLE_RECEIVER = constant(
   ...
   public static TruffleString fromJavaString(TruffleString.FromJavaStringNode node, String str) {
      return str == null ? null : node.execute(str, TruffleString.Encoding.UTF_16);
   }

   public static TruffleString fromCharSequence(CharSequence str) {
      return str == null ? null : fromJavaString(str.toString());
   }
   ...
   public static boolean regionEquals(
      TruffleString.RegionEqualByteIndexNode regionEqualsNode, TruffleString s1, int offset1, TruffleString s2, int offset2, int length
   ) {
   ...
   public static int indexOf(TruffleString.ByteIndexOfCodePointNode node, TruffleString s, int codepoint, int fromIndex) {
      return fromIndex >= length(s) ? -1 : node.execute(s, codepoint, fromIndex << 1, length(s) << 1, TruffleString.Encoding.UTF_16) >> 1;
   }
   ...
   public static boolean equals(TruffleString.EqualNode node, TruffleString s1, TruffleString s2) {
      if (s1 == null) {
         ...
         return !isTString(s2) ? false : node.execute(s1, s2, TruffleString.Encoding.UTF_16);
      }
   }
   ...
   public static TruffleString replace(TruffleString s, TruffleString search, TruffleString replace) {
      ...
      if (pos < 0) {
         return s;
      } else if (length(s) == length(search)) {
         return replace;
      } else {
   ...
   public static TruffleString lazyTrim(TruffleString s) {
      ...
      return start <= 0 && end >= length(s) ? s : lazySubstring(s, start, end - start);
   }
   ...
   public static TruffleString addBrackets(TruffleString str) {
      return concatAll(BRACKET_OPEN, str, BRACKET_CLOSE);
   }
