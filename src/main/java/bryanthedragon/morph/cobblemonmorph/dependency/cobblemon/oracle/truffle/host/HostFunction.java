...
implements TruffleObject {
    ...
    @ExportMessage
    Object execute(Object[] args, @Cached HostExecuteNode execute2) throws UnsupportedTypeException, ArityException {
        return execute2.execute(this.method, this.obj, args, this.context);
    }
