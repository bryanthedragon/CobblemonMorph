...
public class DecimalFormatSymbols implements Cloneable, Serializable {
   ...
   private static final String[] SYMBOL_KEYS = new String[]{
      "decimal",
      "group",
      "percentSign",
      "minusSign",
   ...
   private static final CacheBase<ULocale, DecimalFormatSymbols.CacheData, Void> cachedLocaleData = new SoftCache<ULocale, DecimalFormatSymbols.CacheData, Void>() {
      protected DecimalFormatSymbols.CacheData createInstance(ULocale locale, Void unused) {
   ...
   public boolean equals(Object obj) {
      if (!(obj instanceof DecimalFormatSymbols)) {
         ...
         return this.groupingSeparator == other.groupingSeparator
            ...
            && this.minusString.equals(other.minusString)
            ...
            && this.padEscape == other.padEscape
            && this.plusSign == other.plusSign
            && this.plusString.equals(other.plusString)
            && this.approximatelyString.equals(other.approximatelyString)
            && this.exponentSeparator.equals(other.exponentSeparator)
            && this.monetarySeparator == other.monetarySeparator
            && this.monetaryGroupingSeparator == other.monetaryGroupingSeparator
            && this.exponentMultiplicationSign.equals(other.exponentMultiplicationSign);
      }
   }
   ...
   private void initialize(ULocale locale, NumberingSystem ns) {
      ...
      DecimalFormatSymbols.CacheData data = cachedLocaleData.getInstance(keyLocale, null);
   ...
   private static DecimalFormatSymbols.CacheData loadData(ULocale locale) {
      ...
      DecimalFormatSymbols.DecFmtDataSink sink = new DecimalFormatSymbols.DecFmtDataSink(numberElements);
      ...
      return new DecimalFormatSymbols.CacheData(validLocale, digits, numberElements);
   }
