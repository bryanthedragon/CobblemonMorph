...
public final class JSArguments {
   ...
   public static void setUserArguments(Object[] arguments, int index, Object... userArguments) {
      arraycopy(userArguments, 0, arguments, 2 + index, userArguments.length);
   }

   public static Object[] extractUserArguments(Object[] arguments) {
      Object[] userArguments = new Object[arguments.length - 2];
      arraycopy(arguments, 2, userArguments, 0, userArguments.length);
   ...
   public static Object[] createResumeArguments(
      Object executionContext, Object generatorOrPromiseCapability, Completion.Type completionType, Object completionValue
   ) {
   ...
   public static Completion.Type getResumeCompletionType(Object[] arguments) {
      return (Completion.Type)arguments[4];
   }
