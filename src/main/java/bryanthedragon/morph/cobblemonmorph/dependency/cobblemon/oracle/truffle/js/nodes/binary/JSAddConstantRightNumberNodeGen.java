...
public final class JSAddConstantRightNumberNodeGen extends JSAddConstantRightNumberNode implements Introspection.Provider {
   ...
   @CompilerDirectives.CompilationFinal
   private TruffleString stringNumber_rightString_;
   @Node.Child
   private JSConcatStringsNode stringNumber_createLazyString_;
   @Node.Child
   private JSOverloadedBinaryNode overloaded_overloadedOperatorNode_;
   @Node.Child
   private JSAddConstantRightNumberNodeGen.PrimitiveConversionData primitiveConversion_cache;
   ...
   public Object execute(Object operandNodeValue) {
      ...
      if ((state_0 & 8) != 0 && operandNodeValue instanceof SafeInteger) {
         ...
         return this.doStringNumber(operandNodeValue_x, this.stringNumber_rightString_, this.stringNumber_createLazyString_);
         ...
         if ((state_0 & 128) != 0) {
            JSAddConstantRightNumberNodeGen.PrimitiveConversionData s7_ = this.primitiveConversion_cache;
            if (s7_ != null && !this.hasOverloadedOperators(operandNodeValue)) {
               return this.doPrimitiveConversion(operandNodeValue, s7_.toPrimitiveA_, s7_.toNumberA_, s7_.rightString_, s7_.createLazyString_, s7_.profileA_);
            }
         }
   ...
   private Object execute_generic2(int state_0, VirtualFrame frameValue) {
      ...
      if ((state_0 & 8) != 0 && operandNodeValue_ instanceof SafeInteger) {
         ...
         return this.doStringNumber(operandNodeValue__x, this.stringNumber_rightString_, this.stringNumber_createLazyString_);
         ...
         if ((state_0 & 128) != 0) {
            ...
            if (s7_ != null && !this.hasOverloadedOperators(operandNodeValue_)) {
               return this.doPrimitiveConversion(operandNodeValue_, s7_.toPrimitiveA_, s7_.toNumberA_, s7_.rightString_, s7_.createLazyString_, s7_.profileA_);
            }
         }
   ...
   private Object executeAndSpecialize(Object operandNodeValue) {
      ...
      try {
         ...
         if (operandNodeValue instanceof Integer) {
            ...
            if ((exclude & 2) == 0 && !this.truncate && this.isInt) {
               int var54;
         ...
         if ((exclude & 8) == 0 && (doubleCast0 = JSTypesGen.specializeImplicitDouble(operandNodeValue)) != 0) {
            ...
            TruffleString operandNodeValue_x = (TruffleString)operandNodeValue;
            this.stringNumber_rightString_ = this.rightValueToString();
            ...
            JSAddConstantRightNumberNodeGen.PrimitiveConversionData s7_ = super.insert(new JSAddConstantRightNumberNodeGen.PrimitiveConversionData());
            s7_.toPrimitiveA_ = s7_.insertAccessor(JSToPrimitiveNode.createHintDefault());
            s7_.toNumberA_ = s7_.insertAccessor(JSToNumberNode.create());
            s7_.rightString_ = this.rightValueToString();
   ...
   private static final class PrimitiveConversionData extends Node {
      ...
      @Node.Child
      JSToNumberNode toNumberA_;
      @CompilerDirectives.CompilationFinal
      TruffleString rightString_;
      @Node.Child
