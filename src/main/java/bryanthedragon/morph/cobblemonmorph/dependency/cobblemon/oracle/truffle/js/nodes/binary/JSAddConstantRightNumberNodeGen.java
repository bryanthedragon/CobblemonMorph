...
@GeneratedBy(value=JSAddConstantRightNumberNode.class)
public final class JSAddConstantRightNumberNodeGen
extends JSAddConstantRightNumberNode
implements Introspection.Provider {
    ...
    public Object execute(Object operandNodeValue) {
        ...
        if ((state_0 & 0x20) != 0 && operandNodeValue instanceof TruffleString) {
            ...
            return this.doStringNumber(operandNodeValue_, this.stringNumber_rightString_, this.stringNumber_createLazyString_);
        }
    ...
    private Object execute_generic2(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0x20) != 0 && operandNodeValue_ instanceof TruffleString) {
            ...
            return this.doStringNumber(operandNodeValue__, this.stringNumber_rightString_, this.stringNumber_createLazyString_);
        }
