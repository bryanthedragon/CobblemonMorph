...
public final class JSTemporalDurationRecord {
   ...
   private JSTemporalDurationRecord(
      double years,
      double months,
      double days,
      double hours,
   ...
   public static JSTemporalDurationRecord create(
      double years, double months, double days, double hours, double minutes, double seconds, double milliseconds, double microseconds, double nanoseconds
   ) {
   ...
   public static JSTemporalDurationRecord createWeeks(
      double years,
      double months,
      double weeks,
      double days,
   ...
   public static JSTemporalDurationRecord createWeeksRemainder(
      double years,
      double months,
      double weeks,
      double days,
