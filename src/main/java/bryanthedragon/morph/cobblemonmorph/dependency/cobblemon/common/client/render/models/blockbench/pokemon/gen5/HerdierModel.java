...
public class HerdierModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = HerdierModel::cryAnimation$lambda$0;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: HerdierModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
