...
import com.cobblemon.mod.relocations.ibm.icu.number.SkeletonSyntaxException;
...
class NumberSkeletonImpl {
    ...
    private static void checkNull(Object value2, CharSequence content) {
        if (value2 != null) {
    ...
    static final class EnumToStemString {
        ...
        private static void roundingMode(RoundingMode value2, StringBuilder sb) {
            switch (value2) {
                case CEILING: {
        ...
        private static void groupingStrategy(NumberFormatter.GroupingStrategy value2, StringBuilder sb) {
            switch (value2) {
                case OFF: {
                    sb.append("group-off");
                    break;
        ...
        private static void unitWidth(NumberFormatter.UnitWidth value2, StringBuilder sb) {
            switch (value2) {
                case NARROW: {
        ...
        private static void signDisplay(NumberFormatter.SignDisplay value2, StringBuilder sb) {
            switch (value2) {
                case AUTO: {
                    sb.append("sign-auto");
                    break;
        ...
        private static void decimalSeparatorDisplay(NumberFormatter.DecimalSeparatorDisplay value2, StringBuilder sb) {
            switch (value2) {
                case AUTO: {
