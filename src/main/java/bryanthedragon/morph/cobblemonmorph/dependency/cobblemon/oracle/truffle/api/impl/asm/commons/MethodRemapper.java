...
extends MethodVisitor {
    ...
    public void visitTryCatchBlock(Label start2, Label end2, Label handler, String type) {
        super.visitTryCatchBlock(start2, end2, handler, type == null ? null : this.remapper.mapType(type));
    }
    ...
    public void visitLocalVariable(String name, String descriptor, String signature, Label start2, Label end2, int index) {
        super.visitLocalVariable(name, this.remapper.mapDesc(descriptor), this.remapper.mapSignature(signature, true), start2, end2, index);
    }
    ...
    public AnnotationVisitor visitLocalVariableAnnotation(int typeRef, TypePath typePath, Label[] start2, Label[] end2, int[] index, String descriptor, boolean visible) {
        AnnotationVisitor annotationVisitor = super.visitLocalVariableAnnotation(typeRef, typePath, start2, end2, index, this.remapper.mapDesc(descriptor), visible);
        return annotationVisitor == null ? annotationVisitor : this.createAnnotationRemapper(descriptor, annotationVisitor);
    }
