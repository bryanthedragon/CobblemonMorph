...
public class NodeFactoryDecoderGen
implements NodeDecoder<NodeFactory> {
    private static final Class<?>[] CLASSES = new Class[]{Integer.TYPE, NodeFactory.UnaryOperation.class, NodeFactory.BinaryOperation.class, JSErrorType.class, JavaScriptNode.class, ObjectLiteralNode.ObjectLiteralMemberNode.class, DecoratorListEvaluationNode.class};
    ...
    public Object decodeNode(NodeDecoder.DecoderState decoder, NodeFactory nodeFactory) {
        switch (decoder.getUInt()) {
            case 0: {
                return nodeFactory.createUnary((NodeFactory.UnaryOperation)((Object)decoder.getObject()), (JavaScriptNode)decoder.getObject());
            }
            case 1: {
                return nodeFactory.createLocalVarInc((NodeFactory.UnaryOperation)((Object)decoder.getObject()), (JSFrameSlot)decoder.getObject(), (Boolean)decoder.getObject(), (ScopeFrameNode)decoder.getObject());
            }
            case 2: {
            ...
            case 4: {
                return nodeFactory.createBinary((JSContext)decoder.getObject(), (NodeFactory.BinaryOperation)((Object)decoder.getObject()), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 5: {
            ...
            case 18: {
                return nodeFactory.createSwitch((JavaScriptNode[])decoder.getObject(), (JavaScriptNode[])decoder.getObject(), (int[])decoder.getObject(), (JavaScriptNode[])decoder.getObject());
            }
            case 19: {
            ...
            case 30: {
                return nodeFactory.createForRepeatingNode((JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (FrameDescriptor)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSFrameSlot)decoder.getObject());
            }
            case 31: {
            ...
            case 49: {
                return nodeFactory.createWriteFrameSlot((JSFrameSlot)decoder.getObject(), (ScopeFrameNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 50: {
            ...
            case 55: {
                return nodeFactory.createGlobalVarWrapper((TruffleString)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSTargetableNode)decoder.getObject());
            }
            case 56: {
            ...
            case 59: {
                return nodeFactory.createTryCatch((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (BlockScopeNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 60: {
            ...
            case 62: {
                return nodeFactory.createFunctionCallWithNewTarget((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode[])decoder.getObject());
            }
            case 63: {
                return nodeFactory.createFunctionArguments((JSContext)decoder.getObject(), (JavaScriptNode[])decoder.getObject());
            }
            case 64: {
                return nodeFactory.createNew((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (AbstractFunctionArgumentsNode)decoder.getObject());
            }
            case 65: {
            ...
            case 75: {
                return nodeFactory.createWriteElementNode((JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSContext)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 76: {
                return nodeFactory.createCompoundWriteElementNode((JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (JSContext)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 77: {
            ...
            case 78: {
                return nodeFactory.createReadProperty((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (TruffleString)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 79: {
                return nodeFactory.createWriteProperty((JavaScriptNode)decoder.getObject(), (TruffleString)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSContext)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 80: {
                return nodeFactory.createWriteProperty((JavaScriptNode)decoder.getObject(), (TruffleString)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSContext)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 81: {
            ...
            case 83: {
                return nodeFactory.createDeleteProperty((JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject(), (JSContext)decoder.getObject());
            }
            case 84: {
                return nodeFactory.createFunctionRootNode((AbstractBodyNode)decoder.getObject(), (FrameDescriptor)decoder.getObject(), (JSFunctionData)decoder.getObject(), (SourceSection)decoder.getObject(), (TruffleString)decoder.getObject());
            }
            case 85: {
                return nodeFactory.createModuleRootNode((AbstractBodyNode)decoder.getObject(), (AbstractBodyNode)decoder.getObject(), (FrameDescriptor)decoder.getObject(), (JSFunctionData)decoder.getObject(), (SourceSection)decoder.getObject(), (TruffleString)decoder.getObject());
            }
            case 86: {
            ...
            case 88: {
                return nodeFactory.createFunctionExpression((JSFunctionData)decoder.getObject(), (FunctionRootNode)decoder.getObject(), (JSFrameSlot)decoder.getObject());
            }
            case 89: {
                return nodeFactory.createFunctionExpressionLexicalThis((JSFunctionData)decoder.getObject(), (FunctionRootNode)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 90: {
            ...
            case 94: {
                return nodeFactory.createObjectLiteral((JSContext)decoder.getObject(), (ArrayList)decoder.getObject());
            }
            case 95: {
            ...
            case 97: {
                return nodeFactory.createAccessorMember((TruffleString)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 98: {
                return nodeFactory.createDataMember((TruffleString)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 99: {
                return nodeFactory.createAutoAccessor((TruffleString)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 100: {
                return nodeFactory.createComputedAutoAccessor((JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 101: {
            ...
            case 102: {
                return nodeFactory.createComputedDataMember((JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 103: {
                return nodeFactory.createComputedAccessorMember((JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 104: {
            ...
            case 106: {
                return nodeFactory.createClassDefinition((JSContext)decoder.getObject(), (JSFunctionExpressionNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (ObjectLiteralNode.ObjectLiteralMemberNode[])decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (JavaScriptNode[])decoder.getObject(), (DecoratorListEvaluationNode[])decoder.getObject(), (TruffleString)decoder.getObject(), (Integer)decoder.getObject(), (Integer)decoder.getObject(), (Boolean)decoder.getObject(), (JSFrameSlot)decoder.getObject());
            }
            case 107: {
            ...
            case 113: {
                return nodeFactory.createFunctionData((JSContext)decoder.getObject(), (Integer)decoder.getObject(), (TruffleString)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 114: {
                return nodeFactory.createAwait((JSContext)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject());
            }
            case 115: {
                return nodeFactory.createYield((JSContext)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject(), (ReturnNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject());
            }
            case 116: {
                return nodeFactory.createAsyncGeneratorYield((JSContext)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (ReturnNode)decoder.getObject());
            }
            case 117: {
                return nodeFactory.createAsyncGeneratorYieldStar((JSContext)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (ReturnNode)decoder.getObject());
            }
            case 118: {
                return nodeFactory.createAsyncFunctionBody((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject());
            }
            case 119: {
                return nodeFactory.createGeneratorBody((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject());
            }
            case 120: {
                return nodeFactory.createAsyncGeneratorBody((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject());
            }
            case 121: {
            ...
            case 124: {
                return nodeFactory.createBlockScope((JavaScriptNode)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (FrameDescriptor)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject(), (Integer)decoder.getObject(), (Integer)decoder.getObject());
            }
            case 125: {
            ...
            case 134: {
                return nodeFactory.createIteratorGetNextValue((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 135: {
            ...
            case 137: {
                return nodeFactory.createAsyncIteratorNext((JSContext)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject());
            }
            case 138: {
                return nodeFactory.createIteratorValue((JavaScriptNode)decoder.getObject());
            }
            case 139: {
                return nodeFactory.createAsyncIteratorCloseWrapper((JSContext)decoder.getObject(), (JSFrameSlot)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject(), (JSReadFrameSlotNode)decoder.getObject());
            }
            case 140: {
                return nodeFactory.createIteratorCloseIfNotDone((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 141: {
            ...
            case 146: {
                return nodeFactory.createWithVarWrapper((TruffleString)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSTargetableNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 147: {
            ...
            case 159: {
                return nodeFactory.createDeclareGlobalFunction((TruffleString)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 160: {
                return nodeFactory.createDeclareGlobalLexicalVariable((TruffleString)decoder.getObject(), (Boolean)decoder.getObject());
            }
            case 161: {
                return nodeFactory.createGlobalDeclarationInstantiation((JSContext)decoder.getObject(), (List)decoder.getObject());
            }
            case 162: {
            ...
            case 165: {
                return nodeFactory.createAccessArgumentsArrayDirectly((JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Integer)decoder.getObject());
            }
            case 166: {
                return nodeFactory.createCallApplyArguments((JSFunctionCallNode)decoder.getObject());
            }
            case 167: {
                return nodeFactory.createGuardDisconnectedArgumentRead((Integer)decoder.getObject(), (ReadElementNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSFrameSlot)decoder.getObject());
            }
            case 168: {
                return nodeFactory.createGuardDisconnectedArgumentWrite((Integer)decoder.getObject(), (WriteElementNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSFrameSlot)decoder.getObject());
            }
            case 169: {
            ...
            case 172: {
                return nodeFactory.createTopLevelAsyncModuleBody((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject());
            }
            case 173: {
                return nodeFactory.createImportMeta((JavaScriptNode)decoder.getObject());
            }
            case 174: {
                return nodeFactory.createResolveStarImport((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Module.ModuleRequest)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject());
            }
            case 175: {
                return nodeFactory.createResolveNamedImport((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (Module.ModuleRequest)decoder.getObject(), (TruffleString)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject());
            }
            case 176: {
            ...
            case 178: {
                return nodeFactory.createImportCall((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 179: {
            ...
            case 180: {
                return nodeFactory.createInitializeInstanceElements((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 181: {
            ...
            case 183: {
                return nodeFactory.createPrivateFieldSet((JSContext)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject());
            }
            case 184: {
                return nodeFactory.createPrivateFieldMember((JavaScriptNode)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject());
            }
            case 185: {
                return nodeFactory.createPrivateMethodMember((TruffleString)decoder.getObject(), (Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (Integer)decoder.getObject());
            }
            case 186: {
                return nodeFactory.createPrivateAccessorMember((Boolean)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSWriteFrameSlotNode)decoder.getObject(), (Integer)decoder.getObject());
            }
            case 187: {
            ...
            case 195: {
                return nodeFactory.createDebugVarWrapper((TruffleString)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JavaScriptNode)decoder.getObject(), (JSTargetableNode)decoder.getObject());
            }
            case 196: {
