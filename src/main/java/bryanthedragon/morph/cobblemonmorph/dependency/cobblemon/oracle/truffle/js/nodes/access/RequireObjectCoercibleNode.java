...
extends JavaScriptBaseNode {
    ...
    @Specialization
    protected static void doInt(int value2) {
    }

    @Specialization
    protected static void doSafeInteger(SafeInteger value2) {
    }

    @Specialization
    protected static void doLong(long value2) {
    }

    @Specialization
    protected static void doDouble(double value2) {
    }

    @Specialization
    protected static void doTString(TruffleString value2) {
    }

    @Specialization
    protected static void doBoolean(boolean value2) {
    }

    @Specialization
    protected static void doSymbol(Symbol value2) {
    }

    @Specialization
    protected static void doBigInt(BigInt value2) {
    }

    @Specialization(guards={"cachedClass != null", "isExact(object, cachedClass)"}, limit="1")
    protected static void doCachedJSClass(Object object, @Cached(value="getClassIfJSObject(object)") Class<?> cachedClass) {
    }
    ...
    protected void doForeignObject(Object object, @CachedLibrary(value="object") InteropLibrary interop) {
    ...
    extends JSUnaryNode {
        ...
        protected Object doDefault(Object value2) {
            return this.requireObjectCoercibleNode.execute(value2);
        }

        @Override
        protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
            return RequireObjectCoercibleWrapperNode.create(RequireObjectCoercibleWrapperNode.cloneUninitialized(this.getOperand(), materializedTags));
        }
    }
}
