...
public final class JSContextOptions {
    ...
    @Option(name="js.ecmascript-version", category=OptionCategory.USER, stability=OptionStability.STABLE, usageSyntax="latest|staging|[5, 13]|[2015, 2022]", help="ECMAScript version to be compatible with. Default is 'latest' (latest supported version), staged features are in 'staging'.")
    public static final OptionKey<Integer> ECMASCRIPT_VERSION = new OptionKey<Integer>(13, new OptionType<Integer>("ecmascript-version", new Function<String, Integer>(){
    ...
    public static final OptionKey<Boolean> ANNEX_B = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> SYNTAX_EXTENSIONS = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> SCRIPTING = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> SHEBANG = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> STRICT = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> CONST_AS_VAR = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> FUNCTION_STATEMENT_ERROR = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> INTL_402 = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> REGEXP_MATCH_INDICES = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> REGEXP_STATIC_RESULT = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> SHARED_ARRAY_BUFFER = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> ATOMICS = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> V8_COMPATIBILITY_MODE = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> V8_REALM_BUILTIN = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> V8_LEGACY_CONST = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> NASHORN_COMPATIBILITY_MODE = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Integer> STACK_TRACE_LIMIT = new OptionKey<Integer>(10);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> DEBUG_BUILTIN = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> DIRECT_BYTE_BUFFER = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> PARSE_ONLY = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<String> TIME_ZONE = new OptionKey<String>("", new OptionType<String>("ZoneId", new Function<String, String>(){
    ...
    public static final OptionKey<Boolean> ZONE_RULES_BASED_TIME_ZONES = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    private boolean zoneRulesBasedTimeZones;
    public static final String TIMER_RESOLUTION_NAME = "js.timer-resolution";
    @Option(name="js.timer-resolution", category=OptionCategory.USER, usageSyntax="<nanoseconds>", help="Resolution of timers (performance.now() and Date built-ins) in nanoseconds. Fuzzy time is used when set to 0.")
    public static final OptionKey<Long> TIMER_RESOLUTION = new OptionKey<Long>(1000000L);
    ...
    public static final OptionKey<Boolean> AGENT_CAN_BLOCK = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> JAVA_PACKAGE_GLOBALS = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> GLOBAL_PROPERTY = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> GLOBAL_ARGUMENTS = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> CONSOLE = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> PERFORMANCE = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> SHELL = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> PRINT = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> PRINT_NO_NEWLINE = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> LOAD = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> LOAD_FROM_URL = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> LOAD_FROM_CLASSPATH = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> COMMONJS_REQUIRE = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<String> COMMONJS_REQUIRE_CWD = new OptionKey<String>("");
    ...
    public static final OptionKey<Map<String, String>> COMMONJS_CORE_MODULES_REPLACEMENTS = new OptionKey<Map<String, String>>(Collections.emptyMap(), new OptionType<Map<String, String>>("commonjs-require-globals", new Function<String, Map<String, String>>(){

        @Override
        public Map<String, String> apply(String value2) {
            String[] options;
            HashMap<String, String> map = new HashMap<String, String>();
            if ("".equals(value2)) {
                return map;
            }
            for (String s : options = value2.split(",")) {
    ...
    public static final OptionKey<Boolean> GRAAL_BUILTIN = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> POLYGLOT_BUILTIN = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> POLYGLOT_EVALFILE = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> AWAIT_OPTIMIZATION = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> DISABLE_EVAL = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> DISABLE_WITH = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> BIGINT = new OptionKey<Boolean>(true);
    ...
    public static final OptionKey<Boolean> CLASS_FIELDS = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> REGEX_DUMP_AUTOMATA = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> REGEX_STEP_EXECUTION = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> REGEX_ALWAYS_EAGER = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> SCRIPT_ENGINE_GLOBAL_SCOPE_IMPORT = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> FOREIGN_OBJECT_PROTOTYPE = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> FOREIGN_HASH_PROPERTIES = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Long> FUNCTION_ARGUMENTS_LIMIT = new OptionKey<Long>(65535L);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> TEST262_MODE = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> TESTV8_MODE = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> VALIDATE_REGEXP_LITERALS = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    private boolean validateRegExpLiterals;
    public static final String LOCALE_NAME = "js.locale";
    @Option(name="js.locale", category=OptionCategory.EXPERT, usageSyntax="<locale>", help="Use a specific default locale for locale-sensitive operations.")
    public static final OptionKey<String> LOCALE = new OptionKey<String>("");
    ...
    public static final OptionKey<Integer> FUNCTION_CONSTRUCTOR_CACHE_SIZE = new OptionKey<Integer>(256);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Integer> REGEX_CACHE_SIZE = new OptionKey<Integer>(128);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Integer> STRING_LENGTH_LIMIT = new OptionKey<Integer>(1073741799);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> STRING_LAZY_SUBSTRINGS = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> BIND_MEMBER_FUNCTIONS = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> REGEX_REGRESSION_TEST_MODE = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> INTEROP_COMPLETE_PROMISES = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<String> DEBUG_PROPERTY_NAME = new OptionKey<String>(Strings.toJavaString(JSRealm.DEBUG_CLASS_NAME));
    ...
    public static final OptionKey<Boolean> PROFILE_TIME = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> PROFILE_TIME_PRINT_CUMULATIVE = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> TEST_CLONE_UNINITIALIZED = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> LAZY_TRANSLATION = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Integer> MAX_TYPED_ARRAY_LENGTH = new OptionKey<Integer>(0x3FFFFFFF);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Integer> MAX_APPLY_ARGUMENT_LENGTH = new OptionKey<Integer>(10000000);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Integer> MAX_PROTOTYPE_CHAIN_LENGTH = new OptionKey<Integer>(32766);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> ASYNC_STACK_TRACES = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Integer> PROPERTY_CACHE_LIMIT = new OptionKey<Integer>(5);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Integer> FUNCTION_CACHE_LIMIT = new OptionKey<Integer>(4);
    @CompilerDirectives.CompilationFinal
    ...
    protected static final OptionKey<Boolean> TOP_LEVEL_AWAIT = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> USE_UTC_FOR_LEGACY_DATES = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> WEBASSEMBLY = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> NEW_SET_METHODS = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> OPERATOR_OVERLOADING = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> ERROR_CAUSE = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> IMPORT_ASSERTIONS = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> JSON_MODULES = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> WASM_BIG_INT = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> ESM_EVAL_RETURNS_EXPORTS = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> MLE_MODE = new OptionKey<Boolean>(false);
    ...
    public static final OptionKey<Boolean> PRIVATE_FIELDS_IN = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<Boolean> ESM_BARE_SPECIFIER_RELATIVE_LOOKUP = new OptionKey<Boolean>(false);
    @CompilerDirectives.CompilationFinal
    ...
    public static final OptionKey<String> CHARSET = new OptionKey<String>("", new OptionType<String>("CharsetName", new Function<String, String>(){
    ...
    public static final OptionKey<Boolean> SCOPE_OPTIMIZATION = new OptionKey<Boolean>(true);
    @CompilerDirectives.CompilationFinal
    ...
    private void cacheOptions() {
        ...
        this.regexpStaticResult = this.patchBooleanOption(REGEXP_STATIC_RESULT, REGEXP_STATIC_RESULT_NAME, this.regexpStaticResult, msg -> {
            this.regexpStaticResultCyclicAssumption.invalidate((String)msg);
        ...
        this.v8CompatibilityMode = this.patchBooleanOption(V8_COMPATIBILITY_MODE, V8_COMPATIBILITY_MODE_NAME, this.v8CompatibilityMode, msg -> {
            this.v8CompatibilityModeCyclicAssumption.invalidate((String)msg);
        ...
        this.directByteBuffer = this.patchBooleanOption(DIRECT_BYTE_BUFFER, DIRECT_BYTE_BUFFER_NAME, this.directByteBuffer, msg -> {
            this.directByteBufferCyclicAssumption.invalidate((String)msg);
        ...
        this.timerResolution = this.patchLongOption(TIMER_RESOLUTION, TIMER_RESOLUTION_NAME, this.timerResolution, msg -> {
            this.timerResolutionCyclicAssumption.invalidate((String)msg);
        ...
        boolean bl2 = this.mleMode = this.readBooleanOption(MLE_MODE) || this.readBooleanOption(INTEROP_COMPLETE_PROMISES);
    ...
    public static OptionDescriptor newOptionDescriptor(OptionKey<?> key, String name, OptionCategory category, OptionStability stability, String help, String usageSyntax) {
        return OptionDescriptor.newBuilder(key, name).category(category).help(JSContextOptions.helpWithDefault(help, key)).stability(stability).usageSyntax(usageSyntax).build();
    }
    ...
    public boolean isAtomics() {
        ...
        return ATOMICS.getValue(this.optionValues);
    }
    ...
    public boolean isConsole() {
        ...
        return CONSOLE.getValue(this.optionValues) != false || !CONSOLE.hasBeenSet(this.optionValues) && this.isShell();
    }
    ...
    public boolean isPrint() {
        ...
        return PRINT.getValue(this.optionValues) != false || !PRINT.hasBeenSet(this.optionValues) && (this.isShell() || this.isNashornCompatibilityMode());
    }
    ...
    public boolean isLoad() {
        ...
        return LOAD.getValue(this.optionValues) != false || !LOAD.hasBeenSet(this.optionValues) && (this.isShell() || this.isNashornCompatibilityMode());
    }
    ...
    public boolean isPerformance() {
        ...
        return PERFORMANCE.getValue(this.optionValues) != false || !PERFORMANCE.hasBeenSet(this.optionValues) && this.isShell();
    }
    ...
    public boolean isBigInt() {
        ...
        return BIGINT.getValue(this.optionValues);
    }
