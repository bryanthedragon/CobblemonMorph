...
public abstract class InNode extends JSBinaryNode {
   ...
   protected boolean doProxy(Object needle, JSDynamicObject haystack, @Cached("create(context)") JSProxyHasPropertyNode proxyHasPropertyNode) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return InNodeGen.create(this.context, cloneUninitialized(this.getLeft(), materializedTags), cloneUninitialized(this.getRight(), materializedTags));
   }
}
