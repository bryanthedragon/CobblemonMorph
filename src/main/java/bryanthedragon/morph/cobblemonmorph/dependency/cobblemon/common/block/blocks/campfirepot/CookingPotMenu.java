...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.CobblemonRecipeBookTypes.COOKING_POT
...
public class CookingPotMenu : RecipeBookMenu<CraftingInput, CookingPotRecipeBase>, ContainerListener {
    ...
    override fun handlePlacement(placeAll: Boolean, recipe: RecipeHolder<*>, ServerPlayer player) {
        ...
        if (recipeValue is CookingPotRecipeBase) {
            ...
            throw IllegalArgumentException("Unsupported recipe type: ${recipeValue.class.name}")
        }
    }
    ...
    override fun shouldMoveToInventory(slotInt index): Boolean {
    ...
    override fun slotChanged(containerToSend: AbstractContainerMenu, dataSlotInt index, ItemStack stack) {
