...
public final class LocaleIDParser {
   ...
   public String[] getLanguageScriptCountryVariant() {
      this.reset();
      return new String[]{
         this.getString(this.parseLanguage()), this.getString(this.parseScript()), this.getString(this.parseCountry()), this.getString(this.parseVariant())
      };
   }
   ...
   public Map<String, String> getKeywordMap() {
      if (this.keywords == null) {
         ...
         this.keywords = (Map<String, String>)(m != null ? m : Collections.emptyMap());
      }
