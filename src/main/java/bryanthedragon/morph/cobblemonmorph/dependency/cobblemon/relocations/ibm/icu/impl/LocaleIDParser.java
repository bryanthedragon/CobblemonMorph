...
public final class LocaleIDParser {
    ...
    private String getString(int start2) {
        return this.buffer.substring(start2);
    }
    ...
    private String getKeyword() {
        ...
        --this.index;
        return AsciiUtil.toLowerString(new String(this.id, start2, this.index - start2).trim());
    }
    ...
    private String getValue() {
        ...
        --this.index;
        return new String(this.id, start2, this.index - start2).trim();
    }
                    ...
                    block9: {
                        ...
                        block11: {
                            block10: {
                                ...
                                if (value2.length() == 0) break block9;
    ...
    public void defaultKeywordValue(String keywordName, String value2) {
        this.setKeywordValue(keywordName, value2, false);
    }

    public void setKeywordValue(String keywordName, String value2) {
        this.setKeywordValue(keywordName, value2, true);
    }

    private void setKeywordValue(String keywordName, String value2, boolean reset) {
        if (keywordName == null) {
            if (reset) {
            ...
            if (m.isEmpty()) {
                if (value2 != null) {
                    ...
                    this.keywords.put(keywordName, value2.trim());
                }
            } else if (reset || !m.containsKey(keywordName)) {
                if (value2 != null) {
                    m.put(keywordName, value2);
                } else {
