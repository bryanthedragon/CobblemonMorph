...
public object ItemLikeConditionAdapter : RegistryLikeAdapter<Item> {
   public open val registryLikeConditions: MutableList<(JsonElement) -> RegistryLikeCondition<Item>?>

   override fun deserialize(json: JsonElement, type: Type, ctx: JsonDeserializationContext): RegistryLikeCondition<Item> {
   ...
   fun {
      ...
      val var10003: ResourceKey = Registries.f_256913_;
