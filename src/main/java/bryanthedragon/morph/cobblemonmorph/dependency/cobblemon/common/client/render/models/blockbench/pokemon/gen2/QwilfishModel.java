...
public class QwilfishModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = QwilfishModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "qwilfish", "ground_idle", null, 4, null)},
            null,
      ...
      val var12: Array<StatelessAnimation> = new StatelessAnimation[]{
         PoseableEntityModel.bedrock$default(this, "qwilfish", "ground_idle", null, 4, null),
         new WaveAnimation(
            this,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: QwilfishModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
