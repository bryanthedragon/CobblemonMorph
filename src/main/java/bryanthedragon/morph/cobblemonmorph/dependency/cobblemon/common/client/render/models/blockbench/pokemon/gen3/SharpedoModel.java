...
implements HeadedFrame {
    ...
    public SharpedoModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "sharpedo");
        this.head = this.getPart("body");
        this.portraitScale = 1.5f;
        this.portraitTranslation = new Vec3(-0.24, -0.9, 0.0);
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "sharpedo", "water_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "sharpedo", "water_idle", null, 4, null)};
