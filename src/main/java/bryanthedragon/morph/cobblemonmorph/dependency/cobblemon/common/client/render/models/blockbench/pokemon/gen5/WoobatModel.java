...
public class WoobatModel(root: ModelPart) : PokemonPoseableModel, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = WoobatModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "woobat", "air_idle", null, 4, null),
      ...
      this.setWalk(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "woobat", "air_fly", null, 4, null),
               new WingFlapIdleAnimation(
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: WoobatModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
