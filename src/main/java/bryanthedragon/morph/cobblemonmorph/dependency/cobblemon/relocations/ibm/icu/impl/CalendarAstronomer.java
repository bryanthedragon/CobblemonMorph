...
public class CalendarAstronomer {
    ...
    private static final double normalize(double value2, double range) {
        return value2 - range * Math.floor(value2 / range);
    }
    ...
    private static String radToHms(double angle) {
        ...
        int min2 = (int)((angle * 3.819718634205488 - (double)hrs) * 60.0);
        int sec = (int)((angle * 3.819718634205488 - (double)hrs - (double)min2 / 60.0) * 3600.0);
        return Integer.toString(hrs) + "h" + min2 + "m" + sec + "s";
    }

    private static String radToDms(double angle) {
        int deg = (int)(angle * 57.29577951308232);
        int min2 = (int)((angle * 57.29577951308232 - (double)deg) * 60.0);
        int sec = (int)((angle * 57.29577951308232 - (double)deg - (double)min2 / 60.0) * 3600.0);
        return Integer.toString(deg) + "\u00b0" + min2 + "'" + sec + "\"";
    }
