...
implements HeadedFrame {
    ...
    public MimikyuModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "mimikyu");
        ...
        this.cryAnimation = (arg_0, arg_1) -> MimikyuModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "mimikyu", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "mimikyu", "ground_idle", null, 4, null)};
        this.setWalk(PoseableEntityModel.registerPose$default(poseableEntityModel2, "walk", enumSet3, null, 0, null, null, statelessAnimationArray, null, null, 444, null));
        double shoulderOffset = 0.3;
        Object[] objectArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "mimikyu", "shoulder_left", null, 4, null)};
        StatelessAnimation[] statelessAnimationArray2 = objectArray;
        objectArray = new ModelPartTransformation[]{ModelPartExtensionsKt.createTransformation(this.getRootPart()).addPosition(0, shoulderOffset)};
        ...
        objectArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "mimikyu", "shoulder_right", null, 4, null)};
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(MimikyuModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "mimikyu", "cry", null, 4, null);
    }
}
