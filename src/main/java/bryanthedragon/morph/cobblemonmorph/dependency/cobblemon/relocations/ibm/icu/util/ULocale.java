...
import com.cobblemon.mod.relocations.ibm.icu.impl.ICUResourceTableAccess;
import com.cobblemon.mod.relocations.ibm.icu.impl.LocaleIDParser;
import com.cobblemon.mod.relocations.ibm.icu.impl.LocaleIDs;
...
import com.cobblemon.mod.relocations.ibm.icu.impl.locale.InternalLocaleBuilder;
import com.cobblemon.mod.relocations.ibm.icu.impl.locale.KeyTypeData;
import com.cobblemon.mod.relocations.ibm.icu.impl.locale.LanguageTag;
import com.cobblemon.mod.relocations.ibm.icu.impl.locale.LocaleExtensions;
import com.cobblemon.mod.relocations.ibm.icu.impl.locale.LocaleSyntaxException;
import com.cobblemon.mod.relocations.ibm.icu.impl.locale.ParseStatus;
import com.cobblemon.mod.relocations.ibm.icu.impl.locale.UnicodeLocaleExtension;
...
import com.cobblemon.mod.relocations.ibm.icu.util.IllformedLocaleException;
import com.cobblemon.mod.relocations.ibm.icu.util.LocaleMatcher;
import com.cobblemon.mod.relocations.ibm.icu.util.LocalePriorityList;
...
Comparable<ULocale> {
    ...
    public ULocale setKeywordValue(String keyword, String value2) {
        return new ULocale(ULocale.setKeywordValue(this.localeID, keyword, value2), (Locale)null);
    }

    public static String setKeywordValue(String localeID, String keyword, String value2) {
        LocaleIDParser parser = new LocaleIDParser(localeID);
        parser.setKeywordValue(keyword, value2);
        return parser.getName();
    }
    ...
    private static String getDisplayKeywordValueInternal(ULocale locale, String keyword, ULocale displayLocale) {
        ...
        String value2 = locale.getKeywordValue(keyword);
        return LocaleDisplayNames.getInstance(displayLocale).keyValueDisplayName(keyword, value2);
    }
    ...
    public String getCharacterOrientation() {
        return ICUResourceTableAccess.getTableString("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", this, "layout", "characters", "characters");
    }

    public String getLineOrientation() {
        return ICUResourceTableAccess.getTableString("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", this, "layout", "lines", "lines");
    }
    ...
    private static String lookupLikelySubtags(String localeId) {
        UResourceBundle bundle = UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", "likelySubtags");
        try {
    ...
    public static String toUnicodeLocaleType(String keyword, String value2) {
        String bcpType = KeyTypeData.toBcpType(keyword, value2, null, null);
        if (bcpType == null && UnicodeLocaleExtension.isType(value2)) {
            bcpType = AsciiUtil.toLowerString(value2);
        }
        return bcpType;
    }
    ...
    public static String toLegacyType(String keyword, String value2) {
        String legacyType = KeyTypeData.toLegacyType(keyword, value2, null, null);
        if (legacyType == null && value2.matches("[0-9a-zA-Z]+([_/\\-][0-9a-zA-Z]+)*")) {
            legacyType = AsciiUtil.toLowerString(value2);
        }
        return legacyType;
    }
            ...
            if (!extKeys.isEmpty()) {
                for (Character extKey : extKeys) {
                    if (extKey.charValue() == 'u') {
                        ...
                        Set<String> set2 = loc.getUnicodeLocaleKeys();
                        for (String kwKey : set2) {
    ...
    public static final class Builder {
        ...
        public Builder setExtension(char key, String value2) {
            try {
                this._locbld.setExtension(key, value2);
            }
            catch (LocaleSyntaxException e) {
                throw new IllformedLocaleException(e.getMessage(), e.getErrorIndex());
            }
        ...
        public String replace() {
            ...
            if (this.extensions != null) {
                ...
                while (keywords != null && keywords.hasNext()) {
                    ...
                    String value2 = temp.getKeywordValue(key);
                    String replacement = key.equals("t") ? this.replaceTransformedExtensions(value2) : this.replaceSubdivision(value2);
