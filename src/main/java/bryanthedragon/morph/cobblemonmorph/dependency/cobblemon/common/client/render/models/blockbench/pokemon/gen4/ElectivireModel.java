...
public class ElectivireModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = ElectivireModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "electivire", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: ElectivireModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
