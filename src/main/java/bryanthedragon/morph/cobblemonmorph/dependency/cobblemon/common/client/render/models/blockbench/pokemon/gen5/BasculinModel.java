...
public class BasculinModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = BasculinModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "basculin", "water_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: BasculinModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
