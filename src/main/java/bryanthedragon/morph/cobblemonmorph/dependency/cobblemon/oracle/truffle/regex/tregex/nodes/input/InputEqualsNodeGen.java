...
@GeneratedBy(value=InputEqualsNode.class)
public final class InputEqualsNodeGen
extends InputEqualsNode {
    @CompilerDirectives.CompilationFinal
    private volatile int state_0_;
    @Node.Child
    private TruffleString.RegionEqualByteIndexNode tString_equalsNode_;
    @Node.Child
    private TruffleString.RegionEqualByteIndexNode tStringMask_equalsNode_;
    @Node.Child
            ...
            if ((state_0 & 0x30) != 0 && arg0Value instanceof TruffleString) {
                ...
                if (arg1Value instanceof TruffleString) {
                    ...
                    if ((state_0 & 0x10) != 0 && arg2Value == null) {
                        return this.doTString((TruffleString)arg0Value_, (TruffleString)arg1Value_, arg2Value, arg3Value, this.tString_equalsNode_);
                    }
                    if ((state_0 & 0x20) != 0 && arg2Value instanceof TruffleString.WithMask && (arg2Value_ = (Object)((TruffleString.WithMask)arg2Value)) != null) {
                        return this.doTStringMask((TruffleString)arg0Value_, (TruffleString)arg1Value_, (TruffleString.WithMask)arg2Value_, arg3Value, this.tStringMask_equalsNode_);
                    }
                }
            }
            if ((state_0 & 0x3C0) != 0) {
        ...
        try {
            ...
            if (arg0Value instanceof TruffleString) {
                ...
                if (arg1Value instanceof TruffleString) {
                    ...
                    if (arg2Value == null) {
                        this.tString_equalsNode_ = super.insert(TruffleString.RegionEqualByteIndexNode.create());
                        this.state_0_ = state_0 |= 0x10;
                        lock.unlock();
                        hasLock = false;
                        boolean arg2Value_3 = this.doTString((TruffleString)arg0Value_, (TruffleString)arg1Value_2, arg2Value, arg3Value, this.tString_equalsNode_);
                        return arg2Value_3;
                    }
                    if (arg2Value instanceof TruffleString.WithMask && (arg2Value_22 = (Object)((TruffleString.WithMask)arg2Value)) != null) {
                        this.tStringMask_equalsNode_ = super.insert(TruffleString.RegionEqualByteIndexNode.create());
                        this.state_0_ = state_0 |= 0x20;
                        lock.unlock();
                        hasLock = false;
                        boolean bl = this.doTStringMask((TruffleString)arg0Value_, (TruffleString)arg1Value_2, (TruffleString.WithMask)arg2Value_22, arg3Value, this.tStringMask_equalsNode_);
                        return bl;
                    }
                }
            }
