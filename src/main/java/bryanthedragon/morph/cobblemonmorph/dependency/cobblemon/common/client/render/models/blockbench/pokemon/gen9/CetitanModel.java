...
public class CetitanModel(root: ModelPart) : PokemonPoseableModel {
   ...
   init {
      ...
      this.cryAnimation = CetitanModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "cetitan", "sleep", null, 4, null)},
            null,
            null,
            222,
            null
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "cetitan", "ground_idle", null, 4, null)},
            null,
      ...
      var var11: Array<StatelessAnimation> = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "cetitan", "ground_walk", null, 4, null)};
      ...
      var11 = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "cetitan", "battle_idle", null, 4, null)};
   ...
   public open fun getFaintAnimation(pokemonEntity: PokemonEntity, state: PoseableEntityState<PokemonEntity>): BedrockStatefulAnimation<PokemonEntity>? {
      return if (state.isPosedIn(this.getStanding(), this.getWalking(), this.getBattleidle(), this.getSleep()))
         PoseableEntityModel.bedrockStateful$default(this, "cetitan", "faint", null, 4, null)
         else
         null;
   }

   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: CetitanModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
