...
public class LookAtY : ParticleCameraMode {
   public open val type: ParticleCameraModeType = ParticleCameraModeType.LOOK_AT_Y
   ...
   @JvmStatic
   fun `CODEC$lambda$2$lambda$0`(it: LookAtY): java.lang.String {
      return it.getType().name();
   }

   @JvmStatic
   fun `CODEC$lambda$2$lambda$1`(it: java.lang.String): LookAtY {
      return new LookAtY();
   }

   @JvmStatic
   fun `CODEC$lambda$2`(instance: Instance): App {
      return instance.group(PrimitiveCodec.STRING.fieldOf("type").forGetter(LookAtY::CODEC$lambda$2$lambda$0) as App)
         .apply(instance as Applicative, LookAtY::CODEC$lambda$2$lambda$1);
   }

   @JvmStatic
   fun {
      val var10000: Codec = RecordCodecBuilder.create(LookAtY::CODEC$lambda$2);
      CODEC = var10000;
   }

   public companion object {
      public final val CODEC: Codec<LookAtY>
   }
}
