...
public abstract class ToTemporalCalendarWithISODefaultNode extends JavaScriptBaseNode {
   ...
   @Specialization
   public JSDynamicObject toTemporalCalendarWithISODefault(
      Object calendar,
      ...
      return (JSDynamicObject)(calendarAvailable.profile(calendar == null || calendar == Undefined.instance)
         ? JSTemporalCalendar.create(this.ctx, this.getRealm(), TemporalConstants.ISO8601, errorBranch)
         : toTemporalCalendarNode.executeDynamicObject(calendar));
   }
}
