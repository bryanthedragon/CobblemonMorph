...
implements Introspection.Provider {
    ...
    public Object execute(Object arg0Value) {
        ...
        if ((state_0 & 8) != 0 && JSTypesGen.isImplicitDouble((state_0 & 0x78000) >>> 15, arg0Value)) {
            double arg0Value_ = JSTypesGen.asImplicitDouble((state_0 & 0x78000) >>> 15, arg0Value);
        ...
        if ((state_0 & 0x20) != 0 && JSGuards.isJavaNumber(arg0Value)) {
        ...
        if ((state_0 & 0x7F80) != 0) {
            ...
            if ((state_0 & 0x800) != 0) {
                ForeignObjectAllowed0Data s11_ = this.foreignObjectAllowed0_cache;
                while (s11_ != null) {
            ...
            if (!((state_0 & 0x4000) == 0 || JSGuards.isBoolean(arg0Value) || JSGuards.isNumber(arg0Value) || JSGuards.isString(arg0Value) || JSGuards.isSymbol(arg0Value) || JSGuards.isJSObject(arg0Value) || JSGuards.isForeignObject(arg0Value))) {
    ...
    private Object executeAndSpecialize(Object arg0Value) {
        ...
        try {
            ...
            if (arg0Value instanceof Boolean) {
                ...
                lock.unlock();
                hasLock = false;
                JSDynamicObject jSDynamicObject = this.doBoolean(arg0Value_);
            ...
            if (arg0Value instanceof TruffleString) {
                ...
                lock.unlock();
                hasLock = false;
                JSDynamicObject jSDynamicObject = this.doString(arg0Value_);
                return jSDynamicObject;
            }
            if (arg0Value instanceof Integer) {
                ...
                lock.unlock();
                hasLock = false;
                JSDynamicObject jSDynamicObject = this.doInt(arg0Value_);
                return jSDynamicObject;
            }
            ...
            if (doubleCast0 != 0) {
                ...
                lock.unlock();
                hasLock = false;
                JSDynamicObject jSDynamicObject = this.doDouble(arg0Value_2);
                return jSDynamicObject;
            }
            if (arg0Value instanceof BigInt) {
                ...
                lock.unlock();
                hasLock = false;
                JSDynamicObject arg0Value_2 = this.doBigInt(arg0Value_);
                return arg0Value_2;
            }
            if (JSGuards.isJavaNumber(arg0Value)) {
                ...
                lock.unlock();
                hasLock = false;
                JSDynamicObject arg0Value_ = this.doNumber(arg0Value);
                return arg0Value_;
            }
            if (arg0Value instanceof Symbol) {
                ...
                lock.unlock();
                hasLock = false;
                JSDynamicObject arg0Value_2 = this.doSymbol(arg0Value_);
                return arg0Value_2;
            }
            if ((exclude & 1) == 0) {
                ...
                if (!JSObjectCached_duplicateFound_ && (jSObjectCached_cachedClass__ = this.getClassIfObject(arg0Value)) != null && CompilerDirectives.isExact(arg0Value, jSObjectCached_cachedClass__) && (state_0 & 0x80) == 0) {
            ...
            if (this.isCheckForNullOrUndefined() && JSGuards.isNullOrUndefined(arg0Value)) {
                this.state_0_ = state_0 |= 0x400;
                lock.unlock();
                hasLock = false;
                JSDynamicObject JSObjectCached_duplicateFound_ = this.doNullOrUndefined(arg0Value);
                return JSObjectCached_duplicateFound_;
            }
            if ((exclude & 2) == 0) {
                int count11_ = 0;
                ...
                if (s11_ == null && this.isAllowForeign() && JSGuards.isForeignObject(arg0Value) && count11_ < 5) {
                    s11_ = super.insert(new ForeignObjectAllowed0Data(this.foreignObjectAllowed0_cache));
                    s11_.toObjectNode_ = s11_.insertAccessor(JSToObjectNode.createToObject(this.context, this.checkForNullOrUndefined, this.fromWith, this.allowForeign));
                ...
                if (s11_ != null) {
                    lock.unlock();
                    hasLock = false;
                    Object object2 = this.doForeignObjectAllowed(arg0Value, s11_.toObjectNode_, s11_.interop_);
                    return object2;
                }
            }
    ...
    public NodeCost getCost() {
        ForeignObjectAllowed0Data s11_;
        int state_0 = this.state_0_;
        if ((state_0 & Short.MAX_VALUE) == 0) {
            return NodeCost.UNINITIALIZED;
        }
        if ((state_0 & Short.MAX_VALUE & (state_0 & Short.MAX_VALUE) - 1) == 0 && ((s11_ = this.foreignObjectAllowed0_cache) == null || s11_.next_ == null)) {
