 ...
 */
public class TeamMemberAddNotificationPacket(
    ...
    final class Companion {
        ...
        fun decode(RegistryFriendlyByteBuf buffer) = TeamMemberAddNotificationPacket(buffer.readUUID(), buffer.readText().copy())
    }
}