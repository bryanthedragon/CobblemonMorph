...
public class DirectionZ : ParticleCameraMode {
   public open val type: ParticleCameraModeType = ParticleCameraModeType.DIRECTION_Z
   ...
   public override fun getRotation(
      ...
      var var10001: Quaternionf = Axis.f_252529_
         .m_252977_(-((float)Math.atan2(viewDirection.f_82480_, Math.sqrt(Math.pow(viewDirection.f_82479_, 2.0) + Math.pow(viewDirection.f_82481_, 2.0)))));
      QuaternionUtilsKt.hamiltonProduct(rotation, var10001);
      var10001 = Axis.f_252436_.m_252977_((float)y);
      QuaternionUtilsKt.hamiltonProduct(rotation, var10001);
      return rotation;
   }
   ...
   @JvmStatic
   fun `CODEC$lambda$2$lambda$0`(it: DirectionZ): java.lang.String {
      return it.getType().name();
   }

   @JvmStatic
   fun `CODEC$lambda$2$lambda$1`(it: java.lang.String): DirectionZ {
      return new DirectionZ();
   }

   @JvmStatic
   fun `CODEC$lambda$2`(instance: Instance): App {
      return instance.group(PrimitiveCodec.STRING.fieldOf("type").forGetter(DirectionZ::CODEC$lambda$2$lambda$0) as App)
         .apply(instance as Applicative, DirectionZ::CODEC$lambda$2$lambda$1);
   }

   @JvmStatic
   fun {
      val var10000: Codec = RecordCodecBuilder.create(DirectionZ::CODEC$lambda$2);
      CODEC = var10000;
   }

   public companion object {
      public final val CODEC: Codec<DirectionZ>
   }
}
