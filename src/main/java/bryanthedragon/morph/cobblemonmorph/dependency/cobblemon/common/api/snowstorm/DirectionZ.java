...
implements ParticleCameraMode {
    ...
    public Quaternionf getRotation(@NotNull MatrixWrapper matrixWrapper, float prevAngle, float angle, float deltaTicks, @NotNull Vec3 particlePosition, @NotNull Vec3 cameraPosition, @NotNull Quaternionf cameraAngle, float cameraYaw, float cameraPitch, @NotNull Vec3 viewDirection) {
        ...
        Quaternionf quaternionf = Axis.f_252529_.m_252977_(-((float)x));
        Intrinsics.checkNotNullExpressionValue((Object)quaternionf, (String)"POSITIVE_X.rotationDegrees(-x.toFloat())");
        QuaternionUtilsKt.hamiltonProduct(rotation, quaternionf);
        Quaternionf quaternionf2 = Axis.f_252436_.m_252977_((float)y);
        Intrinsics.checkNotNullExpressionValue((Object)quaternionf2, (String)"POSITIVE_Y.rotationDegrees(y.toFloat())");
    ...
    private static final String CODEC$lambda$2$lambda$0(DirectionZ it) {
        return it.getType().name();
    }

    private static final DirectionZ CODEC$lambda$2$lambda$1(String it) {
        return new DirectionZ();
    }

    private static final App CODEC$lambda$2(RecordCodecBuilder.Instance instance) {
        return instance.group((App)PrimitiveCodec.STRING.fieldOf("type").forGetter(DirectionZ::CODEC$lambda$2$lambda$0)).apply((Applicative)instance, DirectionZ::CODEC$lambda$2$lambda$1);
    }

    static {
        Codec codec2 = RecordCodecBuilder.create(DirectionZ::CODEC$lambda$2);
        Intrinsics.checkNotNullExpressionValue((Object)codec2, (String)"create { instance ->\n   \u2026 DirectionZ() }\n        }");
        CODEC = codec2;
    }

    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\b\u0010\tR\u001d\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u00028\u0006\u00a2\u0006\f\n\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007\u00a8\u0006\n"}, d2={"Lcom/cobblemon/mod/common/api/snowstorm/DirectionZ$Companion;", "", "Lcom/mojang/serialization/Codec;", "Lcom/cobblemon/mod/common/api/snowstorm/DirectionZ;", "CODEC", "Lcom/mojang/serialization/Codec;", "getCODEC", "()Lcom/mojang/serialization/Codec;", "<init>", "()V", "common"})
    public static final class Companion {
        private Companion() {
        }

        @NotNull
        public final Codec<DirectionZ> getCODEC() {
            return CODEC;
        }
