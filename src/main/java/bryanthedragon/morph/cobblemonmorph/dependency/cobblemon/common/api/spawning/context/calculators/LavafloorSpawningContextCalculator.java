...
@Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\t\b\u00c6\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0015\u0010\u0016J\u0017\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u0003H\u0016\u00a2\u0006\u0004\b\u0005\u0010\u0006R&\u0010\n\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u00078\u0016X\u0096\u0004\u00a2\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\rR\u001a\u0010\u000f\u001a\u00020\u000e8\u0016X\u0096D\u00a2\u0006\f\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012R&\u0010\u0013\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u00078\u0016X\u0096\u0004\u00a2\u0006\f\n\u0004\b\u0013\u0010\u000b\u001a\u0004\b\u0014\u0010\r\u00a8\u0006\u0017"}, d2={"Lcom/cobblemon/mod/common/api/spawning/context/calculators/LavafloorSpawningContextCalculator;", "Lcom/cobblemon/mod/common/api/spawning/context/calculators/FlooredSpawningContextCalculator;", "Lcom/cobblemon/mod/common/api/spawning/context/LavafloorSpawningContext;", "Lcom/cobblemon/mod/common/api/spawning/context/calculators/AreaSpawningInput;", "input", "calculate", "(Lcom/cobblemon/mod/common/api/spawning/context/calculators/AreaSpawningInput;)Lcom/cobblemon/mod/common/api/spawning/context/LavafloorSpawningContext;", "Lkotlin/Function1;", "Lnet/minecraft/world/level/block/state/BlockState;", "", "baseCondition", "Lkotlin/jvm/functions/Function1;", "getBaseCondition", "()Lkotlin/jvm/functions/Function1;", "", "name", "Ljava/lang/String;", "getName", "()Ljava/lang/String;", "surroundingCondition", "getSurroundingCondition", "<init>", "()V", "common"})
public final class LavafloorSpawningContextCalculator
implements FlooredSpawningContextCalculator<LavafloorSpawningContext> {
    @NotNull
    public static final LavafloorSpawningContextCalculator INSTANCE = new LavafloorSpawningContextCalculator();
    @NotNull
    private static final String name = "lavafloor";
    @NotNull
    private static final Function1<BlockState, Boolean> baseCondition = SpawningContextCalculator.Companion.isSolidCondition();
    @NotNull
    private static final Function1<BlockState, Boolean> surroundingCondition = SpawningContextCalculator.Companion.isLavaCondition();

    private LavafloorSpawningContextCalculator() {
    }
    ...
    @Override
    @NotNull
    public LavafloorSpawningContext calculate(@NotNull AreaSpawningInput input) {
        ...
        return new LavafloorSpawningContext(spawnCause, serverLevel, blockPos2, n, n2, bl, list, n3, list2, worldSlice);
    }
