...
public object LavafloorSpawningContextCalculator : FlooredSpawningContextCalculator<LavafloorSpawningContext> {
   public open val baseCondition: (BlockState) -> Boolean = SpawningContextCalculator.Companion.isSolidCondition()
   public open val name: String = "lavafloor"
   public open val surroundingCondition: (BlockState) -> Boolean = SpawningContextCalculator.Companion.isLavaCondition()

   public open fun calculate(input: AreaSpawningInput): LavafloorSpawningContext {
      ...
      return new LavafloorSpawningContext(var2, var3, var4, var5, var6, var7, var8, var9, var11, var10);
   }
