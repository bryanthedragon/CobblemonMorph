...
extends ModuleVisitor {
    ...
    public void visitUse(String service2) {
        this.usesIndex.putShort(this.symbolTable.addConstantClass((String)service2).index);
        ++this.usesCount;
    }

    public void visitProvide(String service2, String ... providers) {
        this.provides.putShort(this.symbolTable.addConstantClass((String)service2).index);
