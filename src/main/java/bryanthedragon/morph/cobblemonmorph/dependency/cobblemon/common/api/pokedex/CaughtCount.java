 ...
 */
public interface PokedexValueCalculator<T> {
 ...
 */
public interface GlobalPokedexValueCalculator<T> {
    val outputIsPercentage: Boolean
 ...
 */
public final class CaughtCount : PokedexValueCalculator<Int>, GlobalPokedexValueCalculator<Int> {
 ...
 */
public final class SeenCount : PokedexValueCalculator<Int>, GlobalPokedexValueCalculator<Int> {
    override val outputIsPercentage = false
    override fun calculate(dexManager: AbstractPokedexManager): Int {
 ...
 */
public final class SeenPercent : PokedexValueCalculator<Float>, GlobalPokedexValueCalculator<Float> {
 ...
 */
public final class CaughtPercent : PokedexValueCalculator<Float>, GlobalPokedexValueCalculator<Float> {
    override val outputIsPercentage = true
