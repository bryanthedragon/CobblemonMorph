...
class BasicDurationFormatter implements DurationFormatter {
   ...
   protected BasicDurationFormatter(
   ...
   protected String doFallback(long duration, long referenceDate) {
      return this.fallback != null && this.fallbackLimit > 0L && Math.abs(duration) >= this.fallbackLimit
         ? this.fallback.format(referenceDate + duration)
         : null;
   }
