...
final class UCharacterNameReader implements ICUBinary.Authenticate {
   ...
   protected void read(UCharacterName data) throws IOException {
      ...
      int var11 = this.m_byteBuffer_.getChar();
      data.setGroupCountSize(var11, 3);
      var11 *= 3;
      char[] group = ICUBinary.getChars(this.m_byteBuffer_, var11, 0);
      ...
      var11 = this.m_byteBuffer_.getInt();
      UCharacterName.AlgorithmName[] alg = new UCharacterName.AlgorithmName[var11];
