...
public class IteratorCloseWrapperNode extends JavaScriptNode {
   ...
   public Object execute(VirtualFrame frame) {
      ...
      try {
         ...
         throw var5;
      } catch (ControlFlowException var6) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return new IteratorCloseWrapperNode(
         this.context, cloneUninitialized(this.blockNode, materializedTags), cloneUninitialized(this.iteratorNode, materializedTags)
      );
   }
}
