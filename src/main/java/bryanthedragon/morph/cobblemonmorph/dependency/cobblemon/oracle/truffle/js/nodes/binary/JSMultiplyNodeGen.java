...
@GeneratedBy(value=JSMultiplyNode.class)
public final class JSMultiplyNodeGen
extends JSMultiplyNode
implements Introspection.Provider {
    ...
    public Object execute(Object leftNodeValue, Object rightNodeValue) {
        ...
        if ((state_0 & 8) != 0 && JSTypesGen.isImplicitDouble((state_0 & 0x780) >>> 7, leftNodeValue)) {
        ...
        if ((state_0 & 0x10) != 0 && leftNodeValue instanceof BigInt) {
            ...
            if (rightNodeValue instanceof BigInt) {
                ...
                return this.doBigInts(leftNodeValue_, rightNodeValue_);
            }
        }
        if ((state_0 & 0x60) != 0) {
            GenericData s6_;
    ...
    public Object execute(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        if ((state_0 & 0x78) == 0 && (state_0 & 0x7F) != 0) {
            return this.execute_int_int0(state_0, frameValue);
        }
        if ((state_0 & 0x77) == 0 && (state_0 & 0x7F) != 0) {
    ...
    private Object execute_generic2(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 8) != 0 && JSTypesGen.isImplicitDouble((state_0 & 0x780) >>> 7, leftNodeValue_)) {
        ...
        if ((state_0 & 0x10) != 0 && leftNodeValue_ instanceof BigInt) {
            ...
            if (rightNodeValue_ instanceof BigInt) {
                ...
                return this.doBigInts(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state_0 & 0x60) != 0) {
            GenericData s6_;
