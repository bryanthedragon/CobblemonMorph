...
public class NodeFactory {
    ...
    public JavaScriptNode createConstant(Object value2) {
        return JSConstantNode.create(value2);
    }

    public JavaScriptNode createConstantBoolean(boolean value2) {
        return JSConstantNode.createBoolean(value2);
    }

    public JavaScriptNode createConstantInteger(int value2) {
        return JSConstantNode.createInt(value2);
    }

    public JavaScriptNode createConstantSafeInteger(long value2) {
        return JSConstantNode.createSafeInteger(SafeInteger.valueOf(value2));
    }
    ...
    public JavaScriptNode createConstantDouble(double value2) {
        return JSConstantNode.createDouble(value2);
    }

    public JavaScriptNode createConstantString(TruffleString value2) {
        return JSConstantNode.createString(value2);
    }
    ...
    public IfNode createIf(JavaScriptNode condition2, JavaScriptNode pass, JavaScriptNode fail) {
        return IfNode.create(condition2, pass, fail);
    }
    ...
    public RepeatingNode createWhileDoRepeatingNode(JavaScriptNode condition2, JavaScriptNode body) {
        return WhileNode.createWhileDoRepeatingNode(condition2, body);
    }
    ...
    public RepeatingNode createDoWhileRepeatingNode(JavaScriptNode condition2, JavaScriptNode body) {
        return WhileNode.createDoWhileRepeatingNode(condition2, body);
    }
    ...
    public RepeatingNode createForRepeatingNode(JavaScriptNode condition2, JavaScriptNode body, JavaScriptNode modify, FrameDescriptor frameDescriptor, JavaScriptNode isFirstNode, JavaScriptNode setNotFirstNode, JSFrameSlot blockScopeSlot) {
        IterationScopeNode perIterationScope = this.createIterationScope(frameDescriptor, blockScopeSlot);
        return ForNode.createForRepeatingNode(condition2, body, modify, perIterationScope, isFirstNode, setNotFirstNode);
    }
    ...
    public JavaScriptNode createClearFrameSlotRange(ScopeFrameNode scope, int start2, int end2) {
        return ClearFrameSlotsNode.createRange(scope, start2, end2);
    }
    ...
    public JavaScriptNode createArrayLiteral(JSContext context, JavaScriptNode[] elements2) {
        return ArrayLiteralNode.create(context, elements2);
    }

    public JavaScriptNode createArrayLiteralWithSpread(JSContext context, JavaScriptNode[] elements2) {
        return ArrayLiteralNode.createWithSpread(context, elements2);
    }
    ...
    public ObjectLiteralNode.ObjectLiteralMemberNode createDataMember(TruffleString keyName, boolean isStatic, boolean enumerable, JavaScriptNode value2, boolean isField) {
        return ObjectLiteralNode.newDataMember(keyName, isStatic, enumerable, value2, isField);
    }

    public ObjectLiteralNode.ObjectLiteralMemberNode createAutoAccessor(TruffleString keyName, boolean isStatic, boolean enumerable, JavaScriptNode value2) {
        return ObjectLiteralNode.newAutoAccessor(keyName, isStatic, enumerable, value2);
    }

    public ObjectLiteralNode.ObjectLiteralMemberNode createComputedAutoAccessor(JavaScriptNode key, boolean isStatic, boolean enumerable, JavaScriptNode value2) {
        return ObjectLiteralNode.newComputedAutoAccessor(key, isStatic, enumerable, value2);
    }

    public ObjectLiteralNode.ObjectLiteralMemberNode createProtoMember(TruffleString keyName, boolean isStatic, JavaScriptNode value2) {
        return ObjectLiteralNode.newProtoMember(keyName, isStatic, value2);
    }

    public ObjectLiteralNode.ObjectLiteralMemberNode createComputedDataMember(JavaScriptNode key, boolean isStatic, boolean enumerable, JavaScriptNode value2, boolean isField, boolean isAnonymousFunctionDefinition) {
        return ObjectLiteralNode.newComputedDataMember(key, isStatic, enumerable, value2, isField, isAnonymousFunctionDefinition);
    }
    ...
    public ObjectLiteralNode.ObjectLiteralMemberNode createSpreadObjectMember(boolean isStatic, JavaScriptNode value2) {
        return ObjectLiteralNode.newSpreadObjectMember(isStatic, value2);
    }

    public ObjectLiteralNode.ObjectLiteralMemberNode createStaticBlockMember(JavaScriptNode value2) {
        return ObjectLiteralNode.newStaticBlockMember(value2);
    }
    ...
    public JavaScriptNode createVirtualBlockScope(JavaScriptNode block, int start2, int end2) {
        return BlockScopeNode.createVirtual(block, start2, end2);
    }
    ...
    public IfNode copyIfWithCondition(IfNode origIfNode, JavaScriptNode condition2) {
        return IfNode.create(condition2, origIfNode.getThenPart(), origIfNode.getElsePart());
    }
