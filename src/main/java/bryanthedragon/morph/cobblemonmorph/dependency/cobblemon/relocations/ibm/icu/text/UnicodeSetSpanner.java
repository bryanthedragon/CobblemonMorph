...
public class UnicodeSetSpanner {
    ...
    public int countIn(CharSequence sequence, CountMethod countMethod, UnicodeSet.SpanCondition spanCondition) {
        ...
        while (start2 != length && (endOfSpan = this.unicodeSet.span(sequence, start2, skipSpan)) != length) {
            if (countMethod == CountMethod.WHOLE_SPAN) {
                start2 = this.unicodeSet.span(sequence, endOfSpan, spanCondition);
                ++count;
                continue;
            }
            if (spanCount == null) {
            ...
            start2 = this.unicodeSet.spanAndCount(sequence, endOfSpan, spanCondition, spanCount);
    ...
    public String replaceFrom(CharSequence sequence, CharSequence replacement, CountMethod countMethod, UnicodeSet.SpanCondition spanCondition) {
        ...
        boolean remove2 = replacement.length() == 0;
