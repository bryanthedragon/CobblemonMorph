...
public final class JSOrdinary extends JSNonProxy implements PrototypeSupplier {
   ...
   public static final CompilableBiFunction<JSContext, JSDynamicObject, Shape> SHAPE_SUPPLIER = (ctx, proto) -> JSObjectUtil.getProtoChildShape(
      proto, INSTANCE, ctx
   );
   ...
   public static JSObject createInit(JSRealm realm, JSDynamicObject prototype) {
      ...
      return (JSObject)(context.isMultiContext()
         ? createInitWithInstancePrototype(prototype, context)
         : JSOrdinaryObject.create(
            prototype == Null.instance ? context.getEmptyShapeNullPrototype() : JSObjectUtil.getProtoChildShape(prototype, INSTANCE, context)
         ));
   }
   ...
   public TruffleString getClassName(JSDynamicObject object) {
      ...
      if (context.getEcmaScriptVersion() <= 5) {
         Object toStringTag = this.get(object, Symbol.SYMBOL_TO_STRING_TAG);
