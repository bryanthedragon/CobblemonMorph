...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.client.render.models.blockbench.pokemon.gen5.HydreigonModel;
...
implements HeadedFrame {
    ...
    public HydreigonModel(@NotNull ModelPart root) {
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ HydreigonModel this$0;
            {
        ...
        var wingFrame32 = new BiWingedFrame(this){
            @NotNull
            private final ModelPart rootPart;
            @NotNull
            private final ModelPart leftWing;
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[5];
        ...
        statelessAnimationArray[1] = PoseableEntityModel.bedrock$default(this, "hydreigon", "air_idle", null, 4, null);
        float f = -AngleExtensionsKt.toRadians(Float.valueOf(25.0f));
        statelessAnimationArray[2] = wingFrame12.wingFlap((Function1<? super Float, Float>)WaveFunctionKt.sineFunction$default(0.8f, 1.5f, 0.0f, f, 4, null), registerPoses.1.INSTANCE, 1);
        f = -AngleExtensionsKt.toRadians(Float.valueOf(25.0f));
        statelessAnimationArray[3] = wingFrame22.wingFlap((Function1<? super Float, Float>)WaveFunctionKt.cosineFunction$default(0.65f, 2.0f, 0.0f, f, 4, null), registerPoses.2.INSTANCE, 1);
        f = -AngleExtensionsKt.toRadians(Float.valueOf(25.0f));
        statelessAnimationArray[4] = wingFrame32.wingFlap((Function1<? super Float, Float>)WaveFunctionKt.sineFunction$default(0.5f, 2.0f, 0.0f, f, 4, null), registerPoses.3.INSTANCE, 1);
        StatelessAnimation[] statelessAnimationArray2 = statelessAnimationArray;
        this.setStanding(PoseableEntityModel.registerPose$default((PoseableEntityModel)this, "standing", (Set)object, null, 10, null, null, statelessAnimationArray2, null, modelQuirkArray, 180, null));
        object = new ModelQuirk[]{blink7};
        modelQuirkArray = object;
        object = PoseType.Companion.getMOVING_POSES();
        statelessAnimationArray = new StatelessAnimation[5];
        statelessAnimationArray[0] = HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null);
        statelessAnimationArray[1] = PoseableEntityModel.bedrock$default(this, "hydreigon", "air_fly", null, 4, null);
        f = -AngleExtensionsKt.toRadians(Float.valueOf(25.0f));
        statelessAnimationArray[2] = wingFrame12.wingFlap((Function1<? super Float, Float>)WaveFunctionKt.sineFunction$default(0.5f, 2.0f, 0.0f, f, 4, null), registerPoses.4.INSTANCE, 1);
        f = -AngleExtensionsKt.toRadians(Float.valueOf(25.0f));
        statelessAnimationArray[3] = wingFrame22.wingFlap((Function1<? super Float, Float>)WaveFunctionKt.cosineFunction$default(0.65f, 2.0f, 0.0f, f, 4, null), registerPoses.5.INSTANCE, 1);
        f = -AngleExtensionsKt.toRadians(Float.valueOf(25.0f));
        statelessAnimationArray[4] = wingFrame32.wingFlap((Function1<? super Float, Float>)WaveFunctionKt.sineFunction$default(0.8f, 1.5f, 0.0f, f, 4, null), registerPoses.6.INSTANCE, 1);
        ...
        this.setWalk(PoseableEntityModel.registerPose$default(poseableEntityModel, "walk", (Set)object, null, 10, null, null, statelessAnimationArray2, null, modelQuirkArray, 180, null));
    }
