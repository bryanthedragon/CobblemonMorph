...
public class TimeUnitFormat extends MeasureFormat {
   ...
   private void setup(String resourceKey, Map<TimeUnit, Map<String, Object[]>> timeUnitToCountToPatterns, int style, Set<String> pluralKeywords) {
      try {
         ICUResourceBundle resource = (ICUResourceBundle)UResourceBundle.getBundleInstance(
            "com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/unit", this.locale
         );
         TimeUnitFormat.TimeUnitFormatSetupSink sink = new TimeUnitFormat.TimeUnitFormatSetupSink(timeUnitToCountToPatterns, style, pluralKeywords, this.locale);
   ...
   private void searchInTree(
      String resourceKey, int styl, TimeUnit timeUnit, String srcPluralCount, String searchPluralCount, Map<String, Object[]> countToPatterns
   ) {
      ...
      for (String srcTimeUnitName = timeUnit.toString(); parentLocale != null; parentLocale = parentLocale.getFallback()) {
         try {
            ICUResourceBundle unitsRes = (ICUResourceBundle)UResourceBundle.getBundleInstance(
               "com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/unit", parentLocale
            );
