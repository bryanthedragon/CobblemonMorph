...
import com.cobblemon.mod.relocations.ibm.icu.util.TimeUnitAmount;
...
extends MeasureFormat {
    ...
    private void setup(String resourceKey, Map<TimeUnit, Map<String, Object[]>> timeUnitToCountToPatterns, int style, Set<String> pluralKeywords) {
        try {
            ICUResourceBundle resource = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/unit", this.locale);
    ...
    private void searchInTree(String resourceKey, int styl, TimeUnit timeUnit, String srcPluralCount, String searchPluralCount, Map<String, Object[]> countToPatterns) {
        ...
        for (parentLocale = this.locale; parentLocale != null; parentLocale = parentLocale.getFallback()) {
            try {
                ICUResourceBundle unitsRes = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/unit", parentLocale);
    ...
    extends UResource.Sink {
        ...
        public void put(UResource.Key key, UResource.Value value2, boolean noFallback) {
            ...
            this.beenHere = true;
            UResource.Table units = value2.getTable();
            int i = 0;
            while (units.getKeyAndValue(i, key, value2)) {
                block17: {
                    TimeUnit timeUnit;
                    block11: {
                        String timeUnitName;
                    ...
                    UResource.Table countsToPatternTable = value2.getTable();
                    int j = 0;
                    while (countsToPatternTable.getKeyAndValue(j, key, value2)) {
                        ...
                        if (this.pluralKeywords.contains(pluralCount)) {
                            ...
                            if (pair[this.style] == null) {
                                String pattern = value2.getString();
                                MessageFormat messageFormat = new MessageFormat(pattern, this.locale);
