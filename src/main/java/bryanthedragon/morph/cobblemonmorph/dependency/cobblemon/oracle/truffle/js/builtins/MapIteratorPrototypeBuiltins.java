...
public final class MapIteratorPrototypeBuiltins extends JSBuiltinsContainer.SwitchEnum<MapIteratorPrototypeBuiltins.MapIteratorPrototype> {
   ...
   protected MapIteratorPrototypeBuiltins() {
      super(JSMap.ITERATOR_PROTOTYPE_NAME, MapIteratorPrototypeBuiltins.MapIteratorPrototype.class);
   }

   protected Object createNode(
      JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, MapIteratorPrototypeBuiltins.MapIteratorPrototype builtinEnum
   ) {
      switch (builtinEnum) {
         case next:
            return MapIteratorPrototypeBuiltinsFactory.MapIteratorNextNodeGen.create(context, builtin, args().withThis().createArgumentNodes(context));
         default:
            return null;
      }
   }
   ...
   public static enum MapIteratorPrototype implements BuiltinEnum<MapIteratorPrototypeBuiltins.MapIteratorPrototype> {
      next(0);
