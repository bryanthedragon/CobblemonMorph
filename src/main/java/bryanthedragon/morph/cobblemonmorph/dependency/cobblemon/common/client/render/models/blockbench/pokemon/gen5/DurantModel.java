...
implements HeadedFrame {
    ...
    public DurantModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "durant");
        this.head = this.getPart("head");
        this.portraitScale = 2.8f;
        this.portraitTranslation = new Vec3(-0.4, -1.6, 0.0);
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ DurantModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "durant", "blink", null, 4, null);
            }
        }, 7, null);
        ...
        modelQuirkArray = SetsKt.plus((Set)set2, (Iterable)enumSet2);
        ...
        this.setStanding(PoseableEntityModel.registerPose$default((PoseableEntityModel)this, "standing", (Set)modelQuirkArray, null, 0, null, null, (StatelessAnimation[])objectArray, null, object, 188, null));
        object = PoseType.Companion.getMOVING_POSES();
        objectArray = new ModelQuirk[]{blink7};
        modelQuirkArray = objectArray;
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "durant", "ground_walk", null, 4, null)};
