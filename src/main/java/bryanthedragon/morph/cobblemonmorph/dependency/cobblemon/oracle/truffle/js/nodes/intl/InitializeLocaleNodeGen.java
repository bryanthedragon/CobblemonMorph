...
public final class InitializeLocaleNodeGen extends InitializeLocaleNode implements Introspection.Provider {
   ...
   public Introspection getIntrospectionData() {
      ...
      data[0] = 0;
      int state_0 = this.state_0_;
      Object[] s = new Object[]{"initializeLocaleUsingString", null, null};
      if ((state_0 & 1) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
      ...
      data[1] = s;
      s = new Object[]{"initializeLocaleUsingLocale", null, null};
      if ((state_0 & 2) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
      ...
      data[2] = s;
      s = new Object[]{"initializeLocaleUsingObject", null, null};
      if ((state_0 & 4) != 0) {
         s[1] = (byte)1;
      ...
      data[3] = s;
      s = new Object[]{"initializeLocaleOther", null, null};
      if ((state_0 & 8) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
