...
extends JSBuiltinsContainer.Lambda {
    ...
    protected PerformanceBuiltins() {
        ...
        this.defineFunction(Strings.NOW, 0, JSAttributes.getDefault(), (context, builtin) -> PerformanceBuiltinsFactory.JSPerformanceNowNodeGen.create(context, builtin, PerformanceBuiltins.args().fixedArgs(0).createArgumentNodes(context)));
    }
