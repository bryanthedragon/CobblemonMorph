    ...
    extends LibraryExport<InteropLibrary> {
        ...
        implements LibraryExport.DelegateExport {
            ...
            public boolean accepts(Object receiver) {
                ...
                return this.receiverFunctionInteropLibrary_.accepts(((InteropBoundFunction)receiver).function);
            }
            ...
            private Object executeNode_AndSpecialize(InteropBoundFunction arg0Value, Object[] arg1Value) throws UnsupportedMessageException {
                ...
                try {
                    ...
                    lock.unlock();
                    hasLock = false;
                    Object object = arg0Value.execute(arg1Value, executeNode__execute_self__, this.executeNode__execute_callNode_, this.executeNode__execute_exportNode_);
                    return object;
                }
                finally {
                    if (hasLock) {
