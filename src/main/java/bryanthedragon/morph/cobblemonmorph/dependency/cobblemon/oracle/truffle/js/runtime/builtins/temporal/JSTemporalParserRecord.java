...
public final class JSTemporalParserRecord {
   ...
   public JSTemporalParserRecord(
      ...
      long minute,
      long second,
      TruffleString fraction,
      TruffleString offsetSign,
      long offsetHour,
      long offsetMinute,
      long offsetSecond,
      TruffleString offsetFraction,
      TruffleString timeZoneIANAName,
      TruffleString timeZoneEtcName,
      TruffleString timeZoneUTCOffsetName,
   ...
   public TruffleString getTimeZoneANYName() {
      if (this.timeZoneIANAName != null) {
         return this.timeZoneIANAName;
      } else if (this.timeZoneUTCOffsetName != null) {
         return this.timeZoneUTCOffsetName;
      } else {
         return this.timeZoneEtcName != null ? this.timeZoneEtcName : null;
      }
   }
