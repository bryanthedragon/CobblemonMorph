...
public class MudkipModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = MudkipModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setFloat(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "mudkip", "water_swim", null, 4, null)
            },
            null,
            new ModelQuirk[]{blink},
            188,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: MudkipModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
