...
implements Serializable {
    ...
    public Collection<MatchInfo> find(CharSequence text, int start2, EnumSet<NameType> types) {
    ...
    extends TimeZoneNames {
        ...
        @Override
        public Collection<MatchInfo> find(CharSequence text, int start2, EnumSet<NameType> nameTypes) {
