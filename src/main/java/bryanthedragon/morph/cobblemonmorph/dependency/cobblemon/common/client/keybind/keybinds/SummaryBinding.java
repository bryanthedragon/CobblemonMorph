...
@Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0004J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016\u00a2\u0006\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0006"}, d2={"Lcom/cobblemon/mod/common/client/keybind/keybinds/SummaryBinding;", "Lcom/cobblemon/mod/common/client/keybind/CobblemonPartyLockedKeyBinding;", "", "onPress", "()V", "<init>", "common"})
public final class SummaryBinding
extends CobblemonPartyLockedKeyBinding {
    @NotNull
    public static final SummaryBinding INSTANCE = new SummaryBinding();

    private SummaryBinding() {
        super("key.cobblemon.summary", InputConstants.Type.KEYSYM, 77, "key.cobblemon.categories.cobblemon");
    }
    ...
    public void onPress() {
        if (CobblemonClient.INSTANCE.getStorage().getSelectedSlot() >= 0) {
            try {
                ...
                Cobblemon.INSTANCE.getLOGGER().debug("Failed to open the summary from the Summary keybind", (Throwable)e);
            }
        }
    }
}
