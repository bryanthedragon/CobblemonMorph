...
public final class ChangeTradeAcceptanceHandler : ServerNetworkPacketHandler<ChangeTradeAcceptancePacket> {
    override fun handle(packet: ChangeTradeAcceptancePacket, server: MinecraftServer, ServerPlayer player) {
