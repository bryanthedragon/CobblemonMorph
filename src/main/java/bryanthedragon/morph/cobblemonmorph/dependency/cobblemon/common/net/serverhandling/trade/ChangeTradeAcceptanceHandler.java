...
@Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u00c6\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u000b\u0010\fJ'\u0010\t\u001a\u00020\b2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0016\u00a2\u0006\u0004\b\t\u0010\n\u00a8\u0006\r"}, d2={"Lcom/cobblemon/mod/common/net/serverhandling/trade/ChangeTradeAcceptanceHandler;", "Lcom/cobblemon/mod/common/api/net/ServerNetworkPacketHandler;", "Lcom/cobblemon/mod/common/net/messages/server/trade/ChangeTradeAcceptancePacket;", "packet", "Lnet/minecraft/server/MinecraftServer;", "server", "Lnet/minecraft/server/level/ServerPlayer;", "player", "", "handle", "(Lcom/cobblemon/mod/common/net/messages/server/trade/ChangeTradeAcceptancePacket;Lnet/minecraft/server/MinecraftServer;Lnet/minecraft/server/level/ServerPlayer;)V", "<init>", "()V", "common"})
public final class ChangeTradeAcceptanceHandler
implements ServerNetworkPacketHandler<ChangeTradeAcceptancePacket> {
    @NotNull
    public static final ChangeTradeAcceptanceHandler INSTANCE = new ChangeTradeAcceptanceHandler();

    private ChangeTradeAcceptanceHandler() {
    }

    @Override
    public void handle(@NotNull ChangeTradeAcceptancePacket packet, @NotNull MinecraftServer server, @NotNull ServerPlayer player) {
        ...
        Pokemon pokemon = trade2.getOpposingOffer(tradeParticipant).getPokemon();
        if (Intrinsics.areEqual((Object)(pokemon != null ? pokemon.getUuid() : null), (Object)packet.getPokemonOfferId())) {
            trade2.updateAcceptance(tradeParticipant, packet.getNewAcceptance());
        }
    }

    @Override
    public void handleOnNettyThread(@NotNull ChangeTradeAcceptancePacket packet, @NotNull MinecraftServer server, @NotNull ServerPlayer player) {
