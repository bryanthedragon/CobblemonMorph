...
implements NetworkPacket<PlayPoseableAnimationPacket> {
    ...
    public void encode(@NotNull FriendlyByteBuf buffer) {
        ...
        buffer.m_236828_((Collection)this.animation, PlayPoseableAnimationPacket::encode$lambda$0);
        buffer.m_236828_((Collection)this.expressions, PlayPoseableAnimationPacket::encode$lambda$1);
    }
    ...
    private static final void encode$lambda$1(FriendlyByteBuf pb, String value2) {
        pb.m_130070_(value2);
    }
    ...
    public static final class Companion {
        ...
        @NotNull
        public final PlayPoseableAnimationPacket decode(@NotNull FriendlyByteBuf buffer) {
            Intrinsics.checkNotNullParameter((Object)buffer, (String)"buffer");
            ...
            List list2 = buffer.m_236845_(arg_0 -> Companion.decode$lambda$1(buffer, arg_0));
            Intrinsics.checkNotNullExpressionValue((Object)list2, (String)"buffer.readList { buffer.readString() }");
            return new PlayPoseableAnimationPacket(n, set2, CollectionsKt.toSet((Iterable)list2));
        }
