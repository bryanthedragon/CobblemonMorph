...
public class OrdinaryCreateFromConstructorNode
extends JavaScriptNode {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return new OrdinaryCreateFromConstructorNode(OrdinaryCreateFromConstructorNode.cloneUninitialized(this.getPrototypeFromConstructorNode, materializedTags), (CreateObjectNode.CreateObjectWithPrototypeNode)this.createObjectNode.copyUninitialized((Set)materializedTags));
    }
}
