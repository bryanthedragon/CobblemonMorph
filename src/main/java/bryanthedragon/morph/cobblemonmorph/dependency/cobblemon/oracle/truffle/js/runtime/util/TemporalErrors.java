...
public final class TemporalErrors {
    ...
    @CompilerDirectives.TruffleBoundary
    public static JSException createRangeErrorOptionsNotContained(List<?> values, Object value2) {
        return Errors.createRangeError(String.format("Given options value: %s is not contained in values: %s", value2, values));
    }
