...
public abstract class InputStartsWithNode extends Node {
   ...
   public boolean doTString(
      TruffleString input, TruffleString prefix, Object mask, Encodings.Encoding encoding, @Cached TruffleString.RegionEqualByteIndexNode regionEqualsNode
   ) {
   ...
   public boolean doTruffleObjBytes(
      Object input, byte[] prefix, Object mask, Encodings.Encoding encoding, @Cached InputLengthNode lengthNode, @Cached InputReadNode charAtNode
   ) {
   ...
   public boolean doTruffleObjBytesMask(
      Object input, byte[] prefix, byte[] mask, Encodings.Encoding encoding, @Cached InputLengthNode lengthNode, @Cached InputReadNode charAtNode
   ) {
   ...
   public boolean doTruffleObjString(
      Object input, String prefix, Object mask, Encodings.Encoding encoding, @Cached InputLengthNode lengthNode, @Cached InputReadNode charAtNode
   ) {
      return startsWithTruffleObj(input, prefix, null, encoding, lengthNode, charAtNode);
   }
   ...
   public boolean doTruffleObjStringMask(
      Object input, String prefix, String mask, Encodings.Encoding encoding, @Cached InputLengthNode lengthNode, @Cached InputReadNode charAtNode
   ) {
      assert mask.length() == prefix.length();
   ...
   private static boolean startsWithTruffleObj(
      Object input, byte[] prefix, byte[] mask, Encodings.Encoding encoding, InputLengthNode lengthNode, InputReadNode charAtNode
   ) {
   ...
   private static boolean startsWithTruffleObj(
      Object input, String prefix, String mask, Encodings.Encoding encoding, InputLengthNode lengthNode, InputReadNode charAtNode
   ) {
      if (lengthNode.execute(input, encoding) < prefix.length()) {
         return false;
      } else {
