...
import com.oracle.truffle.js.builtins.math.AtanhNode;
...
@GeneratedBy(value=AtanhNode.class)
public final class AtanhNodeGen
extends AtanhNode
implements Introspection.Provider {
    ...
    private AtanhNodeGen(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
    ...
    private Object execute_double0(int state_0, VirtualFrame frameValue) {
        ...
        assert ((state_0 & 1) != 0);
        return AtanhNode.atanh(arguments0Value_);
    }
    ...
    private Object execute_generic1(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 1) != 0 && JSTypesGen.isImplicitDouble((state_0 & 0x3C) >>> 2, arguments0Value_)) {
            ...
            return AtanhNode.atanh(arguments0Value__);
        }
        if ((state_0 & 2) != 0) {
            return this.atanh(arguments0Value_);
        }
        CompilerDirectives.transferToInterpreterAndInvalidate();
    ...
    private double executeAndSpecialize(Object arguments0Value) {
        ...
        return this.atanh(arguments0Value);
    }
    ...
    public static AtanhNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
        return new AtanhNodeGen(context, builtin, arguments);
    }
}
