...
QuadrupedFrame {
    ...
    public ArcanineModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "arcanine");
        this.head = this.getPart("head");
        this.foreLeftLeg = this.getPart("left_shoulder");
        this.foreRightLeg = this.getPart("right_shoulder");
        this.hindLeftLeg = this.getPart("left_thigh");
        this.hindRightLeg = this.getPart("right_thigh");
        this.portraitScale = 1.37f;
        this.portraitTranslation = new Vec3(-0.58, 1.21, 0.0);
        this.profileScale = 0.58f;
        this.profileTranslation = new Vec3(0.14, 0.92, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> ArcanineModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ ArcanineModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "arcanine", "blink", null, 4, null);
            }
        }, 7, null);
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "arcanine", "idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "arcanine", "idle", null, 4, null), new QuadrupedWalkAnimation(this, 0.0f, 0.0f, 6, null)};
        objectArray = statelessAnimationArray;
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(ArcanineModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "arcanine", "cry", null, 4, null);
    }
}
