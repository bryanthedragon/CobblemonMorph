...
public final class Context implements AutoCloseable {
   ...
   public static Context getCurrent() {
      ...
      return context.currentAPI == null ? context : context.currentAPI;
   }
   ...
   public final class Builder {
      ...
      public Context.Builder allowIO(final boolean enabled) {
         this.allowIO = enabled;
         return this;
      }

      public Context.Builder fileSystem(final FileSystem fileSystem) {
         Objects.requireNonNull(fileSystem, "FileSystem must be non null.");
         this.customFileSystem = fileSystem;
         return this;
      }

      public Context.Builder serverTransport(final MessageTransport serverTransport) {
         Objects.requireNonNull(serverTransport, "MessageTransport must be non null.");
         this.messageTransport = serverTransport;
         return this;
      }

      public Context.Builder logHandler(final Handler logHandler) {
         Objects.requireNonNull(logHandler, "Handler must be non null.");
         this.customLogHandler = logHandler;
         return this;
      }

      public Context.Builder timeZone(final ZoneId zone) {
         this.zone = zone;
         return this;
      }

      public Context.Builder logHandler(final OutputStream logOut) {
      ...
      public Context build() {
         ...
         if (this.allowHostAccess != null && this.hostAccess != null) {
            ...
            if (this.allowHostAccess != null && this.allowHostAccess) {
               if (localHostLookupFilter == Context.UNSET_HOST_LOOKUP) {
                  localHostLookupFilter = Context.ALL_HOST_CLASSES;
               }
            ...
            if (localHostLookupFilter == null) {
               localHostLookupFilter = Context.NO_HOST_CLASSES;
            }
            ...
            if (this.resourceLimits != null) {
               limits = this.resourceLimits.receiver;
            } else {
               limits = null;
            }
            ...
            if (!io && this.customFileSystem != null) {
               ...
               if (engine == null) {
                  Engine.Builder engineBuilder = Engine.newBuilder(this.permittedLanguages)
                     .options(this.options == null ? Collections.emptyMap() : this.options);
               ...
               return engine.dispatch
                  .createContext(
                     ...
                     contextOptions,
                     this.arguments == null ? Collections.emptyMap() : this.arguments,
