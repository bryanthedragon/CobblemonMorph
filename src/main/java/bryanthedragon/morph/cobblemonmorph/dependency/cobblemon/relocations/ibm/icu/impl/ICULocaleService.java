...
extends ICUService {
    ...
    extends LocaleKeyFactory {
        ...
        public ICUResourceBundleFactory() {
            this("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b");
        }
        ...
        @Override
        protected Object handleCreate(ULocale loc, int kind, ICUService service2) {
    ...
    extends LocaleKeyFactory {
        ...
        @Override
        public Object create(ICUService.Key key, ICUService service2) {
    ...
    implements ICUService.Factory {
        ...
        public Object create(ICUService.Key key, ICUService service2) {
            if (this.handlesKey(key)) {
                ...
                return this.handleCreate(uloc, kind, service2);
            }
            return null;
        }
