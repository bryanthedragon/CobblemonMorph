...
@GeneratedBy(value=PolyglotList.class)
final class PolyglotListFactory {
    ...
    @GeneratedBy(value=PolyglotList.Cache.class)
    static final class CacheFactory {
        CacheFactory() {
        }

        @GeneratedBy(value=PolyglotList.Cache.RemoveNode.class)
        static final class RemoveNodeGen
        extends PolyglotList.Cache.RemoveNode {
        ...
        @GeneratedBy(value=PolyglotList.Cache.SetNode.class)
        static final class SetNodeGen
        extends PolyglotList.Cache.SetNode {
            @CompilerDirectives.CompilationFinal
            private volatile int state_0_;
            @CompilerDirectives.CompilationFinal
            private volatile int exclude_;
        ...
        @GeneratedBy(value=PolyglotList.Cache.AddAtIndexNode.class)
        static final class AddAtIndexNodeGen
        extends PolyglotList.Cache.AddAtIndexNode {
            @CompilerDirectives.CompilationFinal
            private volatile int state_0_;
            @CompilerDirectives.CompilationFinal
            private volatile int exclude_;
            ...
            public static PolyglotList.Cache.AddAtIndexNode create(PolyglotList.Cache cache) {
                return new AddAtIndexNodeGen(cache);
            }
        ...
        @GeneratedBy(value=PolyglotList.Cache.AddNode.class)
        static final class AddNodeGen
        extends PolyglotList.Cache.AddNode {
            @CompilerDirectives.CompilationFinal
            private volatile int state_0_;
            @CompilerDirectives.CompilationFinal
            private volatile int exclude_;
        ...
        @GeneratedBy(value=PolyglotList.Cache.GetNode.class)
        static final class GetNodeGen
        extends PolyglotList.Cache.GetNode {
            @CompilerDirectives.CompilationFinal
            private volatile int state_0_;
            @CompilerDirectives.CompilationFinal
            private volatile int exclude_;
        ...
        @GeneratedBy(value=PolyglotList.Cache.SizeNode.class)
        static final class SizeNodeGen
        extends PolyglotList.Cache.SizeNode {
            @CompilerDirectives.CompilationFinal
            private volatile int state_0_;
            @CompilerDirectives.CompilationFinal
            private volatile int exclude_;
            ...
            private Object cached1Boundary(int state_0, PolyglotLanguageContext arg0Value, Object arg1Value, Object[] arg2Value) {
                ...
                try {
                    InteropLibrary cached1_interop__ = INTEROP_LIBRARY_.getUncached(arg1Value);
                    Object object = this.doCached(arg0Value, arg1Value, arg2Value, cached1_interop__);
                    return object;
                }
                finally {
                    encapsulating_.set(prev_);
                ...
                try {
                    ...
                    if (exclude == 0) {
                        ...
                        if (s0_ != null) {
                            lock.unlock();
                            hasLock = false;
                            Object object2 = this.doCached(arg0Value, arg1Value, arg2Value, s0_.interop_);
                            return object2;
                        }
                    }
                    InteropLibrary cached1_interop__ = null;
                    ...
                    try {
                        ...
                        lock.unlock();
                        hasLock = false;
                        object = this.doCached(arg0Value, arg1Value, arg2Value, cached1_interop__);
                        encapsulating_.set(prev_);
                    }
                    catch (Throwable throwable) {
                        encapsulating_.set(prev_);
