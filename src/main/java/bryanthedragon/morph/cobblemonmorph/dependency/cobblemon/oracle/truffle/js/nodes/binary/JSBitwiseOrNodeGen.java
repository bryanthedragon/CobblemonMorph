...
@GeneratedBy(value=JSBitwiseOrNode.class)
public final class JSBitwiseOrNodeGen
extends JSBitwiseOrNode
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if (!this.hasOverloadedOperators(leftNodeValue) && !this.hasOverloadedOperators(rightNodeValue)) {
                ...
                lock.unlock();
                hasLock = false;
                Object object = this.doGeneric(leftNodeValue, rightNodeValue, s7_.leftNumeric_, s7_.rightNumeric_, s7_.or_, s7_.mixedNumericTypes_);
                return object;
            }
