...
public class DiscardResultNode extends JSUnaryNode {
   ...
   public static JavaScriptNode create(JavaScriptNode operand) {
      if (operand.isResultAlwaysOfType(Undefined.class)) {
         ...
         return (JavaScriptNode)(operand instanceof JSConstantNode ? EmptyNode.create() : new DiscardResultNode(operand));
      }
   }
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return new DiscardResultNode(cloneUninitialized(this.getOperand(), materializedTags));
   }
