...
QuadrupedFrame {
    ...
    public SawsbuckModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "sawsbuck");
        this.head = this.getPart("head");
        this.portraitScale = 2.0f;
        this.portraitTranslation = new Vec3(-0.5, 1.1, 0.0);
    ...
    public void registerPoses() {
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), new QuadrupedWalkAnimation(this, 0.9f, 0.9f)};
