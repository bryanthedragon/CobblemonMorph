...
implements ParticleEmitterLifetime {
    ...
    public OnceEmitterLifetime(@NotNull Expression activeTime) {
        Intrinsics.checkNotNullParameter((Object)activeTime, (String)"activeTime");
        this.activeTime = activeTime;
        this.type = ParticleEmitterLifetimeType.ONCE;
    }

    public /* synthetic */ OnceEmitterLifetime(Expression expression, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 1) != 0) {
    ...
    public ParticleEmitterAction getAction(@NotNull MoLangRuntime runtime2, boolean started, double emitterAge) {
        ...
        return emitterAge > activeTime.asDouble() ? ParticleEmitterAction.STOP : ParticleEmitterAction.GO;
    }
    ...
    private static final String CODEC$lambda$3$lambda$0(OnceEmitterLifetime it) {
        return it.getType().name();
    }

    private static final Expression CODEC$lambda$3$lambda$1(OnceEmitterLifetime it) {
        return it.activeTime;
    }

    private static final OnceEmitterLifetime CODEC$lambda$3$lambda$2(String string, Expression activeTime) {
    ...
    private static final App CODEC$lambda$3(RecordCodecBuilder.Instance instance) {
        return instance.group((App)PrimitiveCodec.STRING.fieldOf("type").forGetter(OnceEmitterLifetime::CODEC$lambda$3$lambda$0), (App)ExpressionCodecKt.getEXPRESSION_CODEC().fieldOf("activeTime").forGetter(OnceEmitterLifetime::CODEC$lambda$3$lambda$1)).apply((Applicative)instance, OnceEmitterLifetime::CODEC$lambda$3$lambda$2);
    }
    ...
    static {
        Codec codec2 = RecordCodecBuilder.create(OnceEmitterLifetime::CODEC$lambda$3);
        Intrinsics.checkNotNullExpressionValue((Object)codec2, (String)"create { instance ->\n   \u2026e(activeTime) }\n        }");
        CODEC = codec2;
    }

    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\b\u0010\tR\u001d\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u00028\u0006\u00a2\u0006\f\n\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007\u00a8\u0006\n"}, d2={"Lcom/cobblemon/mod/common/api/snowstorm/OnceEmitterLifetime$Companion;", "", "Lcom/mojang/serialization/Codec;", "Lcom/cobblemon/mod/common/api/snowstorm/OnceEmitterLifetime;", "CODEC", "Lcom/mojang/serialization/Codec;", "getCODEC", "()Lcom/mojang/serialization/Codec;", "<init>", "()V", "common"})
