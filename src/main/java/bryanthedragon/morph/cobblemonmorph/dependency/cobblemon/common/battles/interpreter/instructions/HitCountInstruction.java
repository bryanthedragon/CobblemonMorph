...
implements InterpreterInstruction {
    ...
    public void invoke(@NotNull PokemonBattle battle2) {
        ...
        battle2.dispatchGo((Function0<Unit>)((Function0)new Function0<Unit>(this, battle2){
            final /* synthetic */ HitCountInstruction this$0;
            ...
            public final void invoke() {
                ...
                Object object = this.this$0.getMessage().argumentAt(1);
                if (object == null || (object = StringsKt.toIntOrNull((String)object)) == null) {
                    return;
                }
                int hitCount = (Integer)object;
                if (hitCount == 1) {
                    mutableComponent = LocalizationUtilsKt.battleLang("hit_count_singular", new Object[0]);
                } else {
                    Object[] objectArray = new Object[]{hitCount};
                    mutableComponent = LocalizationUtilsKt.battleLang("hit_count", objectArray);
                }
