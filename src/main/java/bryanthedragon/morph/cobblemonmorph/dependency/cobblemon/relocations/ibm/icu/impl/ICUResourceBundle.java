...
public class ICUResourceBundle extends UResourceBundle {
   ...
   private static CacheBase<String, ICUResourceBundle, ICUResourceBundle.Loader> BUNDLE_CACHE = new SoftCache<String, ICUResourceBundle, ICUResourceBundle.Loader>() {
      protected ICUResourceBundle createInstance(String unusedKey, ICUResourceBundle.Loader loader) {
         return loader.load();
      }
   };
   ...
   private static CacheBase<String, ICUResourceBundle.AvailEntry, ClassLoader> GET_AVAILABLE_CACHE = new SoftCache<String, ICUResourceBundle.AvailEntry, ClassLoader>() {
   ...
   public static final ULocale getFunctionalEquivalent(
      String baseName, ClassLoader loader, String resName, String keyword, ULocale locID, boolean[] isAvailable, boolean omitDefault
   ) {
   ...
   public ICUResourceBundle at(String key) {
      return this instanceof ICUResourceBundleImpl.ResourceTable ? (ICUResourceBundle)this.handleGet(key, null, this) : null;
   }
         ...
         public void put(UResource.Key key, UResource.Value value, boolean noFallback) {
            ...
            for (int i = 0; itemsTable.getKeyAndValue(i, key, value); i++) {
               if (value.getType() == 3) {
                  ...
                  ICUResourceBundle aliasedResource = ICUResourceBundle.getAliasedResource(
                     aliasPath, ICUResourceBundle.this.wholeBundle.loader, "", null, 0, null, null, ICUResourceBundle.this
                  );
   ...
   public static Set<String> getFullLocaleNameSet() {
      return getFullLocaleNameSet("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", ICU_DATA_CLASS_LOADER);
   }
   ...
   public static Set<String> getAvailableLocaleNameSet() {
      return getAvailableLocaleNameSet("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", ICU_DATA_CLASS_LOADER);
   }
   ...
   public static final ULocale[] getAvailableULocales() {
      return getAvailableULocales("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", ICU_DATA_CLASS_LOADER, ULocale.AvailableType.DEFAULT);
   }

   public static final ULocale[] getAvailableULocales(ULocale.AvailableType type) {
      return getAvailableULocales("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", ICU_DATA_CLASS_LOADER, type);
   }
   ...
   public static final Locale[] getAvailableLocales() {
      return getAvailableLocales("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", ICU_DATA_CLASS_LOADER, ULocale.AvailableType.DEFAULT);
   }

   public static final Locale[] getAvailableLocales(ULocale.AvailableType type) {
      return getAvailableLocales("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", ICU_DATA_CLASS_LOADER, type);
   }
   ...
   private static final EnumMap<ULocale.AvailableType, ULocale[]> createULocaleList(String baseName, ClassLoader root) {
      ...
      ICUResourceBundle.AvailableLocalesSink sink = new ICUResourceBundle.AvailableLocalesSink(result);
   ...
   private static Set<String> createFullLocaleNameSet(String baseName, ClassLoader loader) {
      ...
      String skipScan = ICUConfig.get("com.cobblemon.mod.relocations.ibm.icu.impl.ICUResourceBundle.skipRuntimeLocaleResourceScan", "false");
      if (!skipScan.equalsIgnoreCase("true")) {
         addBundleBaseNamesFromClassLoader(bn, loader, set);
         if (baseName.startsWith("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b")) {
            String folder;
            if (baseName.length() == "com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b".length()) {
               folder = "";
            } else if (baseName.charAt("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b".length()) == '/') {
               folder = baseName.substring("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b".length() + 1);
            } else {
               folder = null;
            }
   ...
   public static ICUResourceBundle getBundleInstance(String baseName, String localeID, ClassLoader root, ICUResourceBundle.OpenType openType) {
      if (baseName == null) {
         baseName = "com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b";
      }
   ...
   private static ICUResourceBundle instantiateBundle(String baseName, String localeID, String defaultID, ClassLoader root, ICUResourceBundle.OpenType openType) {
      ...
      String cacheKey = openType != ICUResourceBundle.OpenType.LOCALE_DEFAULT_ROOT
         ? fullName + '#' + openTypeChar
         : fullName + '#' + openTypeChar + '#' + defaultID;
      return BUNDLE_CACHE.getInstance(
         cacheKey,
         new ICUResourceBundle.Loader() {
            @Override
            public ICUResourceBundle load() {
               ...
               if (ICUResourceBundle.DEBUG) {
                  System.out
                     .println("The bundle created is: " + b + " and openType=" + openType + " and bundle.getNoFallback=" + (b != null && b.getNoFallback()));
               }
               ...
               if (openType != ICUResourceBundle.OpenType.DIRECT && (b == null || !b.getNoFallback())) {
                  if (b == null) {
                     ...
                     } else if (openType == ICUResourceBundle.OpenType.LOCALE_DEFAULT_ROOT
                        && !ICUResourceBundle.localeIDStartsWithLangSubtag(defaultID, localeName)) {
   ...
   private static ICUResourceBundle getBundle(ICUResourceBundleReader reader, String baseName, String localeID, ClassLoader loader) {
      ...
      if (ICUResourceBundleReader.URES_IS_TABLE(ICUResourceBundleReader.RES_GET_TYPE(rootRes))) {
         ICUResourceBundle.WholeBundle wb = new ICUResourceBundle.WholeBundle(baseName, localeID, loader, reader);
   ...
   protected static ICUResourceBundle getAliasedResource(
      ICUResourceBundle base, String[] keys, int depth, String key, int _resource, HashMap<String, String> aliasesVisited, UResourceBundle requested
   ) {
      ICUResourceBundle.WholeBundle wholeBundle = base.wholeBundle;
      ...
      if (aliasesVisited.get(rpath) != null) {
         ...
         if (rpath.indexOf(47) == 0) {
            ...
            if (bundleName.equals("ICUDATA")) {
               bundleName = "com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b";
               loaderToUse = ICU_DATA_CLASS_LOADER;
            } else if (bundleName.indexOf("ICUDATA") > -1) {
               int idx = bundleName.indexOf(45);
               if (idx > -1) {
                  bundleName = "com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/" + bundleName.substring(idx + 1, bundleName.length());
                  loaderToUse = ICU_DATA_CLASS_LOADER;
               }
            }
         } else {
            int ix = rpath.indexOf(47);
            if (ix != -1) {
               locale = rpath.substring(0, ix);
               keyPath = rpath.substring(ix + 1);
            } else {
               locale = rpath;
            }
         ...
         if (bundleName.equals("LOCALE")) {
            ...
            if (numKeys > 0) {
               ...
               for (int ix = 0; sub != null && ix < numKeys; ix++) {
                  sub = sub.get(keys[ix], aliasesVisited, requested);
               }
            }
         }
   ...
   private static final class AvailEntry {
      ...
      Locale[] getLocaleList(ULocale.AvailableType type) {
         if (this.locales == null) {
            ...
            synchronized (this) {
               if (this.locales == null) {
                  this.locales = ICUResourceBundle.getLocaleList(this.ulocales.get(type));
               }
            }
         }
