...
public final class ErrorFunctionBuiltins extends JSBuiltinsContainer.Lambda {
   ...
   protected ErrorFunctionBuiltins() {
      ...
      this.defineFunction(
         Strings.CAPTURE_STACK_TRACE,
         2,
         JSAttributes.getDefault(),
         (context, builtin) -> ErrorFunctionBuiltinsFactory.ErrorCaptureStackTraceNodeGen.create(
      ...
      protected Object captureStackTrace(VirtualFrame frame, Object object, Object skipUpTo) {
         if (!JSRuntime.isObject(object)) {
            ...
            if (!JSObject.isExtensible(obj)) {
               ...
               JSFunctionObject skipFramesUpTo = customSkip
                  ? (JSFunctionObject)skipUpTo
                  : (JSFunctionObject)JSArguments.getFunctionObject(frame.getArguments());
               UserScriptException ex = UserScriptException.createCapture(
                  obj, this.getContext().isOptionNashornCompatibilityMode() ? this : null, stackTraceLimit, skipFramesUpTo, customSkip
               );
