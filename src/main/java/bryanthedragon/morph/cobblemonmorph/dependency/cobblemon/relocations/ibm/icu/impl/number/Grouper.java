...
public class Grouper {
    ...
    public static Grouper forProperties(DecimalFormatProperties properties2) {
        if (!properties2.getGroupingUsed()) {
            return GROUPER_NEVER;
        }
        short grouping1 = (short)properties2.getGroupingSize();
        short grouping2 = (short)properties2.getSecondaryGroupingSize();
        short minGrouping = (short)properties2.getMinimumGroupingDigits();
    ...
    public boolean groupAtPosition(int position, DecimalQuantity value2) {
        assert (this.grouping1 != -2 && this.grouping1 != -4);
        if (this.grouping1 == -1 || this.grouping1 == 0) {
            return false;
        }
        return (position -= this.grouping1) >= 0 && position % this.grouping2 == 0 && value2.getUpperDisplayMagnitude() - this.grouping1 + 1 >= this.minGrouping;
    }
