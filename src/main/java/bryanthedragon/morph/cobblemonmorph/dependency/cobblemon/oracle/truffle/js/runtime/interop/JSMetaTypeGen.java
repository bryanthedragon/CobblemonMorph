...
final class JSMetaTypeGen {
   ...
   static {
      LibraryExport.register(JSMetaType.class, new JSMetaTypeGen.InteropLibraryExports());
   }
   ...
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         InteropLibrary uncached = new JSMetaTypeGen.InteropLibraryExports.Uncached();
         return uncached;
      }
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return new JSMetaTypeGen.InteropLibraryExports.Cached();
      }
      ...
      private static final class Cached extends InteropLibrary {
         ...
         @Node.Child
         private JSMetaTypeGen.InteropLibraryExports.Cached.CachedData cached_cache;
         ...
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof JSMetaType) || JSMetaTypeGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
         ...
         public boolean isMetaInstance(Object arg0Value_, Object arg1Value) throws UnsupportedMessageException {
            ...
            if (state_0 != 0) {
               if ((state_0 & 1) != 0) {
                  for (JSMetaTypeGen.InteropLibraryExports.Cached.CachedData s0_ = this.cached_cache; s0_ != null; s0_ = s0_.next_) {
         ...
         private boolean executeAndSpecialize(JSMetaType arg0Value, Object arg1Value) {
            ...
            try {
               ...
               if (exclude == 0) {
                  int count0_ = 0;
                  JSMetaTypeGen.InteropLibraryExports.Cached.CachedData s0_ = this.cached_cache;
                  if ((state_0 & 1) != 0) {
                  ...
                  if (s0_ == null && count0_ < 3) {
                     s0_ = super.insert(new JSMetaTypeGen.InteropLibraryExports.Cached.CachedData(this.cached_cache));
                     s0_.cachedType_ = arg0Value;
                     s0_.valueLib_ = s0_.insertAccessor(JSMetaTypeGen.INTEROP_LIBRARY_.create(arg1Value));
         ...
         private static final class CachedData extends Node {
            @Node.Child
            JSMetaTypeGen.InteropLibraryExports.Cached.CachedData next_;
            @CompilerDirectives.CompilationFinal
            JSMetaType cachedType_;
            @Node.Child
            InteropLibrary valueLib_;

            CachedData(JSMetaTypeGen.InteropLibraryExports.Cached.CachedData next_) {
               this.next_ = next_;
            }
