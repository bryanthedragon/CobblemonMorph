        ...
        if (player != null && blockState.block is CampfireBlock && blockEntity is CampfireBlockEntity) {
            if (blockState.getValue(CampfireBlock.LIT)) {
                ...
                val newBlockState = (if (isSoul) CobblemonBlocks.SOUL_CAMPFIRE else CobblemonBlocks.CAMPFIRE).defaultBlockState()
                    ...
                    .setValue(bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.block.campfirepot.CampfireBlock.Companion.ITEM_DIRECTION, itemFacing.opposite)
                ...
                if (newBlockEntity is bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.block.entity.CampfireBlockEntity) {
