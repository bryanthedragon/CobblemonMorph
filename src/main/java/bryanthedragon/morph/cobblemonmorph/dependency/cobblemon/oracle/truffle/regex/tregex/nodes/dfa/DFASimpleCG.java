...
public final class DFASimpleCG
implements JsonConvertible {
    ...
    public static DFASimpleCG create(DFASimpleCGTransition[] transitions, DFASimpleCGTransition transitionToFinalState, DFASimpleCGTransition transitionToAnchoredFinalState) {
        if (DFASimpleCG.allEmpty(transitions) && transitionToFinalState == DFASimpleCGTransition.getEmptyInstance() && transitionToAnchoredFinalState == DFASimpleCGTransition.getEmptyInstance()) {
            return null;
        }
    ...
    private static boolean allEmpty(DFASimpleCGTransition[] transitions) {
        for (DFASimpleCGTransition t : transitions) {
            if (t == DFASimpleCGTransition.getEmptyInstance()) continue;
            return false;
        }
        return true;
    }
