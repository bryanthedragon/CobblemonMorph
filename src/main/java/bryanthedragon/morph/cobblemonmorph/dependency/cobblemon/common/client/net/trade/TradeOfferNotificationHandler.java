...
implements ClientNetworkPacketHandler<TradeOfferNotificationPacket> {
    ...
    @Override
    public void handle(@NotNull TradeOfferNotificationPacket packet, @NotNull Minecraft client) {
        block0: {
            ...
            objectArray[0] = packet.getTraderName();
            ...
            localPlayer.m_5661_((Component)LocalizationUtilsKt.lang("trade.offer", objectArray), true);
        }
    }

    @Override
    public void handleOnNettyThread(@NotNull TradeOfferNotificationPacket packet) {
