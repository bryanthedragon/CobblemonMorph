...
extends BackwardDFAStateNode {
    ...
    public TraceFinderDFAStateNode(short id, byte flags, short loopTransitionIndex, DFAStateNode.IndexOfCall indexOfCall, short[] successors, Matchers matchers, byte preCalculatedUnAnchoredResult, byte preCalculatedAnchoredResult) {
        ...
        this.preCalculatedAnchoredResult = TraceFinderDFAStateNode.initPreCalculatedAnchoredResult(preCalculatedUnAnchoredResult, preCalculatedAnchoredResult);
    }
