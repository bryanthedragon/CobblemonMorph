...
implements ParticleMotionDirection {
    ...
    public Vec3 getDirectionVector(@NotNull MoLangRuntime runtime2, @NotNull ParticleStorm storm2, @NotNull Vec3 emitterPos, @NotNull Vec3 particlePos) {
        ...
        Vec3 vec3 = (Intrinsics.areEqual((Object)particlePos, (Object)emitterPos) ? new Vec3(storm2.getWorld().f_46441_.m_188500_() - 0.5, storm2.getWorld().f_46441_.m_188500_() - 0.5, storm2.getWorld().f_46441_.m_188500_() - 0.5) : particlePos.m_82546_(emitterPos)).m_82541_();
    ...
    private static final String CODEC$lambda$2$lambda$0(OutwardsMotionDirection it) {
        return it.getType().name();
    }

    private static final OutwardsMotionDirection CODEC$lambda$2$lambda$1(String it) {
        return new OutwardsMotionDirection();
    }

    private static final App CODEC$lambda$2(RecordCodecBuilder.Instance instance) {
        return instance.group((App)PrimitiveCodec.STRING.fieldOf("type").forGetter(OutwardsMotionDirection::CODEC$lambda$2$lambda$0)).apply((Applicative)instance, OutwardsMotionDirection::CODEC$lambda$2$lambda$1);
    }

    static {
        Codec codec2 = RecordCodecBuilder.create(OutwardsMotionDirection::CODEC$lambda$2);
        Intrinsics.checkNotNullExpressionValue((Object)codec2, (String)"create { instance ->\n   \u2026onDirection() }\n        }");
        CODEC = codec2;
    }

    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\b\u0010\tR\u001d\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u00028\u0006\u00a2\u0006\f\n\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007\u00a8\u0006\n"}, d2={"Lcom/cobblemon/mod/common/api/snowstorm/OutwardsMotionDirection$Companion;", "", "Lcom/mojang/serialization/Codec;", "Lcom/cobblemon/mod/common/api/snowstorm/OutwardsMotionDirection;", "CODEC", "Lcom/mojang/serialization/Codec;", "getCODEC", "()Lcom/mojang/serialization/Codec;", "<init>", "()V", "common"})
    public static final class Companion {
        private Companion() {
        }

        @NotNull
        public final Codec<OutwardsMotionDirection> getCODEC() {
            return CODEC;
        }
