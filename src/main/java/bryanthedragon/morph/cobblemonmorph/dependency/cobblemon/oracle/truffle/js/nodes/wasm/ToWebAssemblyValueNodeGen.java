...
public final class ToWebAssemblyValueNodeGen extends ToWebAssemblyValueNode implements Introspection.Provider {
   ...
   @GeneratedBy(ToWebAssemblyValueNode.Uncached.class)
   static final class UncachedNodeGen extends ToWebAssemblyValueNode.Uncached implements Introspection.Provider {
      ...
      public static ToWebAssemblyValueNode.Uncached create() {
         return new ToWebAssemblyValueNodeGen.UncachedNodeGen();
      }
   }
}
