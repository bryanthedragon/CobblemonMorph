...
public abstract class OrdinaryToPrimitiveNode extends JavaScriptBaseNode {
   ...
   protected Object doForeign(Object object, @CachedLibrary("object") InteropLibrary interop) {
      if (this.hint == JSToPrimitiveNode.Hint.String) {
   ...
   private Object doHintString(JSObject object) {
      ...
      if (this.toStringFunctionProfile.profile(this.isCallableNode.executeBoolean(toString))) {
         Object result = this.callToStringNode.executeCall(JSArguments.createZeroArg(object, toString));
      ...
      if (this.valueOfFunctionProfile.profile(this.isCallableNode.executeBoolean(valueOf))) {
         Object result = this.callValueOfNode.executeCall(JSArguments.createZeroArg(object, valueOf));
         if (this.isPrimitiveNode.executeBoolean(result)) {
            return result;
         }
      }
   ...
   private Object doForeignHintString(Object object, InteropLibrary interop) {
      ...
      if (result != null) {
         ...
         if (this.toStringFunctionProfile.profile(this.isCallableNode.executeBoolean(func))) {
            result = this.callToStringNode.executeCall(JSArguments.createZeroArg(object, func));
            if (this.isPrimitiveNode.executeBoolean(result)) {
               return result;
            }
         }
         ...
         if (result != null) {
            ...
            if (this.valueOfFunctionProfile.profile(this.isCallableNode.executeBoolean(func))) {
               result = this.callValueOfNode.executeCall(JSArguments.createZeroArg(object, func));
               if (this.isPrimitiveNode.executeBoolean(result)) {
                  return result;
               }
            }
