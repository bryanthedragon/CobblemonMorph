...
extends JavaScriptNode {
    ...
    @Override
    public abstract JSDynamicObject execute(VirtualFrame var1);
    ...
    protected JSDynamicObject doEnumerateObject(JSDynamicObject iteratedObject, @Cached(value="createBinaryProfile()") ConditionProfile isObject) {
    ...
    protected JSDynamicObject doEnumerateJSAdapter(JSDynamicObject iteratedObject, @Cached(value="createValues()") EnumerateNode enumerateCallbackResultNode) {
        Object returnValue;
    ...
    protected JSDynamicObject doEnumerateTruffleObject(Object iteratedObject, @CachedLibrary(value="iteratedObject") InteropLibrary interop, @CachedLibrary(limit="InteropLibraryLimit") InteropLibrary keysInterop, @Cached BranchProfile notIterable) {
        try {
    ...
    private JSDynamicObject newForInIterator(JSDynamicObject obj) {
        ...
        JSObject iteratorObj = JSOrdinary.create(this.context, this.context.getForInIteratorFactory(), this.getRealm());
    ...
    protected JSDynamicObject doNonObject(Object iteratedObject, @Cached(value="createToObjectNoCheck(context)") JSToObjectNode toObjectNode, @Cached(value="copyRecursive()") EnumerateNode enumerateNode) {
