...
BimanualFrame {
    ...
    public ExploudModel(@NotNull ModelPart root) {
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "exploud", "idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "exploud", "idle", null, 4, null), new BipedWalkAnimation(this, 0.6f, 0.9f), new BimanualSwingAnimation(this, 0.6f, 0.9f)};
