...
public final class CollationTailoring {
   ...
   static VersionInfo makeBaseVersion(VersionInfo ucaVersion) {
      return VersionInfo.getInstance(
         VersionInfo.UCOL_BUILDER_VERSION.getMajor(), (ucaVersion.getMajor() << 3) + ucaVersion.getMinor(), ucaVersion.getMilli() << 6, 0
      );
   }
   ...
   void setVersion(int baseVersion, int rulesVersion) {
      ...
      this.version = VersionInfo.UCOL_BUILDER_VERSION.getMajor() << 24
         | baseVersion & 16760832
         | r + (r >> 6) & 16128
