...
public final class JSUnsignedRightShiftConstantNodeGen extends JSUnsignedRightShiftConstantNode implements Introspection.Provider {
   ...
   public Object execute(VirtualFrame frameValue, Object operandNodeValue) {
      ...
      } else if ((state_0 & 8) != 0 && operandNodeValue instanceof BigInt) {
      ...
      } else if ((state_0 & 32) != 0 && !this.hasOverloadedOperators(operandNodeValue) && !JSUnsignedRightShiftConstantNode.isHandled(operandNodeValue)) {
   ...
   public Object execute(VirtualFrame frameValue) {
      ...
      if ((state_0 & 62) == 0 && (state_0 & 63) != 0) {
         ...
         return (state_0 & 59) == 0 && (state_0 & 63) != 0 ? this.execute_double1(state_0, frameValue) : this.execute_generic2(state_0, frameValue);
      }
   }
   ...
   private Object execute_generic2(int state_0, VirtualFrame frameValue) {
      ...
      } else if ((state_0 & 8) != 0 && operandNodeValue_ instanceof BigInt) {
      ...
      } else if ((state_0 & 32) != 0 && !this.hasOverloadedOperators(operandNodeValue_) && !JSUnsignedRightShiftConstantNode.isHandled(operandNodeValue_)) {
   ...
   public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
      ...
      } else if ((state_0 & 46) == 0 && (state_0 & 47) != 0) {
         return this.executeInt_int3(state_0, frameValue);
      } else {
         return (state_0 & 43) == 0 && (state_0 & 47) != 0 ? this.executeInt_double4(state_0, frameValue) : this.executeInt_generic5(state_0, frameValue);
      }
   }
   ...
   private Object executeAndSpecialize(Object operandNodeValue) {
      ...
      try {
         ...
         if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(operandNodeValue)) != 0) {
            ...
            lock.unlock();
            hasLock = false;
            return this.doDouble(operandNodeValue_x, this.double_toUInt32Node_);
         }
         ...
         if (!(operandNodeValue instanceof JSOverloadedOperatorsObject)) {
            if (this.hasOverloadedOperators(operandNodeValue) || JSUnsignedRightShiftConstantNode.isHandled(operandNodeValue)) {
            ...
            this.generic_innerShiftNode_ = super.insert(this.createInner());
            int var13;
         ...
         lock.unlock();
         hasLock = false;
         operandNodeValue_ = this.doOverloaded(operandNodeValue_x, this.overloaded_overloadedOperatorNode_);
      } finally {
         if (hasLock) {
            lock.unlock();
         }
