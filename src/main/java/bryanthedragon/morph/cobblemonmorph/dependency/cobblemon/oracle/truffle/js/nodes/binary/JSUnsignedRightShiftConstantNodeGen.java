...
implements Introspection.Provider {
    ...
    public Object execute(VirtualFrame frameValue, Object operandNodeValue) {
        ...
        if ((state_0 & 8) != 0 && operandNodeValue instanceof BigInt) {
        ...
        if ((state_0 & 0x20) != 0 && !this.hasOverloadedOperators(operandNodeValue) && !JSUnsignedRightShiftConstantNode.isHandled(operandNodeValue)) {
    ...
    private Object execute_generic2(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0x20) != 0 && !this.hasOverloadedOperators(operandNodeValue_) && !JSUnsignedRightShiftConstantNode.isHandled(operandNodeValue_)) {
    ...
    public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
        ...
        if ((state_0 & 0x2E) == 0 && (state_0 & 0x2F) != 0) {
            return this.executeInt_int3(state_0, frameValue);
        }
        if ((state_0 & 0x2B) == 0 && (state_0 & 0x2F) != 0) {
    ...
    public void executeVoid(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        try {
            if ((state_0 & 0x10) == 0 && (state_0 & 0x3F) != 0) {
    ...
    private Object executeAndSpecialize(Object operandNodeValue) {
        ...
        try {
            ...
            if (doubleCast0 != 0) {
                ...
                lock.unlock();
                hasLock = false;
                Integer n = this.doDouble(operandNodeValue_, this.double_toUInt32Node_);
                return n;
            }
            if (operandNodeValue instanceof BigInt) {
                ...
                lock.unlock();
                hasLock = false;
                Integer n = this.doBigInt(operandNodeValue_);
                return n;
            }
