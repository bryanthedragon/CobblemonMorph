...
public abstract class LocaleDisplayNames {
    ...
    static {
        String implClassName = ICUConfig.get("com.cobblemon.mod.relocations.ibm.icu.text.LocaleDisplayNames.impl", "com.cobblemon.mod.relocations.ibm.icu.impl.LocaleDisplayNamesImpl");
