...
public final class GiveAllPokemon {
    ...
    public final void register(@NotNull CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        LiteralArgumentBuilder literalArgumentBuilder = Commands.m_82127_((String)"giveallpokemon");
        Intrinsics.checkNotNullExpressionValue((Object)literalArgumentBuilder, (String)"literal(\"giveallpokemon\")");
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)PermissionUtilsKt.requiresWithPermission((ArgumentBuilder)literalArgumentBuilder, CobblemonPermissions.INSTANCE.getGIVE_ALL_POKEMON(), (Function1<? super CommandSourceStack, Boolean>)((Function1)register.1.INSTANCE))).then(((RequiredArgumentBuilder)Commands.m_82129_((String)"min", (ArgumentType)((ArgumentType)IntegerArgumentType.integer((int)1))).then(Commands.m_82129_((String)"max", (ArgumentType)((ArgumentType)IntegerArgumentType.integer((int)1))).executes(GiveAllPokemon::register$lambda$0))).executes(GiveAllPokemon::register$lambda$1))).executes(GiveAllPokemon::register$lambda$2));
    }
    ...
    private final int execute(CommandContext<CommandSourceStack> context, IntRange range) {
        ...
        PCStore pc = pCStore;
        Iterable $this$sortedBy$iv = PokemonSpecies.INSTANCE.getImplemented();
        ...
        for (Species species : orderedSpeces) {
            pc.add(Species.create$default(species, 0, 1, null));
        }
        return 1;
    }
