...
public class SuperEffectiveInstruction(message: BattleMessage) : InterpreterInstruction {
      ...
      battle.dispatchGo((new Function0<Unit>(this, battle) {
         ...
         public final void invoke() {
            ...
            if (var10000 != null) {
               ...
               val var10001: MutableComponent = LocalizationUtilsKt.battleLang("superEffective");
