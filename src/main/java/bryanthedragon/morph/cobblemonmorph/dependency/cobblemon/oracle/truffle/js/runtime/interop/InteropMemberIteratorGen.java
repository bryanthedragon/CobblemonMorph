...
final class InteropMemberIteratorGen {
   ...
   static {
      LibraryExport.register(InteropMemberIterator.class, new InteropMemberIteratorGen.InteropLibraryExports());
   }

   @GeneratedBy(InteropMemberIterator.class)
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      private static final InteropMemberIteratorGen.InteropLibraryExports.Uncached UNCACHED = new InteropMemberIteratorGen.InteropLibraryExports.Uncached();
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return new InteropMemberIteratorGen.InteropLibraryExports.Cached(receiver);
      }
      ...
      private static final class Cached extends InteropLibrary {
         ...
         protected Cached(Object receiver) {
            ...
            this.receiverIteratedObjectInteropLibrary_ = super.insert(InteropMemberIteratorGen.INTEROP_LIBRARY_.create(castReceiver.iteratedObject));
            this.receiverKeysObjectInteropLibrary_ = super.insert(InteropMemberIteratorGen.INTEROP_LIBRARY_.create(castReceiver.keysObject));
         }

         @Override
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof InteropMemberIterator) || InteropMemberIteratorGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";

            if (!(receiver instanceof InteropMemberIterator)) {
               return false;
            } else {
               return !this.receiverIteratedObjectInteropLibrary_.accepts(((InteropMemberIterator)receiver).iteratedObject)
                  ? false
                  : this.receiverKeysObjectInteropLibrary_.accepts(((InteropMemberIterator)receiver).keysObject);
            }
         }
      ...
      private static final class Uncached extends InteropLibrary {
         ...
         public Object getIteratorNextElement(Object arg0Value_) throws StopIterationException {
            ...
            return arg0Value.getIteratorNextElement(
               InteropMemberIteratorGen.INTEROP_LIBRARY_.getUncached(arg0Value.iteratedObject),
               InteropMemberIteratorGen.INTEROP_LIBRARY_.getUncached(arg0Value.keysObject)
            );
         }
      }
   }
