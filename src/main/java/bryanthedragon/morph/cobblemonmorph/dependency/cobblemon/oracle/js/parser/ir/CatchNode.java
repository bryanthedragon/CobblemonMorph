...
extends Statement {
    ...
    private CatchNode(CatchNode catchNode, IdentNode exception, Expression pattern, Expression exceptionCondition, Block body, boolean isSyntheticRethrow) {
        super(catchNode);
    ...
    public Node accept(NodeVisitor<? extends LexicalContext> visitor) {
        if (visitor.enterCatchNode(this)) {
            return visitor.leaveCatchNode(this.setException(this.exception == null ? null : (IdentNode)this.exception.accept(visitor)).setDestructuringPattern(this.pattern == null ? null : (Expression)this.pattern.accept(visitor)).setExceptionCondition(this.exceptionCondition == null ? null : (Expression)this.exceptionCondition.accept(visitor)).setBody((Block)this.body.accept(visitor)));
        }
        return this;
    }
    ...
    public CatchNode setExceptionCondition(Expression exceptionCondition) {
        ...
        return new CatchNode(this, this.exception, this.pattern, exceptionCondition, this.body, this.isSyntheticRethrow);
    }
    ...
    public CatchNode setException(IdentNode exception) {
        ...
        return new CatchNode(this, exception, this.pattern, this.exceptionCondition, this.body, this.isSyntheticRethrow);
    }
    ...
    public CatchNode setDestructuringPattern(Expression pattern) {
        ...
        return new CatchNode(this, this.exception, pattern, this.exceptionCondition, this.body, this.isSyntheticRethrow);
    }
    ...
    private CatchNode setBody(Block body) {
        ...
        return new CatchNode(this, this.exception, this.pattern, this.exceptionCondition, body, this.isSyntheticRethrow);
    }
