...
public class RowletHisuiBiasModel(root: ModelPart) : PokemonPoseableModel, BipedFrame, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = RowletHisuiBiasModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "rowlet_hisui_bias", "ground_idle", null, 4, null)},
      ...
      this.setFlyidle(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "rowlet_hisui_bias", "flying_idle", null, 4, null),
      ...
      this.setWalk(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            new StatelessAnimation[]{
               PoseableEntityModel.bedrock$default(this, "rowlet_hisui_bias", "ground_idle", null, 4, null), new BipedWalkAnimation(this, 0.8F, 0.7F)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.wingsOpen).withVisibility(false),
               ModelPartExtensionsKt.createTransformation(this.wingsClosed).withVisibility(true)
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: RowletHisuiBiasModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
