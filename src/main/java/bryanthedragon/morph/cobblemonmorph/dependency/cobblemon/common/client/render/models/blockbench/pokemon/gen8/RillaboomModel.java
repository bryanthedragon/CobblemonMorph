...
public class RillaboomModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BimanualFrame {
   public final lateinit var battleidle: Pose<PokemonEntity, ModelFrame>
   public open val cryAnimation: CryProvider
   public final val drums: ModelPart
   ...
   init {
      ...
      this.cryAnimation = RillaboomModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "rillaboom", "ground_idle", null, 4, null)
            },
            new ModelPartTransformation[]{
               ModelPartExtensionsKt.createTransformation(this.drums).withVisibility(false),
      ...
      var var13: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "rillaboom", "ground_walk", null, 4, null)
      };
      ...
      var11 = new ModelPartTransformation[]{
         ModelPartExtensionsKt.createTransformation(this.drums).withVisibility(true),
         ModelPartExtensionsKt.createTransformation(this.stick_left).withVisibility(true),
         ModelPartExtensionsKt.createTransformation(this.stick_right).withVisibility(true)
      };
      var13 = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "rillaboom", "battle_idle", null, 4, null)
      };
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: RillaboomModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
