...
public class CurrencyMetaInfo {
   ...
   static {
      ...
      try {
         Class<?> clzz = Class.forName("com.cobblemon.mod.relocations.ibm.icu.impl.ICUCurrencyMetaInfo");
   ...
   public static final class CurrencyFilter {
      ...
      private static final CurrencyMetaInfo.CurrencyFilter ALL = new CurrencyMetaInfo.CurrencyFilter(null, null, Long.MIN_VALUE, Long.MAX_VALUE, false);
      ...
      public int hashCode() {
         ...
         return hc * 31 + (this.tenderOnly ? 1 : 0);
      }
