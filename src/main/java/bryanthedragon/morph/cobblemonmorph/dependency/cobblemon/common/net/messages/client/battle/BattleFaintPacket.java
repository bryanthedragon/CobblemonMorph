...
public class BattleFaintPacket(pnx: String) : NetworkPacket<BattleFaintPacket> {
   ...
   public companion object {
      ...
      public fun decode(buffer: FriendlyByteBuf): BattleFaintPacket {
         val var10002: java.lang.String = buffer.m_130277_();
         return new BattleFaintPacket(var10002);
      }
   }
}
