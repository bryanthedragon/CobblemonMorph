...
public class TemporalPlainTimeFunctionBuiltins extends JSBuiltinsContainer.SwitchEnum<TemporalPlainTimeFunctionBuiltins.TemporalPlainTimeFunction> {
   ...
   protected TemporalPlainTimeFunctionBuiltins() {
      super(JSTemporalPlainTime.CLASS_NAME, TemporalPlainTimeFunctionBuiltins.TemporalPlainTimeFunction.class);
   }

   protected Object createNode(
      JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, TemporalPlainTimeFunctionBuiltins.TemporalPlainTimeFunction builtinEnum
   ) {
      switch (builtinEnum) {
         case from:
            return TemporalPlainTimeFunctionBuiltinsFactory.JSTemporalPlainTimeFromNodeGen.create(
               context, builtin, args().fixedArgs(2).createArgumentNodes(context)
            );
         case compare:
            return TemporalPlainTimeFunctionBuiltinsFactory.JSTemporalPlainTimeCompareNodeGen.create(
               context, builtin, args().fixedArgs(2).createArgumentNodes(context)
            );
         default:
            return null;
   ...
   public abstract static class JSTemporalPlainTimeCompareNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      public JSTemporalPlainTimeCompareNode(JSContext context, JSBuiltin builtin) {
         super(context, builtin);
      }

      @Specialization
      protected int compare(Object obj1, Object obj2, @Cached("create(getContext())") ToTemporalTimeNode toTemporalTime) {
   ...
   public abstract static class JSTemporalPlainTimeFromNode extends TemporalPlainDatePrototypeBuiltins.JSTemporalBuiltinOperation {
      public JSTemporalPlainTimeFromNode(JSContext context, JSBuiltin builtin) {
         super(context, builtin);
      }

      @Specialization
      protected Object from(Object item, Object options, @Cached("create(getContext())") ToTemporalTimeNode toTemporalTime) {
         ...
         if (this.isObject(item) && JSTemporalPlainTime.isJSTemporalPlainTime(item)) {
            ...
            return JSTemporalPlainTime.create(
               ...
               timeItem.getMinute(),
               timeItem.getSecond(),
               timeItem.getMillisecond(),
               timeItem.getMicrosecond(),
               timeItem.getNanosecond(),
               this.errorBranch
            );
         } else {
   ...
   public static enum TemporalPlainTimeFunction implements BuiltinEnum<TemporalPlainTimeFunctionBuiltins.TemporalPlainTimeFunction> {
      from(1),
      compare(2);
