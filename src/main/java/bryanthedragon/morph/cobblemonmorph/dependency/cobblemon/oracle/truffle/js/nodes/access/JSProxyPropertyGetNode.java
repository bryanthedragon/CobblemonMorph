...
extends JavaScriptBaseNode {
    ...
    @Specialization
    protected Object doGeneric(JSDynamicObject proxy, Object receiver, Object key, Object defaultValue, @Cached JSToPropertyKeyNode toPropertyKeyNode, @Cached(value="createBinaryProfile()") ConditionProfile hasTrap, @Cached JSClassProfile targetClassProfile) {
    ...
    private boolean isSameValue(Object trapResult, Object value2) {
        if (this.sameValueNode == null) {
            CompilerDirectives.transferToInterpreterAndInvalidate();
            this.sameValueNode = this.insert(JSIdenticalNode.createSameValue());
        }
        return this.sameValueNode.executeBoolean(trapResult, value2);
    }
