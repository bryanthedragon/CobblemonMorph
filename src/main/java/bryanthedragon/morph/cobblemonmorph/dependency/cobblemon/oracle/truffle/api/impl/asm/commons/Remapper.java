...
import com.oracle.truffle.api.impl.asm.commons.SignatureRemapper;
import com.oracle.truffle.api.impl.asm.signature.SignatureReader;
import com.oracle.truffle.api.impl.asm.signature.SignatureVisitor;
import com.oracle.truffle.api.impl.asm.signature.SignatureWriter;
...
public abstract class Remapper {
    ...
    public Object mapValue(Object value2) {
        ...
        if (value2 instanceof Handle) {
            ...
            return new Handle(handle2.getTag(), this.mapType(handle2.getOwner()), this.mapMethodName(handle2.getOwner(), handle2.getName(), handle2.getDesc()), handle2.getTag() <= 4 ? this.mapDesc(handle2.getDesc()) : this.mapMethodDesc(handle2.getDesc()), handle2.isInterface());
        }
