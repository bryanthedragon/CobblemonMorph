...
public final class UnicodeDecompressor implements SCSU {
   ...
   public int decompress(
      byte[] byteBuffer, int byteBufferStart, int byteBufferLimit, int[] bytesRead, char[] charBuffer, int charBufferStart, int charBufferLimit
   ) {
                  ...
                  while (bytePos < byteBufferLimit && ucPos < charBufferLimit) {
                     ...
                     switch (aByte) {
                        ...
                        case 14:
                           ...
                           int var31 = byteBuffer[bytePos++];
                           charBuffer[ucPos++] = (char)(var31 << 8 | byteBuffer[bytePos++] & 255);
                           break;
                        case 15:
                           this.fMode = 1;
                           continue label118;
                        ...
                        case 255:
                           if (this.fOffsets[this.fCurrentWindow] <= 65535) {
                              ...
                              charBuffer[ucPos++] = (char)(56320 + (normalizedBase & 1023) + (aByte & 127));
                           }
                     }
                  }
                  break;
                  ...
                  while (bytePos < byteBufferLimit && ucPos < charBufferLimit) {
                     ...
                     switch (aByte) {
                        ...
                        case 240:
                           ...
                           int var29 = byteBuffer[bytePos++];
                           charBuffer[ucPos++] = (char)(var29 << 8 | byteBuffer[bytePos++] & 255);
                           break;
                        case 241:
                           if (bytePos + 1 >= byteBufferLimit) {
                              System.arraycopy(byteBuffer, --bytePos, this.fBuffer, 0, byteBufferLimit - bytePos);
