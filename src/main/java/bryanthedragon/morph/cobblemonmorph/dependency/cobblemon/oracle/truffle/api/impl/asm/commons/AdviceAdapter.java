...
import com.oracle.truffle.api.impl.asm.commons.GeneratorAdapter;
...
implements Opcodes {
    ...
    public void visitLdcInsn(Object value2) {
        ...
        if (this.isConstructor && !this.superClassConstructorCalled) {
            this.pushValue(OTHER);
            if (value2 instanceof Double || value2 instanceof Long || value2 instanceof ConstantDynamic && ((ConstantDynamic)value2).getSize() == 2) {
                this.pushValue(OTHER);
            }
        }
    }
    ...
    private void doVisitMethodInsn(int opcode, String name, String descriptor) {
        if (this.isConstructor && !this.superClassConstructorCalled) {
            ...
            switch (opcode) {
                ...
                case 183: {
                    Object value2 = this.popValue();
                    if (value2 != UNINITIALIZED_THIS || this.superClassConstructorCalled || !name.equals("<init>")) break;
    ...
    public void visitTryCatchBlock(Label start2, Label end2, Label handler, String type) {
        super.visitTryCatchBlock(start2, end2, handler, type);
    ...
    private void pushValue(Object value2) {
        this.stackFrame.add(value2);
    }
