...
public abstract class Accessor {
   ...
   protected Accessor() {
      ...
      if (!"com.oracle.truffle.api.LanguageAccessor".equals(thisClassName)
         ...
         && !"com.oracle.truffle.api.debug.Debugger$AccessorDebug".equals(thisClassName)
   ...
   public final Accessor.NodeSupport nodeSupport() {
      return Accessor.Constants.NODES;
   }

   public final Accessor.LanguageSupport languageSupport() {
      return Accessor.Constants.LANGUAGE;
   }

   public final Accessor.EngineSupport engineSupport() {
      return Accessor.Constants.ENGINE;
   }

   public final Accessor.InstrumentSupport instrumentSupport() {
      return Accessor.Constants.INSTRUMENT;
   }

   public final Accessor.InteropSupport interopSupport() {
      return Accessor.Constants.INTEROP;
   }

   public final Accessor.ExceptionSupport exceptionSupport() {
      return Accessor.Constants.EXCEPTION;
   }

   public final Accessor.SourceSupport sourceSupport() {
      return Accessor.Constants.SOURCE;
   }

   public final Accessor.FrameSupport framesSupport() {
      return Accessor.Constants.FRAMES;
   }

   public final Accessor.RuntimeSupport runtimeSupport() {
      return Accessor.Constants.RUNTIME;
   }

   public final Accessor.HostSupport hostSupport() {
      return Accessor.Constants.HOST;
   }

   public final Accessor.IOSupport ioSupport() {
      return Accessor.Constants.IO;
   }
   ...
   private static class Constants {
      private static final Accessor.LanguageSupport LANGUAGE = loadSupport("com.oracle.truffle.api.LanguageAccessor$LanguageImpl");
      private static final Accessor.NodeSupport NODES = loadSupport("com.oracle.truffle.api.nodes.NodeAccessor$AccessNodes");
      private static final Accessor.InstrumentSupport INSTRUMENT = loadSupport("com.oracle.truffle.api.instrumentation.InstrumentAccessor$InstrumentImpl");
      private static final Accessor.SourceSupport SOURCE = loadSupport("com.oracle.truffle.api.source.SourceAccessor$SourceSupportImpl");
      private static final Accessor.InteropSupport INTEROP = loadSupport("com.oracle.truffle.api.interop.InteropAccessor$InteropImpl");
      private static final Accessor.ExceptionSupport EXCEPTION = loadSupport("com.oracle.truffle.api.exception.ExceptionAccessor$ExceptionSupportImpl");
      private static final Accessor.IOSupport IO = loadSupport("com.oracle.truffle.api.io.IOAccessor$IOSupportImpl");
      private static final Accessor.FrameSupport FRAMES = loadSupport("com.oracle.truffle.api.frame.FrameAccessor$FramesImpl");
      private static final Accessor.EngineSupport ENGINE = loadSupport("com.oracle.truffle.polyglot.EngineAccessor$EngineImpl");
      private static final Accessor.HostSupport HOST = loadSupport("com.oracle.truffle.host.HostAccessor$HostImpl");
      private static final Accessor.RuntimeSupport RUNTIME = Accessor.getTVMCI().createRuntimeSupport(Accessor.RuntimeSupport.PERMISSION);
   ...
   public abstract static class EngineSupport extends Accessor.Support {
      static final String IMPL_CLASS_NAME = "com.oracle.truffle.polyglot.EngineAccessor$EngineImpl";

      protected EngineSupport() {
         super("com.oracle.truffle.polyglot.EngineAccessor$EngineImpl");
      }
      ...
      public abstract Object importSymbol(Object polyglotLanguageContext, TruffleLanguage.Env env, String symbolName);
      ...
      public abstract TruffleLanguage.Env getEnvForInstrument(String languageId, String mimeType);

      public abstract TruffleLanguage.Env getEnvForInstrument(LanguageInfo language);
      ...
      public abstract SourceSection createSourceSection(
         Object polyglotObject, org.graalvm.polyglot.Source source, com.oracle.truffle.api.source.SourceSection sectionImpl
      );
      ...
      public abstract Object lookupHostSymbol(Object polyglotLanguageContext, TruffleLanguage.Env env, String symbolName);

      public abstract Object asHostSymbol(Object polyglotLanguageContext, Class<?> symbolClass);

      public abstract boolean isHostAccessAllowed(Object polyglotLanguageContext, TruffleLanguage.Env env);

      public abstract boolean isNativeAccessAllowed(Object polyglotLanguageContext, TruffleLanguage.Env env);

      public abstract boolean isInnerContextOptionsAllowed(Object polyglotLanguageContext, TruffleLanguage.Env env);
      ...
      public abstract TruffleContext createInternalContext(
         Object sourcePolyglotLanguageContext,
         OutputStream out,
         OutputStream err,
         InputStream in,
         ZoneId timeZone,
      ...
      public abstract LogRecord createLogRecord(
         Object loggerCache, Level level, String loggerName, String message, String className, String methodName, Object[] parameters, Throwable thrown
      );
      ...
      public abstract <T extends TruffleLanguage<C>, C> TruffleLanguage.ContextReference<C> createContextReference(Class<T> languageClass);

      public abstract <T extends TruffleLanguage<?>> TruffleLanguage.LanguageReference<T> createLanguageReference(Class<T> targetLanguageClass);
      ...
      public abstract Process createSubProcess(
      ...
      public abstract boolean isIOAllowed(Object polyglotLanguageContext, TruffleLanguage.Env env);
      ...
      public abstract Map<String, Collection<? extends TruffleFile.FileTypeDetector>> getEngineFileTypeDetectors(Object engineFileSystemContext);
      ...
      public abstract <T, G> Iterator<T> mergeHostGuestFrames(
         Object instrumentEnv,
      ...
      public abstract Future<Void> submitThreadLocal(
         Object polyglotLanguageContext, Object sourcePolyglotObject, Thread[] threads, ThreadLocalAction action, boolean needsEnter
      );
      ...
      public abstract com.oracle.truffle.api.source.SourceSection getCancelExecutionSourceLocation(Throwable cancelExecution);

      public abstract ThreadDeath createCancelExecution(com.oracle.truffle.api.source.SourceSection sourceSection, String message, boolean resourceLimit);

      public abstract com.oracle.truffle.api.source.SourceSection getExitExceptionSourceLocation(Throwable cancelExecution);

      public abstract ThreadDeath createExitException(com.oracle.truffle.api.source.SourceSection sourceSection, String message, int exitCode);
      ...
      public abstract AbstractPolyglotImpl.AbstractHostLanguageService getHostService(Object polyglotEngineImpl);
   ...
   public abstract static class ExceptionSupport extends Accessor.Support {
      ...
      protected ExceptionSupport() {
         super("com.oracle.truffle.api.exception.ExceptionAccessor$ExceptionSupportImpl");
      }
      ...
      public abstract com.oracle.truffle.api.source.SourceSection getSourceLocation(Object receiver);
   ...
   public abstract static class FrameSupport extends Accessor.Support {
      static final String IMPL_CLASS_NAME = "com.oracle.truffle.api.frame.FrameAccessor$FramesImpl";

      protected FrameSupport() {
         super("com.oracle.truffle.api.frame.FrameAccessor$FramesImpl");
      }
   ...
   public abstract static class HostSupport extends Accessor.Support {
      static final String IMPL_CLASS_NAME = "com.oracle.truffle.host.HostAccessor$HostImpl";

      protected HostSupport() {
         super("com.oracle.truffle.host.HostAccessor$HostImpl");
      }

      public abstract TruffleLanguage<?> createDefaultHostLanguage(AbstractPolyglotImpl polyglot, AbstractPolyglotImpl.AbstractHostAccess access);
      ...
      public abstract <S, T> Object newTargetTypeMapping(
   ...
   public abstract static class IOSupport extends Accessor.Support {
      static final String IMPL_CLASS_NAME = "com.oracle.truffle.api.io.IOAccessor$IOSupportImpl";

      protected IOSupport() {
         super("com.oracle.truffle.api.io.IOAccessor$IOSupportImpl");
      }
   ...
   public abstract static class InstrumentSupport extends Accessor.Support {
      ...
      protected InstrumentSupport() {
         super("com.oracle.truffle.api.instrumentation.InstrumentAccessor$InstrumentImpl");
      }

      public abstract void initializeInstrument(
         Object instrumentationHandler, Object polyglotInstrument, String instrumentClassName, Supplier<? extends Object> instrumentSupplier
      );
      ...
      public abstract Object createInstrumentationHandler(
      ...
      public final DispatchOutputStream createDispatchOutput(OutputStream out) {
         return out instanceof DispatchOutputStream ? (DispatchOutputStream)out : new DispatchOutputStream(out);
      }
      ...
      public abstract SourceSection createSourceSection(
         Object instrumentEnv, org.graalvm.polyglot.Source source, com.oracle.truffle.api.source.SourceSection ss
      );
   ...
   public abstract static class InteropSupport extends Accessor.Support {
      static final String IMPL_CLASS_NAME = "com.oracle.truffle.api.interop.InteropAccessor$InteropImpl";

      protected InteropSupport() {
         super("com.oracle.truffle.api.interop.InteropAccessor$InteropImpl");
      }
   ...
   public abstract static class LanguageSupport extends Accessor.Support {
      static final String IMPL_CLASS_NAME = "com.oracle.truffle.api.LanguageAccessor$LanguageImpl";

      protected LanguageSupport() {
         super("com.oracle.truffle.api.LanguageAccessor$LanguageImpl");
      }
      ...
      public abstract TruffleLanguage.Env createEnv(
         Object polyglotLanguageContext,
      ...
      public abstract Object createEnvContext(TruffleLanguage.Env localEnv, List<Object> servicesCollector);
      ...
      public abstract CallTarget parse(TruffleLanguage.Env env, Source code, Node context, String... argumentNames);

      public abstract ExecutableNode parseInline(TruffleLanguage.Env env, Source code, Node context, MaterializedFrame frame);

      public abstract boolean isVisible(TruffleLanguage.Env env, Object value);
      ...
      public abstract boolean isThreadAccessAllowed(TruffleLanguage.Env env, Thread current, boolean singleThread);

      public abstract void initializeThread(TruffleLanguage.Env env, Thread current);
      ...
      public abstract void finalizeContext(TruffleLanguage.Env localEnv);

      public abstract void exitContext(TruffleLanguage.Env localEnv, TruffleLanguage.ExitMode exitMode, int exitCode);

      public abstract TruffleLanguage.Env patchEnvContext(
   ...
   public abstract static class NodeSupport extends Accessor.Support {
      static final String IMPL_CLASS_NAME = "com.oracle.truffle.api.nodes.NodeAccessor$AccessNodes";

      protected NodeSupport() {
         super("com.oracle.truffle.api.nodes.NodeAccessor$AccessNodes");
      }
      ...
      public abstract LanguageInfo createLanguage(
   ...
   public abstract static class RuntimeSupport {
      ...
      public abstract boolean isGuestCallStackFrame(StackTraceElement e);

      public abstract void initializeProfile(CallTarget target, Class<?>[] argumentTypes);

      public abstract <T extends Node> BlockNode<T> createBlockNode(T[] elements, BlockNode.ElementExecutor<T> executor);
   ...
   public abstract static class SomSupport extends Accessor.Support {
      static final String IMPL_CLASS_NAME = "com.oracle.truffle.api.staticobject.SomAccessor";

      protected SomSupport() {
         super("com.oracle.truffle.api.staticobject.SomAccessor");
      }
   }

   public abstract static class SourceSupport extends Accessor.Support {
      ...
      protected SourceSupport() {
         super("com.oracle.truffle.api.source.SourceAccessor$SourceSupportImpl");
      }
      ...
      public abstract org.graalvm.polyglot.Source getOrCreatePolyglotSource(Source source, Function<Source, org.graalvm.polyglot.Source> createSource);

      public abstract String findMimeType(URL url, Object fileSystemContext) throws IOException;

      public abstract Source.SourceBuilder newBuilder(String language, File origin);

      public abstract void setFileSystemContext(Source.SourceBuilder builder, Object fileSystemContext);

      public abstract void invalidateAfterPreinitialiation(Source source);

      public abstract void mergeLoadedSources(Source[] sources);

      public abstract void setEmbedderSource(Source.SourceBuilder builder, boolean b);

      public abstract void setURL(Source.SourceBuilder builder, URL url);

      public abstract void setPath(Source.SourceBuilder builder, String path);
   }
