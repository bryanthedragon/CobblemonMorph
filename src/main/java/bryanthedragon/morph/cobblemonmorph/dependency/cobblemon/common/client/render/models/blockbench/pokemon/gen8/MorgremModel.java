...
public class MorgremModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame {
   ...
   init {
      ...
      this.cryAnimation = MorgremModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "morgrem", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: MorgremModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
