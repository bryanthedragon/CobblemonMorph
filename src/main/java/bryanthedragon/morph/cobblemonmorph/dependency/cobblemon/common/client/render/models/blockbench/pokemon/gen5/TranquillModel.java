...
public class TranquillModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = TranquillModel::cryAnimation$lambda$0;
   }
      ...
      this.setStand(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "tranquill", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: TranquillModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
