...
public class MessageFormat extends UFormat {
   ...
   public final StringBuffer format(Object[] arguments, StringBuffer result, FieldPosition pos) {
      this.format(arguments, null, new MessageFormat.AppendableWrapper(result), pos);
      return result;
   }

   public final StringBuffer format(Map<String, Object> arguments, StringBuffer result, FieldPosition pos) {
      this.format(null, arguments, new MessageFormat.AppendableWrapper(result), pos);
      return result;
   }
   ...
   public Object[] parse(String source, ParsePosition pos) {
      if (this.msgPattern.hasNamedArguments()) {
         ...
         return pos.getIndex() == backupStartPos ? null : resultArray;
      }
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return Objects.equals(this.ulocale, other.ulocale)
            && Objects.equals(this.msgPattern, other.msgPattern)
            && Objects.equals(this.cachedFormatters, other.cachedFormatters)
            && Objects.equals(this.customFormatArgStarts, other.customFormatArgStarts);
      } else {
         return false;
      }
   }
      ...
      while (true) {
         ...
         if (type == MessagePattern.Part.Type.REPLACE_NUMBER) {
            ...
            if (noArg) {
               ...
               MessageFormat.PluralSelectorProvider selector;
               if (argType == MessagePattern.ArgType.PLURAL) {
                  if (this.pluralProvider == null) {
                     this.pluralProvider = new MessageFormat.PluralSelectorProvider(this, PluralRules.PluralType.CARDINAL);
                  }

                  selector = this.pluralProvider;
               } else {
                  if (this.ordinalProvider == null) {
                     this.ordinalProvider = new MessageFormat.PluralSelectorProvider(this, PluralRules.PluralType.ORDINAL);
                  }
               ...
               MessageFormat.PluralSelectorContext context = new MessageFormat.PluralSelectorContext(i, argName, number, offset);
   ...
   private String getLiteralStringUntilNextArgument(int from) {
      ...
      while (true) {
         ...
         assert type == MessagePattern.Part.Type.SKIP_SYNTAX || type == MessagePattern.Part.Type.INSERT_CHAR : "Unexpected Part "
            + part
            + " in parsed message.";
   ...
   private void format(Object[] arguments, Map<String, Object> argsMap, MessageFormat.AppendableWrapper dest, FieldPosition fp) {
   ...
   Format dateTimeFormatForPatternOrSkeleton(String style) {
      ...
      return (Format)(style.regionMatches(i, "::", 0, 2)
         ? DateFormat.getInstanceForSkeleton(style.substring(i + 2), this.ulocale)
         : new SimpleDateFormat(style, this.ulocale));
   }

   private Format createAppropriateFormat(String type, String style) {
      Format newFormat = null;
      int subformatType = findKeyword(type, typeList);
      RuleBasedNumberFormat var11;
      switch (subformatType) {
         case 0:
            switch (findKeyword(style, modifierList)) {
               case 0:
                  Format var33 = NumberFormat.getInstance(this.ulocale);
                  return var33;
               case 1:
                  Format var32 = NumberFormat.getCurrencyInstance(this.ulocale);
                  return var32;
               case 2:
                  Format var31 = NumberFormat.getPercentInstance(this.ulocale);
                  return var31;
               case 3:
                  Format var30 = NumberFormat.getIntegerInstance(this.ulocale);
                  return var30;
               default:
                  int i = PatternProps.skipWhiteSpace(style, 0);
         ...
         case 1:
            switch (findKeyword(style, dateModifierList)) {
               case 0:
                  Format var28 = DateFormat.getDateInstance(2, this.ulocale);
                  return var28;
               case 1:
                  Format var27 = DateFormat.getDateInstance(3, this.ulocale);
                  return var27;
               case 2:
                  Format var26 = DateFormat.getDateInstance(2, this.ulocale);
                  return var26;
               case 3:
                  Format var25 = DateFormat.getDateInstance(1, this.ulocale);
                  return var25;
               case 4:
                  Format var24 = DateFormat.getDateInstance(0, this.ulocale);
                  return var24;
               default:
         ...
         case 2:
            switch (findKeyword(style, dateModifierList)) {
               case 0:
                  Format var22 = DateFormat.getTimeInstance(2, this.ulocale);
                  return var22;
               case 1:
                  Format var21 = DateFormat.getTimeInstance(3, this.ulocale);
                  return var21;
               case 2:
                  Format var20 = DateFormat.getTimeInstance(2, this.ulocale);
                  return var20;
               case 3:
                  Format var19 = DateFormat.getTimeInstance(1, this.ulocale);
                  return var19;
               case 4:
                  Format var18 = DateFormat.getTimeInstance(0, this.ulocale);
                  return var18;
               default:
                  newFormat = this.dateTimeFormatForPatternOrSkeleton(style);
                  return newFormat;
   ...
   private static final class AppendableWrapper {
      ...
      public void append(CharacterIterator iterator) {
         this.length = this.length + append(this.app, iterator);
      }
   ...
   private static final class PluralSelectorProvider implements PluralFormat.PluralSelector {
      ...
      public String select(Object ctx, double number) {
         ...
         MessageFormat.PluralSelectorContext context = (MessageFormat.PluralSelectorContext)ctx;
