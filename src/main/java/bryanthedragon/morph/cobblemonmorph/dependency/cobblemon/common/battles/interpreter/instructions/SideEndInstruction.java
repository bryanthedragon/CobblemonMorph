...
public class SideEndInstruction(message: BattleMessage) : InterpreterInstruction {
                     ...
                     label62: {
                        label61: {
                           label60: {
                              ...
                              switch (var10000.hashCode()) {
                                 ...
                                 case -694469544:
                                    if (var10000.equals("tailwind")) {
                                       var17 = BattleContext.Type.TAILWIND;
                                       break label62;
                                    }
                                    break;
                                 case 117588:
                              ...
                              var17 = BattleContext.Type.MISC;
                              break label62;
                           }

                           var17 = BattleContext.Type.HAZARD;
                           break label62;
                        }

                        var17 = BattleContext.Type.SCREEN;
                     }

                     side.getContextManager().remove(effect.getId(), var17);
                  }
               }
            }
         ) as () -> Unit
