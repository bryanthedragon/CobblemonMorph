...
extends JSBinaryNode {
    ...
    protected Object doGeneric(Object a, Object b, @Cached(value="create()") JSToNumericNode leftNumeric, @Cached(value="create()") JSToNumericNode rightNumeric, @Cached(value="createInner()") JSBitwiseAndNode and, @Cached(value="create()") BranchProfile mixedNumericTypes) {
