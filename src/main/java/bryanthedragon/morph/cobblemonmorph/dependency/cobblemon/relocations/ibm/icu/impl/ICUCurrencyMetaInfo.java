...
extends CurrencyMetaInfo {
    ...
    public ICUCurrencyMetaInfo() {
        ICUResourceBundle bundle = (ICUResourceBundle)ICUResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/curr", "supplementalData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
