...
public class ChineseCalendar extends Calendar {
   ...
   static final int[][][] CHINESE_DATE_PRECEDENCE = new int[][][]{
      {{5}, {3, 7}, {4, 7}, {8, 7}, {3, 18}, {4, 18}, {8, 18}, {6}, {37, 22}}, {{3}, {4}, {8}, {40, 7}, {40, 18}}
   };
            ...
            if (amount != 0) {
               ...
               if (this.isLeapYear) {
                  if (this.get(22) == 1) {
                     ...
                     int moon1 = moon - (int)(29.530588853 * (m - 0.5));
   ...
   private void computeChineseFields(int days, int gyear, int gmonth, boolean setAllFields) {
      ...
      boolean isLeapMonth = this.isLeapYear
         && this.hasNoMajorSolarTerm(thisMoon)
         && !this.isLeapMonthBetween(firstMoon, this.newMoonNear(thisMoon - 25, false));
