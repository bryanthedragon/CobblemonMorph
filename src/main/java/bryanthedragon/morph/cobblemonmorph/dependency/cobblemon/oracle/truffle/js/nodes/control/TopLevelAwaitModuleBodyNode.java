...
public final class TopLevelAwaitModuleBodyNode extends JavaScriptNode {
   ...
   public Object execute(VirtualFrame frame) {
      ...
      MaterializedFrame moduleFrame = moduleRecord.getEnvironment() != null
         ? JSFrameUtil.castMaterializedFrame(moduleRecord.getEnvironment())
         : frame.materialize();
      PromiseCapabilityRecord promiseCapability = JSArguments.getUserArgumentCount(arguments) >= 2
         ? (PromiseCapabilityRecord)JSArguments.getUserArgument(arguments, 1)
         : null;
      ...
      return promiseCapability == null ? Undefined.instance : promiseCapability.getPromise();
   }
   ...
   private void initializeAsyncCallTarget() {
      ...
      this.atomic(
         () -> {
            if (this.asyncCallTargetInitializationRequired()) {
               TopLevelAwaitModuleBodyNode.TopLevelAwaitModuleRootNode asyncRootNode = new TopLevelAwaitModuleBodyNode.TopLevelAwaitModuleRootNode(
                  this.context, this.moduleBodyNode, this.writeAsyncResult, this.getRootNode().getSourceSection(), ""
               );
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return create(
         this.context,
         cloneUninitialized(this.moduleBodyNode, materializedTags),
         cloneUninitialized(this.writeAsyncResult, materializedTags),
   ...
   public static final class TopLevelAwaitModuleRootNode extends JavaScriptRootNode {
      ...
      TopLevelAwaitModuleRootNode(
         JSContext context, JavaScriptNode body, JSWriteFrameSlotNode asyncResult, SourceSection functionSourceSection, String functionName
      ) {
      ...
      public Object execute(VirtualFrame frame) {
         ...
         try {
            ...
            assert promiseCapability == null ? var8.isYield() : var8.isAwait();
      ...
      public String getName() {
         return this.functionName != null && !this.functionName.isEmpty() ? this.functionName : ":top-level-await-module";
      }
