...
public class PasturePokemonPacket(pokemonId: UUID, pastureId: UUID) : NetworkPacket<PasturePokemonPacket> {
   ...
   public companion object {
      ...
      public fun decode(buffer: FriendlyByteBuf): PasturePokemonPacket {
         val var10002: UUID = buffer.m_130259_();
         val var10003: UUID = buffer.m_130259_();
         return new PasturePokemonPacket(var10002, var10003);
      }
   }
}
