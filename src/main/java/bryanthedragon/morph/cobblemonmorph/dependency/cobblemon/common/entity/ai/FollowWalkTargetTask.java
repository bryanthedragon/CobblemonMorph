...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.util.deleteNode
...
public class FollowWalkTargetTask(
    minRunTime: Int = 150,
    maxRunTime: Int = 250
    ...
    private var lookTarget(BlockPos pos? = null
    private var speed = 0f

    override fun checkExtraStartConditions(ServerLevel level, entity: PathfinderMob): Boolean {
    ...
    override fun stop(ServerLevel world, entity: PathfinderMob, l: Long) {
