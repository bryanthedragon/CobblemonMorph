...
public class TalonflameModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = TalonflameModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      val var18: java.util.Set = SetsKt.minus(SetsKt.minus(var10001, PoseType.HOVER), PoseType.FLOAT);
      ...
      this.setStand(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "talonflame", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: TalonflameModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
