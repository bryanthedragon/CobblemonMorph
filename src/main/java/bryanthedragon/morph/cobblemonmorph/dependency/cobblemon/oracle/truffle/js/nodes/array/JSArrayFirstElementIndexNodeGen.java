...
public final class JSArrayFirstElementIndexNodeGen extends JSArrayFirstElementIndexNode implements Introspection.Provider {
   ...
   @CompilerDirectives.CompilationFinal
   private JSArrayFirstElementIndexNodeGen.WithoutHolesCachedData withoutHolesCached_cache;
   @Node.Child
   private JSArrayFirstElementIndexNodeGen.WithHolesCachedData withHolesCached_cache;
   @Node.Child
   private JSArrayFirstElementIndexNodeGen.WithHolesUncachedData withHolesUncached_cache;
   @Node.Child
      ...
      if (state_0 != 0) {
         if ((state_0 & 63) != 0 && arg0Value instanceof JSDynamicObject) {
            ...
            if ((state_0 & 1) != 0 && arg2Value && !this.hasPrototypeElements(arg0Value_)) {
               for (JSArrayFirstElementIndexNodeGen.WithoutHolesCachedData s0_ = this.withoutHolesCached_cache; s0_ != null; s0_ = s0_.next_) {
            ...
            if ((state_0 & 4) != 0 && arg2Value && !this.hasPrototypeElements(arg0Value_)) {
               for (JSArrayFirstElementIndexNodeGen.WithHolesCachedData s2_ = this.withHolesCached_cache; s2_ != null; s2_ = s2_.next_) {
            ...
            if ((state_0 & 8) != 0) {
               JSArrayFirstElementIndexNodeGen.WithHolesUncachedData s3_ = this.withHolesUncached_cache;
      ...
      try {
         ...
         if (arg0Value instanceof JSDynamicObject) {
            ...
            if ((exclude & 1) == 0 && arg2Value && !this.hasPrototypeElements(arg0Value_)) {
               int count0_ = 0;
               JSArrayFirstElementIndexNodeGen.WithoutHolesCachedData s0_ = this.withoutHolesCached_cache;
               if ((state_0 & 1) != 0) {
               ...
               if (s0_ == null) {
                  ...
                  if (JSArrayElementIndexNode.getArrayType(arg0Value_) == cachedArrayType__ && !cachedArrayType__.hasHoles(arg0Value_) && count0_ < 4) {
                     s0_ = new JSArrayFirstElementIndexNodeGen.WithoutHolesCachedData(this.withoutHolesCached_cache);
            ...
            if ((exclude & 2) == 0 && arg2Value && !this.hasPrototypeElements(arg0Value_)) {
               int count2_ = 0;
               JSArrayFirstElementIndexNodeGen.WithHolesCachedData s2_ = this.withHolesCached_cache;
               if ((state_0 & 4) != 0) {
                  while (
               ...
               if (s2_ == null) {
                  ...
                  if (JSArrayElementIndexNode.getArrayType(arg0Value_) == cachedArrayType__1 && cachedArrayType__1.hasHoles(arg0Value_) && count2_ < 4) {
                     s2_ = super.insert(new JSArrayFirstElementIndexNodeGen.WithHolesCachedData(this.withHolesCached_cache));
            ...
            if (arg2Value && (this.hasPrototypeElements(arg0Value_) || JSArrayElementIndexNode.hasHoles(arg0Value_))) {
               JSArrayFirstElementIndexNodeGen.WithHolesUncachedData s3_ = super.insert(new JSArrayFirstElementIndexNodeGen.WithHolesUncachedData());
   ...
   public Introspection getIntrospectionData() {
      ...
      data[4] = s;
      s = new Object[]{"firstObjectViaEnumeration", null, null};
      if ((state_0 & 16) != 0) {
         s[1] = (byte)1;
         ArrayList<Object> cached = new ArrayList<>();
      ...
      data[5] = s;
      s = new Object[]{"firstObjectViaFullEnumeration", null, null};
      if ((state_0 & 32) != 0) {
         s[1] = (byte)1;
         ArrayList<Object> cached = new ArrayList<>();
   ...
   private static final class WithHolesCachedData extends Node {
      @Node.Child
      JSArrayFirstElementIndexNodeGen.WithHolesCachedData next_;
      @CompilerDirectives.CompilationFinal
      ...
      WithHolesCachedData(JSArrayFirstElementIndexNodeGen.WithHolesCachedData next_) {
         this.next_ = next_;
      }
   ...
   private static final class WithoutHolesCachedData {
      @CompilerDirectives.CompilationFinal
      JSArrayFirstElementIndexNodeGen.WithoutHolesCachedData next_;
      @CompilerDirectives.CompilationFinal
      ScriptArray cachedArrayType_;

      WithoutHolesCachedData(JSArrayFirstElementIndexNodeGen.WithoutHolesCachedData next_) {
         this.next_ = next_;
      }
   }
}
