...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.entity.PoseType.Companion.SHOULDER_POSES
...
public class ParasModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame {
    ...
    override val cryAnimation = CryProvider { bedrockStateful("paras", "cry") }
