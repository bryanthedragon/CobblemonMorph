...
implements PokemonSelectingItem {
    ...
    public HealPowderItem() {
        super(new Item.Properties());
        Cobblemon.INSTANCE.getImplementation().registerCompostable((ItemLike)this, 0.75f);
    }
