...
public final class UniversalTimeScale {
   ...
   private static final UniversalTimeScale.TimeScaleData[] timeScaleTable = new UniversalTimeScale.TimeScaleData[]{
      new UniversalTimeScale.TimeScaleData(10000L, 621355968000000000L, -9223372036854774999L, 9223372036854774999L, -984472800485477L, 860201606885477L),
      new UniversalTimeScale.TimeScaleData(10000000L, 621355968000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -984472800485L, 860201606885L),
      new UniversalTimeScale.TimeScaleData(10000L, 621355968000000000L, -9223372036854774999L, 9223372036854774999L, -984472800485477L, 860201606885477L),
      new UniversalTimeScale.TimeScaleData(1L, 504911232000000000L, -8718460804854775808L, Long.MAX_VALUE, Long.MIN_VALUE, 8718460804854775807L),
      new UniversalTimeScale.TimeScaleData(1L, 0L, Long.MIN_VALUE, Long.MAX_VALUE, Long.MIN_VALUE, Long.MAX_VALUE),
      new UniversalTimeScale.TimeScaleData(10000000L, 600527520000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -982389955685L, 862284451685L),
      new UniversalTimeScale.TimeScaleData(10000000L, 631139040000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -985451107685L, 859223299685L),
      new UniversalTimeScale.TimeScaleData(864000000000L, 599265216000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -11368793L, 9981605L),
      new UniversalTimeScale.TimeScaleData(864000000000L, 599265216000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -11368793L, 9981605L),
      new UniversalTimeScale.TimeScaleData(10L, 621355968000000000L, -9223372036854775804L, 9223372036854775804L, -984472800485477580L, 860201606885477580L)
   };
   ...
   public static long toLong(long universalTime, int timeScale) {
      ...
      if (universalTime < 0L) {
         return universalTime < data.minRound
            ? (universalTime + data.unitsRound) / data.units - data.epochOffsetP1
            : (universalTime - data.unitsRound) / data.units - data.epochOffset;
      } else {
         return universalTime > data.maxRound
            ? (universalTime - data.unitsRound) / data.units - data.epochOffsetM1
            : (universalTime + data.unitsRound) / data.units - data.epochOffset;
      }
   }
