...
import com.oracle.truffle.js.nodes.access.IteratorSetDoneNodeGen;
import com.oracle.truffle.js.runtime.objects.IteratorRecord;
import java.util.Set;

public abstract class IteratorSetDoneNode
extends JavaScriptNode {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return IteratorSetDoneNode.create(IteratorSetDoneNode.cloneUninitialized(this.iteratorNode, materializedTags), IteratorSetDoneNode.cloneUninitialized(this.isDoneNode, materializedTags));
    }
}
