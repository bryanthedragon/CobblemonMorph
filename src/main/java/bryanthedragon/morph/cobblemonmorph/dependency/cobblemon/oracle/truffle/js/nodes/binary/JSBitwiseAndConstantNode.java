...
public abstract class JSBitwiseAndConstantNode extends JSUnaryNode {
   ...
   public InstrumentableNode materializeInstrumentableNodes(Set<Class<? extends Tag>> materializedTags) {
      if (materializedTags.contains(JSTags.BinaryOperationTag.class)) {
         ...
         JavaScriptNode node = JSBitwiseAndNodeGen.create(cloneUninitialized(this.getOperand(), materializedTags), constantNode);
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return JSBitwiseAndConstantNodeGen.create(
         cloneUninitialized(this.getOperand(), materializedTags), this.isInt ? this.rightIntValue : this.rightBigIntValue
      );
   }
   ...
   public String expressionToString() {
      return this.getOperand() != null
         ? "("
            ...
            + " & "
            + (this.isInt ? this.rightIntValue : this.rightBigIntValue.toString())
            + ")"
         : null;
   }
}
