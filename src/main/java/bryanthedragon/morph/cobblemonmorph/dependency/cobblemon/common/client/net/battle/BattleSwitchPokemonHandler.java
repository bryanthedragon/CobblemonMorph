...
public final class BattleSwitchPokemonHandler : ClientNetworkPacketHandler<BattleSwitchPokemonPacket> {
    override fun handle(packet: BattleSwitchPokemonPacket, Minecraft client) {
