...
implements QuadrupedFrame {
    ...
    public FurretModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "furret");
        this.foreLeftLeg = this.getPart("arm_left");
        this.foreRightLeg = this.getPart("arm_right");
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ FurretModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "furret", "blink", null, 4, null);
            }
        }, 7, null);
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "furret", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{new QuadrupedWalkAnimation(this, 0.6f, 0.9f), PoseableEntityModel.bedrock$default(this, "furret", "pose", null, 4, null)};
        objectArray = statelessAnimationArray;
