...
implements Introspection.Provider {
        ...
        if (state_0 != 0 && arg0Value instanceof JSDynamicObject) {
            ...
            if ((state_0 & 2) != 0 && arg1Value instanceof JSDynamicObject) {
                ...
                if (s1_ != null && JSGuards.isJSObject(arg1Value_)) {
                    return CopyDataPropertiesNode.copyDataProperties(arg0Value_, arg1Value_, arg2Value, arg3Value, s1_.getNode_, s1_.getOwnProperty_, s1_.listSize_, s1_.listGet_, s1_.classProfile_, s1_.equalsNode_);
                }
            }
            if ((state_0 & 0xC) != 0) {
                CopyDataPropertiesForeign1Data s3_;
                if ((state_0 & 4) != 0) {
                    ...
                    while (s2_ != null) {
                        if (s2_.objInterop_.accepts(arg1Value) && !JSGuards.isJSDynamicObject(arg1Value)) {
                            return this.copyDataPropertiesForeign(arg0Value_, arg1Value, arg2Value, arg3Value, s2_.objInterop_, s2_.iteratorInterop_, s2_.arrayInterop_, s2_.stringInterop_, s2_.importValue_, s2_.toString_, s2_.equalsNode_);
                        }
                        s2_ = s2_.next_;
                    }
                }
                if ((state_0 & 8) != 0 && (s3_ = this.copyDataPropertiesForeign1_cache) != null && !JSGuards.isJSDynamicObject(arg1Value)) {
    ...
    private Object copyDataPropertiesForeign1Boundary(int state_0, CopyDataPropertiesForeign1Data s3_, JSDynamicObject arg0Value_, Object arg1Value, Object[] arg2Value, boolean arg3Value) {
        EncapsulatingNodeReference encapsulating_ = EncapsulatingNodeReference.getCurrent();
        Node prev_ = encapsulating_.set(this);
        try {
            InteropLibrary objInterop__ = INTEROP_LIBRARY_.getUncached(arg1Value);
            JSDynamicObject jSDynamicObject = this.copyDataPropertiesForeign(arg0Value_, arg1Value, arg2Value, arg3Value, objInterop__, s3_.iteratorInterop_, s3_.arrayInterop_, s3_.stringInterop_, s3_.importValue_, s3_.toString_, s3_.equalsNode_);
        ...
        try {
            ...
            if (arg0Value instanceof JSDynamicObject) {
                ...
                if (JSGuards.isNullOrUndefined(arg1Value)) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    JSDynamicObject jSDynamicObject = CopyDataPropertiesNode.doNullOrUndefined(arg0Value_, arg1Value, arg2Value, arg3Value);
                    return jSDynamicObject;
                }
                if (arg1Value instanceof JSDynamicObject && JSGuards.isJSObject(arg1Value_ = (JSDynamicObject)arg1Value)) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    JSDynamicObject jSDynamicObject = CopyDataPropertiesNode.copyDataProperties(arg0Value_, arg1Value_, arg2Value, arg3Value, s1_.getNode_, s1_.getOwnProperty_, s1_.listSize_, s1_.listGet_, s1_.classProfile_, s1_.equalsNode_);
                    return jSDynamicObject;
                }
                if (exclude == 0) {
                    int count2_ = 0;
                    ...
                    if (s2_ == null && !JSGuards.isJSDynamicObject(arg1Value) && count2_ < 5) {
                        s2_ = super.insert(new CopyDataPropertiesForeign0Data(this.copyDataPropertiesForeign0_cache));
                    ...
                    if (s2_ != null) {
                        lock.unlock();
                        hasLock = false;
                        JSDynamicObject jSDynamicObject = this.copyDataPropertiesForeign(arg0Value_, arg1Value, arg2Value, arg3Value, s2_.objInterop_, s2_.iteratorInterop_, s2_.arrayInterop_, s2_.stringInterop_, s2_.importValue_, s2_.toString_, s2_.equalsNode_);
                        return jSDynamicObject;
                    }
                }
    ...
    public NodeCost getCost() {
        CopyDataPropertiesForeign0Data s2_;
        int state_0 = this.state_0_;
        if (state_0 == 0) {
            return NodeCost.UNINITIALIZED;
        }
        if ((state_0 & state_0 - 1) == 0 && ((s2_ = this.copyDataPropertiesForeign0_cache) == null || s2_.next_ == null)) {
    ...
    public Introspection getIntrospectionData() {
        ...
        if ((state_0 & 4) != 0) {
            ...
            CopyDataPropertiesForeign0Data s2_ = this.copyDataPropertiesForeign0_cache;
            while (s2_ != null) {
                cached.add(Arrays.asList(s2_.objInterop_, s2_.iteratorInterop_, s2_.arrayInterop_, s2_.stringInterop_, s2_.importValue_, s2_.toString_, s2_.equalsNode_));
                s2_ = s2_.next_;
            }
            s[2] = cached;
        } else {
    ...
    @GeneratedBy(value=CopyDataPropertiesNode.class)
    private static final class CopyDataPropertiesForeign1Data
    extends Node {
        @Node.Child
    ...
    @GeneratedBy(value=CopyDataPropertiesNode.class)
    private static final class CopyDataPropertiesForeign0Data
    extends Node {
        @Node.Child
    ...
    @GeneratedBy(value=CopyDataPropertiesNode.class)
    private static final class CopyDataPropertiesData
    extends Node {
        @Node.Child
