...
public final class InteropFunctionGen {
   ...
   static {
      LibraryExport.register(InteropFunction.class, new InteropFunctionGen.InteropLibraryExports());
   }
   ...
   public static class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         InteropLibrary uncached = new InteropFunctionGen.InteropLibraryExports.Uncached(receiver);
         return uncached;
      }
      ...
      protected InteropLibrary createCached(Object receiver) {
         ...
         return new InteropFunctionGen.InteropLibraryExports.Cached(receiver);
      }
      ...
      public static class Cached extends InteropLibrary {
         ...
         protected Cached(Object receiver) {
            ...
            this.receiverClass_ = (Class<? extends InteropFunction>)castReceiver.getClass();
         }

         @Override
         public boolean accepts(Object receiver) {
            assert receiver.getClass() != this.receiverClass_ || InteropFunctionGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
         ...
         private TriState executeAndSpecialize(InteropFunction arg0Value, Object arg1Value) {
            ...
            try {
               int state_0 = this.state_0_;
               this.thisLib_ = super.insert(InteropFunctionGen.INTEROP_LIBRARY_.createDispatched(5));
               this.otherLib_ = super.insert(InteropFunctionGen.INTEROP_LIBRARY_.createDispatched(5));
               int var10;
               this.state_0_ = var10 = state_0 | 1;
               lock.unlock();
               hasLock = false;
               var6 = arg0Value.isIdenticalOrUndefined(arg1Value, this.thisLib_, this.otherLib_);
            } finally {
               if (hasLock) {
                  lock.unlock();
               }
      ...
      public static class Uncached extends InteropLibrary {
         ...
         protected Uncached(Object receiver) {
            this.receiverClass_ = (Class<? extends InteropFunction>)((InteropFunction)receiver).getClass();
         }
         ...
         public TriState isIdenticalOrUndefined(Object arg0Value_, Object arg1Value) {
            ...
            return arg0Value.isIdenticalOrUndefined(
               arg1Value, InteropFunctionGen.INTEROP_LIBRARY_.getUncached(), InteropFunctionGen.INTEROP_LIBRARY_.getUncached()
            );
         }
