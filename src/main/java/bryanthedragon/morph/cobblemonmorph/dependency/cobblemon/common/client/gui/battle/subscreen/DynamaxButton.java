...
public class DynamaxButton(moveSelection: BattleMoveSelection, x: Float, y: Float) : BattleGimmickButton(ShowdownMoveset.Gimmick.DYNAMAX, x, y) {
   ...
   public class DynamaxTile(moveSelection: BattleMoveSelection, move: InBattleMove, x: Float, y: Float) : BattleGimmickButton.GimmickTile(
         ShowdownMoveset.Gimmick.DYNAMAX, moveSelection, move, x, y
      ) {
