...
public final class Null {
   ...
   public static final JSClass NULL_CLASS = Null.NullClass.INSTANCE;
   ...
   static final class NullClass extends AbstractJSClass {
      static final Null.NullClass INSTANCE = new Null.NullClass();
      ...
      public TruffleString toDisplayStringImpl(JSDynamicObject object, boolean allowSideEffects, ToDisplayStringFormat format, int depth) {
         return object == Undefined.instance ? Null.DISPLAY_STRING_UNDEFINED : Null.DISPLAY_STRING_NULL;
      }
