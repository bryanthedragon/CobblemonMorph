...
extends JavaScriptBaseNode {
    ...
    public static JavaScriptNode create(JavaScriptNode object) {
        ...
        implements RepeatableNode {
            ...
            GetPrototypeOfNode(JavaScriptNode val$object) {
    ...
    static JSDynamicObject doCachedShape(JSDynamicObject obj, @Cached(value="obj.getShape()") Shape shape, @Cached(value="getPrototypeLocation(shape)") Location prototypeLocation) {
        assert (!JSGuards.isJSProxy(obj));
        return (JSDynamicObject)prototypeLocation.get((DynamicObject)obj, shape);
    }
    ...
    static JSDynamicObject doProxy(JSDynamicObject obj, @Cached(value="create()") JSClassProfile jsclassProfile) {
