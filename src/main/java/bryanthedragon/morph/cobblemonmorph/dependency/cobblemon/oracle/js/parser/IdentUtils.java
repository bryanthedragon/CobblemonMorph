...
public final class IdentUtils {
   private static final int[] ID_PART_RANGES = new int[]{
      36,
      36,
      48,
      57,
   ...
   private static final int[] ID_START_RANGES = new int[]{
      36,
      36,
      65,
      90,
   ...
   public static boolean isIdentifierStart(int codePoint) {
      return codePoint < 128 ? ID_START_ARRAY[codePoint] : contains(ID_START_RANGES, codePoint);
   }

   public static boolean isIdentifierPart(int codePoint) {
      return codePoint < 128 ? ID_PART_ARRAY[codePoint] : contains(ID_PART_RANGES, codePoint);
   }
