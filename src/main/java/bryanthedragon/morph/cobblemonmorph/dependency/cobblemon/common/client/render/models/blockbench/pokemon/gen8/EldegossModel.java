...
implements HeadedFrame {
    ...
    public EldegossModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "eldegoss");
        this.head = this.getPart("head");
        this.portraitScale = 2.6f;
        this.portraitTranslation = new Vec3(-0.25, -1.41, 0.0);
        this.profileScale = 0.62f;
        this.profileTranslation = new Vec3(0.07, 0.85, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> EldegossModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ EldegossModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "eldegoss", "blink", null, 4, null);
            }
        }, 7, null);
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "eldegoss", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "eldegoss", "ground_idle", null, 4, null)};
        objectArray = statelessAnimationArray;
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(EldegossModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "eldegoss", "cry", null, 4, null);
    }
}
