                    ...
                    if ((state_0 & 1) != 0) {
                        ...
                        while (s0_ != null) {
                            if (s0_.access_.accepts(targetNodeValue_)) {
                                return this.doField(targetNodeValue_, (HiddenKey)keyNodeValue__, valueNodeValue_, s0_.access_, s0_.errorBranch_);
                            }
                            s0_ = s0_.next_;
                        }
                    }
                    if ((state_0 & 2) != 0) {
                        return this.field1Boundary(state_0, targetNodeValue_, (HiddenKey)keyNodeValue__, valueNodeValue_);
                    }
                }
                if ((state_0 & 4) != 0 && keyNodeValue_ instanceof Accessor) {
                    keyNodeValue__ = (Accessor)keyNodeValue_;
                    return this.doAccessor(targetNodeValue_, (Accessor)keyNodeValue__, valueNodeValue_, this.accessor_callNode_, this.accessor_errorBranch_);
                }
            }
            if ((state_0 & 8) != 0 && PrivateFieldSetNodeGen.fallbackGuard_(state_0, targetNodeValue, keyNodeValue_, valueNodeValue_)) {
                    ...
                    if ((state_0 & 1) != 0) {
                        ...
                        while (s0_ != null) {
                            if (s0_.access_.accepts(targetNodeValue__)) {
                                return this.doField(targetNodeValue__, (HiddenKey)keyNodeValue__, valueNodeValue_, s0_.access_, s0_.errorBranch_);
                            }
                            s0_ = s0_.next_;
                        }
                    }
                    if ((state_0 & 2) != 0) {
                        return this.field1Boundary0(state_0, targetNodeValue__, (HiddenKey)keyNodeValue__, valueNodeValue_);
                    }
                }
                if ((state_0 & 4) != 0 && keyNodeValue_ instanceof Accessor) {
                    keyNodeValue__ = (Accessor)keyNodeValue_;
                    return this.doAccessor(targetNodeValue__, (Accessor)keyNodeValue__, valueNodeValue_, this.accessor_callNode_, this.accessor_errorBranch_);
                }
            }
            if ((state_0 & 8) != 0 && PrivateFieldSetNodeGen.fallbackGuard_(state_0, targetNodeValue_, keyNodeValue_, valueNodeValue_)) {
        ...
        try {
            ...
            if (targetNodeValue instanceof JSObject) {
                ...
                if (keyNodeValue instanceof HiddenKey) {
                    ...
                    if (exclude == 0) {
                        ...
                        if (s0_ != null) {
                            lock.unlock();
                            hasLock = false;
                            Object object = this.doField(targetNodeValue_, keyNodeValue_, valueNodeValue, s0_.access_, s0_.errorBranch_);
                            return object;
                        }
                    }
                    ...
                    lock.unlock();
                    hasLock = false;
                    Object object = this.doField(targetNodeValue_, keyNodeValue_, valueNodeValue, field1_access__, this.field1_errorBranch_);
                    return object;
                }
                if (keyNodeValue instanceof Accessor) {
                    ...
                    lock.unlock();
                    hasLock = false;
                    Object object = this.doAccessor(targetNodeValue_, keyNodeValue_, valueNodeValue, this.accessor_callNode_, this.accessor_errorBranch_);
                    return object;
                }
            }
