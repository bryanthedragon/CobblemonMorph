...
@GeneratedBy(JSGreaterOrEqualNode.class)
public final class JSGreaterOrEqualNodeGen extends JSGreaterOrEqualNode implements Introspection.Provider {
   ...
   @Node.Child
   private JSGreaterOrEqualNodeGen.GenericData generic_cache;
   ...
   public boolean executeBoolean(Object leftNodeValue, Object rightNodeValue) {
      ...
      if ((state_0 & 229376) != 0) {
         ...
         if ((state_0 & 131072) != 0) {
            JSGreaterOrEqualNodeGen.GenericData s17_ = this.generic_cache;
            if (s17_ != null && !this.hasOverloadedOperators(leftNodeValue) && !this.hasOverloadedOperators(rightNodeValue)) {
               return this.doGeneric(
                  leftNodeValue,
                  rightNodeValue,
                  s17_.toStringOrNumber1_,
                  s17_.toPrimitive1_,
                  s17_.toStringOrNumber2_,
                  s17_.toPrimitive2_,
                  s17_.greaterOrEqualNode_
               );
            }
         }
      }
   ...
   private boolean executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
      ...
      try {
         ...
         if ((exclude & 256) == 0 && JSGuards.isJavaNumber(leftNodeValue) && JSGuards.isJavaNumber(rightNodeValue)) {
            ...
            JSGreaterOrEqualNodeGen.GenericData s17_ = super.insert(new JSGreaterOrEqualNodeGen.GenericData());
