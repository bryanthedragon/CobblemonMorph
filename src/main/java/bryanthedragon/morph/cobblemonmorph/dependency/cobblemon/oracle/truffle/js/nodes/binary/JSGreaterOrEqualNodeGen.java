...
@GeneratedBy(value=JSGreaterOrEqualNode.class)
public final class JSGreaterOrEqualNodeGen
extends JSGreaterOrEqualNode
implements Introspection.Provider {
    ...
    private JSGreaterOrEqualNodeGen(JavaScriptNode left, JavaScriptNode right) {
        super(left, right);
    }
    ...
    public boolean executeBoolean(Object leftNodeValue, Object rightNodeValue) {
        ...
        if ((state_0 & 0x38000) != 0) {
            ...
            if ((state_0 & 0x20000) != 0 && (s17_ = this.generic_cache) != null && !this.hasOverloadedOperators(leftNodeValue) && !this.hasOverloadedOperators(rightNodeValue)) {
                return this.doGeneric(leftNodeValue, rightNodeValue, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.greaterOrEqualNode_);
            }
        }
    ...
    private boolean executeBoolean_generic6(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0x38000) != 0) {
            ...
            if ((state_0 & 0x20000) != 0 && (s17_ = this.generic_cache) != null && !this.hasOverloadedOperators(leftNodeValue_) && !this.hasOverloadedOperators(rightNodeValue_)) {
                return this.doGeneric(leftNodeValue_, rightNodeValue_, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.greaterOrEqualNode_);
            }
        }
        CompilerDirectives.transferToInterpreterAndInvalidate();
        return this.executeAndSpecialize(leftNodeValue_, rightNodeValue_);
    ...
    private boolean executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if (!this.hasOverloadedOperators(leftNodeValue) && !this.hasOverloadedOperators(rightNodeValue)) {
                ...
                s17_.greaterOrEqualNode_ = s17_.insertAccessor(JSGreaterOrEqualNode.create());
                ...
                lock.unlock();
                hasLock = false;
                boolean bl = this.doGeneric(leftNodeValue, rightNodeValue, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.greaterOrEqualNode_);
                return bl;
            }
    ...
    public Introspection getIntrospectionData() {
        ...
        if ((state_0 & 0x20000) != 0) {
            ...
            if (s17_ != null) {
                cached.add(Arrays.asList(s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.greaterOrEqualNode_));
            }
            s[2] = cached;
        } else {
            s[1] = (byte)0;
    ...
    public static JSGreaterOrEqualNode create(JavaScriptNode left, JavaScriptNode right) {
        return new JSGreaterOrEqualNodeGen(left, right);
    }
    ...
    extends Node {
        ...
        @Node.Child
        JSGreaterOrEqualNode greaterOrEqualNode_;
