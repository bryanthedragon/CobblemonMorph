...
public class UrsalunaModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = UrsalunaModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "ursaluna", "ground_idle", null, 4, null)
            },
            null,
      ...
      val var8: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "ursaluna", "ground_idle", null, 4, null),
         new QuadrupedWalkAnimation(this, 0.75F, 1.0F)
      };
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: UrsalunaModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
