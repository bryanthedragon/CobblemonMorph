...
QuadrupedFrame {
    ...
    public UrsalunaModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "ursaluna");
        this.head = this.getPart("head");
        this.foreLeftLeg = this.getPart("shoulder_left");
        this.foreRightLeg = this.getPart("shoulder_right");
        this.hindLeftLeg = this.getPart("thigh_left");
        this.hindRightLeg = this.getPart("thigh_right");
        this.portraitScale = 1.2f;
        this.portraitTranslation = new Vec3(-1.1, 0.4, 0.0);
        this.profileScale = 0.45f;
        this.profileTranslation = new Vec3(0.0, 0.9, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> UrsalunaModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ UrsalunaModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "ursaluna", "blink", null, 4, null);
            }
        }, 7, null);
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "ursaluna", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "ursaluna", "ground_idle", null, 4, null), new QuadrupedWalkAnimation(this, 0.75f, 1.0f)};
        objectArray = statelessAnimationArray;
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(UrsalunaModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "ursaluna", "cry", null, 4, null);
    }
}
