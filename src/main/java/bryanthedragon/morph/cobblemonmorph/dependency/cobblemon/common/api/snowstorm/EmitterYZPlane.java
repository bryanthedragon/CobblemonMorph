...
public class EmitterYZPlane : ParticleCameraMode {
   public open val type: ParticleCameraModeType = ParticleCameraModeType.EMITTER_YZ_PLANE
   ...
   public override fun getRotation(
      ...
      rotation.set(quat);
      var var10001: Quaternionf = Axis.f_252436_.m_252977_(180.0F);
      QuaternionUtilsKt.hamiltonProduct(rotation, var10001);
      var10001 = Axis.f_252436_.m_252977_(90.0F);
      QuaternionUtilsKt.hamiltonProduct(rotation, var10001);
      return rotation;
   }
   ...
   @JvmStatic
   fun `CODEC$lambda$2$lambda$0`(it: EmitterYZPlane): java.lang.String {
      return it.getType().name();
   }

   @JvmStatic
   fun `CODEC$lambda$2$lambda$1`(it: java.lang.String): EmitterYZPlane {
      return new EmitterYZPlane();
   }

   @JvmStatic
   fun `CODEC$lambda$2`(instance: Instance): App {
      return instance.group(PrimitiveCodec.STRING.fieldOf("type").forGetter(EmitterYZPlane::CODEC$lambda$2$lambda$0) as App)
         .apply(instance as Applicative, EmitterYZPlane::CODEC$lambda$2$lambda$1);
   }

   @JvmStatic
   fun {
      val var10000: Codec = RecordCodecBuilder.create(EmitterYZPlane::CODEC$lambda$2);
      CODEC = var10000;
   }

   public companion object {
      public final val CODEC: Codec<EmitterYZPlane>
   }
}
