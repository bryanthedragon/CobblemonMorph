...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.client.render.models.blockbench.pokemon.gen3.WailmerModel;
...
extends PokemonPoseableModel {
    ...
    public WailmerModel(@NotNull ModelPart root) {
    ...
    @NotNull
    public final ModelPart getFinLeft() {
        return this.finLeft;
    }

    @NotNull
    public final ModelPart getFinRight() {
        return this.finRight;
    }

    @NotNull
    public final ModelPart getJaw() {
        return this.jaw;
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{this.rotation(this.finLeft, (Function1<Float, Float>)WaveFunctionKt.sineFunction$default(0.25f, 4.0f, 0.0f, 0.0f, 12, null), 2, registerPoses.1.INSTANCE), this.rotation(this.finRight, (Function1<Float, Float>)WaveFunctionKt.sineFunction$default(-0.25f, 4.0f, 0.0f, 0.0f, 12, null), 2, registerPoses.2.INSTANCE), this.rotation(this.jaw, (Function1<Float, Float>)WaveFunctionKt.sineFunction$default(0.05f, 8.0f, 0.0f, 0.04f, 4, null), 0, registerPoses.3.INSTANCE)};
        this.setStanding(PoseableEntityModel.registerPose$default(poseableEntityModel, "standing", SetsKt.plus((Set)set2, (Iterable)enumSet2), null, 0, null, null, statelessAnimationArray, null, null, 436, null));
        ...
        statelessAnimationArray = new StatelessAnimation[]{this.rotation(this.finLeft, (Function1<Float, Float>)WaveFunctionKt.sineFunction$default(0.33333334f, 3.0f, 0.0f, 0.0f, 12, null), 2, registerPoses.4.INSTANCE), this.rotation(this.finRight, (Function1<Float, Float>)WaveFunctionKt.sineFunction$default(-0.33333334f, 3.0f, 0.0f, 0.0f, 12, null), 2, registerPoses.5.INSTANCE), this.rotation(this.jaw, (Function1<Float, Float>)WaveFunctionKt.sineFunction$default(0.05f, 8.0f, 0.0f, 0.04f, 4, null), 0, registerPoses.6.INSTANCE)};
        this.setWalk(PoseableEntityModel.registerPose$default(poseableEntityModel2, "walk", enumSet3, null, 0, null, null, statelessAnimationArray, null, null, 436, null));
    }
}
