...
@GeneratedBy(value=DefineMethodPropertyNode.class)
public final class DefineMethodPropertyNodeGen
extends DefineMethodPropertyNode {
    ...
    public void executeDefine(JSDynamicObject arg0Value, ClassElementDefinitionRecord arg1Value, boolean arg2Value) {
        ...
        if (state_0 != 0) {
            ...
            if ((state_0 & 0x10) != 0 && arg1Value instanceof ClassElementDefinitionRecord.AutoAccessor && (arg1Value_ = (ClassElementDefinitionRecord.AutoAccessor)arg1Value).isAutoAccessor() && !arg1Value_.isPrivate()) {
    ...
    private void executeAndSpecialize(JSDynamicObject arg0Value, ClassElementDefinitionRecord arg1Value, boolean arg2Value) {
        ...
        if (arg1Value.isMethod() && !arg1Value.isPrivate()) {
            this.state_0_ = state_0 |= 2;
            this.doMethod(arg0Value, arg1Value, arg2Value);
            return;
        }
        if (arg1Value.isGetter() && !arg1Value.isPrivate()) {
            this.state_0_ = state_0 |= 4;
            this.doGetter(arg0Value, arg1Value, arg2Value);
            return;
        }
        if (arg1Value.isSetter() && !arg1Value.isPrivate()) {
            this.state_0_ = state_0 |= 8;
            this.doSetter(arg0Value, arg1Value, arg2Value);
            return;
        }
        if (arg1Value instanceof ClassElementDefinitionRecord.AutoAccessor && (arg1Value_ = (ClassElementDefinitionRecord.AutoAccessor)arg1Value).isAutoAccessor() && !arg1Value_.isPrivate()) {
