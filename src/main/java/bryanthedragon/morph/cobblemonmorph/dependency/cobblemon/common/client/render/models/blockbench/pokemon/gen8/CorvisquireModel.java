...
public class CorvisquireModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = CorvisquireModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setSleep(
         PoseableEntityModel.registerPose$default(
            ...
            null,
            null,
            new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "corvisquire", "sleep", null, 4, null)},
            null,
            null,
            222,
            null
      ...
      var var16: EnumSet = PoseType.Companion.getSHOULDER_POSES();
      val var17: java.util.Set = var16;
      var var22: EnumSet = PoseType.Companion.getUI_POSES();
      this.setStand(
         PoseableEntityModel.registerPose$default(
            this,
            "standing",
            SetsKt.plus(SetsKt.plus(var17, var22), PoseType.STAND),
            null,
            10,
            null,
            null,
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "corvisquire", "ground_idle", null, 4, null)
            },
            null,
      ...
      var16 = PoseType.Companion.getSTATIONARY_POSES();
      val var19: java.util.Set = SetsKt.minus(var16, PoseType.STAND);
      var22 = PoseType.Companion.getUI_POSES();
      val var20: java.util.Set = SetsKt.minus(var19, var22);
      var22 = PoseType.Companion.getSHOULDER_POSES();
      this.setHover(
         PoseableEntityModel.registerPose$default(
            this,
            "hover",
            SetsKt.minus(var20, var22),
            null,
            10,
            null,
            null,
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "corvisquire", "air_idle", null, 4, null)
            },
            null,
            new ModelQuirk[]{blink},
            180,
      ...
      this.setFly(
         PoseableEntityModel.registerPose$default(
            this,
            "fly",
            SetsKt.minus(var16, PoseType.WALK),
            null,
            10,
            null,
            null,
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "corvisquire", "air_fly", null, 4, null)
            },
            null,
            new ModelQuirk[]{blink},
            180,
      ...
      this.setWalk(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
               PoseableEntityModel.bedrock$default(this, "corvisquire", "ground_walk", null, 4, null)
            },
            null,
            new ModelQuirk[]{blink},
            180,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: CorvisquireModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
