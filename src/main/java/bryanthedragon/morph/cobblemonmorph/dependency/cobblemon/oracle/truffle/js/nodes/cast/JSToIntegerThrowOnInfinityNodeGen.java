...
public final class JSToIntegerThrowOnInfinityNodeGen extends JSToIntegerThrowOnInfinityNode implements Introspection.Provider {
   ...
   private Object executeAndSpecialize(Object arg0Value) {
      ...
      try {
         ...
         if (arg0Value instanceof Integer) {
            ...
            lock.unlock();
            hasLock = false;
            return JSToIntegerThrowOnInfinityNode.doInteger(arg0Value_x);
         }
         ...
         if (arg0Value instanceof Long) {
            ...
            lock.unlock();
            hasLock = false;
            return JSToIntegerThrowOnInfinityNode.doLong(arg0Value_x);
         }
         ...
         if (arg0Value instanceof Boolean) {
            ...
            lock.unlock();
            hasLock = false;
            return JSToIntegerThrowOnInfinityNode.doBoolean(arg0Value_x);
         }
         ...
         if (arg0Value instanceof SafeInteger) {
            ...
            lock.unlock();
            hasLock = false;
            return JSToIntegerThrowOnInfinityNode.doSafeInteger(arg0Value_x);
         }
         ...
         if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(arg0Value)) != 0) {
            ...
            lock.unlock();
            hasLock = false;
            return this.doDoubleInfinite(arg0Value_x);
         }
