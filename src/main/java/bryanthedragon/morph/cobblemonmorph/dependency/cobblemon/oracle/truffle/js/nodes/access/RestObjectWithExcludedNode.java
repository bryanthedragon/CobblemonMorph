...
abstract class RestObjectWithExcludedNode extends JavaScriptNode {
   ...
   protected final Object doOther(
      JSDynamicObject restObj, Object source, Object[] excludedItems, @Cached("createToObjectNoCheck(context)") JSToObjectNode toObjectNode
   ) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return RestObjectWithExcludedNodeGen.create(
         this.context,
         cloneUninitialized(this.targetNode, materializedTags),
         cloneUninitialized(this.sourceNode, materializedTags),
         cloneUninitialized(this.excludedNode, materializedTags)
      );
   }
}
