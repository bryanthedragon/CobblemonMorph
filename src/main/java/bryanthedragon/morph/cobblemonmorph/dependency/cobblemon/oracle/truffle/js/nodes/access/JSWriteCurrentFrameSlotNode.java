...
abstract class JSWriteCurrentFrameSlotNode extends JSWriteFrameSlotNode {
   ...
   protected final int doInteger(VirtualFrame frame, int value, @Bind("getFrameDescriptor(frame).getSlotKind(slot)") FrameSlotKind kind) {
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      return JSWriteCurrentFrameSlotNodeGen.create(this.getSlotIndex(), this.getIdentifier(), cloneUninitialized(this.getRhs(), materializedTags));
   }
