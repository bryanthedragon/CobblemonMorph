...
final class LocalVarPrefixIncNodeGen extends LocalVarPrefixIncNode implements Introspection.Provider {
   ...
   @Node.Child
   private LocalVarPrefixIncNodeGen.ObjectData object_cache;

   private LocalVarPrefixIncNodeGen(LocalVarIncNode.LocalVarOp op, int slot, Object identifier, boolean hasTemporalDeadZone, ScopeFrameNode scopeFrameNode) {
   ...
   public Object execute(VirtualFrame frameValue) {
      ...
      if (state_0 != 0) {
         ...
         if ((state_0 & 16) != 0 && scopeFrameNodeValue_.isInt(this.slot) && this.isDoubleKind(scopeFrameNodeValue_)) {
            return this.doIntOverflow(scopeFrameNodeValue_);
         }

         if ((state_0 & 32) != 0 && scopeFrameNodeValue_.isInt(this.slot)) {
            return this.doIntOverflowObject(scopeFrameNodeValue_);
         }
         ...
         if ((state_0 & 256) != 0) {
            LocalVarPrefixIncNodeGen.ObjectData s8_ = this.object_cache;
         ...
         if ((state_0 & 2048) != 0 && scopeFrameNodeValue_.isLong(this.slot)) {
            return this.doSafeIntegerToObject(scopeFrameNodeValue_);
         }
   ...
   public void executeVoid(VirtualFrame frameValue) {
      ...
      try {
         if ((state_0 & 8176) == 0 && state_0 != 0) {
            this.executeInt(frameValue);
         } else if ((state_0 & 4879) == 0 && state_0 != 0) {
   ...
   private Object executeAndSpecialize(Frame scopeFrameNodeValue) {
      ...
      try {
         ...
         if ((exclude & 8) == 0 && scopeFrameNodeValue.isInt(this.slot) && this.isDoubleKind(scopeFrameNodeValue)) {
            ...
            lock.unlock();
            hasLock = false;
            return this.doIntOverflow(scopeFrameNodeValue);
         }
         ...
         if (scopeFrameNodeValue.isInt(this.slot)) {
            ...
            lock.unlock();
            hasLock = false;
            return this.doIntOverflowObject(scopeFrameNodeValue);
         }
         ...
         if (scopeFrameNodeValue.isObject(this.slot)) {
            LocalVarPrefixIncNodeGen.ObjectData s8_ = super.insert(new LocalVarPrefixIncNodeGen.ObjectData());
         ...
         if ((exclude & 32) != 0 || !scopeFrameNodeValue.isLong(this.slot) || !this.isLongKind(scopeFrameNodeValue)) {
            if ((exclude & 64) != 0 || !scopeFrameNodeValue.isLong(this.slot) || !this.isDoubleKind(scopeFrameNodeValue)) {
               ...
               lock.unlock();
               hasLock = false;
               return this.doSafeIntegerToObject(scopeFrameNodeValue);
            }
   ...
   public Introspection getIntrospectionData() {
      ...
      data[5] = s;
      s = new Object[]{"doIntOverflowObject", null, null};
      if ((state_0 & 32) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
      ...
      data[11] = s;
      s = new Object[]{"doSafeIntegerToObject", null, null};
      if ((state_0 & 2048) != 0) {
         s[1] = (byte)1;
      } else {
         s[1] = (byte)0;
   ...
   public static LocalVarPrefixIncNode create(
      LocalVarIncNode.LocalVarOp op, int slot, Object identifier, boolean hasTemporalDeadZone, ScopeFrameNode scopeFrameNode
   ) {
      return new LocalVarPrefixIncNodeGen(op, slot, identifier, hasTemporalDeadZone, scopeFrameNode);
   }
