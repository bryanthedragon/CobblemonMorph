...
@GeneratedBy(value=LocalVarPrefixIncNode.class)
final class LocalVarPrefixIncNodeGen
extends LocalVarPrefixIncNode
implements Introspection.Provider {
    ...
    public void executeVoid(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        try {
            if ((state_0 & 0x1FF0) == 0 && state_0 != 0) {
                this.executeInt(frameValue);
                return;
            }
            if ((state_0 & 0x130F) == 0 && state_0 != 0) {
    ...
    public static LocalVarPrefixIncNode create(LocalVarIncNode.LocalVarOp op, int slot, Object identifier, boolean hasTemporalDeadZone, ScopeFrameNode scopeFrameNode) {
