...
public final class JSBitwiseAndNodeGen extends JSBitwiseAndNode implements Introspection.Provider {
   ...
   @Node.Child
   private JSBitwiseAndNodeGen.GenericData generic_cache;
   ...
   public Object executeObject(Object leftNodeValue, Object rightNodeValue) {
      ...
      if ((state_0 & 192) != 0) {
         ...
         if ((state_0 & 128) != 0) {
            JSBitwiseAndNodeGen.GenericData s7_ = this.generic_cache;
   ...
   private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
      ...
      try {
         ...
         if (this.hasOverloadedOperators(leftNodeValue) || this.hasOverloadedOperators(rightNodeValue)) {
            ...
            JSBitwiseAndNodeGen.GenericData s7_ = super.insert(new JSBitwiseAndNodeGen.GenericData());
