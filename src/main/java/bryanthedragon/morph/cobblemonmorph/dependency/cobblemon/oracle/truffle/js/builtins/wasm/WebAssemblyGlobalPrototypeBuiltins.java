...
public class WebAssemblyGlobalPrototypeBuiltins extends JSBuiltinsContainer.SwitchEnum<WebAssemblyGlobalPrototypeBuiltins.WebAssemblyGlobalPrototype> {
   ...
   protected WebAssemblyGlobalPrototypeBuiltins() {
      super(JSWebAssemblyGlobal.PROTOTYPE_NAME, WebAssemblyGlobalPrototypeBuiltins.WebAssemblyGlobalPrototype.class);
   }

   protected Object createNode(
      JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, WebAssemblyGlobalPrototypeBuiltins.WebAssemblyGlobalPrototype builtinEnum
   ) {
      switch (builtinEnum) {
         case valueOf:
            return WebAssemblyGlobalPrototypeBuiltinsFactory.WebAssemblyGlobalValueOfNodeGen.create(
   ...
   public static enum WebAssemblyGlobalPrototype implements BuiltinEnum<WebAssemblyGlobalPrototypeBuiltins.WebAssemblyGlobalPrototype> {
      valueOf(0);
