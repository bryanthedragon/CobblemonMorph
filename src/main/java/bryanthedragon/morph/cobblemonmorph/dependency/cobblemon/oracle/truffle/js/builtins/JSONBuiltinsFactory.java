...
public final class JSONBuiltinsFactory {
   ...
   public static final class JSONParseNodeGen extends JSONBuiltins.JSONParseNode implements Introspection.Provider {
      @Node.Child
      ...
      private Object executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
         ...
         IsCallableNode parse_isCallable__;
         try {
            int state_0 = this.state_0_;
            ...
            if (!Parse_duplicateFound_) {
               parse_isCallable__ = super.insert(this.isCallable == null ? IsCallableNode.create() : this.isCallable);
               if (parse_isCallable__.executeBoolean(arguments1Value) && (state_0 & 1) == 0) {
                  if (this.isCallable == null) {
                     ...
                     if (parse_isCallable___check == null) {
                        throw new AssertionError(
                           "Specialization 'parse(Object, Object, IsCallableNode)' contains a shared cache with name 'isCallable' that returned a null value for the cached initializer. Null values are not supported for shared cached initializers because null is reserved for the uninitialized state."
                        );
                     }
            ...
            if (!Parse_duplicateFound_) {
               ...
               if (!ParseUnfiltered_duplicateFound_) {
                  ...
                  if (!parseUnfiltered_isCallable__.executeBoolean(arguments1Value) && (state_0 & 2) == 0) {
                     if (this.isCallable == null) {
                        ...
                        if (parseUnfiltered_isCallable___check == null) {
                           throw new AssertionError(
                              "Specialization 'parseUnfiltered(Object, Object, IsCallableNode)' contains a shared cache with name 'isCallable' that returned a null value for the cached initializer. Null values are not supported for shared cached initializers because null is reserved for the uninitialized state."
                           );
                        }
               ...
               lock.unlock();
               hasLock = false;
               return this.parseUnfiltered(arguments0Value, arguments1Value, this.isCallable);
            }

            lock.unlock();
            hasLock = false;
            parse_isCallable__ = (IsCallableNode)this.parse(arguments0Value, arguments1Value, this.isCallable);
         } finally {
            if (hasLock) {
               lock.unlock();
            }
      ...
      public Introspection getIntrospectionData() {
         ...
         data[1] = s;
         s = new Object[]{"parseUnfiltered", null, null};
         if ((state_0 & 2) != 0) {
            s[1] = (byte)1;
            ArrayList<Object> cached = new ArrayList<>();
            cached.add(Arrays.asList(this.isCallable));
      ...
      public static JSONBuiltins.JSONParseNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new JSONBuiltinsFactory.JSONParseNodeGen(context, builtin, arguments);
      }
   }

   @GeneratedBy(JSONBuiltins.JSONStringifyNode.class)
   public static final class JSONStringifyNodeGen extends JSONBuiltins.JSONStringifyNode implements Introspection.Provider {
      @Node.Child
      private JavaScriptNode arguments0_;
      @Node.Child
      private JavaScriptNode arguments1_;
      ...
      private volatile int state_0_;
      @Node.Child
      private JSONBuiltinsFactory.JSONStringifyNodeGen.StringifyAStringNoReplacerData stringifyAStringNoReplacer_cache;
         ...
         if (state_0 != 0) {
            if ((state_0 & 3) != 0) {
               ...
               if ((state_0 & 2) != 0 && arguments1Value_ instanceof JSDynamicObject) {
                  ...
                  if (this.isArray(arguments1Value__)) {
            ...
            if ((state_0 & 12) != 0) {
               if ((state_0 & 4) != 0 && arguments0Value_ instanceof TruffleString) {
                  ...
                  JSONBuiltinsFactory.JSONStringifyNodeGen.StringifyAStringNoReplacerData s2_ = this.stringifyAStringNoReplacer_cache;
                  if (s2_ != null && !this.isCallable(arguments1Value_) && !this.isArray(arguments1Value_)) {
                     return this.stringifyAStringNoReplacer(
                        arguments0Value__,
                        arguments1Value_,
                        arguments2Value_,
                        s2_.stringBuilderProfile_,
                        s2_.appendRawValueNode_,
                        s2_.appendStringNode_,
                        s2_.builderToStringNode_
                     );
                  }
               }
      ...
      private Object executeAndSpecialize(Object arguments0Value, Object arguments1Value, Object arguments2Value) {
         ...
         try {
            ...
            if (this.isCallable(arguments1Value)) {
               ...
               lock.unlock();
               hasLock = false;
               return this.stringify(arguments0Value, arguments1Value, arguments2Value);
            } else {
               if (arguments1Value instanceof JSDynamicObject) {
                  ...
                  if (this.isArray(arguments1Value_)) {
                     ...
                     lock.unlock();
                     hasLock = false;
                     return this.stringifyReplacerArray(arguments0Value, arguments1Value_, arguments2Value);
                  }
               }
               ...
               if (arguments0Value instanceof TruffleString) {
                  ...
                  if (!this.isCallable(arguments1Value) && !this.isArray(arguments1Value)) {
                     JSONBuiltinsFactory.JSONStringifyNodeGen.StringifyAStringNoReplacerData s2_ = super.insert(
                        new JSONBuiltinsFactory.JSONStringifyNodeGen.StringifyAStringNoReplacerData()
                     );
               ...
               if (JSGuards.isString(arguments0Value) || this.isCallable(arguments1Value) || this.isArray(arguments1Value)) {
                  ...
                  lock.unlock();
                  hasLock = false;
                  return this.stringifyNoReplacer(arguments0Value, arguments1Value, arguments2Value);
               }
            }
         } finally {
            if (hasLock) {
      ...
      public Introspection getIntrospectionData() {
         ...
         data[0] = 0;
         int state_0 = this.state_0_;
         Object[] s = new Object[]{"stringify", null, null};
         if ((state_0 & 1) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
         ...
         data[1] = s;
         s = new Object[]{"stringifyReplacerArray", null, null};
         if ((state_0 & 2) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
         ...
         data[2] = s;
         s = new Object[]{"stringifyAStringNoReplacer", null, null};
         if ((state_0 & 4) != 0) {
            s[1] = (byte)1;
            ArrayList<Object> cached = new ArrayList<>();
            JSONBuiltinsFactory.JSONStringifyNodeGen.StringifyAStringNoReplacerData s2_ = this.stringifyAStringNoReplacer_cache;
         ...
         data[3] = s;
         s = new Object[]{"stringifyNoReplacer", null, null};
         if ((state_0 & 8) != 0) {
            s[1] = (byte)1;
         } else {
            s[1] = (byte)0;
      ...
      public static JSONBuiltins.JSONStringifyNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
         return new JSONBuiltinsFactory.JSONStringifyNodeGen(context, builtin, arguments);
      }

      @GeneratedBy(JSONBuiltins.JSONStringifyNode.class)
      private static final class StringifyAStringNoReplacerData extends Node {
         @CompilerDirectives.CompilationFinal
