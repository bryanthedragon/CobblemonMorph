...
public class SceptileModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame {
   ...
   init {
      ...
      this.cryAnimation = SceptileModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "sceptile", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: SceptileModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
