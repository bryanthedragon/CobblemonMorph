...
@GeneratedBy(value=RegexObject.RegexObjectExecBooleanMethod.class)
final class RegexObjectExecBooleanMethodGen {
    private RegexObjectExecBooleanMethodGen() {
    }

    static {
        LibraryExport.register(RegexObject.RegexObjectExecBooleanMethod.class, new InteropLibraryExports());
    }
        ...
        extends AbstractRegexObjectGen.InteropLibraryExports.Cached {
            ...
            private boolean executeAndSpecialize(RegexObject.RegexObjectExecBooleanMethod arg0Value, Object[] arg1Value) throws ArityException, UnsupportedTypeException, UnsupportedMessageException {
                ...
                try {
                    ...
                    lock.unlock();
                    hasLock = false;
                    boolean bl = arg0Value.execute(arg1Value, s0_.expectStringOrTruffleObjectNode_, s0_.toLongNode_, s0_.execNode_);
                    return bl;
                }
                finally {
                    if (hasLock) {
