...
public final class AccessArgumentsArrayDirectlyNode extends JavaScriptNode {
   ...
   public Object execute(VirtualFrame frame) {
      return this.directArrayAccess ? this.asObjectArray(frame) : this.asArgumentsObject(frame);
   }
   ...
   private Object asArgumentsObject(VirtualFrame frame) {
      ...
      return this.initializedProfile.profile(ArgumentsObjectNode.isInitialized(argumentsArray)) ? argumentsArray : this.writeArgumentsNode.execute(frame);
   }
   ...
   protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
      AccessArgumentsArrayDirectlyNode copy = new AccessArgumentsArrayDirectlyNode(
         cloneUninitialized(this.writeArgumentsNode, materializedTags), cloneUninitialized(this.readArgumentsNode, materializedTags), this.leadingArgCount
      );
