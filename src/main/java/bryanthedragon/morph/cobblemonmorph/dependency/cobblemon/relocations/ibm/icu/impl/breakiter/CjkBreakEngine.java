...
import com.cobblemon.mod.relocations.ibm.icu.impl.breakiter.DictionaryData;
...
extends DictionaryBreakEngine {
    ...
    private static boolean isKatakana(int value2) {
        return value2 >= 12449 && value2 <= 12542 && value2 != 12539 || value2 >= 65382 && value2 <= 65439;
    }
    ...
    private String getPatternFromText(CharacterIterator text, StringBuffer sb, int start2, int length) {
        sb.setLength(0);
        if (length > 0) {
