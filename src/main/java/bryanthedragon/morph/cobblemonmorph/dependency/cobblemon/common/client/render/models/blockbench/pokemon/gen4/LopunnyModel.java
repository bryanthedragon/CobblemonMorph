...
public class LopunnyModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame {
   ...
   init {
      ...
      this.cryAnimation = LopunnyModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "lopunny", "ground_idle", null, 4, null)
            },
            null,
      ...
      val var8: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "lopunny", "ground_idle", null, 4, null),
         new BipedWalkAnimation(this, 0.7F, 0.7F)
      };
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: LopunnyModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
