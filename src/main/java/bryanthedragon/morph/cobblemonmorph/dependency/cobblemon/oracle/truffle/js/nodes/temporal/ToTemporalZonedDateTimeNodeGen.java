...
public final class ToTemporalZonedDateTimeNodeGen extends ToTemporalZonedDateTimeNode implements Introspection.Provider {
   @CompilerDirectives.CompilationFinal
   private volatile int state_0_;
   @Node.Child
   private ToTemporalZonedDateTimeNodeGen.ToTemporalZonedDateTimeData toTemporalZonedDateTime_cache;
   ...
   public JSDynamicObject executeDynamicObject(Object arg0Value, JSDynamicObject arg1Value) {
      ...
      if (state_0 != 0) {
         ToTemporalZonedDateTimeNodeGen.ToTemporalZonedDateTimeData s0_ = this.toTemporalZonedDateTime_cache;
         if (s0_ != null) {
            return this.toTemporalZonedDateTime(
               arg0Value,
               arg1Value,
               s0_.isObjectNode_,
               s0_.toStringNode_,
   ...
   private JSDynamicObject executeAndSpecialize(Object arg0Value, JSDynamicObject arg1Value) {
      ...
      try {
         int state_0 = this.state_0_;
         ToTemporalZonedDateTimeNodeGen.ToTemporalZonedDateTimeData s0_ = super.insert(new ToTemporalZonedDateTimeNodeGen.ToTemporalZonedDateTimeData());
         ...
         lock.unlock();
         hasLock = false;
         var7 = this.toTemporalZonedDateTime(
            arg0Value,
            arg1Value,
            s0_.isObjectNode_,
            s0_.toStringNode_,
   ...
   public Introspection getIntrospectionData() {
      ...
      int state_0 = this.state_0_;
      Object[] s = new Object[]{"toTemporalZonedDateTime", null, null};
      if (state_0 != 0) {
         s[1] = (byte)1;
   ...
   @GeneratedBy(ToTemporalZonedDateTimeNode.class)
   private static final class ToTemporalZonedDateTimeData extends Node {
      @Node.Child
