...
public class AccessRestArgumentsNode extends AccessIndexedArgumentNode {
   ...
   public Object execute(VirtualFrame frame) {
      ...
      return this.profile(restLength > 0)
         ? JSArray.create(
            this.context, realm, ConstantObjectArray.createConstantObjectArray(), JSArguments.extractUserArguments(jsArguments, this.index), restLength
         )
         : JSArray.createEmptyZeroLength(this.context, realm);
   }
