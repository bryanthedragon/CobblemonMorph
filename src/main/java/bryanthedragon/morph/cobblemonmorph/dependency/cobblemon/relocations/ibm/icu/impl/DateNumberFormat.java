...
public final class DateNumberFormat extends NumberFormat {
   ...
   private void initialize(ULocale loc, String digitString, String nsName) {
      ...
      if (elems == null) {
         ICUResourceBundle rb = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", loc);
   ...
   @Override
   public StringBuffer format(com.cobblemon.mod.relocations.ibm.icu.math.BigDecimal number, StringBuffer toAppendTo, FieldPosition pos) {
      throw new UnsupportedOperationException("StringBuffer format(BigDecimal, StringBuffer, FieldPosition) is not implemented");
   }
