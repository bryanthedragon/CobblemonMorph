...
@GeneratedBy(value=WebAssemblyTablePrototypeBuiltins.class)
public final class WebAssemblyTablePrototypeBuiltinsFactory {

    @GeneratedBy(value=WebAssemblyTablePrototypeBuiltins.WebAssemblyTableSetNode.class)
    public static final class WebAssemblyTableSetNodeGen
    extends WebAssemblyTablePrototypeBuiltins.WebAssemblyTableSetNode
    ...
    @GeneratedBy(value=WebAssemblyTablePrototypeBuiltins.WebAssemblyTableGetNode.class)
    public static final class WebAssemblyTableGetNodeGen
    extends WebAssemblyTablePrototypeBuiltins.WebAssemblyTableGetNode
    implements Introspection.Provider {
        @Node.Child
        private JavaScriptNode arguments0_;
        @Node.Child
    ...
    @GeneratedBy(value=WebAssemblyTablePrototypeBuiltins.WebAssemblyTableGrowNode.class)
    public static final class WebAssemblyTableGrowNodeGen
    extends WebAssemblyTablePrototypeBuiltins.WebAssemblyTableGrowNode
    implements Introspection.Provider {
        @Node.Child
        private JavaScriptNode arguments0_;
        @Node.Child
