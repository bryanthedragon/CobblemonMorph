...
package bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.entity.pokemon.ai.sensors
...
public class PokemonGrowableCropSensor : Sensor<PokemonEntity>() {
    ...
    private fun findBoneMealPos(ServerLevel world, entity: PokemonEntity): Optional<BlockPos> {
    ...
    private fun canBoneMeal(BlockPos pos, ServerLevel world): Boolean {
