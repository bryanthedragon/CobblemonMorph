...
class AnyTransliterator extends Transliterator {
   ...
   protected void handleTransliterate(Replaceable text, Transliterator.Position pos, boolean isIncremental) {
      ...
      AnyTransliterator.ScriptRunIterator it = new AnyTransliterator.ScriptRunIterator(text, pos.contextStart, pos.contextLimit);
   ...
   public AnyTransliterator(
      String id, UnicodeFilter filter, String target2, int targetScript2, Transliterator widthFix2, ConcurrentHashMap<Integer, Transliterator> cache2
   ) {
      super(id, filter);
