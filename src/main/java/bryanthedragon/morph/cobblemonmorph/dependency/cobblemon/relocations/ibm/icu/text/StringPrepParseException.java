...
extends ParseException {
    ...
    private void setPreContext(char[] str, int pos) {
        int start2 = pos <= 16 ? 0 : pos - 15;
        int len = start2 <= 16 ? start2 : 16;
        this.preContext.append(str, start2, len);
    }
    ...
    private void setPostContext(char[] str, int pos) {
        int start2 = pos;
        int len = str.length - start2;
        this.postContext.append(str, start2, len);
    }
