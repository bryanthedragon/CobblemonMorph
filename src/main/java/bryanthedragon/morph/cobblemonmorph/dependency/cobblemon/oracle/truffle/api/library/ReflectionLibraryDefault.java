...
final class ReflectionLibraryDefault {
    ...
    static class Send {
        ...
        static Object doSendCached(Object receiver, Message message, Object[] args, @Cached(value="message") Message cachedMessage, @Cached(value="createLibrary(message, receiver)") Library cachedLibrary) throws Exception {
        ...
        static Object doSendGeneric(Object receiver, Message message, Object[] args) throws Exception {
            ...
            return lib.genericDispatch((Library)lib.getUncached(receiver), receiver, message, args, 0);
        }
    }
}
