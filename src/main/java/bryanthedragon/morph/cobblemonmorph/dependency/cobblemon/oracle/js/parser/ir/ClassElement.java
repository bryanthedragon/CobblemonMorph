...
public final class ClassElement extends PropertyNode {
   ...
   public static ClassElement createMethod(
      long token, int finish, Expression key, Expression value, List<Expression> decorators, boolean isStatic, boolean hasComputedKey
   ) {
      return new ClassElement(token, finish, 1, key, value, null, null, decorators, hasComputedKey, false, isStatic, false);
   }

   public static ClassElement createAccessor(
      long token,
      int finish,
      Expression key,
      FunctionNode get,
      ...
      return new ClassElement(token, finish, 2, key, null, get, set, decorators, hasComputedKey, false, isStatic, false);
   }

   public static ClassElement createField(
      long token,
      int finish,
      Expression key,
      ...
      return new ClassElement(token, finish, 4, key, initialize, null, null, decorators, hasComputedKey, anonymousFunctionDefinition, isStatic, false);
   }

   public static ClassElement createDefaultConstructor(long token, int finish, Expression key, Expression value) {
      return new ClassElement(token, finish, 1, key, value, null, null, null, false, false, false, false);
   }

   public static ClassElement createStaticInitializer(long token, int finish, FunctionNode functionNode) {
      return new ClassElement(token, finish, 8, null, functionNode, null, null, null, false, false, true, false);
   }

   public static ClassElement createAutoAccessor(
      long token,
      int finish,
      Expression key,
      ...
      return new ClassElement(
         token, finish, 4, key, initializer, null, null, classElementDecorators, hasComputedKey, anonymousFunctionDefinition, isStatic, true
      );
   }
   ...
   public Node accept(NodeVisitor<? extends LexicalContext> visitor) {
      if (visitor.enterClassElement(this)) {
         ClassElement element = this.setKey(this.key == null ? null : (Expression)this.key.accept(visitor))
