...
public class JSModuleRecord extends ScriptOrModule {
   ...
   private JSModuleRecord.Status status;
   ...
   public boolean hasBeenEvaluated() {
      return this.getStatus() == JSModuleRecord.Status.Evaluated || this.getStatus() == JSModuleRecord.Status.EvaluatingAsync;
   }
   ...
   private void initializeMetaObject(JSObject metaObj) {
      JSObject.set(metaObj, Strings.URL, Strings.fromJavaString(this.getSource().getURI().toString()));
   }

   public void setUnlinked() {
      this.setStatus(JSModuleRecord.Status.Unlinked);
