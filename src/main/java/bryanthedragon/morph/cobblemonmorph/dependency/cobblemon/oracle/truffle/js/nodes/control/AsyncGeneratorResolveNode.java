...
extends JavaScriptBaseNode {
    ...
    public Object execute(VirtualFrame frame, JSDynamicObject generator, Object value2, boolean done) {
        this.performResolve(frame, generator, value2, done);
    ...
    void performResolve(VirtualFrame frame, JSDynamicObject generator, Object value2, boolean done) {
        ...
        JSDynamicObject iteratorResult = this.createIterResultObjectNode.execute(frame, value2, done);
