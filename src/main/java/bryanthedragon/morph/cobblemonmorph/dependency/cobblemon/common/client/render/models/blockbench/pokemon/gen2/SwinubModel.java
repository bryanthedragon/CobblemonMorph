...
extends PokemonPoseableModel {
    ...
    public SwinubModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "swinub");
        this.portraitScale = 2.6800003f;
        this.portraitTranslation = new Vec3(-0.2, -2.5200000000000102, 0.0);
        this.profileScale = 1.2300003f;
        this.profileTranslation = new Vec3(0.0, -0.13999999999999968, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> SwinubModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "swinub", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "swinub", "ground_idle", null, 4, null)};
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(SwinubModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "swinub", "cry", null, 4, null);
    }
}
