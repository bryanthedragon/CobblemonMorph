...
public class SamurottHisuianModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, QuadrupedFrame {
   ...
   init {
      ...
      this.cryAnimation = SamurottHisuianModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "samurott_hisuian", "ground_idle", null, 4, null)
            },
      ...
      val var14: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "samurott_hisuian", "battle_pose", null, 4, null)
      };
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: SamurottHisuianModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
