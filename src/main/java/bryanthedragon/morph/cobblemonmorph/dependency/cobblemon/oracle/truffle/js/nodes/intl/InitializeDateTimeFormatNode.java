...
public abstract class InitializeDateTimeFormatNode extends JavaScriptBaseNode {
      ...
      try {
         ...
         if (dateStyleOpt == null && timeStyleOpt == null
            || weekdayOpt == null
               ...
               && tzNameOpt == null) {
            JSDateTimeFormat.setupInternalDateTimeFormat(
               this.context,
               state,
               locales,
               weekdayOpt,
         ...
         this.errorBranch.enter();
         throw Errors.createICU4JDataError(var26);
      }
   }
   ...
   private static String[] timeZoneNameOptions(JSContext context) {
      return context.getEcmaScriptVersion() >= 13
         ? new String[]{"short", "long", "shortOffset", "longOffset", "shortGeneric", "longGeneric"}
