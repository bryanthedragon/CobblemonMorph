...
import com.oracle.truffle.api.impl.asm.tree.analysis.BasicInterpreter;
import com.oracle.truffle.api.impl.asm.tree.analysis.BasicValue;
...
extends BasicInterpreter {
    ...
    @Override
    public BasicValue copyOperation(AbstractInsnNode insn, BasicValue value2) throws AnalyzerException {
        BasicValue expected;
        switch (insn.getOpcode()) {
            ...
            case 25: {
                if (!value2.isReference()) {
                    throw new AnalyzerException(insn, null, "an object reference", value2);
                }
                return value2;
            }
            case 58: {
                if (!value2.isReference() && !BasicValue.RETURNADDRESS_VALUE.equals(value2)) {
                    throw new AnalyzerException(insn, null, "an object reference or a return address", value2);
                }
                return value2;
            }
            default: {
        ...
        if (!((Object)expected).equals(value2)) {
            throw new AnalyzerException(insn, null, expected, value2);
        }
        return value2;
    }
    ...
    public BasicValue unaryOperation(AbstractInsnNode insn, BasicValue value2) throws AnalyzerException {
        ...
        switch (insn.getOpcode()) {
            ...
            case 190: {
                if (!this.isArrayValue(value2)) {
                    throw new AnalyzerException(insn, null, "an array reference", value2);
                }
        ...
        if (!this.isSubTypeOf(value2, expected)) {
            throw new AnalyzerException(insn, null, expected, value2);
        }
        return super.unaryOperation(insn, value2);
    }
    ...
    public void returnOperation(AbstractInsnNode insn, BasicValue value2, BasicValue expected) throws AnalyzerException {
        if (!this.isSubTypeOf(value2, expected)) {
            throw new AnalyzerException(insn, "Incompatible return type", expected, value2);
        }
    }

    protected boolean isArrayValue(BasicValue value2) {
        return value2.isReference();
    }
    ...
    protected boolean isSubTypeOf(BasicValue value2, BasicValue expected) {
