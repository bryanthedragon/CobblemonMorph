...
public class MaractusModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BimanualFrame {
   ...
   init {
      ...
      this.cryAnimation = MaractusModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "maractus", "ground_idle", null, 4, null)
            },
            null,
      ...
      val var8: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "maractus", "ground_idle", null, 4, null),
         new BimanualSwingAnimation(this, 0.75F, 0.0F, 4, null)
      };
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: MaractusModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
