    ...
    private Object executeAndSpecialize(Object arguments0Value) {
        ...
        try {
            ...
            if (arguments0Value instanceof Integer) {
                ...
                lock.unlock();
                hasLock = false;
                Integer n = FloorNode.floorInt(arguments0Value_);
                return n;
            }
            if (arguments0Value instanceof SafeInteger) {
                ...
                lock.unlock();
                hasLock = false;
                SafeInteger safeInteger = FloorNode.floorSafeInt(arguments0Value_);
                return safeInteger;
            }
            if (exclude == 0 && (doubleCast0 = JSTypesGen.specializeImplicitDouble(arguments0Value)) != 0) {
                ...
                lock.unlock();
                hasLock = false;
                Object object = FloorNode.floorDouble(arguments0Value_, this.isZero, this.fitsInt, this.fitsSafeLong, this.smaller);
                return object;
            }
            this.isZero = this.isZero == null ? ConditionProfile.createBinaryProfile() : this.isZero;
            this.fitsInt = this.fitsInt == null ? ConditionProfile.createBinaryProfile() : this.fitsInt;
            ...
            lock.unlock();
            hasLock = false;
            Object object = this.floorToDouble(arguments0Value, this.isZero, this.fitsInt, this.fitsSafeLong, this.smaller);
            return object;
        }
        finally {
            if (hasLock) {
