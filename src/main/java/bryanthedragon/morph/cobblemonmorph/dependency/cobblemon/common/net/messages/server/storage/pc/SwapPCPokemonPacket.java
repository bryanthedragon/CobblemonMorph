...
public class SwapPCPokemonPacket(pokemon1ID: UUID, position1: PCPosition, pokemon2ID: UUID, position2: PCPosition) : NetworkPacket<SwapPCPokemonPacket> {
   public open val id: ResourceLocation
   public final val pokemon1ID: UUID
   public final val pokemon2ID: UUID
   public final val position1: PCPosition
   public final val position2: PCPosition
   ...
   public companion object {
      ...
      public fun decode(buffer: FriendlyByteBuf): SwapPCPokemonPacket {
         val var10002: UUID = buffer.m_130259_();
         val var10003: PCPosition = PCPosition.Companion.readPCPosition(buffer);
         val var10004: UUID = buffer.m_130259_();
         return new SwapPCPokemonPacket(var10002, var10003, var10004, PCPosition.Companion.readPCPosition(buffer));
      }
   }
}
