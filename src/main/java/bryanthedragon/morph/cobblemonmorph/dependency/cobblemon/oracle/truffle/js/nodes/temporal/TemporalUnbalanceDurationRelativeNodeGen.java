...
@GeneratedBy(value=TemporalUnbalanceDurationRelativeNode.class)
public final class TemporalUnbalanceDurationRelativeNodeGen
extends TemporalUnbalanceDurationRelativeNode
implements Introspection.Provider {
    @CompilerDirectives.CompilationFinal
    private volatile int state_0_;
    @Node.Child
    private UnbalanceDurationRelativeData unbalanceDurationRelative_cache;
    ...
    public JSTemporalDurationRecord execute(double arg0Value, double arg1Value, double arg2Value, double arg3Value, TemporalUtil.Unit arg4Value, JSDynamicObject arg5Value) {
        UnbalanceDurationRelativeData s0_;
        int state_0 = this.state_0_;
        if ((state_0 & 1) != 0 && (s0_ = this.unbalanceDurationRelative_cache) != null) {
            return this.unbalanceDurationRelative(arg0Value, arg1Value, arg2Value, arg3Value, arg4Value, arg5Value, s0_.unitIsYear_, s0_.unitIsWeek_, s0_.unitIsMonth_, s0_.relativeToAvailable_, s0_.toTemporalDateNode_);
        }
    ...
    private JSTemporalDurationRecord executeAndSpecialize(double arg0Value, double arg1Value, double arg2Value, double arg3Value, TemporalUtil.Unit arg4Value, JSDynamicObject arg5Value) {
        ...
        try {
            int state_0 = this.state_0_;
            UnbalanceDurationRelativeData s0_ = super.insert(new UnbalanceDurationRelativeData());
            ...
            lock.unlock();
            hasLock = false;
            JSTemporalDurationRecord jSTemporalDurationRecord = this.unbalanceDurationRelative(arg0Value, arg1Value, arg2Value, arg3Value, arg4Value, arg5Value, s0_.unitIsYear_, s0_.unitIsWeek_, s0_.unitIsMonth_, s0_.relativeToAvailable_, s0_.toTemporalDateNode_);
    ...
    public Introspection getIntrospectionData() {
        ...
        s[0] = "unbalanceDurationRelative";
        if ((state_0 & 1) != 0) {
            s[1] = (byte)1;
            ArrayList<List<Cloneable>> cached = new ArrayList<List<Cloneable>>();
            UnbalanceDurationRelativeData s0_ = this.unbalanceDurationRelative_cache;
            if (s0_ != null) {
    ...
    @GeneratedBy(value=TemporalUnbalanceDurationRelativeNode.class)
    private static final class UnbalanceDurationRelativeData
    extends Node {
        @CompilerDirectives.CompilationFinal
