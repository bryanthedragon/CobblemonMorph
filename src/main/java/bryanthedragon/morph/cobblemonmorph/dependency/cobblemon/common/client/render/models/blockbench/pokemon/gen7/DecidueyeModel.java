...
public class DecidueyeModel(root: ModelPart) : PokemonPoseableModel, HeadedFrame, BipedFrame, BiWingedFrame {
   ...
   init {
      ...
      this.cryAnimation = DecidueyeModel::cryAnimation$lambda$0;
   }
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: DecidueyeModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
