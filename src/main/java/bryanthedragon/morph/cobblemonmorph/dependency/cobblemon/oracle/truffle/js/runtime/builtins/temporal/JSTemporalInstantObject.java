...
extends JSNonProxyObject {
    ...
    final LocalDate asDate() {
        LocalDate ld = LocalDate.ofInstant((Instant)this.asInstant(), (ZoneId)this.asTimeZone());
        return ld;
    }
    ...
    final LocalTime asTime() {
        LocalTime lt = LocalTime.ofInstant((Instant)this.asInstant(), (ZoneId)this.asTimeZone());
        return lt;
    }
}
