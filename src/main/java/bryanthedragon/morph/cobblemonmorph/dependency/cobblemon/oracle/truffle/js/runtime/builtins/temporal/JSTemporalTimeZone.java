...
public final class JSTemporalTimeZone
extends JSNonProxy
...
PrototypeSupplier {
    ...
    public static JSTemporalTimeZoneObject create(JSContext context, BigInt nanoseconds, TruffleString identifier) {
        ...
        return JSTemporalTimeZone.create(context, realm, nanoseconds, identifier);
    }
    ...
    public JSDynamicObject createPrototype(JSRealm realm, JSFunctionObject constructor) {
        ...
        JSObjectUtil.putBuiltinAccessorProperty(prototype, TemporalConstants.ID, realm.lookupAccessor(TemporalTimeZonePrototypeBuiltins.BUILTINS, TemporalConstants.ID));
