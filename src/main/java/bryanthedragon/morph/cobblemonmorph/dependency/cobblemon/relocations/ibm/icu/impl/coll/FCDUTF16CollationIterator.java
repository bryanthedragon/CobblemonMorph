   ...
   public boolean equals(Object other) {
      if (other instanceof CollationIterator && this.equals(other) && other instanceof FCDUTF16CollationIterator) {
         ...
         if (this.checkDir != o.checkDir) {
            ...
            return this.checkDir == 0 && this.seq != this.rawSeq
               ? this.segmentStart - 0 == o.segmentStart - 0 && this.pos - this.start == o.pos - o.start
               : this.pos - 0 == o.pos - 0;
         }
      } else {
         return false;
      ...
      while (true) {
         ...
         if (this.checkDir > 0) {
            ...
            if (CollationFCD.hasTccc(c)
               && (CollationFCD.maybeTibetanCompositeVowel(c) || this.pos != this.limit && CollationFCD.hasLccc(this.seq.charAt(this.pos)))) {
               this.pos--;
               this.nextSegment();
               c = this.seq.charAt(this.pos++);
            }
      ...
      while (true) {
         ...
         if (this.checkDir < 0) {
            ...
            if (CollationFCD.hasLccc(c)
               && (CollationFCD.maybeTibetanCompositeVowel(c) || this.pos != this.start && CollationFCD.hasTccc(this.seq.charAt(this.pos - 1)))) {
               this.pos++;
