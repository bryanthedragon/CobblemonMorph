...
import com.cobblemon.mod.relocations.ibm.icu.text.ReplaceableContextIterator;
...
extends Transliterator {
    ...
    protected synchronized void handleTransliterate(Replaceable text, Transliterator.Position offsets, boolean isIncremental) {
        ...
        for (int start2 = offsets.start - 1; start2 >= offsets.contextStart; start2 -= UTF16.getCharCount(c)) {
            c = text.char32At(start2);
