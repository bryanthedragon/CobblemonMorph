...
public abstract class BlockScopeNode extends NamedEvaluationTargetNode implements RepeatingNode {
   ...
   public static BlockScopeNode create(
      ...
      return new BlockScopeNode.FrameBlockScopeNode(
         block,
         blockScopeSlot.getIndex(),
         frameDescriptor,
         parentSlot.getIndex(),
         functionBlock,
   ...
   public static BlockScopeNode createVirtual(JavaScriptNode block, int frameStart, int frameEnd) {
      return new BlockScopeNode.VirtualBlockScopeNode(block, frameStart, frameEnd);
   }
   ...
   public Object execute(VirtualFrame frame) {
      Object var2;
      try {
         var2 = this.block.execute(this.appendScopeFrame(frame));
      } finally {
   ...
   public boolean executeRepeating(VirtualFrame frame) {
      boolean var2;
      try {
         var2 = ((RepeatingNode)this.block).executeRepeating(this.appendScopeFrame(frame));
      } finally {
         this.exitScope(frame);
      }
   ...
   public Object executeWithName(VirtualFrame frame, Object name) {
      Object var3;
      try {
         var3 = ((NamedEvaluationTargetNode)this.block).executeWithName(this.appendScopeFrame(frame), name);
      } finally {
         this.exitScope(frame);
      }
   ...
   public static class FrameBlockScopeNode extends BlockScopeNode implements ResumableNode.WithObjectState, FrameDescriptorProvider {
      ...
      public InstrumentableNode materializeInstrumentableNodes(Set<Class<? extends Tag>> materializedTags) {
         if (materializedTags.contains(JSTags.DeclareTag.class) && !DeclareTagProvider.isMaterializedFrameProvider(this)) {
            JavaScriptNode materialized = DeclareTagProvider.createMaterializedBlockNode(
               this,
   ...
   public static class VirtualBlockScopeNode extends BlockScopeNode implements ResumableNode {
      ...
      public Object resume(VirtualFrame frame, int stateSlot) {
         ...
         Object e;
         try {
            e = this.block.execute(this.appendScopeFrame(frame));
      ...
      @Override
      protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
         return new BlockScopeNode.VirtualBlockScopeNode(cloneUninitialized(this.block, materializedTags), this.start, this.end);
      }
   }
}
