...
BipedFrame {
    ...
    public GrimmsnarlModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "grimmsnarl");
        this.head = this.getPart("head");
        this.leftLeg = this.getPart("leg_left");
        this.rightLeg = this.getPart("leg_right");
        this.portraitScale = 1.97f;
        this.portraitTranslation = new Vec3(-0.42, 2.38, 0.0);
        this.profileScale = 0.52f;
        this.profileTranslation = new Vec3(0.06, 0.97, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> GrimmsnarlModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ GrimmsnarlModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "grimmsnarl", "blink", null, 4, null);
            }
        }, 7, null);
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, Float.valueOf(0.5f), Float.valueOf(0.1f), null, null, null, null, 975, null), PoseableEntityModel.bedrock$default(this, "grimmsnarl", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, Float.valueOf(0.5f), Float.valueOf(0.1f), null, null, null, null, 975, null), PoseableEntityModel.bedrock$default(this, "grimmsnarl", "ground_idle", null, 4, null), new BipedWalkAnimation(this, 0.6f, 0.9f)};
        objectArray = statelessAnimationArray;
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(GrimmsnarlModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "grimmsnarl", "cry", null, 4, null);
    }
}
