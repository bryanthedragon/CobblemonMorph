...
public final class RegExpStringIteratorPrototypeBuiltins
   extends JSBuiltinsContainer.SwitchEnum<RegExpStringIteratorPrototypeBuiltins.RegExpStringIteratorPrototype> {
   ...
   protected RegExpStringIteratorPrototypeBuiltins() {
      super(JSString.REGEXP_ITERATOR_PROTOTYPE_NAME, RegExpStringIteratorPrototypeBuiltins.RegExpStringIteratorPrototype.class);
   }
   ...
   protected Object createNode(
      ...
      boolean construct,
      boolean newTarget,
      RegExpStringIteratorPrototypeBuiltins.RegExpStringIteratorPrototype builtinEnum
   ) {
      switch (builtinEnum) {
         case next:
            return RegExpStringIteratorPrototypeBuiltinsFactory.RegExpStringIteratorNextNodeGen.create(
   ...
   public abstract static class RegExpStringIteratorNextNode extends RegExpPrototypeBuiltins.RegExpPrototypeSymbolOperation {
      @Node.Child
      ...
      protected JSDynamicObject doRegExpStringIterator(VirtualFrame frame, JSDynamicObject iterator) {
         ...
         if (done) {
            ...
            if (this.noMatchProfile.profile(match == Null.instance)) {
               ...
               return this.getCreateIterResultObjectNode().execute(frame, Undefined.instance, true);
            } else if (this.globalProfile.profile(global)) {
   ...
   public static enum RegExpStringIteratorPrototype implements BuiltinEnum<RegExpStringIteratorPrototypeBuiltins.RegExpStringIteratorPrototype> {
      next(0);
