...
GuiEventListener {
    ...
    @NotNull
    private static final ResourceLocation frameResource = MiscUtils.cobblemonResource("textures/gui/dialogue/dialogue_face.png");
    @NotNull
    private static final ResourceLocation frameBackground = MiscUtils.cobblemonResource("textures/gui/dialogue/dialogue_face_background.png");
