...
public final class GraalJSParserHelper {
   ...
   public static FunctionNode parseScript(
      JSContext context,
   ...
   private static FunctionNode parseSource(
      JSContext context,
      Source truffleSource,
      JSParserOptions parserOptions,
      boolean parseModule,
      ...
      CompilerAsserts.neverPartOfCompilation("do not parse from compiled code");
      CharSequence code;
   ...
   private static Parser createParser(
      JSContext context, ScriptEnvironment env, com.oracle.js.parser.Source source, ErrorManager errors, JSParserOptions parserOptions
   ) {
            ...
            if (lexerToken instanceof Lexer.RegexToken) {
               ...
               if (context.getContextOptions().isValidateRegExpLiterals()) {
                  try {
                     ...
                     throw this.error(var4.getRawMessage());
                  }
               }
            }
         }
   ...
   public static void checkFunctionSyntax(
   ...
   public static String parseToJSON(String code, String name, boolean includeLoc, JSParserOptions parserOptions) {
      ...
      try {
         ...
         throw Errors.createSyntaxError(var6.getMessage());
      }
   }
}
