...
public final class Value extends AbstractValue {
   ...
   public Value execute(Object... arguments) {
      return arguments.length == 0 ? this.dispatch.execute(this.context, this.receiver) : this.dispatch.execute(this.context, this.receiver, arguments);
   }
   ...
   public Value invokeMember(String identifier, Object... arguments) {
      ...
      return arguments.length == 0
         ? this.dispatch.invoke(this.context, this.receiver, identifier)
         : this.dispatch.invoke(this.context, this.receiver, identifier, arguments);
   }
   ...
   public <T> T as(Class<T> targetType) throws ClassCastException, IllegalStateException, PolyglotException {
      ...
      return (T)(targetType == Value.class ? this : this.dispatch.as(this.context, this.receiver, targetType));
   }
   ...
   public Context getContext() {
      ...
      return c != null && c.currentAPI != null ? c.currentAPI : c;
   }
   ...
   public static Value asValue(Object o) {
      return o instanceof Value ? (Value)o : Engine.getImpl().asValue(o);
   }
