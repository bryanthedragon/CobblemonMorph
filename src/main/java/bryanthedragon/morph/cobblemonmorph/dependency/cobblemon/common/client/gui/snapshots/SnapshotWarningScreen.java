...
package bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.client.gui.snapshots;
...
public class SnapshotWarningScreen(consumer: (Acknowledgement, Boolean) -> Unit) : Screen(TITLE) {
    ...
    private dontShowAgain = OptionInstance.createBoolean("cobblemon\$snapshots\$dont_show_again", false);
    ...
    init() {
        ...
        helper.addChild(Checkbox.builder(Component.translatable("cobblemon.snapshots.warning.dont_show_again"), Minecraft.getInstance().font).selected(dontShowAgain).tooltip(Tooltip.create(DONT_SHOW_AGAIN_TIP)).build(), 2, settings);
