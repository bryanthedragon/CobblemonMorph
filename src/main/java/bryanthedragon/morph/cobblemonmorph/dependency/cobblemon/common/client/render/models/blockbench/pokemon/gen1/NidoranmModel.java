...
public class NidoranmModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame, QuadrupedFrame {
    ...
    override val cryAnimation = CryProvider { bedrockStateful("nidoranm", "cry") }
