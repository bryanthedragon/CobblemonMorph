...
import com.cobblemon.mod.relocations.ibm.icu.util.STZInfo;
...
extends BasicTimeZone {
    ...
    public void setStartRule(int month, int dayOfMonth, int dayOfWeek, int time, boolean after2) {
        if (this.isFrozen()) {
            throw new UnsupportedOperationException("Attempt to modify a frozen SimpleTimeZone instance.");
        }
        this.getSTZInfo().setStart(month, -1, dayOfWeek, time, dayOfMonth, after2);
        this.setStartRule(month, after2 ? dayOfMonth : -dayOfMonth, -dayOfWeek, time, 0);
    }
    ...
    public void setEndRule(int month, int dayOfMonth, int dayOfWeek, int time, boolean after2) {
        if (this.isFrozen()) {
            throw new UnsupportedOperationException("Attempt to modify a frozen SimpleTimeZone instance.");
        }
        this.getSTZInfo().setEnd(month, -1, dayOfWeek, time, dayOfMonth, after2);
        this.setEndRule(month, dayOfMonth, dayOfWeek, time, 0, after2);
    }

    private void setEndRule(int month, int dayOfMonth, int dayOfWeek, int time, int mode, boolean after2) {
        assert (!this.isFrozen());
        this.setEndRule(month, after2 ? dayOfMonth : -dayOfMonth, -dayOfWeek, time, mode);
    }
