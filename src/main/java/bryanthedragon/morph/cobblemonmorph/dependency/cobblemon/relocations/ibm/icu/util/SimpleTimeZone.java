...
public class SimpleTimeZone extends BasicTimeZone {
   ...
   public SimpleTimeZone(
      int rawOffset, String ID, int startMonth, int startDay, int startDayOfWeek, int startTime, int endMonth, int endDay, int endDayOfWeek, int endTime
   ) {
      super(ID);
   ...
   public SimpleTimeZone(
      ...
      super(ID);
      this.construct(
         rawOffset, startMonth, startDay, startDayOfWeek, startTime, startTimeMode, endMonth, endDay, endDayOfWeek, endTime, endTimeMode, dstSavings
      );
   }
      ...
      if ((era == 1 || era == 0)
         ...
         if (this.useDaylight && year >= this.startYear && era == 1) {
            ...
            int startCompare = this.compareToRule(
               ...
               dayOfWeek,
               millis,
               this.startTimeMode == 2 ? -this.raw : 0,
               this.startMode,
               this.startMonth,
               this.startDayOfWeek,
               this.startDay,
            ...
            if (southern != startCompare >= 0) {
               endCompare = this.compareToRule(
                  ...
                  dayOfWeek,
                  millis,
                  this.endTimeMode == 0 ? this.dst : (this.endTimeMode == 2 ? -this.raw : 0),
                  this.endMode,
                  this.endMonth,
                  this.endDayOfWeek,
                  this.endDay,
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return this.raw == that.raw
            ...
            && this.idEquals(this.getID(), that.getID())
            && (
               !this.useDaylight
                  || this.dst == that.dst
   ...
   public int hashCode() {
      ...
      if (!this.useDaylight) {
         ret += this.dst
            ^ (this.dst >>> 10) + this.startMode
            ^ (this.startMode >>> 11) + this.startMonth
            ^ (this.startMonth >>> 12) + this.startDay
            ^ (this.startDay >>> 13) + this.startDayOfWeek
            ^ (this.startDayOfWeek >>> 14) + this.startTime
            ^ (this.startTime >>> 15) + this.startTimeMode
            ^ (this.startTimeMode >>> 16) + this.endMode
            ^ (this.endMode >>> 17) + this.endMonth
            ^ (this.endMonth >>> 18) + this.endDay
            ^ (this.endDay >>> 19) + this.endDayOfWeek
            ^ (this.endDayOfWeek >>> 20) + this.endTime
            ^ (this.endTime >>> 21) + this.endTimeMode
            ^ (this.endTimeMode >>> 22) + this.startYear
            ^ this.startYear >>> 23;
      }
   ...
   public boolean hasSameRules(TimeZone othr) {
      if (this == othr) {
         ...
         return other != null
            && this.raw == other.raw
            && this.useDaylight == other.useDaylight
            && (
               !this.useDaylight
                  || this.dst == other.dst
      ...
      if (!this.useDaylight) {
         ...
         if (base >= firstTransitionTime && (!inclusive || base != firstTransitionTime)) {
            ...
            if (stdDate == null || dstDate != null && !stdDate.before(dstDate)) {
               return dstDate == null || stdDate != null && !dstDate.before(stdDate)
                  ? null
                  : new TimeZoneTransition(dstDate.getTime(), this.stdRule, this.dstRule);
            } else {
      ...
      if (!this.useDaylight) {
         ...
         if (base >= firstTransitionTime && (inclusive || base != firstTransitionTime)) {
            ...
            if (stdDate == null || dstDate != null && !stdDate.after(dstDate)) {
               return dstDate == null || stdDate != null && !dstDate.after(stdDate)
                  ? null
                  : new TimeZoneTransition(dstDate.getTime(), this.stdRule, this.dstRule);
            } else {
               return new TimeZoneTransition(stdDate.getTime(), this.dstRule, this.stdRule);
