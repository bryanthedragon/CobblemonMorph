...
final class SafeIntegerGen {
   ...
   static {
      LibraryExport.register(SafeInteger.class, new SafeIntegerGen.InteropLibraryExports());
   }

   @GeneratedBy(SafeInteger.class)
   private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
      static final FinalBitSet ENABLED_MESSAGES = createMessageBitSet(
         SafeIntegerGen.INTEROP_LIBRARY_, "hasLanguage", "getLanguage", "toDisplayString", "hasMetaObject", "getMetaObject"
      );
      private static final SafeIntegerGen.InteropLibraryExports.Uncached UNCACHED = new SafeIntegerGen.InteropLibraryExports.Uncached();
      ...
      protected InteropLibrary createUncached(Object receiver) {
         ...
         return createDelegate(SafeIntegerGen.INTEROP_LIBRARY_, UNCACHED);
      }

      protected InteropLibrary createCached(Object receiver) {
         assert receiver instanceof SafeInteger;

         return createDelegate(SafeIntegerGen.INTEROP_LIBRARY_, new SafeIntegerGen.InteropLibraryExports.Cached(receiver));
      }
      ...
      private static final class Cached extends InteropLibrary implements LibraryExport.DelegateExport {
         ...
         protected Cached(Object receiver) {
            ...
            this.receiverValueInteropLibrary_ = super.insert(SafeIntegerGen.INTEROP_LIBRARY_.create(castReceiver.value));
         }

         @Override
         public FinalBitSet getDelegateExportMessages() {
            return SafeIntegerGen.InteropLibraryExports.ENABLED_MESSAGES;
         }
         ...
         public boolean accepts(Object receiver) {
            assert !(receiver instanceof SafeInteger) || SafeIntegerGen.DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";

            return !(receiver instanceof SafeInteger) ? false : this.receiverValueInteropLibrary_.accepts(((SafeInteger)receiver).value);
         }
      ...
      private static final class Uncached extends InteropLibrary implements LibraryExport.DelegateExport {
         ...
         public Library getDelegateExportLibrary(Object delegate_) {
            return SafeIntegerGen.INTEROP_LIBRARY_.getUncached(delegate_);
         }
