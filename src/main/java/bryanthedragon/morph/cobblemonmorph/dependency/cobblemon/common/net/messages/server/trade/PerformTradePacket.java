...
public class PerformTradePacket(val pokemonOfferId: UUID) : NetworkPacket<PerformTradePacket> {
    final class Companion {
        val ID = cobblemonResource("perform_trade")
        fun decode(RegistryFriendlyByteBuf buffer) = PerformTradePacket(buffer.readUUID())
    }
