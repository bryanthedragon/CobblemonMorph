...
public class FloatRange(override val start: Float, override val endInclusive: Float) : ClosedFloatingPointRange<Float> {
...
public class DoubleRange(override val start: Double, override val endInclusive: Double) : ClosedFloatingPointRange<Double> {
...
operator fun Matrix3f.times(Vec3 vec3d): Vec3 {
    val vec3f = Vector3f()
