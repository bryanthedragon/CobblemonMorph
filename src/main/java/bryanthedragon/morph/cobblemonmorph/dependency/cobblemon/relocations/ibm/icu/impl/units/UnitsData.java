...
public class UnitsData {
   ...
   public String getCategory(MeasureUnitImpl measureUnit) {
      ...
      Integer index = UnitsData.Categories.baseUnitToIndex.get(identifier);
      if (index == null) {
         baseMeasureUnitImpl.takeReciprocal();
         baseMeasureUnitImpl.serialize();
         identifier = baseMeasureUnitImpl.getIdentifier();
         index = UnitsData.Categories.baseUnitToIndex.get(identifier);
      }
   ...
   static {
      ...
      UnitsData.SimpleUnitIdentifiersSink sink = new UnitsData.SimpleUnitIdentifiersSink();
   ...
   public static class Categories {
      ...
      static {
         ICUResourceBundle resource = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", "units");
         UnitsData.CategoriesSink sink = new UnitsData.CategoriesSink();
   ...
   public static class SimpleUnitIdentifiersSink extends UResource.Sink {
      ...
      public void put(UResource.Key key, UResource.Value value, boolean noFallback) {
         ...
         for (int ix = 0; ix < this.simpleUnitCategories.length; ix++) {
            this.simpleUnitCategories[ix] = iter.next();
         }
      }
   }
}
