...
extends PokemonPoseableModel {
    ...
    public ShellderModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "shellder");
        this.portraitScale = 2.2f;
        this.portraitTranslation = new Vec3(0.0, -1.7, 0.0);
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "shellder", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{PoseableEntityModel.bedrock$default(this, "shellder", "ground_idle", null, 4, null)};
