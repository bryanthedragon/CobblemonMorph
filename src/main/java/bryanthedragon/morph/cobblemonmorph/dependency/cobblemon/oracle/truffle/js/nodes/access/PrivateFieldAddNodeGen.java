...
public final class PrivateFieldAddNodeGen extends PrivateFieldAddNode implements Introspection.Provider {
   ...
   @Node.Child
   private PrivateFieldAddNodeGen.FieldAdd0Data fieldAdd0_cache;
      ...
      if (state_0 != 0) {
         if ((state_0 & 3) != 0 && arg0Value instanceof JSObject) {
            ...
            if (arg1Value instanceof HiddenKey) {
               ...
               if ((state_0 & 1) != 0) {
                  for (PrivateFieldAddNodeGen.FieldAdd0Data s0_ = this.fieldAdd0_cache; s0_ != null; s0_ = s0_.next_) {
         ...
         if ((state_0 & 4) != 0 && fallbackGuard_(state_0, arg0Value, arg1Value, arg2Value)) {
      ...
      try {
         ...
         if (arg0Value instanceof JSObject) {
            ...
            if (arg1Value instanceof HiddenKey) {
               ...
               if (exclude == 0) {
                  int count0_ = 0;
                  PrivateFieldAddNodeGen.FieldAdd0Data s0_ = this.fieldAdd0_cache;
                  if ((state_0 & 1) != 0) {
                  ...
                  if (s0_ == null && count0_ < 3) {
                     s0_ = super.insert(new PrivateFieldAddNodeGen.FieldAdd0Data(this.fieldAdd0_cache));
   ...
   public Introspection getIntrospectionData() {
      ...
      int state_0 = this.state_0_;
      int exclude = this.exclude_;
      Object[] s = new Object[]{"doFieldAdd", null, null};
      if ((state_0 & 1) != 0) {
         s[1] = (byte)1;
      ...
      data[1] = s;
      s = new Object[]{"doFieldAdd", null, null};
      if ((state_0 & 2) != 0) {
         s[1] = (byte)1;
         ArrayList<Object> cached = new ArrayList<>();
   ...
   private static final class FieldAdd0Data extends Node {
      @Node.Child
      PrivateFieldAddNodeGen.FieldAdd0Data next_;
      @Node.Child
      DynamicObjectLibrary access_;

      FieldAdd0Data(PrivateFieldAddNodeGen.FieldAdd0Data next_) {
         this.next_ = next_;
      }
