...
public class StringExtensions {    
    ...
    MutableList<Pair<String, String?>> String.splitMap(String delimiter,String assigner)  {
    ...
    Either<ResourceLocation, TagKey<T>> <T, U : Registry<T>> String.asIdentifierOrTag(ResourceKey<U> resourceKey) {
    ...
    Boolean String.isLaterVersion(String otherVersion) {
