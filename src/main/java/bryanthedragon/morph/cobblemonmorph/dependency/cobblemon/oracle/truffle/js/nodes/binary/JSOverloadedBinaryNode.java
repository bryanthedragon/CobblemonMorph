...
public abstract class JSOverloadedBinaryNode extends JavaScriptBaseNode {
   ...
   protected Object doToOperandGeneric(
      ...
      @Cached("create(getOverloadedOperatorName())") JSOverloadedBinaryNode.DispatchBinaryOperatorNode dispatchBinaryOperatorNode
   ) {
      Object leftOperand;
      Object rightOperand;
      if (this.leftToRight) {
   ...
   @Specialization(guards = {"!isNumeric()", "isAddition()"})
   protected Object doToOperandAddition(
      Object left,
      Object right,
      ...
      if (leftStringProfile.profile(JSGuards.isString(leftOperand))) {
         ...
         return rightStringProfile.profile(JSGuards.isString(rightOperand))
            ? addNode.execute(toStringLeftNode.executeString(leftOperand), rightOperand)
            : dispatchBinaryOperatorNode.execute(leftOperand, rightOperand);
      }
   }

   @Specialization(guards = "isNumeric()")
   protected Object doToNumericOperand(
      Object left,
      Object right,
   ...
   public abstract static class DispatchBinaryOperatorNode extends JavaScriptBaseNode {
      ...
      protected Object doOverloadedOverloaded(
         JSOverloadedOperatorsObject left,
         JSOverloadedOperatorsObject right,
         @Cached("left.getOperatorCounter()") int leftOperatorCounter,
         @Cached("right.getOperatorCounter()") int rightOperatorCounter,
      ...
      protected Object doOverloadedNumber(
         JSOverloadedOperatorsObject left,
         Object right,
         @Cached("left.getOperatorCounter()") int leftOperatorCounter,
         @Cached("getOperatorImplementation(left, right, getOverloadedOperatorName())") Object operatorImplementation,
      ...
      protected Object doOverloadedBigInt(
         JSOverloadedOperatorsObject left,
         BigInt right,
         @Cached("left.getOperatorCounter()") int leftOperatorCounter,
         @Cached("getOperatorImplementation(left, right, getOverloadedOperatorName())") Object operatorImplementation,
      ...
      protected Object doOverloadedString(
         JSOverloadedOperatorsObject left,
         Object right,
         @Cached("left.getOperatorCounter()") int leftOperatorCounter,
         @Cached("getOperatorImplementation(left, right, getOverloadedOperatorName())") Object operatorImplementation,
      ...
      protected Object doNumberOverloaded(
         Object left,
         JSOverloadedOperatorsObject right,
         @Cached("right.getOperatorCounter()") int rightOperatorCounter,
         @Cached("getOperatorImplementation(left, right, getOverloadedOperatorName())") Object operatorImplementation,
      ...
      protected Object doBigIntOverloaded(
         BigInt left,
         JSOverloadedOperatorsObject right,
         @Cached("right.getOperatorCounter()") int rightOperatorCounter,
         @Cached("getOperatorImplementation(left, right, getOverloadedOperatorName())") Object operatorImplementation,
      ...
      protected Object doStringOverloaded(
         Object left,
         JSOverloadedOperatorsObject right,
         @Cached("right.getOperatorCounter()") int rightOperatorCounter,
         @Cached("getOperatorImplementation(left, right, getOverloadedOperatorName())") Object operatorImplementation,
      ...
      protected Object doGeneric(Object left, Object right, @Cached("createCall()") JSFunctionCallNode callNode) {
      ...
      private Object performOverloaded(JSFunctionCallNode callNode, Object operatorImplementation, Object left, Object right) {
         return operatorImplementation == null
            ? this.missingImplementation()
            : callNode.executeCall(JSArguments.create(Undefined.instance, operatorImplementation, left, right));
      }
