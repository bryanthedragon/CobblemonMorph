...
import com.cobblemon.mod.relocations.ibm.icu.impl.number.LongNameMultiplexer;
...
import com.cobblemon.mod.relocations.ibm.icu.impl.number.SimpleModifier;
...
LongNameMultiplexer.ParentlessMicroPropsGenerator {
    ...
    private static String getGenderForBuiltin(ULocale locale, MeasureUnit builtinUnit) {
        ICUResourceBundle unitsBundle = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b/unit", locale);
    ...
    static void getMeasureData(ULocale locale, MeasureUnit unit, NumberFormatter.UnitWidth width, String unitDisplayCase, String[] outArray) {
        ...
        ICUResourceBundle metadataResource = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", "metadata");
    ...
    private static String getDeriveCompoundRule(ULocale locale, String feature, String structure) {
        ...
        ICUResourceBundle derivationsBundle = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/cobblemon/mod/relocations/ibm/icu/impl/data/icudt71b", "grammaticalFeatures");
    ...
    private static class DerivedComponents {
        ...
        DerivedComponents(ULocale locale, String feature, String structure) {
            try {
                ...
                String value2 = stackBundle.getString(0);
                this.value0 = value2.compareTo("compound") == 0 ? null : value2;
                value2 = stackBundle.getString(1);
                this.value1 = value2.compareTo("compound") == 0 ? null : value2;
            }
            catch (MissingResourceException missingResourceException) {
                // empty catch block
            }
    ...
    extends UResource.Sink {
        ...
        public void put(UResource.Key key, UResource.Value value2, boolean noFallback) {
            UResource.Table aliasTable = value2.getTable();
            int i = 0;
            while (aliasTable.getKeyAndValue(i, key, value2)) {
                String keyString = key.toString();
                if (keyString.equals("replacement")) {
                    this.replacement = value2.toString();
                }
                ++i;
            }
        }
    ...
    extends UResource.Sink {
        ...
        public void put(UResource.Key key, UResource.Value value2, boolean noFallback) {
            ...
            int i = 0;
            while (pluralsTable.getKeyAndValue(i, key, value2)) {
                int index;
                String keyString = key.toString();
                if (!keyString.equals("case") && this.outArray[index = LongNameHandler.getIndex(keyString)] == null) {
                    String formatString;
                    this.outArray[index] = formatString = value2.getString();
                }
                ++i;
            }
        }
    ...
    extends UResource.Sink {
        ...
        public void put(UResource.Key key, UResource.Value value2, boolean noFallback) {
            ...
            while (pluralsTable.getKeyAndValue(i, key, value2)) {
                ...
                if (this.outArray[pluralIndex] == null && this.loadForPluralForm(genderTable = value2.getTable(), value2)) {
                    this.outArray[pluralIndex] = value2.getString();
                }
                ++i;
            }
        }

        private boolean loadForPluralForm(UResource.Table genderTable, UResource.Value value2) {
            if (this.gender != null && !this.gender.isEmpty()) {
                if (this.loadForGender(genderTable, this.gender, value2)) {
                    return true;
                }
                if (this.gender != "neuter" && this.loadForGender(genderTable, "neuter", value2)) {
                    return true;
                }
            }
            return this.loadForGender(genderTable, "_", value2);
        }

        private boolean loadForGender(UResource.Table genderTable, String genderVal, UResource.Value value2) {
            if (!genderTable.findValue(genderVal, value2)) {
                return false;
            }
            UResource.Table caseTable = value2.getTable();
            if (this.caseVariant != null && !this.caseVariant.isEmpty()) {
                if (this.loadForCase(caseTable, this.caseVariant, value2)) {
                    return true;
                }
                if (this.caseVariant != "nominative" && this.loadForCase(caseTable, "nominative", value2)) {
                    return true;
                }
            }
            return this.loadForCase(caseTable, "_", value2);
        }

        private boolean loadForCase(UResource.Table caseTable, String caseValue, UResource.Value value2) {
            return caseTable.findValue(caseValue, value2);
        }
    }
