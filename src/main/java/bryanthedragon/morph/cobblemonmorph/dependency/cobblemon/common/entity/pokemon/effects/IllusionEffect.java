...
implements MocKEffect {
    ...
    public IllusionEffect(@NotNull PokemonProperties mock, float scale) {
        Intrinsics.checkNotNullParameter((Object)mock, (String)"mock");
        this.mock = mock;
        this.scale = scale;
    }

    public /* synthetic */ IllusionEffect(PokemonProperties pokemonProperties, float f, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 1) != 0) {
    ...
    public IllusionEffect(@NotNull Pokemon disguise) {
        Intrinsics.checkNotNullParameter((Object)disguise, (String)"disguise");
        this(disguise.createPokemonProperties(PokemonPropertyExtractor.ILLUSION), disguise.getForm().getBaseScale() * disguise.getScaleModifier());
    }
    ...
    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0007\u0010\bR\u001a\u0010\u0003\u001a\u00020\u00028\u0006X\u0086D\u00a2\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006\u00a8\u0006\t"}, d2={"Lcom/cobblemon/mod/common/entity/pokemon/effects/IllusionEffect$Companion;", "", "", "ID", "Ljava/lang/String;", "getID", "()Ljava/lang/String;", "<init>", "()V", "common"})
