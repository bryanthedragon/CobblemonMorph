...
BimanualFrame {
    ...
    public IncineroarModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "incineroar");
        this.head = this.getPart("head");
        this.leftArm = this.getPart("arm_left1");
        this.rightArm = this.getPart("arm_right1");
        this.leftLeg = this.getPart("leg_left1");
        this.rightLeg = this.getPart("leg_right1");
        this.portraitScale = 2.6f;
        this.portraitTranslation = new Vec3(-0.35, 1.9, 0.0);
        this.profileScale = 0.65f;
        this.profileTranslation = new Vec3(0.0, 0.76, 0.0);
        this.cryAnimation = (arg_0, arg_1) -> IncineroarModel.cryAnimation$lambda$0(this, arg_0, arg_1);
    }
    ...
    public void registerPoses() {
        SimpleQuirk blink7 = PoseableEntityModel.quirk$default(this, null, null, null, new Function1<PoseableEntityState<PokemonEntity>, StatefulAnimation<PokemonEntity, ?>>(this){
            final /* synthetic */ IncineroarModel this$0;
            {
            ...
            public final StatefulAnimation<PokemonEntity, ?> invoke(@NotNull PoseableEntityState<PokemonEntity> it) {
                ...
                return PoseableEntityModel.bedrockStateful$default(this.this$0, "incineroar", "blink", null, 4, null);
            }
        }, 7, null);
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "incineroar", "ground_idle", null, 4, null)};
        ...
        statelessAnimationArray = new StatelessAnimation[]{HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null), PoseableEntityModel.bedrock$default(this, "incineroar", "ground_idle", null, 4, null), new BipedWalkAnimation(this, 0.6f, 0.9f), new BimanualSwingAnimation(this, 0.6f, 0.9f)};
        objectArray = statelessAnimationArray;
    ...
    private static final StatefulAnimation cryAnimation$lambda$0(IncineroarModel this$0, PokemonEntity pokemonEntity, PoseableEntityState poseableEntityState) {
        ...
        return PoseableEntityModel.bedrockStateful$default(this$0, "incineroar", "cry", null, 4, null);
    }
}
