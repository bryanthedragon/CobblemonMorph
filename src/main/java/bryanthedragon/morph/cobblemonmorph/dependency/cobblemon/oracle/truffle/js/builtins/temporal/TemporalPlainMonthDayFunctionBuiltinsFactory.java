...
@GeneratedBy(TemporalPlainMonthDayFunctionBuiltins.class)
public final class TemporalPlainMonthDayFunctionBuiltinsFactory {
   @GeneratedBy(TemporalPlainMonthDayFunctionBuiltins.JSTemporalPlainMonthDayFromNode.class)
   public static final class JSTemporalPlainMonthDayFromNodeGen
      ...
      private JSDynamicObject executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
         ...
         try {
            ...
            lock.unlock();
            hasLock = false;
            var6 = this.from(arguments0Value, arguments1Value, this.toTemporalMonthDayNode_);
         } finally {
            if (hasLock) {
               lock.unlock();
            }
      ...
      public static TemporalPlainMonthDayFunctionBuiltins.JSTemporalPlainMonthDayFromNode create(
         JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments
      ) {
         return new TemporalPlainMonthDayFunctionBuiltinsFactory.JSTemporalPlainMonthDayFromNodeGen(context, builtin, arguments);
      }
   }
}
