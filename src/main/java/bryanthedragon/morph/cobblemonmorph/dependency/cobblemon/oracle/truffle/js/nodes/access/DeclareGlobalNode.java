...
@ImportStatic(value={JSGlobal.class})
public abstract class DeclareGlobalNode
extends JavaScriptBaseNode {
    ...
    public abstract void executeVoid(VirtualFrame var1, JSContext var2, JSRealm var3);
    ...
    protected abstract DeclareGlobalNode copyUninitialized(Set<Class<? extends Tag>> var1);
}
