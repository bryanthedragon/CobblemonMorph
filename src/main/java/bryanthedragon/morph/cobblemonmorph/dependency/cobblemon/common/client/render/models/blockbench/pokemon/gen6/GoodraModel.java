...
public class GoodraModel(root: ModelPart) : PokemonPoseableModel, BipedFrame, BimanualFrame, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = GoodraModel::cryAnimation$lambda$0;
   }
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "goodra", "ground_idle", null, 4, null)
            },
            null,
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: GoodraModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
