...
public class SliggooHisuianModel(root: ModelPart) : PokemonPoseableModel, BimanualFrame, HeadedFrame {
   ...
   init {
      ...
      this.cryAnimation = SliggooHisuianModel::cryAnimation$lambda$0;
   }
   ...
   public override fun registerPoses() {
      ...
      this.setStanding(
         PoseableEntityModel.registerPose$default(
            ...
            new StatelessAnimation[]{
               ...
               PoseableEntityModel.bedrock$default(this, "sliggoo_hisuian", "ground_idle", null, 4, null)
            },
            null,
      ...
      val var8: Array<StatelessAnimation> = new StatelessAnimation[]{
         HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null),
         PoseableEntityModel.bedrock$default(this, "sliggoo_hisuian", "ground_idle", null, 4, null),
         new BimanualSwingAnimation(this, 0.4F, 1.0F)
      };
   ...
   @JvmStatic
   fun `cryAnimation$lambda$0`(`this$0`: SliggooHisuianModel, var1: PokemonEntity, var2: PoseableEntityState): StatefulAnimation {
