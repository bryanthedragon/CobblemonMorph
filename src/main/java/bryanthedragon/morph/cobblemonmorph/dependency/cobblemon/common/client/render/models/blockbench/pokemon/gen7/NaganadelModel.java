...
import bryanthedragon.morph.cobblemonmorph.dependency.cobblemon.common.client.render.models.blockbench.pokemon.gen7.NaganadelModel;
...
BiWingedFrame {
    ...
    public NaganadelModel(@NotNull ModelPart root) {
        Intrinsics.checkNotNullParameter((Object)root, (String)"root");
        this.rootPart = this.registerChildWithAllChildren(root, "naganadel");
        this.head = this.getPart("head");
        this.leftWing = this.getPart("wing_left");
        this.rightWing = this.getPart("wing_right");
        this.portraitScale = 2.0f;
        this.portraitTranslation = new Vec3(0.0, 4.3, 0.0);
        this.profileScale = 0.4f;
        this.profileTranslation = new Vec3(0.05, 1.3, 0.0);
    }
    ...
    public void registerPoses() {
        ...
        StatelessAnimation[] statelessAnimationArray = new StatelessAnimation[4];
        ...
        statelessAnimationArray[1] = PoseableEntityModel.bedrock$default(this, "naganadel", "ground_idle", null, 4, null);
        float f = -AngleExtensionsKt.toRadians(Float.valueOf(10.0f));
        statelessAnimationArray[2] = this.wingFlap((Function1<? super Float, Float>)WaveFunctionKt.sineFunction$default(0.4f, 0.9f, 0.0f, f, 4, null), registerPoses.1.INSTANCE, 1);
        statelessAnimationArray[3] = this.translation(this.getRootPart(), (Function1<Float, Float>)WaveFunctionKt.sineFunction$default(-3.0f, 0.9f, 0.0f, 0.0f, 12, null), 1, registerPoses.2.INSTANCE);
        ...
        statelessAnimationArray = new StatelessAnimation[4];
        statelessAnimationArray[0] = HeadedFrame.DefaultImpls.singleBoneLook$default(this, false, false, false, false, null, null, null, null, null, null, 1023, null);
        statelessAnimationArray[1] = PoseableEntityModel.bedrock$default(this, "naganadel", "ground_idle", null, 4, null);
        f = -AngleExtensionsKt.toRadians(Float.valueOf(10.0f));
        statelessAnimationArray[2] = this.wingFlap((Function1<? super Float, Float>)WaveFunctionKt.sineFunction$default(0.4f, 0.9f, 0.0f, f, 4, null), registerPoses.3.INSTANCE, 1);
        statelessAnimationArray[3] = this.translation(this.getRootPart(), (Function1<Float, Float>)WaveFunctionKt.sineFunction$default(-3.0f, 0.9f, 0.0f, 0.0f, 12, null), 1, registerPoses.4.INSTANCE);
