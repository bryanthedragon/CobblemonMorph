...
public final class ClearPartyCommand {
    ...
    public final void register(@NotNull CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        LiteralArgumentBuilder command = (LiteralArgumentBuilder)((LiteralArgumentBuilder)PermissionUtilsKt.permission$default((ArgumentBuilder)literalArgumentBuilder, CobblemonPermissions.INSTANCE.getCLEAR_PARTY(), false, 2, null)).then(Commands.m_82129_((String)PLAYER, (ArgumentType)((ArgumentType)EntityArgument.m_91470_())).executes(this::execute));
    ...
    private final int execute(CommandContext<CommandSourceStack> context) {
        ...
        List pokemonList = CollectionsKt.filterNotNull((Iterable)party);
        if (pokemonList.isEmpty()) {
            ...
            commandSourceStack.m_81352_((Component)LocalizationUtilsKt.commandLang("clearparty.nonethere", objectArray));
            return 0;
        }
        for (Pokemon pokemon : pokemonList) {
            party.remove(pokemon);
        }
        ((CommandSourceStack)context.getSource()).m_288197_(() -> ClearPartyCommand.execute$lambda$0(target), true);
        return 1;
    }
    ...
    private static final Component execute$lambda$0(ServerPlayer $target) {
        Object[] objectArray = new Object[1];
        Intrinsics.checkNotNullExpressionValue((Object)$target.m_5446_(), (String)"target.displayName");
        return (Component)LocalizationUtilsKt.commandLang("clearparty.cleared", objectArray);
    }
}
