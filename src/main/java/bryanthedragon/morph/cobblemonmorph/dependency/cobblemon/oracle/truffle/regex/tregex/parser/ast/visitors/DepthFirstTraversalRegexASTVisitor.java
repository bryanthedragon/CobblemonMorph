...
import com.oracle.truffle.regex.tregex.parser.ast.visitors.RegexASTVisitor;
import com.oracle.truffle.regex.tregex.parser.ast.visitors.RegexASTVisitorIterable;

public abstract class DepthFirstTraversalRegexASTVisitor
extends RegexASTVisitor {
    ...
    private boolean doAdvance() {
        ...
        if (this.cur instanceof RegexASTVisitorIterable) {
            return this.advance((RegexASTVisitorIterable)((Object)this.cur));
        }
        return this.advanceLeafNode(this.cur);
    }
    ...
    private boolean advance(RegexASTVisitorIterable iterable) {
        ...
        this.cur = ((RegexASTNode)((Object)iterable)).getParent();
        return true;
    }
