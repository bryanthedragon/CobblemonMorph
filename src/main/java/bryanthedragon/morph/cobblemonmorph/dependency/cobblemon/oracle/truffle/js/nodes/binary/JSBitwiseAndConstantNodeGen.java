...
@GeneratedBy(value=JSBitwiseAndConstantNode.class)
public final class JSBitwiseAndConstantNodeGen
extends JSBitwiseAndConstantNode
    ...
    public Object executeObject(Object operandNodeValue) {
        ...
        if ((state_0 & 0x300) != 0) {
            ...
            if ((state_0 & 0x100) != 0 && (s8_ = this.generic_cache) != null && !this.hasOverloadedOperators(operandNodeValue)) {
                assert (this.isInt);
                return this.doGeneric(operandNodeValue, s8_.toNumeric_, s8_.profileIsBigInt_, s8_.innerAndNode_);
            }
    ...
    private Object execute_generic2(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0x300) != 0) {
            ...
            if ((state_0 & 0x100) != 0 && (s8_ = this.generic_cache) != null && !this.hasOverloadedOperators(operandNodeValue_)) {
                assert (this.isInt);
                return this.doGeneric(operandNodeValue_, s8_.toNumeric_, s8_.profileIsBigInt_, s8_.innerAndNode_);
            }
    ...
    private Object executeAndSpecialize(Object operandNodeValue) {
        ...
        try {
            ...
            if (!this.hasOverloadedOperators(operandNodeValue) && this.isInt) {
                ...
                s8_.innerAndNode_ = s8_.insertAccessor(this.makeCopy());
                ...
                lock.unlock();
                hasLock = false;
                Object object = this.doGeneric(operandNodeValue, s8_.toNumeric_, s8_.profileIsBigInt_, s8_.innerAndNode_);
                return object;
            }
            if (!this.hasOverloadedOperators(operandNodeValue) && !this.isInt()) {
