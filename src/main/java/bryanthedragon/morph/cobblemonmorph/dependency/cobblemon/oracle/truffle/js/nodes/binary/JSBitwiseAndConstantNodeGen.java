...
public final class JSBitwiseAndConstantNodeGen extends JSBitwiseAndConstantNode implements Introspection.Provider {
   ...
   @Node.Child
   private JSBitwiseAndConstantNodeGen.GenericData generic_cache;
   @Node.Child
   ...
   public Object executeObject(Object operandNodeValue) {
      ...
      if ((state_0 & 1) != 0 && operandNodeValue instanceof Integer) {
         ...
         if ((state_0 & 768) != 0) {
            if ((state_0 & 256) != 0) {
               JSBitwiseAndConstantNodeGen.GenericData s8_ = this.generic_cache;
   ...
   private Object executeAndSpecialize(Object operandNodeValue) {
      ...
      try {
         ...
         if (operandNodeValue instanceof JSOverloadedOperatorsObject) {
            ...
            JSBitwiseAndConstantNodeGen.GenericData s8_ = super.insert(new JSBitwiseAndConstantNodeGen.GenericData());
